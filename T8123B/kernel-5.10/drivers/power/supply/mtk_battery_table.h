...
int g_Q_MAX[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	/*bat1,   bat2,   bat3,    bat4*/
	{ 2946, 2946, 2490, 1965},/*T0*/
	{ 2796, 2796, 2468, 1984},/*T1*/
	{ 2718, 2718, 2310, 1946},/*T2*/
	{ 2535, 2535, 1858, 1873},/*T3*/
	{ 2523, 2523, 1843, 1851},/*T4*/
...
int g_Q_MAX_H_CURRENT[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	/*bat1,   bat2,   bat3,    bat4*/
	{ 2646, 2646, 2190, 1665},/*T0*/
	{ 2496, 2496, 2168, 1684},/*T1*/
	{ 2418, 2418, 2010, 1646},/*T2*/
	{ 2235, 2235, 1558, 1573},/*T3*/
	{ 2223, 2223, 1543, 1551},/*T4*/
...
int g_PMIC_MIN_VOL[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	...
	{33001, 33001, 33009, 33004},/*T5*/
	{33002, 33002, 33008, 33003},/*T6*/
	{33003, 33003, 33007, 33002},/*T7*/
	{33004, 33004, 33006, 33001},/*T8*/
	{33005, 33005, 33005, 33000} /*T9*/
};
...
int g_QMAX_SYS_VOL[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	/*bat1,   bat2,   bat3,    bat4*/
	{32500, 32500, 32500, 32500},/*T0*/
	{32500, 32500, 32500, 32500},/*T1*/
	{32500, 32500, 32500, 32500},/*T2*/
	{32500, 32500, 32500, 32500},/*T3*/
	{32500, 32500, 32500, 32500},/*T4*/
	{32800, 32800, 32800, 32800},/*T5*/
	{32800, 32800, 32800, 32800},/*T6*/
	{32800, 32800, 32800, 32800},/*T7*/
	{32800, 32800, 32800, 32800},/*T8*/
	{32800, 32800, 32800, 32800} /*T9*/
};
...
#if (BAT_NTC_10 == 1)
struct fg_temp fg_temp_table[41] = {
		{-20,83061},
		{-18,74061},
		{-16,66273},
		{-14,59970},
