...
int mmc_send_ext_csd(struct mmc_card *card, u8 *ext_csd)
{
	...
	printk("ext_csd[185] HS Timing	   :0x%2x\n", ext_csd[185]);
	printk("ext_csd[183] Bus Width     :0x%2x\n", ext_csd[183]);
	printk("ext_csd[493] Support Mode  :0x%2x\n", ext_csd[493]);
	printk("ext_csd[169] FW Config     :0x%2x\n", ext_csd[169]);
	printk("ext_csd[26] FFU Status     :0x%2x\n", ext_csd[26]);
	printk("ext_csd[30] FFU Mode       :0x%2x\n", ext_csd[30]);
	printk("ext_csd[66,65] FFU error code       :0x%2x, 0x%2x\n", ext_csd[66],ext_csd[65]);
	printk("ext_csd[64] FFU type     :0x%2x\n", ext_csd[64]);
	printk("ext_csd[490~487] FFU Arg         :0x%2x %2x %2x %2x \n", ext_csd[490], ext_csd[489], ext_csd[488], ext_csd[487]);
	printk("ext_csd[305~302] FW Number Sector:0x%2x %2x %2x %2x \n", ext_csd[305], ext_csd[304], ext_csd[303], ext_csd[302]);
	printk("ext_csd[257~254] FW Version      :0x%2x %2x %2x %2x \n", ext_csd[257], ext_csd[256], ext_csd[255], ext_csd[254]);    
