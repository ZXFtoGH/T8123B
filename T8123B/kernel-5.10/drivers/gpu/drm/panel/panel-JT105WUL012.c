...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx, 0xC0, 0x50);
    ...
    lcm_dcs_write_seq_static(ctx, 0xB3, 0x04, 0xB0);
    lcm_dcs_write_seq_static(ctx, 0x00, 0xA3);
    lcm_dcs_write_seq_static(ctx, 0xB3, 0x07, 0x80);
    lcm_dcs_write_seq_static(ctx, 0x00, 0xA5);
    lcm_dcs_write_seq_static(ctx, 0xB3, 0x80, 0x13);
    ...
    lcm_dcs_write_seq_static(ctx, 0xC2, 0x40);
    lcm_dcs_write_seq_static(ctx, 0x00, 0x88);
    ...
    lcm_dcs_write_seq_static(ctx, 0xC5, 0x09);
    lcm_dcs_write_seq_static(ctx, 0x00, 0xB6);
    lcm_dcs_write_seq_static(ctx, 0xC5, 0x73, 0x73);
    lcm_dcs_write_seq_static(ctx, 0x00, 0xB8);
...
MODULE_DESCRIPTION("JT105WUL012 LCD Panel Driver");
