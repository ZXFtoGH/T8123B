...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx,0xE0,0x00,0x03,0x08,0x0D,0x12,0x18,0x2E,0x36,0x3D,0x3B,0x58,0x62,0x6B,0x7E,0x80,0x8C,0x96,0xAA,0xAA,0x54,0x5A,0x61,0x63,0x00,0x03,0x08,0x0D,0x12,0x18,0x2E,0x36,0x3D,0x3B,0x58,0x62,0x6B,0x7E,0x80,0x8C,0x96,0xAA,0xAA,0x54,0x5A,0x61,0x63);
...
bool gesture_enable_for_lcmone = false;
EXPORT_SYMBOL(gesture_enable_for_lcmone);
static int lcm_unprepare(struct drm_panel *panel)
{
    ...
    ctx->error = 0;
    ctx->prepared = false;
	if(gesture_enable_for_lcmone == true)
	{
	    return 0;
	}
...
static const struct of_device_id lcm_of_match[] = {
    { .compatible = "tclm,TLCM_HJR101059D_A0,vdo", },
    { }
};
...
MODULE_DESCRIPTION("TLCM_HJR101059D_A0 LCD Panel Driver");
