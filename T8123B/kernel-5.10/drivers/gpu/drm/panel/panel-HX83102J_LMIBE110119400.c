...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx,0xB1,0x2C,0xB5,0xB5,0x31,0xF1,0x42,0xEB,0x43,0x36,0x36,0x36,0x36,0x1A,0x8B,0x11,0x65,0x00,0x88,0xFA,0xFF,0xFF,0x8F,0xFF,0x08,0xB8,0x33);
    lcm_dcs_write_seq_static(ctx,0xB2,0x00,0x47,0xB0,0xD0,0x00,0x12,0x66,0x3C,0x5B,0x03,0x03,0x03,0x00,0x88,0xF5);
    lcm_dcs_write_seq_static(ctx,0xB4,0x40,0x45,0x40,0x45,0x40,0x45,0x4A,0x58,0x7C,0x70,0x01,0x58,0x01,0x06,0x01,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0xB6,0x40,0x40,0x03); // OTP vcom ºóÆÁ±Î´Ë¶Î
    ...
    lcm_dcs_write_seq_static(ctx,0xC0,0x36,0x36,0x22,0x11,0x22,0xA0,0x61,0x08,0xF5,0x03);
    ...
    lcm_dcs_write_seq_static(ctx,0xCB,0x08,0x13,0x07,0x00,0x09,0xCE);
    ...
    lcm_dcs_write_seq_static(ctx,0xD3,0x06,0x00,0x00,0x00,0x00,0x00,0x08,0x00,0x08,0x37,0x47,0x34,0x3B,0x16,0x16,0x03,0x03,0x32,0x10,0x14,0x00,0x14,0x32,0x10,0x08,0x00,0x08,0x32,0x17,0xE8,0x07,0xE8,0x00,0x00);
    lcm_dcs_write_seq_static(ctx,0xD5,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x19,0x19,0x18,0x18,0x1A,0x1A,0x1B,0x1B,0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x20,0x21,0x28,0x29,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18);
    lcm_dcs_write_seq_static(ctx,0xD6,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x19,0x19,0x1A,0x1A,0x1B,0x1B,0x07,0x06,0x05,0x04,0x03,0x02,0x01,0x00,0x29,0x28,0x21,0x20,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18);
    lcm_dcs_write_seq_static(ctx,0xD8,0xAA,0xBB,0xAA,0xAA,0xAA,0xA0,0xAA,0xBB,0xAA,0xAA,0xAA,0xA0,0xAA,0xBB,0xAA,0xAA,0xAA,0xA0,0xAA,0xBB,0xAA,0xAA,0xAA,0xA0,0xAA,0xBB,0xAA,0xAA,0xAA,0xA0,0xAA,0xBB,0xAA,0xAA,0xAA,0xA0);
	lcm_dcs_write_seq_static(ctx,0xE0,0x00,0x0A,0x19,0x23,0x2C,0x53,0x6B,0x70,0x74,0x6E,0x82,0x83,0x83,0x8E,0x8A,0x91,0x9A,0xAE,0xAD,0x55,0x5C,0x67,0x73,0x00,0x0A,0x19,0x23,0x2C,0x53,0x6B,0x70,0x74,0x6E,0x82,0x83,0x83,0x8E,0x8A,0x91,0x9A,0xAE,0xAD,0x55,0x5C,0x67,0x73);
    lcm_dcs_write_seq_static(ctx,0xE1,0x11,0x00,0x00,0x89,0x30,0x80,0x07,0xD0,0x02,0x58,0x00,0x28,0x02,0x58,0x02,0x58,0x02,0x00,0x02,0x2C,0x00,0x20,0x04,0x12,0x00,0x08,0x00,0x0C,0x02,0x77,0x02,0x4A,0x18,0x00,0x10,0xF0,0x03,0x0C,0x20,0x00,0x06,0x0B,0x0B,0x33,0x0E);
    lcm_dcs_write_seq_static(ctx,0xE7,0x06,0x0A,0x0A,0x19,0x14,0x68,0x02,0x2C,0x68,0x14,0x14,0x00,0x00,0x00,0x00,0x4A,0x07,0x01,0x02,0x00,0x33,0x03,0x84,0x18,0x01,0x69,0x77);
    lcm_dcs_write_seq_static(ctx,0xBD,0x01);
    lcm_dcs_write_seq_static(ctx,0xB1,0x01,0x7F,0x11);
    lcm_dcs_write_seq_static(ctx,0xCB,0x80);
    lcm_dcs_write_seq_static(ctx,0xD2,0xB6,0xFA);
    lcm_dcs_write_seq_static(ctx,0xE9,0xC5);
    lcm_dcs_write_seq_static(ctx,0xD3,0x20,0x00,0x00,0x00,0x80,0x0C,0x01);
    lcm_dcs_write_seq_static(ctx,0xE9,0x3F);
    ...
    lcm_dcs_write_seq_static(ctx,0xE7,0x01,0x00,0xCC,0x01,0xC6,0x09,0xDC,0x0A,0xA0,0x00,0x00,0x20,0x40,0x50,0x40);
    lcm_dcs_write_seq_static(ctx,0xBD,0x02);
    lcm_dcs_write_seq_static(ctx,0xCB,0x03,0x07,0x00,0x09,0x53,0x00,0x20,0x03);
    lcm_dcs_write_seq_static(ctx,0xD8,0xFF,0xFF,0xBF,0xFE,0xAA,0xA0,0xFF,0xFF,0xBF,0xFE,0xAA,0xA0);
    lcm_dcs_write_seq_static(ctx,0xE7,0xFE,0x03,0xFE,0x03,0xFE,0x03,0x02,0x02,0x02,0x05,0x00,0x05,0x81,0x02,0x40,0x00,0x20,0x58,0x05,0x04,0x03,0x02,0x01,0x00,0x00,0x00,0x01,0x00);
    lcm_dcs_write_seq_static(ctx,0xBD,0x03);
    lcm_dcs_write_seq_static(ctx,0xD8,0x00,0x2A,0xAA,0xA8,0x00,0x00,0x00,0x2A,0xAA,0xA8,0x00,0x00,0x00,0x3F,0xFF,0xFC,0x00,0x00,0x00,0x3F,0xFF,0xFC,0x00,0x00,0x00,0x2A,0xAA,0xA8,0x00,0x00,0x00,0x2A,0xAA,0xA8,0x00,0x00);
...
#if IS_ENABLED(CONFIG_EMDOOR_DEVICEINFO)
    if(hw_dev) {
        strcpy(hw_dev->dev_LCM.model, "LMIBE110119400");
...
static const struct of_device_id lcm_of_match[] = {
    { .compatible = "LXD,hx83102j_lmibe110119400,vdo", },
    { }
};
...
static struct mipi_dsi_driver lcm_driver = {
    ...
    .remove = lcm_remove,
    .driver = {
        .name = "panel-HX83102J_LMIBE110119400",
        .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("HX83102J_LMIBE110119400 LCD Panel Driver");
