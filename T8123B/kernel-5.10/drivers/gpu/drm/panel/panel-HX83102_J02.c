...
bool gesture_wp_hx83102j_enable = false;
EXPORT_SYMBOL(gesture_wp_hx83102j_enable);
struct gpio_desc *lcm_rst_gpio;
EXPORT_SYMBOL(lcm_rst_gpio);
...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx,0xD9,0xD1);
    lcm_dcs_write_seq_static(ctx,0xE9,0x3F);
    lcm_dcs_write_seq_static(ctx,0xB1,0x2C,0xAD,0xAD,0x19,0xD9,0x52,0xF7,0x39,0x36,0x36,0x36,0x36,0x32,0x8B,0x11,0x65,0x00,0x88,0xFA,0xFF,0xFF,0x8F,0xFF,0x08,0xD6,0x33);
    lcm_dcs_write_seq_static(ctx,0xB2,0x00,0x68,0x40,0x80,0x01,0x12,0xC0,0x3C,0x41,0x22,0x20,0x00,0x00,0x88,0x01);
    lcm_dcs_write_seq_static(ctx,0xB4,0x41,0x41,0x43,0x43,0x41,0x41,0x42,0x42,0x42,0x42,0x01,0x67,0x01,0x06,0x01,0x00,0x01);
    ...
    lcm_dcs_write_seq_static(ctx,0xBF,0xFC,0xC4,0x80,0x9C,0x36,0x00,0x0D,0x04);
    lcm_dcs_write_seq_static(ctx,0xC0,0x34,0x34,0x22,0x11,0x22,0xA0,0x31,0x08,0xF5,0x03);
    ...
    lcm_dcs_write_seq_static(ctx,0xE9,0x3F);
    lcm_dcs_write_seq_static(ctx,0xC9,0x00,0x1E,0x13,0x88,0x01);
    lcm_dcs_write_seq_static(ctx,0xCB,0x08,0x13,0x07,0x00,0x07,0xDF);
    lcm_dcs_write_seq_static(ctx,0xCC,0x02,0x03,0x4C);
    lcm_dcs_write_seq_static(ctx,0xE9,0xC4);
    lcm_dcs_write_seq_static(ctx,0xD0,0x03);
    lcm_dcs_write_seq_static(ctx,0xE9,0x3F);
    lcm_dcs_write_seq_static(ctx,0xD1,0x07,0x06,0x00,0x02,0x04,0x2C,0xFF);
    lcm_dcs_write_seq_static(ctx,0xD3,0x06,0x00,0x00,0x00,0x00,0x08,0x08,0x08,0x08,0x37,0x07,0x44,0x7C,0x11,0x11,0x03,0x03,0x32,0x10,0x0E,0x00,0x0E,0x32,0x18,0x96,0x08,0x96,0x32,0x00,0x02,0x00,0x02,0x00,0x00);
    lcm_dcs_write_seq_static(ctx,0xD5,0x25,0x24,0x25,0x24,0x18,0x18,0x18,0x18,0x07,0x06,0x07,0x06,0x05,0x04,0x05,0x04,0x03,0x02,0x03,0x02,0x01,0x00,0x01,0x00,0x3E,0x3E,0x3E,0x3E,0xBE,0xBE,0xBE,0xBE,0x21,0x20,0x21,0x20,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18);
    ...
    lcm_dcs_write_seq_static(ctx,0xE0,0x00,0x02,0x07,0x0A,0x0E,0x10,0x22,0x26,0x2D,0x28,0x40,0x46,0x4C,0x5C,0x5C,0x67,0x71,0x87,0x8B,0x46,0x50,0x5D,0x73,0x00,0x02,0x07,0x0A,0x0E,0x10,0x22,0x26,0x2D,0x28,0x40,0x46,0x4C,0x5C,0x5C,0x67,0x71,0x87,0x8B,0x46,0x50,0x5D,0x73);
    lcm_dcs_write_seq_static(ctx,0xE1,0x11,0x00,0x00,0x89,0x30,0x80,0x08,0x80,0x03,0x20,0x00,0x28,0x03,0x20,0x03,0x20,0x02,0x00,0x02,0x91,0x00,0x20,0x04,0x9F,0x00,0x0B,0x00,0x0C,0x02,0x77,0x01,0xB1,0x18,0x00,0x10,0xD0,0x03,0x0C,0x20,0x00,0x06,0x0B,0x0B,0x33,0x0E);
    lcm_dcs_write_seq_static(ctx,0xE7,0x1D,0x0A,0x0A,0x30,0x3E,0x61,0x03,0x33,0x61,0x14,0x14,0x00,0x00,0x00,0x00,0x94,0x0A,0x01,0x0C,0x00,0x33,0x03,0x84,0x18,0x01,0x69,0x77);
    lcm_dcs_write_seq_static(ctx,0xBD,0x01);
    lcm_dcs_write_seq_static(ctx,0xB1,0x01,0x7F,0x11,0xFD);
    lcm_dcs_write_seq_static(ctx,0xCB,0x80);
    lcm_dcs_write_seq_static(ctx,0xD2,0x64,0x00,0x0A,0x64);
    lcm_dcs_write_seq_static(ctx,0xD8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
    lcm_dcs_write_seq_static(ctx,0xE1,0x40,0x09,0xBE,0x19,0xFC,0x19,0xFA,0x19,0xF8,0x1A,0x38,0x1A,0x78,0x1A,0xB6,0x2A,0xF6,0x2B,0x34,0x2B,0x74,0x3B,0x74,0x6B,0x74);
    lcm_dcs_write_seq_static(ctx,0xE7,0x01,0x00,0x8C,0x01,0xE6,0x09,0xDA,0x0A,0xA0,0x00,0x00);
    lcm_dcs_write_seq_static(ctx,0xBD,0x02);
    lcm_dcs_write_seq_static(ctx,0xBF,0xF2);
    lcm_dcs_write_seq_static(ctx,0xCB,0x03,0x07,0x00,0x08,0x87);
    lcm_dcs_write_seq_static(ctx,0xD8,0xFF,0xFF,0xFF,0xFF,0xFA,0xA0,0xFF,0xFF,0xFF,0xFF,0xFA,0xA0);
    lcm_dcs_write_seq_static(ctx,0xE7,0xFE,0x01,0xFE,0x01,0xFE,0x01,0x00,0x00,0x00,0x23,0x00,0x23,0x81,0x02,0x40,0x00,0x20,0x87,0x02,0x01,0x00);
    lcm_dcs_write_seq_static(ctx,0xBD,0x03);
    lcm_dcs_write_seq_static(ctx,0xD8,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0xFF,0xFF,0xFF,0xFF,0xFA,0xA0,0xFF,0xFF,0xFF,0xFF,0xFA,0xA0,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
    ...
    lcm_dcs_write_seq_static(ctx,0xBD,0x03);
    lcm_dcs_write_seq_static(ctx,0xE9,0xC6);
    lcm_dcs_write_seq_static(ctx,0xB4,0x03,0xFF,0xF8);
    lcm_dcs_write_seq_static(ctx,0xE9,0x3F);
    lcm_dcs_write_seq_static(ctx,0xBD,0x00);
    lcm_dcs_write_seq_static(ctx,0xB9,0x00,0x00,0x00,0x00,0x00);
...
static struct mtk_panel_params ext_params = {
   // .pll_clk = 322,
    ...
    .dsc_params = {
        ...
        .dec_delay = 657,
        .scale_value = 32,
        .increment_interval = 1183,
        .decrement_interval = 11,
        .line_bpg_offset = 12,
        .nfl_bpg_offset = 631,
        .slice_bpg_offset = 433,
        .initial_offset = 6144,
        .final_offset = 4304,
        .flatness_minqp = 3,
        .flatness_maxqp = 12,
...
#if IS_ENABLED(CONFIG_EMDOOR_DEVICEINFO)
    if(hw_dev) {
        strcpy(hw_dev->dev_LCM.model, "LLZZE127120840-BL-101");
        strcpy(hw_dev->dev_LCM.supplier, "LXD");
        strcpy(hw_dev->dev_LCM.param, "1600x2176");
...
MODULE_DESCRIPTION("HX83102_J02 LCD Panel Driver");
