...
#define PHYSICAL_WIDTH     107640
#define PHYSICAL_HEIGHT    172224
...
static struct mipi_dsi_driver lcm_driver = {
    ...
    .remove = lcm_remove,
    .driver = {
        .name = "panel-HX83102E_SAT080AT39IM0224_HD",
        .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("HX83102E_SAT080AT39IM0224_HD LCD Panel Driver");
