...
#include "gc13a1mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc13a1_camera_sensor"
#define LOG_1 LOG_INF("GC13A1, MIPI 4LANE\n")
/****************************   Modify end    *******************************************/
#define GC13A1_DEBUG                0
#if GC13A1_DEBUG
...
#if VERSION_CHECK
struct proc_dir_entry *gc13a1_proc_vendor_file;
static uint8_t GC13A1_PROC_FLAG = 0;
static kal_uint8 module_info[11];
#endif
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC13A1_SENSOR_ID,
...
#if GC13A1_MIRROR_NORMAL
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr,
  #elif GC13A1_MIRROR_HV
...
kal_uint16 gc13a1_init_addr_data[] = {
/*system*/
	0x031c, 0x20,
	0x0337, 0x05,
	0x0335, 0x01,
...
/*PDAF_1/128*/
	...
	0x00e4, 0x30,
	0x00e5, 0x08,
	0x00a0, GC13A1_PDAF00A0,
	0x00c3, GC13A1_PDAF00C3,
/*MIPI*/
	0x0114, 0x03,
	0x0115, 0x30,
	0x0180, 0x44,
...
static kal_uint16 gc13a1_2104x1560_addr_data[] = {
/*system*/
	0x031c, 0x20,
	0x0337, 0x05,
	0x0335, 0x05,
...
static kal_uint16 gc13a1_4208x3120_addr_data[] = {
/*system*/
	0x031c, 0x20,
	0x0337, 0x05,
	0x0335, 0x01,
...
static kal_uint16 gc13a1_4208x2368_addr_data[] = {
/*system*/
	0x031c, 0x20,
	0x0337, 0x05,
	0x0335, 0x01,
...
static kal_uint16 gc13a1_1280x720_addr_data[] = {
/*system*/
	0x031c, 0x20,
	0x0337, 0x05,
	0x0335, 0x05,
...
static void gc13a1_stream_on(void)
{
	write_cmos_sensor_8bit(0x0100, 0x01);
}

static void gc13a1_stream_off(void)
{
...
{
	table_write_cmos_sensor(gc13a1_init_addr_data,
		sizeof(gc13a1_init_addr_data)/sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	gc13a1_stream_off();
#if PDAFSUPPORT
	table_write_cmos_sensor(gc13a1_4208x3120_addr_data,
	  sizeof(gc13a1_4208x3120_addr_data)/sizeof(kal_uint16));
#else
	table_write_cmos_sensor(gc13a1_2104x1560_addr_data,
	  sizeof(gc13a1_2104x1560_addr_data)/sizeof(kal_uint16));
#endif
...
{
	gc13a1_stream_off();
	table_write_cmos_sensor(gc13a1_4208x2368_addr_data,
		sizeof(gc13a1_4208x2368_addr_data)/sizeof(kal_uint16));
	gc13a1_stream_on();
}
...
{
	gc13a1_stream_off();
	table_write_cmos_sensor(gc13a1_1280x720_addr_data,
		sizeof(gc13a1_1280x720_addr_data)/sizeof(kal_uint16));
	gc13a1_stream_on();
}
...
static void gc13a1_otp_read_group(kal_uint16 addr, kal_uint8 *data, kal_uint16 length)
{
	kal_uint16 i = 0;
...
static ssize_t gc13a1_vendor_read(struct file *file, char *buf,
...
static const struct proc_ops gc13a1_proc_vendor_ops = {
	.proc_read = gc13a1_vendor_read,
};
#endif
		...
		do {
			*sensor_id = return_sensor_id()+1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc13a1_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
#if VERSION_CHECK
				memset(&module_info, 0, sizeof(module_info));

				gc13a1_otp_read_group(0x001, &module_info[0], 11);

				gc13a1_proc_vendor_file = proc_create("otp_camera_main", 0444,
					NULL, &gc13a1_proc_vendor_ops);
				if (gc13a1_proc_vendor_file == NULL) {
			...
			pr_debug("[gc13a1_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id()+1;
			if (sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc13a1_camera_sensor]open:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			pr_debug("[gc13a1_camera_sensor]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
UINT32 GC13A1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
