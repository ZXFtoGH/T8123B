...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV13850MAIN_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h

    .checksum_value = 0xd0eb21fe,        //checksum value for Camera Auto Test
...
{ 4208, 3120, 0, 0, 4208, 3120, 2104, 1560, 0, 0, 1024, 768, 0, 0, 1024, 768}, //hight speed video 
// { 4208, 3120, 0, 0, 4208, 3120, 2104, 1560, 0, 0, 2104, 1560, 2, 2, 1280, 720}, // slim video 
	{ 4208, 3120, 0, 0, 4208, 3120, 2104, 1560, 0, 0, 1280, 720, 0, 0, 1280, 720}, 
...
//		*sensor_id =  imgsensor_info.sensor_id;
            ...
            LOG_ERR("20190729Read sensor ok  \n");
            ...
            LOG_ERR("20190729Read sensor id fail, write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
...
UINT32 OV13850MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    OV13850MAIN_MIPI_RAW_SensorInit    */
