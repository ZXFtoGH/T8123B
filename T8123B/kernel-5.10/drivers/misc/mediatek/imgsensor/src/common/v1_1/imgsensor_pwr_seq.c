...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
		...
		{
			SENSOR_DRVNAME_GC08A8MAIN_MIPI_RAW,
			{
				{RST, Vol_Low, 0},
				{PDN, Vol_Low, 1},
		...
		{
			SENSOR_DRVNAME_GC08A8SUB_MIPI_RAW,
			{
				{RST, Vol_Low, 0},
				{PDN, Vol_Low, 1},
				{SensorMCLK, Vol_High, 1},
		...
		{
			SENSOR_DRVNAME_GC08A8MAINCXT_MIPI_RAW,
			{
				{RST, Vol_Low, 0},
				{PDN, Vol_Low, 1},
				{SensorMCLK, Vol_High, 1},
		...
		{
			SENSOR_DRVNAME_GC08A8SUBCXT_MIPI_RAW,
			{
				{RST, Vol_Low, 0},
				{PDN, Vol_Low, 1},
				{SensorMCLK, Vol_High, 1},
	...
	{
		SENSOR_DRVNAME_OV8856MAIN_MIPI_RAW,
		{
	...
	{
		SENSOR_DRVNAME_OV8856SUB_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_2800, 0},
...
#if defined(S5K5E9_MIPI_RAW)
	{
		...
		{
			SENSOR_DRVNAME_HI846FRONT_MIPI_RAW,
			{
				{RST, Vol_Low, 1},
				{AVDD, Vol_2800, 0},
				{DVDD, Vol_1200, 0},
		...
		{
			SENSOR_DRVNAME_GC08A3MAIN_MIPI_RAW,
			{
				{RST, Vol_Low, 0},
				{PDN, Vol_Low, 1},
				{DOVDD, Vol_1800, 1},
		...
		{
			SENSOR_DRVNAME_GC08A3FRONT_MIPI_RAW,
			{
				{RST, Vol_Low, 0},
				{PDN, Vol_Low, 1},
				{DOVDD, Vol_1800, 1},
	...
	{
		SENSOR_DRVNAME_OV13850MAIN_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_2800, 0},
	...
	{
		SENSOR_DRVNAME_GC13A0MAIN_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{DOVDD, Vol_1800, 0},
			{DVDD, Vol_1200, 0},
	...
	{
		SENSOR_DRVNAME_GC05A2FRONT_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_2800, 0},
