 ...
 */
#define PFX "gc05a2front_camera_sensor"
...
#include "gc05a2front_mipi_Sensor.h"

static DEFINE_SPINLOCK(imgsensor_drv_lock);


static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC05A2FRONT_SENSOR_ID,
	.checksum_value = 0x3e27a291,
	.pre = {
		.pclk = 224000000,
		.linelength = 3616,
		.framelength = 2064,
...
UINT32 GC05A2FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
