...
#include "gc08a3front_mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc08a3front_camera_sensor"
#define LOG_1 LOG_INF("GC08A3FRONT, MIPI 4LANE\n")
/****************************   Modify end    *******************************************/
//#define GC08A3MAIN_DEBUG
#ifdef GC08A3MAIN_DEBUG
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC08A3FRONT_SENSOR_ID,
...
#if GC08A3FRONT_MIRROR_NORMAL
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,
#elif GC08A3FRONT_MIRROR_H
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr,
#elif GC08A3FRONT_MIRROR_V
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gb,
#elif GC08A3FRONT_MIRROR_HV
	...
	.i2c_addr_table = {0x20, 0x62, 0x22, 0x24, 0xff},
	.i2c_speed = 400,
};
...
static kal_uint16 gc08a3_init_addr_data[] = {
/*system*/
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x51,
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_info("[gc08a3 front]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			pr_info("[gc08a3 front]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
				pr_info("[gc08a3 front]open:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			pr_info("[gc08a3 front]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
UINT32 GC08A3FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
