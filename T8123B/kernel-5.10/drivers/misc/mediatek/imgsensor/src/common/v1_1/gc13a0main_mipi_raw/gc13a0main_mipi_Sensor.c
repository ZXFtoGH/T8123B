 ...
 */
#define PFX "gc13a0main_camera_sensor"
...
#include "gc13a0main_mipi_Sensor.h"

static DEFINE_SPINLOCK(imgsensor_drv_lock);


static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC13A0MAIN_SENSOR_ID,
...
#if GC13A0MAIN_MIRROR_NORMAL
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr,
  #elif GC13A0MAIN_MIRROR_HV
...
kal_uint16 gc13a0main_init_addr_data[] = {
/*system*/
	0x031c, 0x20,
	0x0337, 0x05,
	0x0335, 0x01,
...
/*Pre_set*/
	...
	0x0218, 0x00,
	0x0241, 0x88,
	0x0101, GC13A0MAIN_MIRROR,
	0x00a1, GC13A0MAIN_PARA,
/*analog*/
	0x0c17, 0x12,
	0x0c16, 0x24,
	0x0c15, 0x04,
...
/*PDAF_1/128*/
	...
	0x00e4, 0x30,
	0x00e5, 0x08,
	0x00a0, GC13A0MAIN_PDAF00A0,
	0x00c3, GC13A0MAIN_PDAF00C3,
/*MIPI*/
	0x0114, 0x03,
	0x0115, 0x30,
	0x0180, 0x44,
...
static kal_uint16 gc13a0main_2104x1560_addr_data[] = {
/*system*/
	0x031c, 0x20,
	0x0337, 0x05,
	0x0335, 0x05,
...
static kal_uint16 gc13a0main_4208x3120_addr_data[] = {
/*system*/
	0x031c, 0x20,
	0x0337, 0x05,
	0x0335, 0x01,
...
static kal_uint16 gc13a0main_4208x2368_addr_data[] = {
/*system*/
	0x031c, 0x20,
	0x0337, 0x05,
	0x0335, 0x01,
...
static kal_uint16 gc13a0main_1280x720_addr_data[] = {
/*system*/
	0x031c, 0x20,
	0x0337, 0x05,
	0x0335, 0x05,
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(gc13a0main_init_addr_data,
		sizeof(gc13a0main_init_addr_data)/sizeof(kal_uint16));
	pr_debug("[%s] init_End\n", __func__);
}	/*	  sensor_init  */
...
#if PDAFSUPPORT
	table_write_cmos_sensor(gc13a0main_4208x3120_addr_data,
	  sizeof(gc13a0main_4208x3120_addr_data)/sizeof(kal_uint16));
#else
	table_write_cmos_sensor(gc13a0main_2104x1560_addr_data,
	  sizeof(gc13a0main_2104x1560_addr_data)/sizeof(kal_uint16));
#endif
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(gc13a0main_4208x2368_addr_data,
		sizeof(gc13a0main_4208x2368_addr_data)/sizeof(kal_uint16));
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(gc13a0main_1280x720_addr_data,
		sizeof(gc13a0main_1280x720_addr_data)/sizeof(kal_uint16));
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc13a0main_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			pr_debug("[gc13a0main_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc13a0main_camera_sensor]open:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			pr_debug("[gc13a0main_camera_sensor]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
UINT32 GC13A0MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
