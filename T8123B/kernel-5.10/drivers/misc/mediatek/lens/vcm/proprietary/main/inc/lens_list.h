...
#define PD9151PAF_SetI2Cclient PD9151PAF_SetI2Cclient_Main
#define PD9151PAF_Ioctl PD9151PAF_Ioctl_Main
#define PD9151PAF_Release PD9151PAF_Release_Main
#define PD9151PAF_GetFileName PD9151PAF_GetFileName_Main
extern int PD9151PAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long PD9151PAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int PD9151PAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int PD9151PAF_GetFileName(unsigned char *pFileName);
#endif
