...
#define HIMAX_DRIVER_VER "3.0.0.10_#5212_OL_HW_03"
...
struct himax_debug {
	...
	int (*_raw_full_stack)(struct himax_ic_data *hx_s_ic_data_ol,
				struct himax_report_data *hx_s_touch_data_ol);
	int (*_set_diag_cmd)(struct himax_ic_data *hx_s_ic_data_ol,
				struct himax_report_data *hx_s_touch_data_ol);
};
...
extern struct himax_core_fp hx_s_core_fp_ol;
extern struct himax_ts_data *hx_s_ts_ol;
extern struct himax_ic_data *hx_s_ic_data_ol;
...
extern void himax_parse_dt_ol_ic_info(struct himax_ts_data *ts,
	struct himax_platform_data *pdata);

extern void hx_parse_assign_cmd_ol(uint32_t addr, uint8_t *cmd, int len);
