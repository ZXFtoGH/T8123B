...
extern struct proc_dir_entry *hx_touch_proc_dir_ol;
...
extern int himax_input_register_ol(struct himax_ts_data *ts);
#if defined(HX_TP_PROC_2T2R)
extern bool Is_2T2R_OL;
#endif

extern void himax_ic_reset(int level);

extern uint8_t HX_PROC_SEND_FLAG_OL;
extern struct himax_target_report_data *g_target_report_data_ol;
extern struct himax_report_data *hx_s_touch_data_ol;
extern int g_ts_dbg_ol;
