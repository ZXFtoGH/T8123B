...
#define FTS_DEBUG(fmt, args...) do { \
    printk(KERN_DEBUG "[FTS_P]%s:"fmt"\n", __func__, ##args); \
} while (0)

#define FTS_FUNC_ENTER() do { \
    printk(KERN_DEBUG "[FTS_P]%s: Enter\n", __func__); \
} while (0)

#define FTS_FUNC_EXIT() do { \
    printk(KERN_DEBUG "[FTS_P]%s: Exit(%d)\n", __func__, __LINE__); \
} while (0)
...
#define FTS_INFO(fmt, args...) do { \
    printk(KERN_INFO "[FTS_P/I]%s:"fmt"\n", __func__, ##args); \
} while (0)

#define FTS_ERROR(fmt, args...) do { \
    printk(KERN_ERR "[FTS_P/E]%s:"fmt"\n", __func__, ##args); \
} while (0)
