...
#define SAR_REPORT_VENUS_KEY

#define HX9023E_ON_BOARD 0
#define HX9031A_ON_BOARD 1
#define HX9031A_CHIP_SELECT HX9023E_ON_BOARD
#define HX9031A_DRIVER_NAME "hx9031a" //i2c addr: 0x28

#define TYHX_DELAY_US(x) msleep((x)/1000)
#define TYHX_DELAY_MS(x) msleep(x)
#define HX9031A_TEST_ON_MTK_DEMO_XY6761 0 //仅在6761开发板调试时置1
#define HX9031A_TEST_CHS_EN 0      //开机打开所有通道，仅在测试阶段用

#define HX9031A_CH_NUM 4
#define HX9031A_CH_USED 0x0F
...
#define HX9031A_ID_CHECK_COUNT 2
#define HX9031A_CHIP_ID 0x1D //23E和31A都是1D
...
struct hx9031a_platform_data {
    ...
    struct hx9031a_channel_info *chs_info;
    uint32_t channel_used_flag;
    int irq;      //irq number
    int irq_gpio; //gpio numver
    char irq_disabled;
    uint32_t prox_state_reg;//寄存器显示的prox状态
    bool sel_bl[HX9031A_CH_NUM];
    bool sel_raw[HX9031A_CH_NUM];
    bool sel_diff[HX9031A_CH_NUM];
    bool sel_lp[HX9031A_CH_NUM];
...
static struct hx9031a_addr_val_pair hx9031a_reg_init_list[] = {
    ...
    {RA_RANGE_7_0_0x0D,                0x03}, //range ch1 ch0 1.25p
    {RA_RANGE_9_8_0x0E,                0x00}, //range ch3 1.25p ch2 1.25pf
    {RA_AVG0_NOSR0_CFG_0x10,           0x15}, //ch0 osr 512 avg 1 warm 16.
    {RA_NOSR12_CFG_0x11,               0x05}, //ch2 osr 512; ch1 osr 512
    {RA_NOSR43_CFG_0x12,               0x00}, //ch3 osr 512
    {RA_AVG12_CFG_0x13,                0x00}, //ch1 and ch2 avg 1
    {RA_AVG34_CFG_0x14,                0x00}, //ch3 avg 1
    {RA_SAMPLE_NUM_7_0_0x1f,           0x25}, //sample frequency 0x96: 31K. 0x4B 62K, 0x3a 83K
    {RA_INTEGRATION_NUM_7_0_0x21,      0x25}, //sample frequency 0x96: 31K. 0x4B 62K, 0x3a 83K
    {RA_MOD_RST_CFG_0x28,              0xf5}, //change offset cali delay
    {RA_LP_ALP_1_0_CFG_0x2a,           0x33}, //ch1 LP alpha 4. ch0 LP alpha 4
    {RA_LP_ALP_3_2_CFG_0x2b,           0x33}, //ch3 LP alpha 4. ch2 LP alpha 4
