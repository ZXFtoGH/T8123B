...
&emigen_set_lpddr_id(0);

&emigen_set_id("MT6983", "v00");
...
&emigen_support_ddr("LPDDR5");
&emigen_support_ddr("LPDDR5X");


&emigen_support_hw_trap("LPDDR5");
&emigen_support_hw_trap("LPDDR5X");
