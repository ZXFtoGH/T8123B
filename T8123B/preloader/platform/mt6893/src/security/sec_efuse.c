...
#define EFUSE_BLOW_UVOL             725000 /* 0.8V */
#define EFUSE_READ_UVOL_HIGH        725000 /* 0.8V */
#define EFUSE_READ_UVOL_LOW         725000 /* 0.8V */
/*#define EFUSE_VSRAM_UVOL            900000*/  /* do not need to set while VCORE is under the spec @mt6893 */
...
U32 efuse_vcore_blow(void)
{
	...
	/* ---------- Control the vsram_others ----- don't need on mt6893 --------- */
	/*struct mtk_regulator reg_vsram_others = empty_regulator;*/
	/* Required to set VSRAM to 0.85V in MT6893 because VSRAM must be 0.1V higher than VCORE */
