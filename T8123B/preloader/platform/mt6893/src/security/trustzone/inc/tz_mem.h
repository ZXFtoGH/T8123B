...
#define SEC_MEM_RESERVED_M4U_SIZE       (0x60000)//384KB by default
#define SEC_MEM_RESERVED_CMDQ_SIZE      (0xF0000)//960KB by default
#define SEC_MEM_RESERVED_SPI_SIZE       (0x200000)//256KB*8 by default
...
#define SEC_MEM_RESERVED_MAX_SIZE       (0x400000)

/* Config for GZ DDR remap offset */
#define CFG_GZ_REMAP_OFFSET_ENABLE      (1)
#define TEE_BOOT_ARG_RESERVED_SIZE      0x1000
#ifndef TFA_AS_BL31
#define BL31_ENTRY                      (PL_ATF_BASE + 0x3000)
#define CFG_ATF_ROM_MEMADDR             (PL_ATF_BASE + TEE_BOOT_ARG_RESERVED_SIZE - ATF_HEADER_SIG_SIZE)
#define ATF_BOOT_ARG_ADDR               (PL_ATF_BASE)
#else
#define BL31_ENTRY                      (PL_ATF_BASE)
#define CFG_ATF_ROM_MEMADDR             (PL_ATF_BASE)
/* MEMBASE + 70MB, Size: 64KB */
#define ATF_BOOT_ARG_ADDR               (PL_ATF_BASE + PL_ATF_MAX_SIZE - TEE_BOOT_ARG_RESERVED_SIZE)
/* vector is not placed in header of BL31 anymore */
#endif /* TFA_AS_BL31 */
#define ATF_HEADER_SIG_SIZE             (0x240)

#define BL31_DRAM_BASE                  (PL_ATF_BASE)
#define BL31_DRAM_SIZE                  (PL_ATF_MAX_SIZE)
...
#ifndef TFA_AS_BL31
#define ATF_LOG_BUFFER_SIZE             (0x40000)
#else
#define ATF_LOG_BUFFER_SIZE             (0x200000)
#endif
...
#ifdef KASAN_SUPPORT
#define ATF_RAMDUMP_BUFFER_SIZE				(0xC0000) /* 768KB */
#else
