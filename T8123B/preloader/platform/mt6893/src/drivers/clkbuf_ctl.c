...
void _pmic_interface_select(enum pmic_interface mode){
	...
	#if 0
	clk_buf_warn("[%s] PMIFSPI_SLEEP_PROTECTION_CRL(0x%x)\n", __func__, DRV_Reg32(PMIFSPI_SLEEP_PROTECTION_CRL));
	clk_buf_warn("[%s] PMIFSPMI_SLEEP_PROTECTION_CRL(0x%x)\n", __func__, DRV_Reg32(PMIFSPMI_SLEEP_PROTECTION_CRL));
	clk_buf_warn("[%s] PMIFSPI_MODE_CRL(0x%x)\n", __func__, DRV_Reg32(PMIFSPI_MODE_CRL));
	clk_buf_warn("[%s] PMIFSPMI_MODE_CRL(0x%x)\n", __func__, DRV_Reg32(PMIFSPMI_MODE_CRL));
	clk_buf_warn("[%s] PMIFSPI_INF_EN(0x%x)\n", __func__, DRV_Reg32(PMIFSPI_INF_EN));
	clk_buf_warn("[%s] PMIFSPI_OTHER_INF_EN(0x%x)\n", __func__, DRV_Reg32(PMIFSPI_OTHER_INF_EN));
	clk_buf_warn("[%s] PMIFSPI_ARB_EN(0x%x)\n", __func__, DRV_Reg32(PMIFSPI_ARB_EN));
	#endif
}
