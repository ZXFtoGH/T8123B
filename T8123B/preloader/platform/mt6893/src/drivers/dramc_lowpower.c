...
GOLDEN_FIELD_T shuf_golden_setting_anwer[] =
{
    ...
    {"MISC_SHU_RX_CG_CTRL_RX_APHY_CTRL_DCM_OPT", DDRPHY_REG_MISC_SHU_RX_CG_CTRL, MISC_SHU_RX_CG_CTRL_RX_APHY_CTRL_DCM_OPT, 0x1},
...
GOLDEN_FIELD_T nonshuf_golden_setting_anwer[] =
{
    ...
    {"TEST2_A0_TA2_CG_FR", DRAMC_REG_TEST2_A0, TEST2_A0_TA2_CG_FR, 0x0},
    ...
    {"ACTIMING_CTRL_SEQCLKRUN3", DRAMC_REG_ACTIMING_CTRL, ACTIMING_CTRL_SEQCLKRUN3, 0x0},
...
GOLDEN_FIELD_T shuf_golden_setting_anwer[] =
{
    ...
    {"MISC_SHU_RX_CG_CTRL_RX_DQSIEN_STBCAL_CG_EN", DDRPHY_REG_MISC_SHU_RX_CG_CTRL, MISC_SHU_RX_CG_CTRL_RX_DQSIEN_STBCAL_CG_EN, 0x0},
    {"MISC_SHU_RX_CG_CTRL_RX_APHY_CTRL_DCM_OPT", DDRPHY_REG_MISC_SHU_RX_CG_CTRL, MISC_SHU_RX_CG_CTRL_RX_APHY_CTRL_DCM_OPT, 0x0},
    {"MISC_SHU_CG_CTRL0_R_PHY_MCK_CG_CTRL", DDRPHY_REG_MISC_SHU_CG_CTRL0, MISC_SHU_CG_CTRL0_R_PHY_MCK_CG_CTRL, 0x33403000},
};
...
GOLDEN_FIELD_T nonshuf_golden_setting_anwer[] =
{
    ...
    {"TEST2_A0_TA2_CG_FR", DRAMC_REG_TEST2_A0, TEST2_A0_TA2_CG_FR, 0x1},
...
void EnableDramcPhyDCMNonShuffle(DRAMC_CTX_T *p, bool bEn)
{
    ...
    if(bEn)
    {
        ...
        vIO32WriteFldAlign_All(DRAMC_REG_TEST2_A0, 0x0, TEST2_A0_TA2_CG_FR);
        vIO32WriteFldAlign_All(DRAMC_REG_TEST2_A3, 0x0, TEST2_A3_TESTCLKRUN);
        ...
        vIO32WriteFldMulti_All(DRAMC_REG_ACTIMING_CTRL,
                ...
                P_Fld(0x1, ACTIMING_CTRL_SEQCLKRUN3));
    ...
    else
    {
        ...
        vIO32WriteFldAlign_All(DRAMC_REG_TEST2_A0, 0x1, TEST2_A0_TA2_CG_FR);
        vIO32WriteFldAlign_All(DRAMC_REG_TEST2_A3, 0x1, TEST2_A3_TESTCLKRUN);
        vIO32WriteFldAlign_All(DRAMC_REG_DUMMY_RD, 0x1, DUMMY_RD_DUMMY_RD_PA_OPT);
...
void EnableDramcPhyDCMShuffle(DRAMC_CTX_T *p, bool bEn, U32 u4DramcShuOffset, U32 u4DDRPhyShuOffset)
{
    ...
    vIO32WriteFldMulti_All(DDRPHY_REG_SHU_B0_DQ7 + u4DDRPhyShuOffset,
        P_Fld(0x0, MISC_SHU_RX_CG_CTRL_RX_PRECAL_CG_EN) |
        P_Fld(0x1, MISC_SHU_RX_CG_CTRL_RX_DQSIEN_RETRY_CG_EN) |
        P_Fld(0x0, MISC_SHU_RX_CG_CTRL_RX_RDSEL_TRACKING_CG_EN));
    ...
    else
    {
        ...
        vIO32WriteFldMulti_All(DDRPHY_REG_MISC_SHU_RX_CG_CTRL + u4DDRPhyShuOffset,
                P_Fld(0x0, MISC_SHU_RX_CG_CTRL_RX_DQSIEN_AUTOK_CG_EN) |
                P_Fld(0x0, MISC_SHU_RX_CG_CTRL_RX_DQSIEN_STBCAL_CG_EN) |
                P_Fld(0x0, MISC_SHU_RX_CG_CTRL_RX_APHY_CTRL_DCM_OPT));
        vIO32WriteFldAlign_All(DDRPHY_REG_MISC_SHU_CG_CTRL0 + u4DDRPhyShuOffset, 0x33403000, MISC_SHU_CG_CTRL0_R_PHY_MCK_CG_CTRL);
    }
    return;
}
...
DRAM_STATUS_T CheckGoldenSetting(DRAMC_CTX_T *p)
{
    ...
    if(gAndroid_DVFS_en)
    {
        for (u1ShuffleIdx = 0; u1ShuffleIdx <= DRAM_DFS_SRAM_MAX; u1ShuffleIdx++)
        {
            ...
            mcSHOW_DBG_MSG(("shuf_golden_setting_anwer:%d\n",  sizeof(shuf_golden_setting_anwer)));
...
void EnableCmdPicgEffImprove(DRAMC_CTX_T *p, U32 u4DramcShuOffset)
{
    ...
    vIO32WriteFldMulti(DRAMC_REG_SHU_DCM_CTRL0 + u4DramcShuOffset, P_Fld(1, SHU_DCM_CTRL0_DDRPHY_CLK_EN_OPT) | P_Fld(u2Clk_Dyn_Gating_Sel, SHU_DCM_CTRL0_DDRPHY_CLK_DYN_GATING_SEL));
}
//#endif
