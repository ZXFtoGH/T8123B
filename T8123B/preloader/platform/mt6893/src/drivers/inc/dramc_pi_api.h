...
#define CHANNEL_NUM      4   // single chhanel for A60868.  1 single channel, 2 dual channel, 4 channel
...
#define ENABLE_EYESCAN_GRAPH 1 //__ETT__ //draw eye diagram after calibration, if enable, need to fix code size problem.
...
#define ENABLE_RX_TRACKING_HW_SAVE_WA 1 //for Pexxxs/xxx868 only
...
#define DRAMC_DFS_MODE 1 // 0:Legacy, 1:MD32 RG, 2: PHY RG, 3: MD32 PST
#define ENABLE_SRAM_DMA_WA 1 // for Pexxxs/Maxxxx/xxx868
#define ENABLE_TX_REBASE_ODT_WA 1 // for Pexxxs/xxx868
#if ENABLE_TX_WDQS
#define ENABLE_TX_REBASE_WDQS_DQS_PI_WA 1
#endif
...
#if (fcFOR_CHIP_ID == fcA60868)
#define CBT_O1_PINMUX_WORKAROUND  1
#define WLEV_O1_PINMUX_WORKAROUND 0
#elif(fcFOR_CHIP_ID == fcPetrus)
#define CBT_O1_PINMUX_WORKAROUND  0
#define WLEV_O1_PINMUX_WORKAROUND 1
#endif
...
#undef DRAMC_DFS_MODE
#define DRAMC_DFS_MODE 0 // 0:Legacy, 1:MD32 RG, 2: PHY RG, 3: MD32 PST
...
typedef enum {
    CK_WRITE_TO_ONE_CHANNEL = 0,
    CK_WRITE_TO_ALL_CHANNEL,
} CK_FIX_CHANNEL;
...
typedef struct _SAVE_TIME_FOR_CALIBRATION_T
{
    ...
    // delay cell time
    //U16 u2g_num_dlycell_perT_all[DRAM_DFS_SHUFFLE_MAX][CHANNEL_NUM];
