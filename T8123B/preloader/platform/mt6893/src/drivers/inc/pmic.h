...
extern void pmic_warm_reset(void);
extern bool has_pmic_warm_reset(void);
extern void set_delayed_pmic_cold_reset(void);
extern bool has_delayed_pmic_cold_reset(void);
extern void delayed_pmic_cold_reset(void);
