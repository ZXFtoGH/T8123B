...
EXTERN void DumpAoNonShuReg(void);
EXTERN void DumpAoShuReg(U32 u4DramcShuOffset, U32 u4DDRPhyShuOffset);
EXTERN void DumpNaoReg(void);
#endif
...
EXTERN void sv_algorithm_assistance_LP4_4266(DRAMC_CTX_T *p);
...
EXTERN U8 u1IsDDR800PhaseMode(DRAMC_CTX_T *p);
...
EXTERN void DramCLKAlwaysOnOff(DRAMC_CTX_T *p, U8 option, CK_FIX_CHANNEL WriteChannelNUM);
