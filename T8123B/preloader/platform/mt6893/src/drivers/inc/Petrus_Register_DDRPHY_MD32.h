...
#define DDRPHY_MD32_REG_LPIF_RESERVED_5                        (DDRPHY_MD32_BASE_ADDRESS + 0x7064)
    #define LPIF_RESERVED_5_COUNTER_HW_S1_STEP                 Fld(3, 0) //[2:0]
    #define LPIF_RESERVED_5_RESERVED_X64_3_3                   Fld(1, 3) //[3:3]
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH1                        (DDRPHY_MD32_BASE_ADDRESS + 0x7384)
    #define LPIF_DBG_LATCH1_CUR_DDR_PST_STA                    Fld(32, 0) //[31:0]
