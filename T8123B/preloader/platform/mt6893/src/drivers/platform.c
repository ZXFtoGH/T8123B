...
#include "lastpc.h"
#if (TARGET_BOARD_PLATFORM == MT6893)
	#include "delsel.h"
#endif
...
#endif
#if CFG_ENABLE_DCACHE
    /* disable data cache and MMU to do seclib */
    paging_uninit();
...
/*In FPGA phase, dram related function should by pass*/
    ...
    cache_delsel_init( MT_CPU_DVFS_B, H300_800000KHz);
...
#if !CFG_FPGA_PLATFORM
	brisket2_init();
	BOOTING_TIME_PROFILING_LOG("brisket2_init");
#endif
...
/******************************************************************************
* NOTE: This function is for the internal projects of MT6893.
*        -----------------------------------------
