...
u32 tee_log_buf_start;
u32 tee_ree_share_buf_start;
...
void teei_boot_param_prepare(u32 param_addr, u32 tee_entry, u64 teei_sec_dram_size, u64 dram_base,
    ...
    teearg->tee_log_base = tee_log_buf_start;
...
#endif
    CONFIG_ISEE_FLAGS(&teearg->flags, ISEE_FLAGS_TEE_SGPT_TIMER, ISEE_FLAGS_TEE_TIMER_MASK, ISEE_FLAGS_TEE_TIMER_OFFSET);
