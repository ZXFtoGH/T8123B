...
//#define CFG_MICROTRUST_TEE_LOG_CRYPTO_SUPPORT
...
enum isee_flags {
    ...
    /* bit 30 */
    ISEE_FLAGS_TEE_TIMER_OFFSET    = 30,
    ISEE_FLAGS_TEE_ARCH_TIMER   = 0b0,
    ISEE_FLAGS_TEE_SGPT_TIMER   = 0b1,
    ISEE_FLAGS_TEE_TIMER_MASK      = 0x0000000040000000,
...
extern u32 tee_log_buf_start;
extern u32 tee_ree_share_buf_start;
