...
{
    TZ_SET_FIELD(SRAMROM_DM_REMAP0, 0xFFFFFFFF, 0xFFFFFFFF);
    TZ_SET_FIELD(SRAMROM_DM_REMAP1, 0xFFFFFFFF, 0xFFFFFFFF);

    TZ_SET_FIELD(SRAMROM_DM_REMAP0, INFRA_AP, DOMAIN_0 << SRAMROM_RMP_DOM0_SHIFT);
    TZ_SET_FIELD(SRAMROM_DM_REMAP0, INFRA_SSPM, DOMAIN_1 << SRAMROM_RMP_DOM8_SHIFT);
    TZ_SET_FIELD(SRAMROM_DM_REMAP0, INFRA_CONN, DOMAIN_2 << SRAMROM_RMP_DOM2_SHIFT);
    TZ_SET_FIELD(SRAMROM_DM_REMAP0, INFRA_SCP, DOMAIN_3 << SRAMROM_RMP_DOM3_SHIFT);
    ...
    TZ_SET_FIELD(SRAMROM_SEC_CTRL, SRAMROM_SEC_CTRL_SEC0_DOM0_MASK, PERMIT_S_RW_NS_BLOCK    << SRAMROM_SEC_CTRL_SEC0_DOM0_SHIFT); // can't boot
    TZ_SET_FIELD(SRAMROM_SEC_CTRL, SRAMROM_SEC_CTRL_SEC0_DOM1_MASK, PERMIT_S_BLOCK_NS_BLOCK << SRAMROM_SEC_CTRL_SEC0_DOM1_SHIFT);
    TZ_SET_FIELD(SRAMROM_SEC_CTRL, SRAMROM_SEC_CTRL_SEC0_DOM2_MASK, PERMIT_S_BLOCK_NS_BLOCK << SRAMROM_SEC_CTRL_SEC0_DOM2_SHIFT); //OK
    TZ_SET_FIELD(SRAMROM_SEC_CTRL, SRAMROM_SEC_CTRL_SEC0_DOM3_MASK, PERMIT_S_BLOCK_NS_BLOCK << SRAMROM_SEC_CTRL_SEC0_DOM3_SHIFT); //OK
