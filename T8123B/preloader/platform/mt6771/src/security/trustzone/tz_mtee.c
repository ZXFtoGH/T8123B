...
void mtee_boot_param_prepare(u32 param_addr, u32 tee_entry, u32 mtee_sec_dram_size, u64 dram_base,
    ...
    teearg->secDRamSize = mtee_sec_dram_size;       /* Secure DRAM size */
...
DECLARE_TEE_MODULE("MTEE", mtee_get_reserved_tee_address, NULL, mtee_boot_param_prepare, mtee_key_param_prepare);
