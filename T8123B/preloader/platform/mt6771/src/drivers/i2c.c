...
int i2c_hw_init(void)
{
	...
	I2C_SET_REG32(IOCFG_RB_BASE + 0xF0, 0x00380E00, 0x0);
	/* SDA1[14:12] SCL1[24:22] */
	I2C_SET_REG32(IOCFG_RB_BASE + 0xF0, 0x01C07000, 0x0);
	/* SDA3[9:7] SCL3[14:12] */
	I2C_SET_REG32(IOCFG_BL_BASE + 0xF0, 0x00007380, 0x0);
	/* SDA2[16:14] SCL2[26:24] */
	I2C_SET_REG32(IOCFG_RM_BASE + 0xF0, 0x0701C000, 0x0);
	/* SDA4[19:17] SCL4[29:27] */
	I2C_SET_REG32(IOCFG_RM_BASE + 0xF0, 0x380E0000, 0x0);
	/* SDA5[17:15] SCL5[22:20] */
	I2C_SET_REG32(IOCFG_LB_BASE + 0xF0, 0x00738000, 0x0);
