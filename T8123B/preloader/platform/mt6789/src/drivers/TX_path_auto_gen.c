...
void get_TX_path_config(DRAMC_CTX_T *p, TX_path_config_T *TX_C,U8 ch_id, U32 group_id)
{
  U8 BYTE_swap;
...
#endif
	       default  : mcSHOW_DBG_MSG("[TX_path_auto_gen] DRAMOBF_PIPE_NO Unexpected DFS(group_id)->data_rate=%1d input \n",TX_C->data_ratio);
	     }//switch
    }
    else 
    {
