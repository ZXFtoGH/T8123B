...
void PMIC_enable_long_press_reboot(void)
{
	...
	pmic_config_interface(PMIC_RG_HOMEKEY_RST_EN_ADDR, 0x00,
	...
	pmic_config_interface(PMIC_RG_PWRKEY_RST_EN_ADDR, 0x01,
			      PMIC_RG_PWRKEY_RST_EN_MASK,
			      PMIC_RG_PWRKEY_RST_EN_SHIFT);
	pmic_config_interface(PMIC_RG_HOMEKEY_RST_EN_ADDR, 0x01,
			      PMIC_RG_HOMEKEY_RST_EN_MASK,
			      PMIC_RG_HOMEKEY_RST_EN_SHIFT);
...
{
	pmic_config_interface(PMIC_RG_CRST_ADDR, 0x1,
			      PMIC_RG_CRST_MASK,
			      PMIC_RG_CRST_SHIFT);
}

int32_t pmic_reinit(void)
{
	int ret = 0;
...
U32 pmic_init (void)
{
	...
	/* enable vcn28 for wifi */
	pmic_config_interface(PMIC_RG_LDO_VCN28_EN_ADDR, 0x1,
