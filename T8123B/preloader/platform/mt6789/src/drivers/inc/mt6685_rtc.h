...
#define BANK_FQMTR_RST				(1U << MT6685_RG_BANK_FQMTR_RST_SHIFT)
#define FQMTR_EN					(1U << MT6685_FQMTR_EN_SHIFT)
#define FQMTR_BUSY					(1U << MT6685_FQMTR_BUSY_SHIFT)
#define FQMTR_DCXO26M_EN			(1U << MT6685_FQMTR_DCXO26M_EN_SHIFT)
...
#define RTC_75K_TO_32K				(1U << MT6685_RG_RTC_32K1V8_0_SEL_SHIFT)
...
extern bool boot_check(void);
extern void mark_bypass_pwrkey(void);
