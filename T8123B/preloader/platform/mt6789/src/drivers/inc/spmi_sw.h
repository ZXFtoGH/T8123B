...
#define SPMI_DRV_CFG                (IOCFG_LM_BASE+0x60)
#define SPMI_DRV_CFG_SET            (SPMI_DRV_CFG+0x4)
#define SPMI_DRV_CFG_CLR            (SPMI_DRV_CFG+0x8)
#define SPMI_DRV_SPMI_SCL_OFFSET    (15)
#define SPMI_DRV_SPMI_OFFSET        (18)

#define SPMI_IES_CFG0               (IOCFG_LM_BASE+0xE0)
#define SPMI_IES_CFG0_SET           (SPMI_IES_CFG0+0x4)
#define SPMI_IES_CFG0_CLR           (SPMI_IES_CFG0+0x8)
#define SPMI_M_SCL_IES_CFG_OFFSET   (20)

#define SPMI_IES_CFG1               (IOCFG_LM_BASE+0xE0)
#define SPMI_IES_CFG1_SET           (SPMI_IES_CFG1+0x4)
#define SPMI_IES_CFG1_CLR           (SPMI_IES_CFG1+0x8)
#define SPMI_M_SDA_IES_CFG_OFFSET   (21)
#define SPMI_P_SCL_IES_CFG_OFFSET   (1)
#define SPMI_P_SDA_IES_CFG_OFFSET   (2)

#define SPMI_PD_CFG                 (IOCFG_LM_BASE+0x110)
#define SPMI_PD_CFG_SET             (SPMI_PD_CFG+0x4)
#define SPMI_PD_CFG_CLR             (SPMI_PD_CFG+0x8)
#define SPMI_PD_CFG_SCL_OFFSET      (8)
#define SPMI_PD_CFG_OFFSET          (9)

#define SPMI_PU_CFG                 (IOCFG_LM_BASE+0x150)
#define SPMI_PU_CFG_SET             (SPMI_PU_CFG+0x4)
#define SPMI_PU_CFG_CLR             (SPMI_PU_CFG+0x8)
#define SPMI_PU_CFG_SCL_OFFSET      (8)
#define SPMI_PU_CFG_OFFSET          (9)

#define SPMI_RDSEL_CFG              (IOCFG_LM_BASE+0x1C0)
#define SPMI_RDSEL_CFG_SET          (SPMI_RDSEL_CFG+0x4)
#define SPMI_RDSEL_CFG_CLR          (SPMI_RDSEL_CFG+0x8)
#define SPMI_RDSEL_CFG_SCL_OFFSET   (10)
#define SPMI_RDSEL_CFG_OFFSET       (12)

#define SPMI_SMT_CFG                (IOCFG_LM_BASE+0x1F0)
#define SPMI_SMT_CFG_SET            (SPMI_SMT_CFG+0x4)
#define SPMI_SMT_CFG_CLR            (SPMI_SMT_CFG+0x8)
#define SPMI_SMT_CFG_SCL_OFFSET     (17)
#define SPMI_SMT_CFG_OFFSET         (18)

#define SPMI_TDSEL_CFG              (IOCFG_LM_BASE+0x250)
#define SPMI_TDSEL_CFG_CLR          (SPMI_TDSEL_CFG+0x4)
#define SPMI_TDSEL_CFG_CLR          (SPMI_TDSEL_CFG+0x8)
#define SPMI_TDSEL_CFG_SCL_OFFSET   (12)
#define SPMI_TDSEL_CFG_OFFSET       (16)
