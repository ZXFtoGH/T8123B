...
//#define UPDATE_HIGHEST_FREQ_TO_3733 0
...
#define SAMSUNG_TEST_MODE_MRS_FOR_PRELOADER 6
...
#define PER_BANK_REFRESH_USE_MODE 0 // 0: original mode, 1: hybrid mode, 2: always pb mode
...
#define ENABLE_EARLY_BG_CMD 1   // 0: Disable 1: Enable, Reduce the CMD latency by CTO_EBG request(EMI and DRAMC RG should both be enable) //fixed after fcPalmer @Chris
...
#define ENABLE_DDR800_SOPEN_DSC_WA 1 //fcPalmer
#if ENABLE_TX_WDQS
...
EXTERN int get_dram_mdl_number(void);
