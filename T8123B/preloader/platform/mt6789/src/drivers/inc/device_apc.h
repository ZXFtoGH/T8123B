...
/* INFRA AO */
#define CONN			(0xF << 16)	// DOM_2
#define SSPM			(0xF << 24)	// DOM_3
#define MCUPM			(0xF << 8)	// DOM_5

/* PERI AO */
#define SPM			(0xF << 16)	// DOM_2

/* FMEM AO */
#define MD1			(0xF << 8)	// DOM_1
#define MFG			(0xF << 16)	// DOM_6
...
enum DEVAPC_MASTER_NUM {
	MASTER_INFRA_AO_NUM = 5,
	MASTER_PERI_AO_NUM = 6,
	MASTER_PERI_PAR_AO_NUM = 8,
