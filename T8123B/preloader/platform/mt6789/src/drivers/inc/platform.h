...
#define BOOT_TAG_AEE_EXCEPTION_INFO 0x8861001D
...
#define BOOT_TAG_DDR_INFO (0x8861002C)
struct boot_tag_ddr_info {
    u32 mdl_number;
};
...
typedef struct {
    ...
    union {
        ...
        struct boot_tag_ddr_info ddr_info;
    } u;
}boot_tag;
...
extern void platform_set_addr_reset_vector(unsigned int addr);
...
extern void jumparch64(mtk_bl_param_t *bl31_info, u32 reserved1, u32 reserved2, u32 reserved3);
