...
#define MCUCK_BASE          (0x0C53A000)

#define IOCFG_RB_BASE       (0x11C30000)
...
#define MSDC1_TOP_BASE      (IO_PHYS + 0x01EF0000)
#define MSDC1_BASE          (IO_PHYS + 0x01240000)
#define UFS0_AO_CFG_BASE    (IO_PHYS + 0x012B8000)
#define UFS0_PDN_CFG_BASE   (IO_PHYS + 0x012BC000)
#define USB_BASE            (IO_PHYS + 0x01200000) /* MAC: 0x1120_0000 */
#define USBSIF_BASE         (IO_PHYS + 0x01F40000) /* PHY: 0x11F4_0000 */
...
#define MFG_PLL_CTRL_BASE             (IO_PHYS + 0x03FA0000)
#define APU_PLL_CTRL_BASE             (IO_PHYS + 0x090F3000)

/*=======================================================================*/
/* 26Mhz Stable Control                                                     */
/*=======================================================================*/
#define ABB_MIXEDSYS_RSV_REG_BASE     (0x2619DF00)

/* IRQ */
#define SYS_TIMER_IRQ       (265 + 32)
#endif
