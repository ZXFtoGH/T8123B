...
struct spmi_device {
	...
	unsigned char hwcid_mask;
	unsigned short swcid_addr;
	unsigned char swcid_val;
	unsigned short wpk_key_addr;
	unsigned short wpk_key_val;
	unsigned short tma_key_addr;
	unsigned short tma_key_val;
	unsigned short rcs_en_addr;
	unsigned short rcs_slvid_addr;
	struct pmif *pmif_arb;
};

struct io_driving {
	unsigned int sd; /* set driving bit */
	unsigned int cd; /* clear driving bit */
};
