...
#define PMIF_SRCLKEN_RC_EN	1
#define PMIF_CHAN_EN		0x7EFFFF
#define PMIF_CHAN_P_EN		0x1FFFFF
#define MD_DVFS_HIGH_PRIO	0x1 << 1
/* LAT_UNIT_SEL=25;Lat unit=26T ~=1us */
#define LAT_UNIT_SEL		0x19 << 1 //LAT_UNIT_SEL is bit[5:1]
...
#define PMIF_SWINF_0_CHAN_NO_P	10
/* MD: 0, security domain: 1, AP: 2 */
#define PMIF_AP_SWINF_NO	2
/* 0: SPMI_M, 1: SPMI_P */
#define PMIF_PMIFID_0		0
#define PMIF_PMIFID_1		1
...
extern void spmi_pmif_doe_load(void);
#endif /*__PMIF_SW_H__*/
