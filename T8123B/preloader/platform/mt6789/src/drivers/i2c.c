	...
	U32 *timing_sample_cnt)
{
	...
	/* Just for MT6761/MT6762/MT6765/MT6789 */
...
{
	/* Config driving set EH2,EH1= 2'b11 */
	/* EH: 1, i2c mode;0, GPIO mode */
	/* [EH2,EH1]: 2'b00,0.31;2'b01,0.61;2'b10,1.1;2'b11,1.41 */
	/* [EH,EH2,EH1] = [bit2,bit1,bit0] */

	/* sda7[29:27] sda6[26:24] sda5[23:21] sda3[20:18] */
	/* sda0[17:15] scl7[14:12] scl6[11:9] */
	/* scl5[8:6] scl3[5:3] scl0[2:0] */
	I2C_SET_REG32((IOCFG_LM_BASE + 0x80), 0x3FFFFFFF, 0x3FFFFFFF);
	/* sda9[23:21] sda8[20:18] sda4[17:15] sda2[14:12] */
	/* scl9[11:9] scl8[8:6] scl4[5:3] scl2[2:0] */
	I2C_SET_REG32((IOCFG_RT_BASE + 0x50), 0xFFFFFF, 0xFFFFFF);
	/* sda1[5:3] scl1[2:0] */
	I2C_SET_REG32((IOCFG_BL_BASE + 0x30), 0x3F, 0x3F);
}
...
static void internal_resister_setting(void)
{
	...
	/* sda0[17:15] scl7[14:12] scl6[11:9] */
	/* scl5[8:6] scl3[5:3] scl0[2:0] */
	I2C_SET_REG32((IOCFG_LM_BASE + 0x1D0), 0x3FFFFFFF, 0x3FFFFFFF);
	/* sda9[23:21] sda8[20:18] sda4[17:15] sda2[14:12] */
	/* scl9[11:9] scl8[8:6] scl4[5:3] scl2[2:0] */
	I2C_SET_REG32((IOCFG_RT_BASE + 0x130), 0xFFFFFF, 0xFFFFFF);
	/* sda1[5:3] scl1[2:0] */
	I2C_SET_REG32((IOCFG_BL_BASE + 0xC0), 0x3F, 0x3F);
}
#endif
...
int i2c_hw_init(void)
{
	...
	mt_set_gpio_mode(GPIO_SCL3, SCL3);
	mt_set_gpio_pull_enable(GPIO_SCL3, 1);
	mt_set_gpio_pull_select(GPIO_SCL3, 1);
	mt_set_gpio_mode(GPIO_SDA3, SDA3);
	mt_set_gpio_pull_enable(GPIO_SDA3, 1);
	mt_set_gpio_pull_select(GPIO_SDA3, 1);
