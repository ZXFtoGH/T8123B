...
U8 u1GetDQSIEN_p2s_latency(U8 p2s_ratio)
{
    U8 ser_latency = 0;
...
U8 u1GetDQ_CA_p2s_latency(U8 p2s_ratio, U8 frate)
{
    U8 ser_latency = 0;
...
void DramcCalculate_Datlat_val(DRAMC_CTX_T *p)
{
    ...
    U32 u4CAdefault_delay = 1, u4CS2RL_start = 0, u4Read_cmd_out = 1, u4tRPRE_toggle = 0;
    U32 u4DQSIEN_default_delay = 0, u4DQSIEN_ser_latency = 0, u4CA_ser_latency = 0;
    ...
    U32 u4tDQSCK_Max = 0;
    U32 u4RX_rdcmdout2rdcmdbus_by_ps = 0, u4Gating_window_ahead_dqs = 2;

    u4DQ_ui_unit =  (1000000 / (p->frequency * 2)) * (1026 / 1000); //multiply 1.026 for real data_rate is little small.
