	...
	U32 *timing_sample_cnt)
{
	...
	/* Just for MT6761/MT6762/MT6765/MT6853 */
...
static void i2c_set_driving(void)
{
	...
	/*SDA1[11:9]  SCL1[8:6]*/
	I2C_SET_REG32((IOCFG_BR_BASE + 0x50), (7 << 9 | 7 << 6), (7 << 9 | 7 << 6));
	/*SDA2[14:12]  SCL2[2:0]*/
	...
	/*SCL5[26:24]*/
	I2C_SET_REG32((IOCFG_BR_BASE + 0x40), (7 << 24), (7 << 24));
	/*SDA5[2:0]*/
	...
	/*SCL8[8:6]  SDA8[20:18]*/
	I2C_SET_REG32((IOCFG_BR_BASE + 0x40), (7 << 18 | 7 << 6), (7 << 18 | 7 << 6));
	/*SCL9[11:9]  SDA9[23:21]*/
	I2C_SET_REG32((IOCFG_BR_BASE + 0x40), (7 << 21 | 7 << 9), (7 << 21 | 7 << 9));
}
...
static void internal_resister_setting(void)
{
	...
	/* 0x2:15k 0x3:1k */
	/*I2C0*/
	I2C_SET_REG32(IOCFG_LM_BASE + 0x90, 0xF, 0xF);
	/*I2C1,2,4,5,7,8,9*/
	I2C_SET_REG32(IOCFG_BR_BASE + 0xE0, 0xFFFFFFF, 0xFFFFFFF);
	/*I2C3*/
	I2C_SET_REG32(IOCFG_RT_BASE + 0x90, 0xF, 0xF);
	/*I2C6*/
	I2C_SET_REG32(IOCFG_TL_BASE + 0xD0, 0xF, 0xF);
}
#endif
