...
void mt_pll_init(void)
{
    ...
    //step 54
    DRV_WriteReg32(USBPLL_CON1, 0x80180000); //2496/13 MHz
    //DRV_WriteReg32(USBPLL_CON1, 0x841D89D8); //192 MHz
    ...
    //step 90
    /*
     * for MT6853, the rstb_en bit of syspll is turned off by BROM force download mode,
    ...
    //step 82
    /* ARM BL3 setting, no need for MT6873/MT6853 */
    ...
    DRV_WriteReg32(CLK_CFG_9_CLR, 0xFFFFFFFF);
    /* dpi=297M, scam=109.2M, disp_pwm=26M, usb_top=104M */
    DRV_WriteReg32(CLK_CFG_9_SET, 0x02000101);
    ...
    DRV_WriteReg32(MMSYS_CG_CLR0, 0x01FFFFFF);//bit 25~31 empty
#endif
