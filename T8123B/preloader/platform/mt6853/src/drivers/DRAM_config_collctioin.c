...
U8 LP4_DRAM_INIT_RLWL_MRfield_config(U32 data_rate)
{
    ...
    else if (data_rate<=400 )                         {MR2_RLWL = 2 ;}
...
U32 Get_RL_LP5_DVFSC_DIS( U8 MR_RL_field_value, U8 DBI_EN, U8 BYTE_MODE_EN,U8 CKR)
{
    ...
    if(CKR == 2) 
    {
        switch(MR_RL_field_value)
        {
            ...
            default:{mcSHOW_DBG_MSG(("ERROR: DVFSC_DIS:Unexpected MR_RL_field_value:%1d -CKR:%1d under LPDDR5, \n",MR_RL_field_value,CKR));}
        }
    } 
    else if (CKR == 4) 
    {
        switch(MR_RL_field_value)
        {
            ...
            default:{mcSHOW_DBG_MSG(("ERROR: DVFSC_DIS:Unexpected MR_RL_field_value:%1x -CKR:%1d under LPDDR5, \n",MR_RL_field_value,CKR));}
        }
    } 
    else 
    {
        mcSHOW_DBG_MSG(("ERROR: DVFSC_DIS:Unexpected CKR:%1d under LPDDR5 \n",CKR)); 
    }
...
U32 Get_RL_LP5_DVFSC_EN( U8 MR_RL_field_value, U8 DBI_EN, U8 BYTE_MODE_EN,U8 CKR)
{
    ...
    if(CKR == 2) 
    {
        switch(MR_RL_field_value)
        {
            ...
            default:{mcSHOW_DBG_MSG(("ERROR: DVFSC_EN: Unexpected MR_RL_field_value:%1d -CKR:%1d under LPDDR5, \n",MR_RL_field_value,CKR));}
        }
    } 
    else if (CKR == 4) 
    {
        switch(MR_RL_field_value)
        {
            ...
            default:{mcSHOW_DBG_MSG(("ERROR: DVFSC_EN:Unexpected MR_RL_field_value:%1x -CKR:%1d under LPDDR5, \n",MR_RL_field_value,CKR));}
        }
    } 
    else 
    {
        mcSHOW_DBG_MSG(("ERROR: DVFSC_EN:Unexpected CKR:%1d under LPDDR5 \n",CKR)); 
    }
