...
#define MSDC0_GPIO_IES_ADDR			(MSDC0_IO_PAD_BASE + 0x40)
#define MSDC0_GPIO_PUPD0_ADDR			(MSDC0_IO_PAD_BASE + 0x60)
#define MSDC0_GPIO_R0_ADDR			(MSDC0_IO_PAD_BASE + 0x80)
#define MSDC0_GPIO_R1_ADDR			(MSDC0_IO_PAD_BASE + 0x90)
#define MSDC0_GPIO_RDSEL0_ADDR_0		(MSDC0_IO_PAD_BASE + 0xA0)
#define MSDC0_GPIO_RDSEL0_ADDR_1		(MSDC0_IO_PAD_BASE + 0xB0)
#define MSDC0_GPIO_RDSEL0_ADDR_2		(MSDC0_IO_PAD_BASE + 0xC0)
#define MSDC0_GPIO_SMT_ADDR			(MSDC0_IO_PAD_BASE + 0xE0)
...
#define MSDC0_SMT_DAT0_MASK		(0xFF << 2)
#define MSDC0_SMT_DAT1_MASK		(0xFF << 2)
#define MSDC0_SMT_DAT2_MASK		(0xFF << 2)
#define MSDC0_SMT_DAT3_MASK		(0xFF << 2)
#define MSDC0_SMT_DAT4_MASK		(0xFF << 2)
#define MSDC0_SMT_DAT5_MASK		(0xFF << 2)
#define MSDC0_SMT_DAT6_MASK		(0xFF << 2)
#define MSDC0_SMT_DAT7_MASK		(0xFF << 2)
