...
EXTERN U16 u2g_num_dlycell_perT_all[DRAM_DFS_SRAM_MAX][CHANNEL_NUM];	//TODO: to be removed by Francis
...
EXTERN void DramCLKAlwaysOnOff(DRAMC_CTX_T *p, U8 option);
...
EXTERN U16 DDRPhyFMeter(DRAMC_CTX_T *p);
