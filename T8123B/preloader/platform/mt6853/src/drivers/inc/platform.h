...
#define CFG_SEC_VIDEO_PATH_SIZE 0x400000
#else
#define CFG_SEC_VIDEO_PATH_SIZE (0)
#endif
#if CFG_TEE_SUPPORT
#ifdef CFG_TEE_TRUSTED_APP_HEAP_SIZE
#define CFG_TEE_CORE_SIZE               (0x500000 + CFG_TEE_TRUSTED_APP_HEAP_SIZE + CFG_TEE_TUI_HEAP_SIZE + CFG_TEE_FP_HEAP_SIZE+CFG_SEC_VIDEO_PATH_SIZE)
#else
