...
INCLUDE_FILE     +=  \
    ...
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/inc

########
# TZCC
########
INCLUDE_FILE     +=  \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/codesafe/src/secure_boot/crypto_driver/dsc \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/shared/include/pal/no_os  \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/shared/include/sbrom \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/shared/include/proj/ssi64 \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/shared/include/pal \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/codesafe/src/secure_boot/platform/common/tz  \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/codesafe/src/secure_boot/secure_boot_gen  \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/codesafe/src/crys/sym/driver/  \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/host/src/sbromlib  \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/codesafe/src/secure_boot/platform/pal/dx_linux    \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/shared/include    \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/shared/hw/include  \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/host/src/ssi4tzlib    \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/codesafe/src/secure_boot/platform/pal  \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/codesafe/src/secure_boot/crypto_driver    \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/codesafe/src/secure_boot/util  \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/codesafe/src/secure_boot/platform/hal/hal_host/dsc \
    -I$(MTK_PATH_PLATFORM)/src/secure_lib/src/platform/$(PLATFORM_UPPER_CASE)/src/tzcc/codesafe/src/secure_boot/platform/hal
endif
