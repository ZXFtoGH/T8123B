...
static signed int _pwrap_init_reg_clock(unsigned int regck_sel)
{
	...
	WRAP_WR32(IOCFG_LM_DRV_CFG1_CLR, 0x7 << 6);
	WRAP_WR32(IOCFG_LM_DRV_CFG1_SET, 0x1 << 6);
...
{
	/*
	 * config new pmic wrap mpu
	 * CH0(MD HW) CH1(MD DVFS HW) CH2(SPM HW) CH3(MCUPM HW) CH4(SRCLKEN_RC HW)
	 * CH5(TIA HW) CH6(APU HW) CH7(NO USE) CH8(MD SW) CH9(AP SW1 GZ)
	 * CH10(AP SW0) CH11(AP SW2 or APU SW) CH12(SCP SW) CH13(SSPM SW)
	 * CH14(STAUPD HW) CH15(SPM_DCXO HW0) CH16(SPM_DCXO HW1)
	 * CH17(MD AUXADC HW0) CH18(MD AUXADC HW1) CH19(Internal GPS AUXADC HW0)
	 * CH20(Internal GPS AUXADC HW1)
	 */
	WRAP_WR32(PMIF_SPI_PMIF_MPU_CTRL, 0x34); // pdomain_scp[5:2] = 0xd for scp

	//RTC 0x600~0x67e CH8(MD SW):RO (10), CH9(AP SW1 GZ): R/W (00)
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_0_START, 0x600);//start address
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_0_END, 0x67e);//end address
	//bit[17:16]=10, bit[19:18] = 00
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_0_PER0, 0x0ff10000);//permission for ch0~ch15
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_0_PER1, 0x0);//permission for ch16~20

	//0x800~0x13fe CH8(MD SW):RO (10), CH10(AP SW0): R/W(00),CH13(SSPM SW): R/W(00)
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_1_START, 0x800);
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_1_END, 0x13fe);
	//bit[17:16]=01, bit[20:21]=00, bit[27:26]=00
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_1_PER0, 0x030d0000);
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_1_PER1, 0x0);


	//0x1400~0x207e  CH8(MD SW),CH10(AP SW0),CH13(SSPM SW): R/W(00)
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_2_START, 0x1400);
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_2_END, 0x207e);
	//bit[17:16, 21:20, 26:27]=[00,00,00]
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_2_PER0, 0x03cc0000);
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_2_PER1, 0x0);

	//0x2080~0x26fe CH8(MD SW):RO (10), CH10(AP SW0): R/W(00),
	//CH12(SSPM SW): R/W(00), CH13(SSPM SW): R/W(00)
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_3_START, 0x2080);
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_3_END, 0x26fe);
	//bit[17:16]=01, bit[20:21]=00, bit[25:24]=00, bit[27:26]=00
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_3_PER0, 0x00cd0000);
	WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_3_PER1, 0x0);
}

signed int pwrap_enable_mpu(bool en)
{
	if (en == TRUE)
		WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_EN, 0x0000000f);  //Enable Protect Region 0~3
	else
		WRAP_WR32(PMIF_SPI_PMIF_PMIC_ALL_RGN_EN, 0x00000000);  //Disable Protect Region 0~3

	WRAP_WR32(PMIF_SPI_PMIF_MPU_CTRL, 0x1);  //Enable Security write control
	PWRAPLOG("PMIF_SPI_PMIF_PMIC_ALL_RGN_EN = 0x%x\n", WRAP_RD32(PMIF_SPI_PMIF_PMIC_ALL_RGN_EN));
...
signed int pwrap_init(void)
{
	...
	*/
	...
	/* Configure MD HW Channel Write permission. */
	WRAP_WR32(PMIF_CTRL, WRAP_RD32(PMIF_CTRL) | (0x1 << 2));
