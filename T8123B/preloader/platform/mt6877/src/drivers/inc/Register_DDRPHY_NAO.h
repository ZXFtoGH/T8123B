...
#define DDRPHY_REG_MISC_DMA_DEBUG0                             (DDRPHY_NAO_BASE_ADDRESS + 0x000C)
...
#define DDRPHY_REG_MISC_DMA_DEBUG1                             (DDRPHY_NAO_BASE_ADDRESS + 0x0010)
...
#define DDRPHY_REG_MISC_DMA_DEBUG2                             (DDRPHY_NAO_BASE_ADDRESS + 0x0014)
    #define MISC_DMA_DEBUG2_PSEL_DDRPHY_NAO                    Fld(1, 0) //[0:0]
    #define MISC_DMA_DEBUG2_SRAM_NAO_DONE                      Fld(1, 1) //[1:1]
    #define MISC_DMA_DEBUG2_APB_NAO_DONE                       Fld(1, 2) //[2:2]
    #define MISC_DMA_DEBUG2_WDT_RESTORE_ACK                    Fld(1, 4) //[4:4]
    #define MISC_DMA_DEBUG2_WDT_DRAMC_SREF_Q                   Fld(1, 5) //[5:5]
...
#define DDRPHY_REG_MISC_RETRY_DBG3                             (DDRPHY_NAO_BASE_ADDRESS + 0x0024)
...
#define DDRPHY_REG_RX_AUTOK_DBG_STATUS8                        (DDRPHY_NAO_BASE_ADDRESS + 0x05A4)
...
#define DDRPHY_REG_RX_AUTOK_DBG_STATUS9                        (DDRPHY_NAO_BASE_ADDRESS + 0x05A8)
...
#define DDRPHY_REG_RX_AUTOK_DBG_STATUS10                       (DDRPHY_NAO_BASE_ADDRESS + 0x05AC)
...
#define DDRPHY_REG_RX_AUTOK_DBG_STATUS11                       (DDRPHY_NAO_BASE_ADDRESS + 0x05B0)
...
#define DDRPHY_REG_RX_AUTOK_DBG_STATUS12                       (DDRPHY_NAO_BASE_ADDRESS + 0x05B4)
...
#define DDRPHY_REG_JM_8PH_AUTOK_STATUS0                        (DDRPHY_NAO_BASE_ADDRESS + 0x05C0)
...
#define DDRPHY_REG_JM_8PH_AUTOK_STATUS1                        (DDRPHY_NAO_BASE_ADDRESS + 0x05C4)
...
#define DDRPHY_REG_JM_8PH_AUTOK_STATUS2                        (DDRPHY_NAO_BASE_ADDRESS + 0x05C8)
    #define JM_8PH_AUTOK_STATUS2_JM_8PH_AUTOK_TRANS_POS6       Fld(9, 0) //[8:0]

#define DDRPHY_REG_JM_8PH_AUTOK_DBG_STATUS0                    (DDRPHY_NAO_BASE_ADDRESS + 0x05CC)
...
#define DDRPHY_REG_JM_8PH_AUTOK_DBG_STATUS1                    (DDRPHY_NAO_BASE_ADDRESS + 0x05D0)
...
#define DDRPHY_REG_JM_8PH_AUTOK_DBG_STATUS2                    (DDRPHY_NAO_BASE_ADDRESS + 0x05D4)
...
#define DDRPHY_REG_JM_8PH_AUTOK_DBG_STATUS3                    (DDRPHY_NAO_BASE_ADDRESS + 0x05D8)
...
#define DDRPHY_REG_JM_8PH_AUTOK_DBG_STATUS4                    (DDRPHY_NAO_BASE_ADDRESS + 0x05DC)
...
#define DDRPHY_REG_JM_8PH_AUTOK_DBG_STATUS5                    (DDRPHY_NAO_BASE_ADDRESS + 0x05E0)
...
#define DDRPHY_REG_JM_8PH_AUTOK_DBG_STATUS6                    (DDRPHY_NAO_BASE_ADDRESS + 0x05E4)
...
#define DDRPHY_REG_OE_LPBK_STATUS0                             (DDRPHY_NAO_BASE_ADDRESS + 0x05F0)
    #define OE_LPBK_STATUS0_LPBK_OE_DONE                       Fld(28, 0) //[27:0]

#define DDRPHY_REG_OE_LPBK_STATUS1                             (DDRPHY_NAO_BASE_ADDRESS + 0x05F4)
    #define OE_LPBK_STATUS1_LPBK_OE_FAIL                       Fld(31, 0) //[30:0]

#define DDRPHY_REG_RODT_LPBK_STATUS0                           (DDRPHY_NAO_BASE_ADDRESS + 0x05F8)
    #define RODT_LPBK_STATUS0_LPBK_RODT_DONE                   Fld(28, 0) //[27:0]

#define DDRPHY_REG_RODT_LPBK_STATUS1                           (DDRPHY_NAO_BASE_ADDRESS + 0x05FC)
    #define RODT_LPBK_STATUS1_LPBK_RODT_FAIL                   Fld(31, 0) //[30:0]
...
#define DDRPHY_REG_MISC_DMA_SRAM_MBIST                         (DDRPHY_NAO_BASE_ADDRESS + 0x0754)
    #define MISC_DMA_SRAM_MBIST_DRAMC_MBIST_MBIST_PREFUSE_0    Fld(8, 0) //[7:0]
...
#define DDRPHY_REG_MISC_DBG_DB_MESSAGE0                        (DDRPHY_NAO_BASE_ADDRESS + 0x1600)
    #define MISC_DBG_DB_MESSAGE0_DBG_DB_REFRESH_RATE_FOR_INT_X0 Fld(5, 0) //[4:0]
    #define MISC_DBG_DB_MESSAGE0_DBG_DB_REFRESH_QUEUE_CNT_FOR_INT_X0 Fld(4, 8) //[11:8]
    #define MISC_DBG_DB_MESSAGE0_DBG_DB_REFRESH_RATE_CHG_QUEUE_CNT_FOR_INT_X0 Fld(4, 12) //[15:12]
    #define MISC_DBG_DB_MESSAGE0_DBG_DB_REFRESH_RATE_RK1_FOR_INT_X0 Fld(5, 16) //[20:16]
    #define MISC_DBG_DB_MESSAGE0_DBG_DB_REFRESH_QUEUE_CNT_RK1_FOR_INT_X0 Fld(4, 24) //[27:24]
    #define MISC_DBG_DB_MESSAGE0_DBG_DB_REFRESH_RATE_CHG_QUEUE_CNT_RK1_FOR_INT_X0 Fld(4, 28) //[31:28]

#define DDRPHY_REG_MISC_DBG_DB_MESSAGE1                        (DDRPHY_NAO_BASE_ADDRESS + 0x1604)
    #define MISC_DBG_DB_MESSAGE1_DBG_DB_PRE_REFRESH_RATE_RK0_FOR_INT_X0 Fld(5, 0) //[4:0]
    #define MISC_DBG_DB_MESSAGE1_DBG_DB_PRE_REFRESH_RATE_RK1_FOR_INT_X0 Fld(5, 8) //[12:8]
    #define MISC_DBG_DB_MESSAGE1_DBG_DB_PRE_REFRESH_RATE_RK0_B1_FOR_INT_X0 Fld(5, 16) //[20:16]
    #define MISC_DBG_DB_MESSAGE1_DBG_DB_PRE_REFRESH_RATE_RK1_B1_FOR_INT_X0 Fld(5, 24) //[28:24]
...
#define DDRPHY_REG_MISC_APHY_DBG_MON_B0                        (DDRPHY_NAO_BASE_ADDRESS + 0x16B0)
    #define MISC_APHY_DBG_MON_B0_AD_TX_ARDQ_ODTEN_MON_B0       Fld(1, 25) //[25:25]
    #define MISC_APHY_DBG_MON_B0_AD_TX_ARDQS0_ODTEN_MON_B0     Fld(1, 26) //[26:26]
    #define MISC_APHY_DBG_MON_B0_AD_TX_ARDQ_OE_MON_B0          Fld(1, 27) //[27:27]
    #define MISC_APHY_DBG_MON_B0_AD_TX_ARDQS0_OE_MON_B0        Fld(1, 28) //[28:28]
    #define MISC_APHY_DBG_MON_B0_AD_RX_ARDQ_RANK_SEL_MON_B0    Fld(1, 29) //[29:29]
    #define MISC_APHY_DBG_MON_B0_AD_RX_ARDQS0_DQSIEN_RK0_MON_B0 Fld(1, 30) //[30:30]
    #define MISC_APHY_DBG_MON_B0_AD_RX_ARDQS0_DQSIEN_RK1_MON_B0 Fld(1, 31) //[31:31]

#define DDRPHY_REG_MISC_APHY_DBG_MON_B1                        (DDRPHY_NAO_BASE_ADDRESS + 0x16B4)
    #define MISC_APHY_DBG_MON_B1_AD_TX_ARDQ_ODTEN_MON_B1       Fld(1, 25) //[25:25]
    #define MISC_APHY_DBG_MON_B1_AD_TX_ARDQS0_ODTEN_MON_B1     Fld(1, 26) //[26:26]
    #define MISC_APHY_DBG_MON_B1_AD_TX_ARDQ_OE_MON_B1          Fld(1, 27) //[27:27]
    #define MISC_APHY_DBG_MON_B1_AD_TX_ARDQS0_OE_MON_B1        Fld(1, 28) //[28:28]
    #define MISC_APHY_DBG_MON_B1_AD_RX_ARDQ_RANK_SEL_MON_B1    Fld(1, 29) //[29:29]
    #define MISC_APHY_DBG_MON_B1_AD_RX_ARDQS0_DQSIEN_RK0_MON_B1 Fld(1, 30) //[30:30]
    #define MISC_APHY_DBG_MON_B1_AD_RX_ARDQS0_DQSIEN_RK1_MON_B1 Fld(1, 31) //[31:31]

#define DDRPHY_REG_MISC_APHY_DBG_MON_C0                        (DDRPHY_NAO_BASE_ADDRESS + 0x16B8)
    #define MISC_APHY_DBG_MON_C0_AD_TX_ARCMD_ODTEN_MON_C0      Fld(1, 25) //[25:25]
    #define MISC_APHY_DBG_MON_C0_AD_TX_ARCLK_ODTEN_MON_C0      Fld(1, 26) //[26:26]
    #define MISC_APHY_DBG_MON_C0_AD_TX_ARCMD_OE_MON_C0         Fld(1, 27) //[27:27]
    #define MISC_APHY_DBG_MON_C0_AD_TX_ARCLK_OE_MON_C0         Fld(1, 28) //[28:28]
    #define MISC_APHY_DBG_MON_C0_AD_RX_ARCMD_RANK_SEL_MON_C0   Fld(1, 29) //[29:29]
    #define MISC_APHY_DBG_MON_C0_AD_RX_ARCLK_DQSIEN_RK0_MON_C0 Fld(1, 30) //[30:30]
    #define MISC_APHY_DBG_MON_C0_AD_RX_ARCLK_DQSIEN_RK1_MON_C0 Fld(1, 31) //[31:31]

#define DDRPHY_REG_MISC_DBG_DB_TXTRACK_MESSAGE0                (DDRPHY_NAO_BASE_ADDRESS + 0x16C0)
    #define MISC_DBG_DB_TXTRACK_MESSAGE0_RK0_MR18_INT1_FOR_INT_X0 Fld(16, 0) //[15:0]
    #define MISC_DBG_DB_TXTRACK_MESSAGE0_RK0_MR19_INT1_FOR_INT_X0 Fld(16, 16) //[31:16]

#define DDRPHY_REG_MISC_DBG_DB_TXTRACK_MESSAGE1                (DDRPHY_NAO_BASE_ADDRESS + 0x16C4)
    #define MISC_DBG_DB_TXTRACK_MESSAGE1_RK1_MR18_INT1_FOR_INT_X0 Fld(16, 0) //[15:0]
    #define MISC_DBG_DB_TXTRACK_MESSAGE1_RK1_MR19_INT1_FOR_INT_X0 Fld(16, 16) //[31:16]

#define DDRPHY_REG_MISC_DBG_DB_TXTRACK_MESSAGE2                (DDRPHY_NAO_BASE_ADDRESS + 0x16C8)
    #define MISC_DBG_DB_TXTRACK_MESSAGE2_RK0_MR18_INT2_FOR_INT_X0 Fld(16, 0) //[15:0]
    #define MISC_DBG_DB_TXTRACK_MESSAGE2_RK0_MR19_INT2_FOR_INT_X0 Fld(16, 16) //[31:16]

#define DDRPHY_REG_MISC_DBG_DB_TXTRACK_MESSAGE3                (DDRPHY_NAO_BASE_ADDRESS + 0x16CC)
    #define MISC_DBG_DB_TXTRACK_MESSAGE3_RK1_MR18_INT2_FOR_INT_X0 Fld(16, 0) //[15:0]
    #define MISC_DBG_DB_TXTRACK_MESSAGE3_RK1_MR19_INT2_FOR_INT_X0 Fld(16, 16) //[31:16]

#define DDRPHY_REG_MISC_DBG_DB_DVFS                            (DDRPHY_NAO_BASE_ADDRESS + 0x16D0)
    #define MISC_DBG_DB_DVFS_SHUFFLE_END_FOR_INT_X0            Fld(1, 0) //[0:0]
    #define MISC_DBG_DB_DVFS_TCKFSPE_OK_FOR_INT_X0             Fld(1, 1) //[1:1]
    #define MISC_DBG_DB_DVFS_TCKFSPX_OK_FOR_INT_X0             Fld(1, 2) //[2:2]
    #define MISC_DBG_DB_DVFS_TVRCG_EN_OK_FOR_INT_X0            Fld(1, 3) //[3:3]
    #define MISC_DBG_DB_DVFS_RTMRW_MRW1_RSP_FOR_INT_X0         Fld(1, 4) //[4:4]
    #define MISC_DBG_DB_DVFS_RTMRW_MRW2_RSP_FOR_INT_X0         Fld(1, 5) //[5:5]
    #define MISC_DBG_DB_DVFS_RTMRW_MRW3_RSP_FOR_INT_X0         Fld(1, 6) //[6:6]
    #define MISC_DBG_DB_DVFS_DVFS_STATE_FOR_INT_X0             Fld(8, 8) //[15:8]
    #define MISC_DBG_DB_DVFS_SCARB_SM_FOR_INT_X0               Fld(5, 16) //[20:16]
