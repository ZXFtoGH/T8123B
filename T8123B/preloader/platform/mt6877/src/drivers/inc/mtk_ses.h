...
#define AMUX_OUT	0x11D40060

/* eFuse */
#define CPU0_EFUSE	(0x11C10B70)
#define CPU1_EFUSE	(0x11C10B74)
#define CPU2_EFUSE	(0x11C10B60)
#define CPU3_EFUSE	(0x11C10B60)
#define CPU4_EFUSE	(0x11C10B60)
#define CPU5_EFUSE	(0x11C10B64)
#define CPU6_EFUSE	(0x11C10B68)
#define CPU7_EFUSE	(0x11C10B6C)
#define SESBG_EFUSE	(0x11C10B70)
