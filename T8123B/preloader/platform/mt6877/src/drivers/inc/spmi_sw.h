...
/* macro for spmi_mst clock config */
#ifndef WDT_SWSYSRST2
#define WDT_SWSYSRST2			(RGU_BASE+0x0210)
#endif
#ifndef CLK_CFG_UPDATE2
#define CLK_CFG_UPDATE2			(TOPCKGEN_BASE+0x00c)
#endif
#ifndef CLK_CFG_15_SET
#define CLK_CFG_15_SET			(TOPCKGEN_BASE+0x104)
#endif
#ifndef CLK_CFG_15_CLR
#define CLK_CFG_15_CLR			(TOPCKGEN_BASE+0x108)
#endif
#ifndef CLK_CFG_16_SET
 ...
 */
#define SPMI_SCL_GPIO			115
#define SPMI_SDA_GPIO			116
#define SPMI_SCL_P_GPIO			117
#define SPMI_SDA_P_GPIO			118
#define SPMI_SCL_DRV_ADDR		(IOCFG_LM_BASE+0x0010)
#define SPMI_SDA_DRV_ADDR		(IOCFG_LM_BASE+0x0010)
#define SPMI_SCL_DRV_OFFSET		(18)
#define SPMI_SDA_DRV_OFFSET		(21)
#define SPMI_SCL_P_DRV_OFFSET		(24)
#define SPMI_SDA_P_DRV_OFFSET		(27)
...
#define IOCFG_LM_DRV_CFG2_SET		((IOCFG_LM_BASE+0x024))
#define IOCFG_LM_DRV_CFG2_CLR		((IOCFG_LM_BASE+0x028))
#define IOCFG_LM_EH_CFG0_CLR		((IOCFG_LM_BASE+0x038))
#define IOCFG_LM_IES_CFG0_SET		((IOCFG_LM_BASE+0x054))
#define IOCFG_LM_IES_CFG0_CLR		((IOCFG_LM_BASE+0x058))
#define IOCFG_LM_PD_CFG0_CLR		((IOCFG_LM_BASE+0x068))
#define IOCFG_LM_PU_CFG0_CLR		((IOCFG_LM_BASE+0x078))
#define IOCFG_LM_RDSEL_CFG0_CLR		((IOCFG_LM_BASE+0x088))
#define IOCFG_LM_SMT_CFG0_SET		((IOCFG_LM_BASE+0x0A4))
#define IOCFG_LM_TDSEL_CFG1_CLR		((IOCFG_LM_BASE+0x0C8))
