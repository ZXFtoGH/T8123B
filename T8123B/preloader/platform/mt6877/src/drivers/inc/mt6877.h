...
#define IOCFG_RB_BASE       (IO_PHYS + 0x01C30000)
...
#define PMIF_SPMI_P_BASE    (IO_PHYS + 0x00024000)
#define SPMI_MST_P_BASE     (IO_PHYS + 0x00025000)
...
#define MSDCSYS_TOP_CG_CON  (IO_PHYS + 0x01F10000)
...
#define MSDC2_BASE          (IO_PHYS + 0x01F80000)
...
#define SCP_BASE        (IO_PHYS + 0x10700000)

#define GPU_PLL_CTRL_BASE	(IO_PHYS + 0x03FA0000)
...
/* IRQ */
#define SYS_TIMER_IRQ       (277 + 32)
#define GZ_SW_IRQ           (304 + 32)
