...
#define DDRPHY_MD32_REG_SSPM_CFGREG_SRAM_DELSEL         (DDRPHY_MD32_BASE_ADDRESS + 0x40194)
...
#define DDRPHY_MD32_REG_SSPM_CFGREG_SPM_UNI_ARB         (DDRPHY_MD32_BASE_ADDRESS + 0x401B0)
    #define SSPM_CFGREG_SPM_UNI_ARB_RG_SW_MODE                 Fld(1, 0) //[0:0]
    #define SSPM_CFGREG_SPM_UNI_ARB_RG_BYPASS_MODE             Fld(1, 1) //[1:1]
...
#define DDRPHY_MD32_REG_LPIF_FSM_CTRL_0                 (DDRPHY_MD32_BASE_ADDRESS + 0x47020)
    ...
    #define LPIF_FSM_CTRL_0_RESERVED_X20_31_31                 Fld(1, 31) //[31:31]
...
#define DDRPHY_MD32_REG_LPIF_LOW_POWER_CFG_4            (DDRPHY_MD32_BASE_ADDRESS + 0x4703C)
    ...
    #define LPIF_LOW_POWER_CFG_4_MD32_DRAMC_CKGEN_MCK_CG_EN    Fld(1, 31) //[31:31]
...
#define DDRPHY_MD32_REG_LPIF_TOP_CKANCHOR_RSV           (DDRPHY_MD32_BASE_ADDRESS + 0x4706C)
    #define LPIF_TOP_CKANCHOR_RSV_RSV_TO_TOP_CK_ANCHOR         Fld(32, 0) //[31:0]
...
#define DDRPHY_MD32_REG_LPIF_RESERVED_10                (DDRPHY_MD32_BASE_ADDRESS + 0x47078)
...
#define DDRPHY_MD32_REG_LPIF_SEMA_2MCU                  (DDRPHY_MD32_BASE_ADDRESS + 0x4707C)
    ...
    #define LPIF_SEMA_2MCU_SEMA_MD32_REQ                       Fld(1, 4) //[4:4]
    #define LPIF_SEMA_2MCU_SEMA_MD32_HGIH_PRI                  Fld(1, 5) //[5:5]
    #define LPIF_SEMA_2MCU_RESERVED_X7C_15_4                   Fld(10, 6) //[15:6]
    #define LPIF_SEMA_2MCU_SEMA_MD32_IN_PRE_REQ                Fld(1, 16) //[16:16]
    #define LPIF_SEMA_2MCU_SEMA_MD32_IN_POST_REQ               Fld(1, 17) //[17:17]
    #define LPIF_SEMA_2MCU_SEMA_MD32_IN_PRE_ACK                Fld(1, 18) //[18:18]
    #define LPIF_SEMA_2MCU_SEMA_MD32_IN_POST_ACK               Fld(1, 19) //[19:19]
    #define LPIF_SEMA_2MCU_SEMA_MD32_OUT_PRE_REQ               Fld(1, 20) //[20:20]
    #define LPIF_SEMA_2MCU_SEMA_MD32_OUT_POST_REQ              Fld(1, 21) //[21:21]
    #define LPIF_SEMA_2MCU_SEMA_MD32_OUT_PRE_ACK               Fld(1, 22) //[22:22]
    #define LPIF_SEMA_2MCU_SEMA_MD32_OUT_POST_ACK              Fld(1, 23) //[23:23]
...
#define DDRPHY_MD32_REG_LPIF_STATUS_20                  (DDRPHY_MD32_BASE_ADDRESS + 0x470DC)
    ...
    #define LPIF_STATUS_20_RESERVED_XDC_31_28                  Fld(2, 30) //[31:30]
...
#define DDRPHY_MD32_REG_LPIF_STATUS_21                  (DDRPHY_MD32_BASE_ADDRESS + 0x47174)
    #define LPIF_STATUS_21_RESERVED_X174_11_0                  Fld(12, 0) //[11:0]
    ...
    #define LPIF_STATUS_21_RESERVED_X174_31_16                 Fld(16, 16) //[31:16]
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH18                (DDRPHY_MD32_BASE_ADDRESS + 0x473C8)
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_ROOT_1ST_CK_SEL_EN Fld(2, 0) //[1:0]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_ROOT_2ND_CK_SEL_EN Fld(2, 2) //[3:2]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_ROOT_CK_SEL        Fld(4, 4) //[7:4]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_ROOT_CK_UPDATE     Fld(2, 8) //[9:8]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_SUB_DCM_FREERUN    Fld(2, 10) //[11:10]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_ALL_TRACKING_OFF   Fld(2, 12) //[13:12]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_SHU_SRAM_LP_RESTORE Fld(2, 14) //[15:14]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_SHU_SRAM_LP_LOAD   Fld(2, 16) //[17:16]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_SHU_DRAM_DMA_STOP  Fld(2, 18) //[19:18]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_SHU_SRAM_DMA_HIGH_PRIORITY Fld(2, 20) //[21:20]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_BLOCK_CTO_ALE      Fld(2, 22) //[23:22]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_PLL_RESETB         Fld(2, 24) //[25:24]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DR_GATE_RETRY_RK       Fld(2, 26) //[27:26]
    #define LPIF_DBG_LATCH18_DRAMC_MD32_DPY_DVFSNOQUEFLUSH_DIS Fld(2, 28) //[29:28]
    #define LPIF_DBG_LATCH18_LPIF_DFD_DEBUG_ISO_EN             Fld(1, 30) //[30:30]
    #define LPIF_DBG_LATCH18_MD32_DRAMC_CKGEN_MCK_CG_EN        Fld(1, 31) //[31:31]
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH20                (DDRPHY_MD32_BASE_ADDRESS + 0x473D0)
    #define LPIF_DBG_LATCH20_RESERVED_X310_11_0                Fld(2, 10) //[11:10]
    ...
    #define LPIF_DBG_LATCH20_RESERVED_X310_31_16               Fld(16, 16) //[31:16]
