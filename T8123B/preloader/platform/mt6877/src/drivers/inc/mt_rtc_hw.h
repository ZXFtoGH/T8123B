...
#define RTC_RG_EOSC_CALI_TD_1SEC		(3 << PMIC_RG_EOSC_CALI_TD_SHIFT)
#define RTC_RG_EOSC_CALI_TD_2SEC		(4 << PMIC_RG_EOSC_CALI_TD_SHIFT)
#define RTC_RG_EOSC_CALI_TD_4SEC		(5 << PMIC_RG_EOSC_CALI_TD_SHIFT)
#define RTC_RG_EOSC_CALI_TD_8SEC		(6 << PMIC_RG_EOSC_CALI_TD_SHIFT)
#define RTC_RG_EOSC_CALI_TD_16SEC		(7 << PMIC_RG_EOSC_CALI_TD_SHIFT)
