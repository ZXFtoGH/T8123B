...
/**********************************************/
  ...
  #define mcPRINTF print
    ...
    #define mcSHOW_DUMP_INIT_RG_MSG(_x_) {mcPRINTF _x_;}
#else
    #define mcSHOW_DBG_MSG(_x_)   {mcPRINTF _x_;}
    #define mcSHOW_DBG_MSG2(_x_)  {mcPRINTF _x_;}
    #define mcSHOW_DBG_MSG3(_x_)  {mcPRINTF _x_;}
    #define mcSHOW_DBG_MSG4(_x_)  {mcPRINTF _x_;}
    #define mcSHOW_DBG_MSG5(_x_)
    #define mcSHOW_DBG_MSG6(_x_)  {mcPRINTF _x_;}
    #define mcSHOW_EYESCAN_MSG(_x_)
    #define mcSHOW_TIME_MSG(_x_)
    #define mcSHOW_ERR_MSG(_x_)   {mcPRINTF _x_;}
    #define mcDUMP_REG_MSG(_x_)
    ...
    #define mcSHOW_EYESCAN_MSG(_x_)
    #define mcSHOW_TIME_MSG(_x_)   {mcPRINTF _x_;}
    #define mcSHOW_ERR_MSG(_x_)
    #define mcDUMP_REG_MSG(_x_)
    #elif DUMP_ALLSUH_RG
    #define mcSHOW_DBG_MSG(_x_)     {mcDELAY_US(50);mcPRINTF _x_;}
    ...
    #define mcSHOW_EYESCAN_MSG(_x_)
    #define mcSHOW_TIME_MSG(_x_)
    #define mcSHOW_ERR_MSG(_x_) {mcDELAY_US(50);mcPRINTF _x_;}
    #define mcDUMP_REG_MSG(_x_) {mcDELAY_US(50);mcPRINTF _x_;}
    ...
    #define mcSHOW_DBG_MSG5(_x_)
    #define mcSHOW_DBG_MSG6(_x_)
    #define mcSHOW_JV_LOG_MSG(_x_) {mcPRINTF _x_;}
    #define mcSHOW_EYESCAN_MSG(_x_) {mcPRINTF _x_;}   //mcSHOW_JV_LOG_MSG(_x_) is for vendor JV
    #define mcSHOW_TIME_MSG(_x_)
    #define mcSHOW_ERR_MSG(_x_)
    #define mcDUMP_REG_MSG(_x_)
    #elif VENDER_JV_LOG
    ...
    #define mcSHOW_DBG_MSG5(_x_)
    #define mcSHOW_DBG_MSG6(_x_)
    #define mcSHOW_JV_LOG_MSG(_x_)    {mcPRINTF _x_;}   //mcSHOW_JV_LOG_MSG(_x_) is for vendor JV
    #define mcSHOW_EYESCAN_MSG(_x_) {mcPRINTF _x_;}   //mcSHOW_JV_LOG_MSG(_x_) is for vendor JV
    #define mcSHOW_TIME_MSG(_x_)
    #define mcSHOW_ERR_MSG(_x_)
    #define mcDUMP_REG_MSG(_x_)
    ...
    #define mcSHOW_DBG_MSG6(_x_)
    #define mcSHOW_JV_LOG_MSG(_x_)
    #define mcSHOW_DUMP_INIT_RG_MSG(_x_) {GPT_Delay_us(50); mcPRINTF _x_;}
    #define mcSHOW_EYESCAN_MSG(_x_)
    #define mcSHOW_TIME_MSG(_x_)
    #define mcSHOW_ERR_MSG(_x_)
    #define mcDUMP_REG_MSG(_x_)
    ...
    #define mcSHOW_DBG_MSG6(_x_)
    #define mcSHOW_JV_LOG_MSG(_x_)
    #define mcSHOW_MRW_MSG(_x_)    {mcPRINTF_RG _x_;}
    #define mcSHOW_EYESCAN_MSG(_x_)
    #define mcSHOW_TIME_MSG(_x_)
    #define mcSHOW_ERR_MSG(_x_)    {mcPRINTF_RG _x_;}
    #define mcDUMP_REG_MSG(_x_)
    #else   // ETT real chip
    #define mcSHOW_DBG_MSG(_x_)   {mcDELAY_US(100); mcPRINTF _x_;}
    #define mcSHOW_DBG_MSG2(_x_)  {mcDELAY_US(100); mcPRINTF _x_;}
    #define mcSHOW_DBG_MSG3(_x_)  {mcDELAY_US(100); mcPRINTF _x_;}
    #define mcSHOW_DBG_MSG4(_x_)
    #define mcSHOW_DBG_MSG5(_x_)
    #define mcSHOW_DBG_MSG6(_x_)
    #define mcSHOW_JV_LOG_MSG(_x_)
    #define mcSHOW_EYESCAN_MSG(_x_) {if (gEye_Scan_color_flag) {mcDELAY_US(200);};mcPRINTF _x_;}
    #define mcSHOW_TIME_MSG(_x_)
    #define mcSHOW_ERR_MSG(_x_)   {mcPRINTF _x_;}
    #define mcDUMP_REG_MSG(_x_)
    #endif
    ...
    #define mcSHOW_DBG_MSG6(_x_)  {mcPRINTF _x_;}
        ...
        #define mcSHOW_EYESCAN_MSG(_x_)  {mcPRINTF _x_;}
        #define mcSHOW_JV_LOG_MSG(_x_)   {mcPRINTF _x_;}
        #else
        #define mcSHOW_EYESCAN_MSG(_x_)
        #define mcSHOW_JV_LOG_MSG(_x_)
