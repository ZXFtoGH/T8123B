...
#if defined(MTK_MSDC_BRINGUP_DEBUG)
	if (id == 0) {
		msdc_pr_err("MSDC0 MODE3[%x] = 0x%X\tshould: 0x11111111\n",
			MSDC0_GPIO_MODE3, MSDC_READ32(MSDC0_GPIO_MODE3));
		msdc_pr_err("MSDC0 MODE4[%x] = 0x%X\tshould: 0x????1111\n",
			MSDC0_GPIO_MODE4, MSDC_READ32(MSDC0_GPIO_MODE4));
		msdc_pr_err("MSDC0 IES   [%x] = 0x%X\tshould: 0x???1FFE?\n",
			MSDC0_GPIO_IES_ADDR, MSDC_READ32(MSDC0_GPIO_IES_ADDR));
		msdc_pr_err("MSDC0 SMT   [%x] = 0x%X\tshould: 0x?????FFF\n",
			MSDC0_GPIO_SMT_ADDR, MSDC_READ32(MSDC0_GPIO_SMT_ADDR));
		msdc_pr_err("MSDC0 TDSEL0[%x] = 0x%X,[%x] = 0x%X"
			"\tshould: 0x00000000 should: 0x????0000\n",
			MSDC0_GPIO_TDSEL0_ADDR_0,
			MSDC_READ32(MSDC0_GPIO_TDSEL0_ADDR_0),
			MSDC0_GPIO_TDSEL0_ADDR_1,
			MSDC_READ32(MSDC0_GPIO_TDSEL0_ADDR_1));
		msdc_pr_err("MSDC0 RDSEL0[%x] = 0x%X,[%x] = 0x%X,[%x] = 0x%X"
			"\tshould: 0x00000000 should: 0x00000000 should: 0x?????000\n",
		...
		msdc_pr_err("MSDC0 DRV0  [%x] = 0x%X,[%x] = 0x%X"
			"\tshould: 0x?9249249 should:???????9\n",
...
void msdc_pin_config_by_id(u32 id, u32 mode)
{
	if (id == 0) {
		...
		if (mode == MSDC_PIN_PULL_NONE) {
			...
			MSDC_SET_FIELD(MSDC0_GPIO_R0_ADDR, MSDC0_R0_ALL_MASK, 0x0);
			MSDC_SET_FIELD(MSDC0_GPIO_R1_ADDR, MSDC0_R1_ALL_MASK, 0xFFF);
			...
			MSDC_SET_FIELD(MSDC0_GPIO_R0_ADDR, MSDC0_R0_ALL_MASK, 0xBFE);
