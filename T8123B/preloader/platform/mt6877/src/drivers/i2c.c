	...
	U32 *timing_sample_cnt)
{
	...
	/* Just for MT6761/MT6762/MT6765/MT6877 */
...
static void i2c_set_driving(void)
{
	...
	/* SDA0[5:3]  SCL0[2:0]*/
	I2C_SET_REG32((IOCFG_LM_BASE + 0x30), 0x3F, 0x3F);
	/*SCL1[5:3]*/
	I2C_SET_REG32((IOCFG_BR_BASE + 0x50), (7 << 3), (7 << 3));
	/*SDA1[5:3]*/
	I2C_SET_REG32((IOCFG_BM_BASE + 0x30), (7 << 3), (7 << 3));
	/*SDA2[14:12]  SCL2[2:0]*/
	I2C_SET_REG32((IOCFG_BR_BASE + 0x40), (7 << 12 | 7 << 0), (7 << 12 | 7 << 0));
	/*SDA3[5:3]  SCL3[2:0]*/
	I2C_SET_REG32((IOCFG_RT_BASE + 0x30), 0x3F, 0x3F);
	/*SDA4[17:15]  SCL4[5:3]*/
	I2C_SET_REG32((IOCFG_BR_BASE + 0x40), (7 << 15 | 7 << 3), (7 << 15 | 7 << 3));
	/*SCL5[29:27]*/
	I2C_SET_REG32((IOCFG_BR_BASE + 0x40), (7 << 27), (7 << 27));
	/*SDA5[2:0]*/
	I2C_SET_REG32((IOCFG_BR_BASE + 0x50), (7 << 0), (7 << 0));
	/*SDA6[5:3]  SCL6[2:0]*/
	I2C_SET_REG32((IOCFG_TL_BASE + 0x30), 0x3F, 0x3F);
	/*SCL7[8:6]  SDA7[20:18]*/
	I2C_SET_REG32((IOCFG_BR_BASE + 0x40), (7 << 6 | 7 << 18), (7 << 6 | 7 << 18));
	/*SCL8[2:0]*/
	I2C_SET_REG32((IOCFG_BM_BASE + 0x30), 0x3F, 0x3F);
	/*SDA8[23:21]*/
	I2C_SET_REG32((IOCFG_BR_BASE + 0x40), (7 << 21), (7 << 21));
	/*SCL9[11:9]  SDA9[26:24]*/
	I2C_SET_REG32((IOCFG_BR_BASE + 0x40), (7 << 24 | 7 << 9), (7 << 24 | 7 << 9));
}

static void internal_resister_setting(void)
{
	/* Switch internal resistor */
	/* 0x0:75k 0x1:10k 0x2:5k   0x3:4k*/
	/* 0x4:3k  0x5:2k  0x6:1.5k 0x7:1k*/
	/*SCL0[2:0] SDA0[5:3]*/
	I2C_SET_REG32(IOCFG_LM_BASE + 0xA0, (7 << 3 | 7 << 0), (7 << 3 | 7 << 0));
	/*SCL1[5:3]*/
	I2C_SET_REG32(IOCFG_BR_BASE + 0xF0, (7 << 3), (7 << 3));
	/*SDA1[5:3]*/
	I2C_SET_REG32(IOCFG_BM_BASE + 0xE0, (7 << 3), (7 << 3));
	/*I2C2,4,7,9*/
	I2C_SET_REG32(IOCFG_BR_BASE + 0xE0, 0x7E3FFFF,
		(7 << 24 | 7 << 18 | 7 << 15 | 7 << 12 | 7 << 9 | 7 << 6 | 7 << 3 | 7));
	/*SCL3[2:0] SDA3[5:3]*/
	I2C_SET_REG32(IOCFG_RT_BASE + 0xC0, (7 << 3 | 7 << 0), (7 << 3 | 7 << 0));
	/*SCL5[29:27]*/
	I2C_SET_REG32(IOCFG_BR_BASE + 0xE0, (7 << 27), (7 << 27));
	/*SDA5[2:0]*/
	I2C_SET_REG32(IOCFG_BR_BASE + 0xF0, (7 << 0), (7 << 0));
	/*SCL6[2:0] SDA6[5:3]*/
	I2C_SET_REG32(IOCFG_TL_BASE + 0xE0, (7 << 3 | 7 << 0), (7 << 3 | 7 << 0));
	/*SCL8[29:27]*/
	I2C_SET_REG32(IOCFG_BM_BASE + 0xE0, (7 << 0), (7 << 0));
	/*SDA8[29:27]*/
	I2C_SET_REG32(IOCFG_BR_BASE + 0xE0, (7 << 21), (7 << 21));
}
#endif
