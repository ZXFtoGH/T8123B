...
DRAM_DFS_FREQUENCY_TABLE_T* get_FreqTbl_by_SRAMIndex(DRAMC_CTX_T *p, DRAM_DFS_SRAM_SHU_T SRAMIdx)
{
    U8 u1ShuffleIdx = 0;
    DRAM_DFS_FREQUENCY_TABLE_T *pFreqTbl;
    mcSHOW_DBG_MSG3(("\n get_FreqTbl_by_shuffleIndex SRAMIdx=%d \n", SRAMIdx));
...
void DFSRuntimeMRW_preset_LP4(DRAMC_CTX_T *p, U8 sram_shu_level, K_TIME_BASED_T BeforeAfter)
{
    ...
    vIO32WriteFldMulti_All(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_0 + (sram_shu_level << 5),
    ...
    vIO32WriteFldMulti_All(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_1 + (sram_shu_level << 5),
    ...
    //! save shux mr51
    vIO32WriteFldMulti_All(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_2 + (sram_shu_level << 5),
    ...
    //! save shux mr12
    vIO32WriteFldMulti_All(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_3 + (sram_shu_level << 5),
        P_Fld(u1MR12Value[CHANNEL_A][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_0_3_MR_OP_SET_SHU_0_12) |
        P_Fld(u1MR12Value[CHANNEL_A][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_0_3_MR_OP_SET_SHU_0_13) |
        P_Fld(u1MR12Value[CHANNEL_B][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_0_3_MR_OP_SET_SHU_0_14) |
        P_Fld(u1MR12Value[CHANNEL_B][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_0_3_MR_OP_SET_SHU_0_15));
    #if ENABLE_DFS_DEBUG_LOG
    mcSHOW_DBG_MSG(("\tMR12: CHA RK0 = 0x%x, CHA RK1 = 0x%x, CHB RK0 = 0x%x, CHB RK1 = 0x%x\n", u1MR12Value[CHANNEL_A][RANK_0][p->dram_fsp], u1MR12Value[CHANNEL_A][RANK_1][p->dram_fsp], u1MR12Value[CHANNEL_B][RANK_0][p->dram_fsp], u1MR12Value[CHANNEL_B][RANK_1][p->dram_fsp]));
    #endif

    //! save shux mr14
    vIO32WriteFldMulti_All(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_0 + (sram_shu_level << 5),
        P_Fld(u1MR14Value[CHANNEL_A][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_0_MR_OP_SET_SHU_1_0) |
        P_Fld(u1MR14Value[CHANNEL_A][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_0_MR_OP_SET_SHU_1_1) |
        P_Fld(u1MR14Value[CHANNEL_B][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_0_MR_OP_SET_SHU_1_2) |
        P_Fld(u1MR14Value[CHANNEL_B][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_0_MR_OP_SET_SHU_1_3));
    #if ENABLE_DFS_DEBUG_LOG
    mcSHOW_DBG_MSG(("\tMR14: CHA RK0 = 0x%x, CHA RK1 = 0x%x, CHB RK0 = 0x%x, CHB RK1 = 0x%x\n", u1MR14Value[CHANNEL_A][RANK_0][p->dram_fsp], u1MR14Value[CHANNEL_A][RANK_1][p->dram_fsp], u1MR14Value[CHANNEL_B][RANK_0][p->dram_fsp], u1MR14Value[CHANNEL_B][RANK_1][p->dram_fsp]));
    #endif
}
...
static void DFSRuntimeMRWEn_LP4(DRAMC_CTX_T *p, U8 cur_shu_mux_index, U8 nxt_shu_level)
{
    ...
    rtmr1 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_0 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_0_MR_OP_SET_SHU_0_0);
    rtmr2 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_0 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_0_MR_OP_SET_SHU_0_1);
    rtmr3 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_0 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_0_MR_OP_SET_SHU_0_2);
    //! get shux mr21/mr22/mr51
    rtmr21 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_1 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_1_MR_OP_SET_SHU_0_5);
    rtmr51 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_2 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_2_MR_OP_SET_SHU_0_8);

    rtmr13_cur &= 0x3F;
    rtmr13_nxt = rtmr13_cur;
    if (p->boot_fsp== FSP_1)
    {
        if(cur_shu_mux_index == PHYPLL_MODE) // FSP1 -> FSP0, from PHYPLL to CLRPLL
        {
            rtmr13_cur |= (0x3 << 6); // MR13 OP7(FSP-OP) = 1, OP6(FSP-WR) = 1
            rtmr13_nxt |= (0x2 << 6); // MR13 OP7(FSP-OP) = 1, OP6(FSP-WR) = 0
        }
        else // FSP0 -> FSP1, from PCLRPLL to PHYPLL
        {
    ...
    {
        if(cur_shu_mux_index == PHYPLL_MODE) // FSP0 -> FSP1, from PCLRPLL to PHYPLL
        {
            rtmr13_cur |= (0x0 << 6); // MR13 OP7(FSP-OP) = 0, OP6(FSP-WR) = 0
            rtmr13_nxt |= (0x1 << 6); // MR13 OP7(FSP-OP) = 0, OP6(FSP-WR) = 1
        }
        else // FSP1 -> FSP0, from PHYPLL to CLRPLL
        {
            rtmr13_cur |= (0x3 << 6); // MR13 OP7(FSP-OP) = 1, OP6(FSP-WR) = 1
            rtmr13_nxt |= (0x2 << 6); // MR13 OP7(FSP-OP) = 1, OP6(FSP-WR) = 0
        }
    ...
    for (u1ChIdx = CHANNEL_A; u1ChIdx < p->support_channel_num; u1ChIdx++)
    {
        ...
        for (u1RankIdx = RANK_0; u1RankIdx < p->support_rank_num; u1RankIdx++)
        {
            ...
            if (u1RankIdx==RANK_0)
            {
                rtmr11 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_0 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_0_MR_OP_SET_SHU_0_3);
                rtmr22 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_1 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_1_MR_OP_SET_SHU_0_6);
            }
            else //(u1RankIdx==RANK_1)
            {
                rtmr11 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_1 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_1_MR_OP_SET_SHU_0_4);
                rtmr22 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_1 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_1_MR_OP_SET_SHU_0_7);
            }

            //By CHANNEL By RANK
            rtmr12 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_3 + DPMOffset + (nxt_shu_level << 5),  Fld(8, (u1ChIdx*2+u1RankIdx*1)*8));
            rtmr14 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_0 + DPMOffset + (nxt_shu_level << 5),  Fld(8, (u1ChIdx*2+u1RankIdx*1)*8));
...
void DFSRuntimeMRW_preset_LP5(DRAMC_CTX_T *p, U8 sram_shu_level, K_TIME_BASED_T BeforeAfter)
{
    ...
    vIO32WriteFldMulti_All(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_3 + (sram_shu_level << 5),
        P_Fld(u1MR12Value[CHANNEL_A][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_0_3_MR_OP_SET_SHU_0_12) |
        P_Fld(u1MR12Value[CHANNEL_A][RANK_1][p->dram_fsp], LPIF_MR_OP_STORE_SHU_0_3_MR_OP_SET_SHU_0_13) |
        P_Fld(u1MR12Value[CHANNEL_B][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_0_3_MR_OP_SET_SHU_0_14) |
        P_Fld(u1MR12Value[CHANNEL_B][RANK_1][p->dram_fsp], LPIF_MR_OP_STORE_SHU_0_3_MR_OP_SET_SHU_0_15));
    #if ENABLE_DFS_DEBUG_LOG
    mcSHOW_DBG_MSG(("\tMR12: CHA RK0 = 0x%x, CHA RK1 = 0x%x, CHB RK0 = 0x%x, CHB RK1 = 0x%x\n", u1MR12Value[CHANNEL_A][RANK_0][p->dram_fsp], u1MR12Value[CHANNEL_A][RANK_1][p->dram_fsp], u1MR12Value[CHANNEL_B][RANK_0][p->dram_fsp], u1MR12Value[CHANNEL_B][RANK_1][p->dram_fsp]));
    #endif
    ...
    vIO32WriteFldMulti_All(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_0 + (sram_shu_level << 5),
        P_Fld(u1MR14Value[CHANNEL_A][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_0_MR_OP_SET_SHU_1_0) |
        P_Fld(u1MR14Value[CHANNEL_A][RANK_1][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_0_MR_OP_SET_SHU_1_1) |
        P_Fld(u1MR14Value[CHANNEL_B][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_0_MR_OP_SET_SHU_1_2) |
        P_Fld(u1MR14Value[CHANNEL_B][RANK_1][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_0_MR_OP_SET_SHU_1_3));
    #if ENABLE_DFS_DEBUG_LOG
    mcSHOW_DBG_MSG(("\tMR14: CHA RK0 = 0x%x, CHA RK1 = 0x%x, CHB RK0 = 0x%x, CHB RK1 = 0x%x\n", u1MR14Value[CHANNEL_A][RANK_0][p->dram_fsp], u1MR14Value[CHANNEL_A][RANK_1][p->dram_fsp], u1MR14Value[CHANNEL_B][RANK_0][p->dram_fsp], u1MR14Value[CHANNEL_B][RANK_1][p->dram_fsp]));
    #endif

    //! save shux mr15
    vIO32WriteFldMulti_All(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_1 + (sram_shu_level << 5),
        P_Fld(u1MR15Value[CHANNEL_A][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_1_MR_OP_SET_SHU_1_4) |
        P_Fld(u1MR15Value[CHANNEL_A][RANK_1][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_1_MR_OP_SET_SHU_1_5) |
        P_Fld(u1MR15Value[CHANNEL_B][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_1_MR_OP_SET_SHU_1_6) |
        P_Fld(u1MR15Value[CHANNEL_B][RANK_1][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_1_MR_OP_SET_SHU_1_7));
    #if ENABLE_DFS_DEBUG_LOG
    mcSHOW_DBG_MSG(("\tMR15: CHA RK0 = 0x%x, CHA RK1 = 0x%x, CHB RK0 = 0x%x, CHB RK1 = 0x%x\n", u1MR15Value[CHANNEL_A][RANK_0][p->dram_fsp], u1MR15Value[CHANNEL_A][RANK_1][p->dram_fsp], u1MR15Value[CHANNEL_B][RANK_0][p->dram_fsp], u1MR15Value[CHANNEL_B][RANK_1][p->dram_fsp]));
    #endif

    //! save shux mr24
    vIO32WriteFldMulti_All(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_2 + (sram_shu_level << 5),
        P_Fld(u1MR24Value[CHANNEL_A][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_2_MR_OP_SET_SHU_1_8) |
        P_Fld(u1MR24Value[CHANNEL_A][RANK_1][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_2_MR_OP_SET_SHU_1_9) |
        P_Fld(u1MR24Value[CHANNEL_B][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_2_MR_OP_SET_SHU_1_10) |
        P_Fld(u1MR24Value[CHANNEL_B][RANK_1][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_2_MR_OP_SET_SHU_1_11));
    #if ENABLE_DFS_DEBUG_LOG
    mcSHOW_DBG_MSG(("\tMR24: CHA RK0 = 0x%x, CHA RK1 = 0x%x, CHB RK0 = 0x%x, CHB RK1 = 0x%x\n", u1MR24Value[CHANNEL_A][RANK_0][p->dram_fsp], u1MR24Value[CHANNEL_A][RANK_1][p->dram_fsp], u1MR24Value[CHANNEL_B][RANK_0][p->dram_fsp], u1MR24Value[CHANNEL_B][RANK_1][p->dram_fsp]));
    #endif

    //! save shux mr30
    vIO32WriteFldMulti_All(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_3 + (sram_shu_level << 5),
        P_Fld(u1MR30Value[CHANNEL_A][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_3_MR_OP_SET_SHU_1_12) |
        P_Fld(u1MR30Value[CHANNEL_A][RANK_1][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_3_MR_OP_SET_SHU_1_13) |
        P_Fld(u1MR30Value[CHANNEL_B][RANK_0][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_3_MR_OP_SET_SHU_1_14) |
        P_Fld(u1MR30Value[CHANNEL_B][RANK_1][p->dram_fsp], LPIF_MR_OP_STORE_SHU_1_3_MR_OP_SET_SHU_1_15));
    #if ENABLE_DFS_DEBUG_LOG
    mcSHOW_DBG_MSG(("\tMR30: CHA RK0 = 0x%x, CHA RK1 = 0x%x, CHB RK0 = 0x%x, CHB RK1 = 0x%x\n", u1MR30Value[CHANNEL_A][RANK_0][p->dram_fsp], u1MR30Value[CHANNEL_A][RANK_1][p->dram_fsp], u1MR30Value[CHANNEL_B][RANK_0][p->dram_fsp], u1MR30Value[CHANNEL_B][RANK_1][p->dram_fsp]));
    #endif
...
static void DFSRuntimeMRWEn_LP5(DRAMC_CTX_T *p, U8 cur_shu_mux_index, U8 nxt_shu_level)
{
    ...
    rtmr2 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_0 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_0_MR_OP_SET_SHU_0_1);
    rtmr3 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_0 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_0_MR_OP_SET_SHU_0_2);
    rtmr10 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_0 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_0_MR_OP_SET_SHU_0_3);
    //! get shux mr11/mr17/mr18/mr19
    rtmr11 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_1 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_1_MR_OP_SET_SHU_0_4);
    rtmr17 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_1 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_1_MR_OP_SET_SHU_0_5);
    rtmr18 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_1 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_1_MR_OP_SET_SHU_0_6);
    rtmr19 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_1 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_1_MR_OP_SET_SHU_0_7);
    //! get shux mr20/mr22/mr41
    rtmr22 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_2 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_2_MR_OP_SET_SHU_0_10);
    rtmr41 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_2 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_2_MR_OP_SET_SHU_0_11);
    ...
    for (u1ChIdx = CHANNEL_A; u1ChIdx < p->support_channel_num; u1ChIdx++)
    {
        ...
        for (u1RankIdx = RANK_0; u1RankIdx < p->support_rank_num; u1RankIdx++)
        {
           //! get shux mr20 (by RK)
           if (u1RankIdx==RANK_0)
               rtmr20 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_2 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_2_MR_OP_SET_SHU_0_8);
           else // if (u1RankIdx==RANK_1)
               rtmr20 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_2 + (nxt_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_2_MR_OP_SET_SHU_0_9);

            //! get shux mr12/mr14/mr15/mr24/mr30 (by CH by RK)
            rtmr12 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_3 + DPMOffset + (nxt_shu_level << 5),  Fld(8, (u1ChIdx*2+u1RankIdx*1)*8));
            rtmr14 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_0 + DPMOffset + (nxt_shu_level << 5),  Fld(8, (u1ChIdx*2+u1RankIdx*1)*8));
            rtmr15 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_1 + DPMOffset + (nxt_shu_level << 5),  Fld(8, (u1ChIdx*2+u1RankIdx*1)*8));
            rtmr24 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_2 + DPMOffset + (nxt_shu_level << 5),  Fld(8, (u1ChIdx*2+u1RankIdx*1)*8));
            rtmr30 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_3 + DPMOffset + (nxt_shu_level << 5),  Fld(8, (u1ChIdx*2+u1RankIdx*1)*8));
            #if ENABLE_DFS_DEBUG_LOG
            mcSHOW_DBG_MSG(("CH%d RK%d\n", u1ChIdx, u1RankIdx));
...
static void DFSRTMRW_HwsetWA(DRAMC_CTX_T *p, U8 cur_shu_mux_index, U8 pingpong_shu_level, U8 CH_num)
{
    ...
    mcSHOW_DBG_MSG(("cur_shu_mux_index = %d, pingpong_shu_level = %d \n", cur_shu_mux_index, pingpong_shu_level));
    #endif
        ...
        if(p->boot_fsp == FSP_1)
        {
            if (cur_shu_mux_index == PHYPLL_MODE)
            {
                ...
                if (is_lp5_family(p))
                {
                    u1MR13_OP &= 0xF0; //! MR16 OP[3:2] = 0, OP[1:0] = 0, from PHYPLL to CLRPLL
                    u1VRCG_OP &= 0xF0; //! MR16 OP[3:2] = 0, OP[1:0] = 0, from PHYPLL to CLRPLL
                }
                else
            #endif
                {
            ...
            else
            {
                ...
                if (is_lp5_family(p))
                {
                    u1MR13_OP = (u1MR13_OP & 0xF0)|0x5; //! MR16 OP[3:2] = 1, OP[1:0] = 1, from CLRPLL to PHYPLL
                    u1VRCG_OP = (u1VRCG_OP & 0xF0)|0x5; //! MR16 OP[3:2] = 1, OP[1:0] = 1, from CLRPLL to PHYPLL
                }
                else
            #endif
                {
...
void DFSNoQueueFlushMode(DRAMC_CTX_T *p, DFS_NOQUE_MODE_T NoQueMode)
{
    U8 QUEFLUSH_NEW_EN = 0, NOQUEFLUSH_EN = 0;

    if (NoQueMode == NOQUEFLUSH_MODE)
    {
        NOQUEFLUSH_EN = 1;
    }
    else if (NoQueMode == QUEFLUSH_NEW_MODE)
    {
        QUEFLUSH_NEW_EN = 1;
    }
...
void DFSNoQueueFlushWA(DRAMC_CTX_T *p, U8 u1OnOff, U8 cur_shu_mux_index, U8 pingpong_shu_level)
{
...
void DVFSSettings(DRAMC_CTX_T *p, K_TIME_BASED_T u1BeforeAfterK)
{
    ...
    vIO32WriteFldAlign(DRAMC_REG_SA_RESERVE, vGet_Current_SRAMIdx(p), SA_RESERVE_DRM_SHU_SRAM_LEVEL);
    vIO32WriteFldAlign(DRAMC_REG_SA_RESERVE, p->ShuRGAccessIdx, SA_RESERVE_DRM_SHU_LEVEL);
    #if ENABLE_DFS_RUNTIME_MRW
    DFSRuntimeFspMRW(p);
    #endif
    ...
    {
        DFSNoQueueFlushMode(p, QUEFLUSH_OLD_MODE); // QUEFLUSH_OLD_MODE is SCSM(in Calibration)
    ...
    else //(u1BeforeAfterK == AFTER_K) //NON_SHU setting for DVFS
    {
        ...
        DFSNoQueueFlushMode(p, NOQUEFLUSH_MODE); // NOQUEFLUSH_MODE is RTMRW(in Runtime)
        //DFSNoQueueFlushMode(p, QUEFLUSH_NEW_MODE); // QUEFLUSH_NEW_MODE is RTMRW(in Runtime)
    #endif
...
void TriggerWck2dqoOSC(DRAMC_CTX_T *p, DRAM_DFS_SRAM_SHU_T current_shu_level)
{
    ...
    U8 MR19 = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_1 + (current_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_1_MR_OP_SET_SHU_0_7);
    ...
    vIO32WriteFldAlign(DDRPHY_MD32_REG_LPIF_LOW_POWER_CFG_3, Precal_en, LPIF_LOW_POWER_CFG_3_DPY_FASTK_RDDQS_EN);

    while(u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_STATUS_4, LPIF_STATUS_4_DPY_FASTK_RDDQS_MPC_ACK) != Precal_en);
    mcSHOW_DBG_MSG4(("WCK2DQO precal mpc trigger done!!\n"));
    while(u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_STATUS_4, LPIF_STATUS_4_DPY_FASTK_RQQDS_ACK) != Precal_en);
    mcSHOW_DBG_MSG4(("2 rank MRR for MR38/39 done!\n"));

    vIO32WriteFldAlign(DDRPHY_MD32_REG_LPIF_LOW_POWER_CFG_3, 0x0, LPIF_LOW_POWER_CFG_3_DPY_FASTK_RDDQS_EN);

}

void Wck2dqoPrecalCalculation(DRAMC_CTX_T *p, DRAM_DFS_SRAM_SHU_T current_shu_level, U8 pingpong_shu_level)
{
    ...
    U16 u2pi2ps;
    U8 ui2pi = 32;
    U8 MR18_cur = u4IO32ReadFldAlign(DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_1 + (current_shu_level << 5), LPIF_MR_OP_STORE_SHU_0_1_MR_OP_SET_SHU_0_6);
    U8 CKR_cur = (MR18_cur&0x80)? 2:4;
    ...
    for (u1ChIdx = CHANNEL_A; u1ChIdx < p->support_channel_num; u1ChIdx++)
    {
        ...
        for(u1RkIdx = RANK_0; u1RkIdx < p->support_rank_num; u1RkIdx++)
        {
            ...
            BaseGatingPos[0] = u4IO32ReadFldAlign(DRAMC_REG_ADDR(DDRPHY_REG_SHU_R0_B0_NEXT_INI_UIPI), SHU_R0_B0_NEXT_INI_UIPI_NEXT_INI_PI_B0)
                             + u4IO32ReadFldAlign(DRAMC_REG_ADDR(DDRPHY_REG_SHU_R0_B0_NEXT_INI_UIPI), SHU_R0_B0_NEXT_INI_UIPI_NEXT_INI_UI_B0) * ui2pi;

            BaseGatingPos[1] = u4IO32ReadFldAlign(DRAMC_REG_ADDR(DDRPHY_REG_SHU_R0_B1_NEXT_INI_UIPI), SHU_R0_B1_NEXT_INI_UIPI_NEXT_INI_PI_B1)
                             + u4IO32ReadFldAlign(DRAMC_REG_ADDR(DDRPHY_REG_SHU_R0_B1_NEXT_INI_UIPI), SHU_R0_B1_NEXT_INI_UIPI_NEXT_INI_UI_B1) * ui2pi;
...
static void Wck2dqoPrecal(DRAMC_CTX_T *p, DRAM_DFS_SRAM_SHU_T current_shu_level, DRAM_DFS_SRAM_SHU_T next_shu_level, U8 pingpong_shu_level)
{
    U8 cur_osc_fm, nxt_osc_fm, bk_ShuRGAccessIdx = p->ShuRGAccessIdx;
    ...
    if(is_lp5_family(p))
    {
        ...
        {
            TriggerWck2dqoOSC(p, current_shu_level);
            Wck2dqoPrecalCalculation(p, current_shu_level, pingpong_shu_level);
        }
        p->ShuRGAccessIdx = bk_ShuRGAccessIdx;
    }
}
...
static void PreKorRetryBeforeDFS(DRAMC_CTX_T *p, DRAM_DFS_SRAM_SHU_T current_shu_level, DRAM_DFS_SRAM_SHU_T next_shu_level, U8 pingpong_shu_level)
{
	#if TDQSCK_PRECALCULATION_FOR_DVFS && __LP5_COMBO__
	Wck2dqoPrecal(p, (current_shu_level & 0xf), (next_shu_level & 0xf), (pingpong_shu_level & 0x1));
	#endif
...
#if __LP5_COMBO__ && (fcFOR_CHIP_ID == fcIPMv2)
    /* LP5_5500 ?? */
...
void DramcDFSDirectJump_SRAMShuRGMode(DRAMC_CTX_T *p, DRAM_DFS_SRAM_SHU_T next_shu_level)
{
    ...
    PreKorRetryBeforeDFS(p, current_shu_level, next_shu_level, pingpong_shu_level);
    ...
    vIO32WriteFldAlign(DRAMC_REG_SA_RESERVE, next_shu_level, SA_RESERVE_DRM_SHU_SRAM_LEVEL);
    vIO32WriteFldAlign(DRAMC_REG_SA_RESERVE, !pingpong_shu_level, SA_RESERVE_DRM_SHU_LEVEL);
...
void DramcDFSDirectJump_SPMMode(DRAMC_CTX_T *p, DRAM_DFS_SRAM_SHU_T next_shu_level)
{
    ...
    #if ENABLE_DFS_NOQUEUE_FLUSH_WA && DFS_NOQUEUE_FLUSH_ENABLE
    DFSNoQueueFlushWA(p, DISABLE, p->u1PLLMode, !p->u1PLLMode);
    #endif
    ...
    vIO32WriteFldAlign(DRAMC_REG_SA_RESERVE, next_shu_level, SA_RESERVE_DRM_SHU_SRAM_LEVEL);
    vIO32WriteFldAlign(DRAMC_REG_SA_RESERVE, (pingpong_shu_level & 0x1), SA_RESERVE_DRM_SHU_LEVEL);
    ...
    #if ENABLE_DFS_NOQUEUE_FLUSH_WA && DFS_NOQUEUE_FLUSH_ENABLE
    DFSNoQueueFlushWA(p, ENABLE, p->u1PLLMode, !p->u1PLLMode);
    #endif
...
void ShuffleDfsToOriginalFSP(DRAMC_CTX_T *p)
{
    ...
    if (is_lp5_family(p))
    {
        ...
        DramcModeRegWriteByRank(p, MRW_BOTH_RANK, 16, u1MR16Value[p->rank]);
