    ...
    u32 tbase_sec_dram_size, u64 dram_base, u64 dram_size)
{
    ...
    teearg->ssiq_number           = (32 + 115);                      /* reserve SPI ID 115 for <t-base, which is ID 147 */
...
DECLARE_TEE_MODULE("Trustonic", tbase_get_reserved_tee_address, NULL, tbase_boot_param_prepare, NULL);
