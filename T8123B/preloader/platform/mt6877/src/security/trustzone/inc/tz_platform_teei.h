...
#define MT_SEC_GPT_IRQ (306)
#define MT_SEC_GPT_DAPC (0)

/* Secure watch Dog setting (SEJ) */
#define MT_SEC_WDT_BASE (0x1000A000)
#define MT_SEC_WDT_IRQ (307)
#define MT_SEC_WDT_DAPC (0)

/* Secure IRQ used in TEE */
#define TEE_FCH_IRQ_NO  (152)
#define TEE_DRV_IRQ_NO  (153)
#define TEE_REV_IRQ_NO  (151)
#define TEE_DUMPER_IRQ_NO  (154)
