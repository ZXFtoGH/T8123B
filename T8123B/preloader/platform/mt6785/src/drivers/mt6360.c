...
int mtk_ext_chgdet(CHARGER_TYPE *chg_type)
{
	...
	/* set iaicr to 500 ma to avoid voltage drop for pc usb */
	mt6360_i2c_update_bits(MT6360_PMU_CHG_CTRL2, MT6360_MASK_AICR, 2 << MT6360_SHFT_AICR);
