...
C_OPTION += -DCFG_LPDDR_ENABLE=1
export CFG_LPDDR_ENABLE
C_OPTION += -DSUPPORT_TYPE_LPDDR5=1
export SUPPORT_TYPE_LPDDR5
C_OPTION += -DCFG_PCDDR_ENABLE=0
...
ifdef CFG_HASH_RULE_MP
C_OPTION += -DCFG_HASH_RULE_MP="$(CFG_HASH_RULE_MP)"
export CFG_HASH_RULE_MP
endif
...
ifdef SECOND_PMIC_CHIP
C_OPTION += -DSECOND_PMIC_CHIP="$(SECOND_PMIC_CHIP)"
export SECOND_PMIC_CHIP
endif

ifeq ("$(SECOND_PMIC_CHIP)","0x6373")
ifeq ("$(USE_MT6373_GPIO)","yes")
export USE_MT6373_GPIO
endif
endif
...
ifeq ($(strip "$(ARM_MTE_SUPPORT)"),"yes")
C_OPTION += -DARM_MTE_SUPPORT
export ARM_MTE_SUPPORT
endif
...
ifdef CFG_GZ_SPMI_ENABLE
C_OPTION += -DCFG_GZ_SPMI_ENABLE="$(CFG_GZ_SPMI_ENABLE)"
export CFG_GZ_SPMI_ENABLE
endif
...
ifeq ($(strip "$(I2C_MULTI_CH_MASK)"),"yes")
C_OPTION += -DI2C_MULTI_CH_MASK
export I2C_MULTI_CH_MASK
endif
...
ifdef CFG_DRM_ENABLE
export CFG_DRM_ENABLE
endif
...
ifeq ("$(MTK_AOD_SCP_SUPPORT)","yes")
    C_OPTION += -DMTK_AOD_SCP_SUPPORT
    export MTK_AOD_SCP_SUPPORT
endif


ifdef MTK_SCP_I2C0_I3C_EN
C_OPTION += -DMTK_SCP_I2C0_I3C_EN
export MTK_SCP_I2C0_I3C_EN
endif

ifdef MTK_SCP_I2C2_I3C_EN
C_OPTION += -DMTK_SCP_I2C2_I3C_EN
export MTK_SCP_I2C2_I3C_EN
endif

ifdef MTK_SCP_I2C3_I3C_EN
C_OPTION += -DMTK_SCP_I2C3_I3C_EN
export MTK_SCP_I2C3_I3C_EN
endif

ifdef MTK_SCP_I2C4_I3C_EN
C_OPTION += -DMTK_SCP_I2C4_I3C_EN
export MTK_SCP_I2C4_I3C_EN
endif

ifeq ("$(HIGHEST_DRAM_DATARATE_DDR5500)", "yes")
CFG_HIGHEST_DRAM_DATARATE_DDR5500 := 1
C_OPTION += -DHIGHEST_DRAM_DATARATE_DDR5500=1
export HIGHEST_DRAM_DATARATE_DDR5500
endif
...
ifeq ($(strip "$(MTK_INFOB_FLAVOR_LOAD)"),"yes")
C_OPTION += -DMTK_INFOB_FLAVOR_LOAD
endif

ifeq ($(strip "$(MTK_MCL50_FLAVOR_LOAD)"),"yes")
C_OPTION += -DMTK_MCL50_FLAVOR_LOAD
endif
