...
/*sec.c*/
#define SEC_WORKING_BUFFER_LENGTH   0x1000
#define SEC_LIB_HEAP_LENGTH         0x1000
#define SEC_IMG_BUFFER_LENGTH       0x1000
...
typedef struct{
    ...
    part_t  partition_info[PART_MAX_ENTRY_SUPPORT];

#if ((CFG_BOOT_DEV == BOOTDEV_SDMMC) || (CFG_BOOT_DEV == BOOTDEV_UFS))
    struct part_meta_info meta_info[PART_MAX_ENTRY_SUPPORT];
#endif
	/*platform.c*/
	boot_arg_t bootarg;
	/*print.c*/
