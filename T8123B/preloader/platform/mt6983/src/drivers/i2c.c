...
static inline void i2c_writeb(mt_i2c * i2c, U16 offset, U8 value)
{
  DRV_WriteReg8((i2c->base) + (offset), value);
}

static inline U8 i2c_readb(mt_i2c *i2c, U16 offset)
{
  return DRV_Reg8((i2c->base) + (offset));
}
	...
	U32 *timing_sample_cnt)
{
	...
	/* Just for MT6761/MT6762/MT6765/MT6983 */
...
void _config_mt_i2c(mt_i2c *i2c)
{
  ...
  switch(i2c->id)
  {
    ...
    case I2C12:
      i2c->base = I2C12_BASE;
	  i2c->pdmabase = I2C12_APDMA_BASE;
      break;
    case I2C13:
      i2c->base = I2C13_BASE;
	  i2c->pdmabase = I2C13_APDMA_BASE;
      break;
    default:
...
static void i2c_set_driving(void)
{
	...
	/* SDA6[17:15] SDA5[14:12] SDA0[11:9] SCL6[8:6] SCL5[5:3] SCL0[2:0]*/
	I2C_SET_REG32((IOCFG_LT_BASE + 0x30), 0x3FFFF, 0x3FFFF);
	/* SDA9[29:27] SDA8[26:24] SDA7[23:21] SDA4[20:18] SDA2[17:15] */
	/* SCL9[14:12] SCL8[11:9]  SCL7[8:6]   SCL4[5:3]   SCL2[2:0]   */
	I2C_SET_REG32((IOCFG_BR_BASE + 0x50), 0x3FFFFFFF, 0x3FFFFFFF);
	/* SDA3[11:9]  SDA1[8:6] SCL3[5:3] SCL1[2:0] */
	I2C_SET_REG32((IOCFG_BR_BASE + 0x60), 0xFFF, 0xFFF);

	/* Config SCP I2C driving */
	/* SDA3[17:15] SDA2[14:12] SDA0[11:9] SCL3[8:6] SCL2[5:3] SCL0[2:0]*/
	I2C_SET_REG32((IOCFG_BL_BASE + 0x20), 0x3FFFF, 0x3FFFF);
	/* SDA6[23:21] SDA5[20:18] SDA4[17:15] SCL6[14:12] SCL5[11:9] SCL4[8:6] SDA1[5:3] SCL1[2:0] */
	I2C_SET_REG32((IOCFG_TL_BASE + 0x30), 0xFFFFFF, 0xFFFFFF);

#ifdef MTK_SCP_I2C0_I3C_EN
	//SCP_SCL0: gpio133, SCP_SDA0: gpio134
	//EH: scp_scl0[2:0], scp_sda0[11:9]
	I2C_SET_REG32((IOCFG_BL_BASE + 0x20), ((7 << 9) | (7 << 0)), 0x0);
	//DRV_CFG1: scp_scl0,scp_sda0,scp_scl2,scp_sda2[5:3]
	I2C_SET_REG32((IOCFG_BL_BASE + 0x10), (7 << 3), (MTK_SCP_I3C0_DRIVING << 3));
	I2CERR("[%s] MTK_SCP_I2C0_I3C_EN: driving=%d\n", __func__, MTK_SCP_I3C0_DRIVING);
#endif
#ifdef MTK_SCP_I2C2_I3C_EN
	//SCP_SCL2: gpio135, SCP_SDA2: gpio136
	//EH: scp_scl2[5:3], scp_sda2[14:12]
	I2C_SET_REG32((IOCFG_BL_BASE + 0x20), ((7 << 12) | (7 << 3)), 0x0);
	//DRV_CFG1: scp_scl0,scp_sda0,scp_scl2,scp_sda2[5:3]
	I2C_SET_REG32((IOCFG_BL_BASE + 0x10), (7 << 3), (MTK_SCP_I3C2_DRIVING << 3));
	I2CERR("[%s] MTK_SCP_I2C2_I3C_EN: driving=%d\n", __func__, MTK_SCP_I3C2_DRIVING);
#endif
#ifdef MTK_SCP_I2C3_I3C_EN
	//SCP_SCL3: gpio137, SCP_SDA3: gpio138
	//EH: scp_scl3[8:6], scp_sda3[17:15]
	I2C_SET_REG32((IOCFG_BL_BASE + 0x20), ((7 << 15) | (7 << 6)), 0x0);
	//DRV_CFG1: scp_scl3,scp_sda3[8:6]
	I2C_SET_REG32((IOCFG_BL_BASE + 0x10), (7 << 6), (MTK_SCP_I3C3_DRIVING << 6));
	I2CERR("[%s] MTK_SCP_I2C3_I3C_EN: driving=%d\n", __func__, MTK_SCP_I3C3_DRIVING);
#endif
#ifdef MTK_SCP_I2C4_I3C_EN
	//SCP_SCL4: gpio55, SCP_SDA4: gpio56
	//EH: scp_scl4[8:6], scp_sda4[17:15]
	I2C_SET_REG32((IOCFG_TL_BASE + 0x30), ((7 << 15) | (7 << 6)), 0x0);
	//DRV_CFG1: scp_scl4[23:21],scp_sda4[26:24]
	I2C_SET_REG32((IOCFG_TL_BASE + 0x10), ((7 << 24) | (7 << 21)),
		((MTK_SCP_I3C4_DRIVING << 24) | (MTK_SCP_I3C4_DRIVING << 21)));
	I2CERR("[%s] MTK_SCP_I2C4_I3C_EN: driving=%d\n", __func__, MTK_SCP_I3C4_DRIVING);
#endif
}
...
static void internal_resister_setting(void)
{
	...
	/* SDA6[17:15] SDA5[14:12] SDA0[11:9] SCL6[8:6] SCL5[5:3] SCL0[2:0] */
	I2C_SET_REG32(IOCFG_LT_BASE + 0xB0, 0x3FFFF, 0x3FFFF);
	/* SDA9[29:27] SDA8[26:24] SDA7[23:21] SDA4[20:18] SDA2[17:15] */
	/* SCL9[14:12] SCL8[11:9]  SCL7[8:6]   SCL4[5:3]   SCL2[2:0]   */
	I2C_SET_REG32(IOCFG_BR_BASE + 0x100, 0x3FFFFFFF, 0x3FFFFFFF);
	/* SDA3[14:12] SDA1[11:9] SCL3[8:6] SCL1[5:3] */
	I2C_SET_REG32(IOCFG_BR_BASE + 0x110, 0xFFF, 0xFFF);

	/* Switch SCP I2C internal resistor */
	/* SDA3[17:15] SDA2[14:12] SDA0[11:9] SCL3[8:6] SCL2[5:3] SCL0[2:0] */
	I2C_SET_REG32(IOCFG_BL_BASE + 0x70, 0x3FFFF, 0x3FFFF);
	/* SDA6[23:21] SDA5[20:18] SDA4[17:15] SCL6[14:12] SCL5[11:9] SCL4[8:6] SDA1[5:3] SCL1[2:0] */
	I2C_SET_REG32(IOCFG_TL_BASE + 0xB0, 0xFFFFFF, 0xFFFFFF);
}
#endif
...
int i2c_hw_init(void)
{
	...
	unsigned int reg = 0;
	int tmo_cnt = 1000;
	/* set I3C clock src ulposc_div2 260Mhz/2 = 130Mhz for I2C */
	reg = DRV_Reg32(SCP_I3C_BCLK_SW);
	if ((reg & SCP_BCLK_CK_STA_MASK) != SCP_I3C_BCLK_CK_STA_ULPOSC_DIV2) {
		I2C_SET_REG32(SCP_I3C_BCLK_SW, SCP_BCLK_SW_ULPOSC_MASK,
					SCP_I3C_BCLK_SW_ULPOSC_DIV2);
	}
	tmo_cnt = 1000;
	do {
		tmo_cnt--;
		reg = DRV_Reg32(SCP_I3C_BCLK_SW);
	} while (((reg & SCP_BCLK_CK_STA_MASK) != SCP_I3C_BCLK_CK_STA_ULPOSC_DIV2)
				&& tmo_cnt);
	I2CLOG("scp_i2c clk update. tmo_cnt=%d, SCP_I3C_BCLK_SW=0x%x\n", tmo_cnt, reg);

	reg = DRV_Reg32(SCP_CLK_CG_CTRL);
	if ((reg & (I2C_BCLK_CG_BIT | I2C_PCLK_CG_BIT | I2C_DMA_CG_BIT)) !=
				(I2C_BCLK_CG_BIT | I2C_PCLK_CG_BIT | I2C_DMA_CG_BIT)) {
		I2C_SET_REG32(SCP_CLK_CG_CTRL, (I2C_BCLK_CG_BIT | I2C_PCLK_CG_BIT | I2C_DMA_CG_BIT),
					(I2C_BCLK_CG_BIT | I2C_PCLK_CG_BIT | I2C_DMA_CG_BIT));
	}
	I2CLOG("scp_i2c open bclk and pclk. SCP_CLK_CG_CTRL=0x%x,0x%x\n",
		reg, DRV_Reg32(SCP_CLK_CG_CTRL));
	reg = DRV_Reg32(SCP_CLK_CG_CTRL1);
	if ((reg & (I2C_I3C2_1_CG_BIT | I2C_I3C1_1_CG_BIT)) !=
				(I2C_I3C2_1_CG_BIT | I2C_I3C1_1_CG_BIT)) {
		I2C_SET_REG32(SCP_CLK_CG_CTRL1, (I2C_I3C2_1_CG_BIT | I2C_I3C1_1_CG_BIT),
					(I2C_I3C2_1_CG_BIT | I2C_I3C1_1_CG_BIT));
	}
	I2CLOG("scp_i2c open i2c1,i2c2. SCP_CLK_CG_CTRL1=0x%x,0x%x\n",
		reg, DRV_Reg32(SCP_CLK_CG_CTRL1));
	DRV_WriteReg32(SCP_CLK_CG_W1C_CEN, SCP_CLK_W1C_CEN_I2C1);

	I2C_SET_REG32((SCP_I2C1_BASE_SE + OFFSET_MULTI_DMA), SHADOW_REG_MODE, (0x01<<1));
	I2CLOG("[scp_i2c1]ADDR:0x%x,multi_DMA:0x%x\n", SCP_I2C1_BASE_SE + OFFSET_MULTI_DMA,
	DRV_Reg32(SCP_I2C1_BASE_SE + OFFSET_MULTI_DMA));

	I2C_SET_REG32((SCP_I2C0_APDMA_BASE + OFFSET_SEC_DOMAIN), DMA_DOMAIN_3, DMA_DOMAIN_3);
	I2C_SET_REG32((SCP_I2C1_CH1_APDMA_BASE + OFFSET_SEC_DOMAIN), DMA_DOMAIN_3, DMA_DOMAIN_3);
	I2C_SET_REG32((SCP_I2C2_APDMA_BASE + OFFSET_SEC_DOMAIN), DMA_DOMAIN_3, DMA_DOMAIN_3);
	I2C_SET_REG32((SCP_I2C3_APDMA_BASE + OFFSET_SEC_DOMAIN), DMA_DOMAIN_3, DMA_DOMAIN_3);
	I2C_SET_REG32((SCP_I2C4_APDMA_BASE + OFFSET_SEC_DOMAIN), DMA_DOMAIN_3, DMA_DOMAIN_3);
	I2C_SET_REG32((SCP_I2C5_APDMA_BASE + OFFSET_SEC_DOMAIN), DMA_DOMAIN_3, DMA_DOMAIN_3);
	I2C_SET_REG32((SCP_I2C6_APDMA_BASE + OFFSET_SEC_DOMAIN), DMA_DOMAIN_3, DMA_DOMAIN_3);
	I2C_SET_REG32(SCP_GLOBAL_DMA_SEC, DMA_DOMAIN_LOCK, DMA_DOMAIN_LOCK);
#endif

#ifndef I2C_MULTI_CH_MASK
	/* Todo: Enable multi-channel by request in future */
	...
	I2C_SET_REG32((I2C7_BASE_SE + OFFSET_MULTI_DMA), SHADOW_REG_MODE, (0x01<<1));
	...
	I2C_SET_REG32((I2C12_BASE_SE + OFFSET_MULTI_DMA), SHADOW_REG_MODE, (0x01<<1));
	I2C_SET_REG32((I2C13_BASE_SE + OFFSET_MULTI_DMA), SHADOW_REG_MODE, (0x01<<1));
	...
	I2CLOG("[i2c7]ADDR:0x%x,multi_DMA:0x%x\n", I2C7_BASE_SE + OFFSET_MULTI_DMA,
		DRV_Reg32(I2C7_BASE_SE + OFFSET_MULTI_DMA));
	...
	I2CLOG("[i2c12]ADDR:0x%x,multi_DMA:0x%x\n", I2C12_BASE_SE + OFFSET_MULTI_DMA,
		DRV_Reg32(I2C12_BASE_SE + OFFSET_MULTI_DMA));
	I2CLOG("[i2c13]ADDR:0x%x,multi_DMA:0x%x\n", I2C13_BASE_SE + OFFSET_MULTI_DMA,
		DRV_Reg32(I2C13_BASE_SE + OFFSET_MULTI_DMA));
#endif
