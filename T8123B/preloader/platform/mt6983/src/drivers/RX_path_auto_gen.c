...
{
  mcSHOW_DBG_MSG6 ("=================================== \n");
  mcSHOW_DBG_MSG6 ("RX_path CONFIGURATION\n"               );
  mcSHOW_DBG_MSG6 ("=================================== \n");
  mcSHOW_DBG_MSG6 ( "data_rate               is %d\n", tr->data_rate		       );
  mcSHOW_DBG_MSG6 ( "dq_p2s_ratio            is %d\n", tr->dq_p2s_ratio	               );
  mcSHOW_DBG_MSG6 ( "ca_default_delay        is %d\n", tr->ca_default_delay	       );
  mcSHOW_DBG_MSG6 ( "ca_ser_latency          is %d\n", tr->ca_ser_latency  	       );
  mcSHOW_DBG_MSG6 ( "cs2RL_start             is %d\n", tr->cs2RL_start       	       );
  mcSHOW_DBG_MSG6 ( "byte_num                is %d\n", tr->byte_num		       );
  mcSHOW_DBG_MSG6 ( "rank_num                is %d\n", tr->rank_num		       );
  mcSHOW_DBG_MSG6 ( "RL[0]                   is %d\n", tr->RL[0]		       );
  mcSHOW_DBG_MSG6 ( "RL[1]                   is %d\n", tr->RL[1] 		       );
  mcSHOW_DBG_MSG6 ( "RL_min                  is %d\n", tr->RL_min		       );
  mcSHOW_DBG_MSG6 ( "RL_max                  is %d\n", tr->RL_max		       );
  mcSHOW_DBG_MSG6 ( "TDQSCK[0]               is %d\n", tr->TDQSCK[0]		       );
  mcSHOW_DBG_MSG6 ( "TDQSCK[1]               is %d\n", tr->TDQSCK[1]	     	       );
  mcSHOW_DBG_MSG6 ( "TDQSCK[2]               is %d\n", tr->TDQSCK[2]	     	       );
  mcSHOW_DBG_MSG6 ( "TDQSCK[3]               is %d\n", tr->TDQSCK[3]	     	       );
  mcSHOW_DBG_MSG6 ( "dqsien_default_delay    is %d\n", tr->dqsien_default_delay	       );
  mcSHOW_DBG_MSG6 ( "dqsien_ser_latency      is %d\n", tr->dqsien_ser_latency          );
  mcSHOW_DBG_MSG6 ( "oe_ser_latency          is %d\n", tr->oe_ser_latency          );
  mcSHOW_DBG_MSG6 ( "gating_window_ahead_dqs is %d\n", tr->gating_window_ahead_dqs     );
  mcSHOW_DBG_MSG6 ( "aphy_slice_delay        is %d\n", tr->aphy_slice_delay	       );
  mcSHOW_DBG_MSG6 ( "aphy_dtc_delay          is %d\n", tr->aphy_dtc_delay  	       );
  mcSHOW_DBG_MSG6 ( "aphy_lead_lag_margin    is %d\n", tr->aphy_lead_lag_margin        );
  mcSHOW_DBG_MSG6 ( "dram_ui_ratio           is %d\n", tr->dram_ui_ratio	       );
  mcSHOW_DBG_MSG6 ( "dq_ui_unit              is %d\n", tr->dq_ui_unit   	       );
  mcSHOW_DBG_MSG6 ( "ca_ui_unit              is %d\n", tr->ca_ui_unit   	       );
  mcSHOW_DBG_MSG6 ( "MCK_unit                is %d\n", tr->MCK_unit		       );
  mcSHOW_DBG_MSG6 ( "dramc_dram_ratio        is %d\n", tr->dramc_dram_ratio	       );
  mcSHOW_DBG_MSG6 ( "CKR                     is %d\n", tr->CKR		               );
  mcSHOW_DBG_MSG6 ( "tRPRE_toggle            is %d\n", tr->tRPRE_toggle	               );
  mcSHOW_DBG_MSG6 ( "tRPRE_static            is %d\n", tr->tRPRE_static	               );
  mcSHOW_DBG_MSG6 ( "tRPST                   is %d\n", tr->tRPST  	               );
  mcSHOW_DBG_MSG6 ( "DQSIENMODE              is %d\n", tr->DQSIENMODE  	               );
  mcSHOW_DBG_MSG6 ( "BL                      is %d\n", tr->BL   	               );
  mcSHOW_DBG_MSG6 ( "FAKE_1TO16_MODE         is %d\n", tr->FAKE_1TO16_MODE             );
  mcSHOW_DBG_MSG6 ( "SVA_1_10_t2_SPEC        is %d\n", tr->SVA_1_10_t2_SPEC            );
  mcSHOW_DBG_MSG6 ( "read_cmd_out            is %d\n", tr->read_cmd_out	               );
  mcSHOW_DBG_MSG6 ( "ca_MCKIO_ui_unit        is %d\n", tr->ca_MCKIO_ui_unit            );
  //mcSHOW_DBG_MSG6 ( "ca_default_PI           is %d\n", tr->ca_default_PI	       );
  mcSHOW_DBG_MSG6 ( "ca_p2s_ratio            is %d\n", tr->ca_p2s_ratio 	       );
  //mcSHOW_DBG_MSG6 ( "ca_ui_pi_ratio          is %d\n", tr->ca_ui_pi_ratio              );
  mcSHOW_DBG_MSG6 ( "TDQSCK_min_SPEC         is %d\n", tr->TDQSCK_min_SPEC	       );
  mcSHOW_DBG_MSG6 ( "TDQSCK_max_SPEC         is %d\n", tr->TDQSCK_max_SPEC	       );
  mcSHOW_DBG_MSG6 ( "TX_pipeline             is %d\n", tr->TX_pipeline       	       );
  mcSHOW_DBG_MSG6 ( "RX_pipeline             is %d\n", tr->RX_pipeline       	       );
...
{
  mcSHOW_DBG_MSG6 ("=================================== \n");
  mcSHOW_DBG_MSG6 ("RX_path RG value\n"               );
  mcSHOW_DBG_MSG6 ("=================================== \n");
  //mcSHOW_DBG_MSG6 ( "RX_UI_MCK_P0[0]          is %d\n", tr->RX_UI_MCK_P0[0]         );
  //mcSHOW_DBG_MSG6 ( "RX_UI_MCK_P0[1]          is %d\n", tr->RX_UI_MCK_P0[1]         );
  //mcSHOW_DBG_MSG6 ( "RX_UI_MCK_P0[2]          is %d\n", tr->RX_UI_MCK_P0[2]         );
  //mcSHOW_DBG_MSG6 ( "RX_UI_MCK_P0[3]          is %d\n", tr->RX_UI_MCK_P0[3]         );
  //mcSHOW_DBG_MSG6 ( "RX_UI_MCK_P1[0]          is %d\n", tr->RX_UI_MCK_P1[0]         );
  //mcSHOW_DBG_MSG6 ( "RX_UI_MCK_P1[1]          is %d\n", tr->RX_UI_MCK_P1[1]         );
  //mcSHOW_DBG_MSG6 ( "RX_UI_MCK_P1[2]          is %d\n", tr->RX_UI_MCK_P1[2]         );
  //mcSHOW_DBG_MSG6 ( "RX_UI_MCK_P1[3]          is %d\n", tr->RX_UI_MCK_P1[3]         );
  mcSHOW_DBG_MSG6 ( "RX_UI_P0[0]              is %d\n", tr->RX_UI_P0[0]             );
  mcSHOW_DBG_MSG6 ( "RX_UI_P0[1]              is %d\n", tr->RX_UI_P0[1]             );
  mcSHOW_DBG_MSG6 ( "RX_UI_P0[2]              is %d\n", tr->RX_UI_P0[2]             );
  mcSHOW_DBG_MSG6 ( "RX_UI_P0[3]              is %d\n", tr->RX_UI_P0[3]             );
  mcSHOW_DBG_MSG6 ( "RX_UI_P1[0]              is %d\n", tr->RX_UI_P1[0]             );
  mcSHOW_DBG_MSG6 ( "RX_UI_P1[1]              is %d\n", tr->RX_UI_P1[1]             );
  mcSHOW_DBG_MSG6 ( "RX_UI_P1[2]              is %d\n", tr->RX_UI_P1[2]             );
  mcSHOW_DBG_MSG6 ( "RX_UI_P1[3]              is %d\n", tr->RX_UI_P1[3]             );
  mcSHOW_DBG_MSG6 ( "RX_PI[0]                 is %d\n", tr->RX_PI[0]                );
  mcSHOW_DBG_MSG6 ( "RX_PI[1]                 is %d\n", tr->RX_PI[1]                );
  mcSHOW_DBG_MSG6 ( "RX_PI[2]                 is %d\n", tr->RX_PI[2]                );
  mcSHOW_DBG_MSG6 ( "RX_PI[3]                 is %d\n", tr->RX_PI[3]                );
  mcSHOW_DBG_MSG6 ( "DQSINCTL                 is %d\n", tr->DQSINCTL                );
  mcSHOW_DBG_MSG6 ( "DATLAT_DSEL              is %d\n", tr->DATLAT_DSEL             );
  mcSHOW_DBG_MSG6 ( "DATLAT                   is %d\n", tr->DATLAT                  );
  mcSHOW_DBG_MSG6 ( "DATLAT_DSEL_PHY          is %d\n", tr->DATLAT_DSEL_PHY         );
  mcSHOW_DBG_MSG6 ( "DLE_EXTEND               is %d\n", tr->DLE_EXTEND              );
  mcSHOW_DBG_MSG6 ( "RX_IN_GATE_EN_HEAD       is %d\n", tr->RX_IN_GATE_EN_HEAD      );
  mcSHOW_DBG_MSG6 ( "RX_IN_GATE_EN_TAIL       is %d\n", tr->RX_IN_GATE_EN_TAIL      );
  mcSHOW_DBG_MSG6 ( "RX_IN_BUFF_EN_HEAD       is %d\n", tr->RX_IN_BUFF_EN_HEAD      );
  mcSHOW_DBG_MSG6 ( "RX_IN_BUFF_EN_TAIL       is %d\n", tr->RX_IN_BUFF_EN_TAIL      );
  mcSHOW_DBG_MSG6 ( "RX_IN_GATE_EN_PRE_OFFSET is %d\n", tr->RX_IN_GATE_EN_PRE_OFFSET);
  mcSHOW_DBG_MSG6 ( "RANKINCTL_ROOT1          is %d\n", tr->RANKINCTL_ROOT1         );
  mcSHOW_DBG_MSG6 ( "RANKINCTL                is %d\n", tr->RANKINCTL               );
  mcSHOW_DBG_MSG6 ( "RANKINCTL_STB            is %d\n", tr->RANKINCTL_STB           );
  mcSHOW_DBG_MSG6 ( "RANKINCTL_RXDLY          is %d\n", tr->RANKINCTL_RXDLY         );
  mcSHOW_DBG_MSG6 ( "SHU_GW_THRD_POS          is %d\n", tr->SHU_GW_THRD_POS         );
  mcSHOW_DBG_MSG6 ( "SHU_GW_THRD_NEG          is %d\n", tr->SHU_GW_THRD_NEG         );
  mcSHOW_DBG_MSG6 ( "RDSEL_TRACK_EN           is %d\n", tr->RDSEL_TRACK_EN          );
  mcSHOW_DBG_MSG6 ( "RDSEL_HWSAVE_MSK         is %d\n", tr->RDSEL_HWSAVE_MSK        );
  mcSHOW_DBG_MSG6 ( "DMDATLAT_i               is %d\n", tr->DMDATLAT_i              );
  mcSHOW_DBG_MSG6 ( "RODT                     is %d\n", tr->RODT                    );
  mcSHOW_DBG_MSG6 ( "RODTE                    is %d\n", tr->RODTE                   );
  mcSHOW_DBG_MSG6 ( "RODTE2                   is %d\n", tr->RODTE2                  );
  mcSHOW_DBG_MSG6 ( "ODTEN_MCK_P0[0]          is %d\n", tr->ODTEN_MCK_P0[0]         );
  mcSHOW_DBG_MSG6 ( "ODTEN_MCK_P0[1]          is %d\n", tr->ODTEN_MCK_P0[1]         );
  mcSHOW_DBG_MSG6 ( "ODTEN_MCK_P0[2]          is %d\n", tr->ODTEN_MCK_P0[2]         );
  mcSHOW_DBG_MSG6 ( "ODTEN_MCK_P0[3]          is %d\n", tr->ODTEN_MCK_P0[3]         );
  mcSHOW_DBG_MSG6 ( "ODTEN_MCK_P1[0]          is %d\n", tr->ODTEN_MCK_P1[0]         );
  mcSHOW_DBG_MSG6 ( "ODTEN_MCK_P1[1]          is %d\n", tr->ODTEN_MCK_P1[1]         );
  mcSHOW_DBG_MSG6 ( "ODTEN_MCK_P1[2]          is %d\n", tr->ODTEN_MCK_P1[2]         );
  mcSHOW_DBG_MSG6 ( "ODTEN_MCK_P1[3]          is %d\n", tr->ODTEN_MCK_P1[3]         );
  mcSHOW_DBG_MSG6 ( "ODTEN_UI_P0[0]           is %d\n", tr->ODTEN_UI_P0[0]          );
  mcSHOW_DBG_MSG6 ( "ODTEN_UI_P0[1]           is %d\n", tr->ODTEN_UI_P0[1]          );
  mcSHOW_DBG_MSG6 ( "ODTEN_UI_P0[2]           is %d\n", tr->ODTEN_UI_P0[2]          );
  mcSHOW_DBG_MSG6 ( "ODTEN_UI_P0[3]           is %d\n", tr->ODTEN_UI_P0[3]          );
  mcSHOW_DBG_MSG6 ( "ODTEN_UI_P1[0]           is %d\n", tr->ODTEN_UI_P1[0]          );
  mcSHOW_DBG_MSG6 ( "ODTEN_UI_P1[1]           is %d\n", tr->ODTEN_UI_P1[1]          );
  mcSHOW_DBG_MSG6 ( "ODTEN_UI_P1[2]           is %d\n", tr->ODTEN_UI_P1[2]          );
  mcSHOW_DBG_MSG6 ( "ODTEN_UI_P1[3]           is %d\n", tr->ODTEN_UI_P1[3]          );
  mcSHOW_DBG_MSG6 ( "RX_RANK_DQS_LAT          is %d\n", tr->RX_RANK_DQS_LAT         );
  mcSHOW_DBG_MSG6 ( "RX_RANK_DQ_LAT           is %d\n", tr->RX_RANK_DQ_LAT          );
  mcSHOW_DBG_MSG6 ( "RANKINCTL_PHY            is %d\n", tr->RANKINCTL_PHY           );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_LAT_CA          is %d\n", tr->RANK_SEL_LAT_CA         );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_LAT_B0          is %d\n", tr->RANK_SEL_LAT_B0         );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_LAT_B1          is %d\n", tr->RANK_SEL_LAT_B1         );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_STB_EN          is %d\n", tr->RANK_SEL_STB_EN         );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_RXDLY_TRACK     is %d\n", tr->RANK_SEL_RXDLY_TRACK    );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_STB_TRACK       is %d\n", tr->RANK_SEL_STB_TRACK      );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_STB_PHASE_EN    is %d\n", tr->RANK_SEL_STB_PHASE_EN   );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_PHSINCTL        is %d\n", tr->RANK_SEL_PHSINCTL       );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_STB_UI_MINUS    is %d\n", tr->RANK_SEL_STB_UI_MINUS   );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_STB_UI_PLUS     is %d\n", tr->RANK_SEL_STB_UI_PLUS    );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_MCK_P0          is %d\n", tr->RANK_SEL_MCK_P0         );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_UI_P0           is %d\n", tr->RANK_SEL_UI_P0          );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_MCK_P1          is %d\n", tr->RANK_SEL_MCK_P1         );
  mcSHOW_DBG_MSG6 ( "RANK_SEL_UI_P1           is %d\n", tr->RANK_SEL_UI_P1          );
  mcSHOW_DBG_MSG6 ( "R0DQSIENLLMTEN           is %d\n", tr->R0DQSIENLLMTEN          );
  mcSHOW_DBG_MSG6 ( "R0DQSIENLLMT             is %d\n", tr->R0DQSIENLLMT            );
  mcSHOW_DBG_MSG6 ( "R0DQSIENHLMTEN           is %d\n", tr->R0DQSIENHLMTEN          );
  mcSHOW_DBG_MSG6 ( "R0DQSIENHLMT             is %d\n", tr->R0DQSIENHLMT            );
  mcSHOW_DBG_MSG6 ( "R1DQSIENLLMTEN           is %d\n", tr->R1DQSIENLLMTEN          );
  mcSHOW_DBG_MSG6 ( "R1DQSIENLLMT             is %d\n", tr->R1DQSIENLLMT            );
  mcSHOW_DBG_MSG6 ( "R1DQSIENHLMTEN           is %d\n", tr->R1DQSIENHLMTEN          );
  mcSHOW_DBG_MSG6 ( "R1DQSIENHLMT             is %d\n", tr->R1DQSIENHLMT            );
  mcSHOW_DBG_MSG6 ( "DQSIEN_FIFO_DEPTH_HALF   is %d\n", tr->DQSIEN_FIFO_DEPTH_HALF  );
  mcSHOW_DBG_MSG6 ("=================================== \n");
}

void print_RX_path_rg_val_to_file( RX_path_attribution_T *tr, U8 group_id)
{
  ...
  fprintf(f_val, "%d\n", tr->RX_PI[3])   ;
  fclose(f_val);
  mcSHOW_DBG_MSG6 ("print f_group_num and f_gating_val done \n");
#endif
}
...
void get_RX_path_config (DRAMC_CTX_T * p, RX_path_config_T *RX_C, U8 ch_id, U8 group_id)
{
...
#endif
  {
    mcSHOW_ERR_MSG("Error: wrong memory type, LP4 LP5 DDR3 DDR4 are support lists.--RX caculation\n");
    ASSERT(0);
  }
  ...
  //  default: mcSHOW_ERR_MSG("Error get wrong dq_p2s_ratio\n");
  //}
  ...
  if (LPDDR5_EN_S)
  {
    ...
    {     mcSHOW_ERR_MSG("Error DQSIENMODE is %0d which is not considered when LPDDR5 \n", RX_C->DQSIENMODE);  }
  }
  else
#endif
...
#endif
  {
      mcSHOW_ERR_MSG("Error only support PCDDR3, PCDDR4, LPDDR4 and LPDDR5 \n");
      ASSERT(0);
  }
...
void calculate_RX_path_rg_val (RX_path_config_T *RX_C, RX_path_attribution_T *RX_R, U32 ch_id)
{
  ...
  mcSHOW_DBG_MSG6("UI_MCK_least is %d\n", UI_MCK_least);
  mcSHOW_DBG_MSG6("[RX_path_auto_gen]june_debug impact_latency_for_dramobf is %d\n", RX_C->impact_latency_for_dramobf);
  ...
  for (byte_id = 0; byte_id < RX_C->byte_num * RX_C->rank_num ; byte_id++)
  {
    ...
    mcSHOW_DBG_MSG6("RX_GW_selph_by_ps[%1d] is %d\n", byte_id, RX_GW_selph_by_ps[byte_id]);
  }
  ...
  //use DE algorithm for ASVA_1_3 }
  //use DE algorithm for ASVA_1_3 //mcSHOW_DBG_MSG6 (" RX_IN_GATE_EN_HEAD        is %d\n", RX_R->RX_IN_GATE_EN_HEAD)        ;
  ...
  //use DE algorithm for ASVA_1_3     RX_R->RX_IN_GATE_EN_HEAD = RX_R->RX_IN_GATE_EN_HEAD + 1;
  //use DE algorithm for ASVA_1_3     mcSHOW_DBG_MSG6 (" GATE_EN_HEAD + 1 when RX_UI_P0_min >= RX_C->dq_p2s_ratio / 2  \n") ;
  //use DE algorithm for ASVA_1_3 } 
  ...
  //use DE algorithm for ASVA_1_3     mcSHOW_DBG_MSG6 (" GATE_EN_HEAD + 1 when RX_UI_P0_min < RX_C->dq_p2s_ratio / 2  \n") ;
  //use DE algorithm for ASVA_1_3 }
  //use DE algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" dqs_shift_right_may_lead_MCK_up         is %d\n", dqs_shift_right_may_lead_MCK_up)       ;
  //use DE algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" dqs_shift_right_without_update_MCK      is %d\n", dqs_shift_right_without_update_MCK)     ;
  //use DE algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" dqs_shift_left_UI_may_down_to_0         is %d\n", dqs_shift_left_UI_may_down_to_0)        ;
  //use DE algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" dqs_shift_left_lead_BUFF_HEAD_EXT       is %d\n", dqs_shift_left_lead_BUFF_HEAD_EXT)      ;
  ...
  { 
        ...
        RX_R->RX_IN_GATE_EN_TAIL = 1;
        RX_R->RX_IN_BUFF_EN_HEAD = 0;
        RX_R->RX_IN_GATE_EN_HEAD = 2;
        #endif
  }


  //use DW algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" tDQSCK_min                        is %d\n", tDQSCK_min)        ;
  //use DW algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" tDQSCK_max                        is %d\n", tDQSCK_max)        ;
  //use DW algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" tDQSCK_shift_left_boundary        is %d\n", tDQSCK_shift_left_boundary)        ;
  //use DW algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" tDQSCK_shift_right_boundary       is %d\n", tDQSCK_shift_right_boundary)        ;
  //use DW algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" RX_rdcmdout2rdcmdbus_by_ps        is %d\n", RX_rdcmdout2rdcmdbus_by_ps)        ;
  //use DW algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" RX_rdcmdout2GATE_EN_min_by_ps     is %d\n", RX_rdcmdout2GATE_EN_min_by_ps)     ;
  //use DW algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" RX_rdcmdout2GATE_EN_max_by_ps     is %d\n", RX_rdcmdout2GATE_EN_max_by_ps)     ;
  //use DW algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" RX_rdcmdout2dqspre_min_by_ps      is %d\n", RX_rdcmdout2dqspre_min_by_ps)      ;
  //use DW algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" RX_rdcmdout2dq_end_max_by_ps      is %d\n", RX_rdcmdout2dq_end_max_by_ps)      ;
  //use DW algorithm for ASVA_1_3 mcSHOW_DBG_MSG6 (" RX_rdcmdout2GATE_EN_end_min_by_ps is %d\n", RX_rdcmdout2GATE_EN_end_min_by_ps) ;
  ...
  //! RX_R->RANK_RXDLY_UPD_OFFSET = (DUT_p.NEW_RANK_MODE == 0) ? 1 : 2; //redmine #45522
      ...
      RX_R->RANK_RXDLY_UPD_OFFSET = 2; //! Trunk ASVA1-8, ASVA1-7, ASVA1-3-5
#else
...
void RX_PATH_auto_gen_and_set(DRAMC_CTX_T *p,U32 ch_id, U8 group_id)
{
  U8       rank_sel;

  RX_path_config_T	   RX_C = {0};
  RX_path_attribution_T    RX_R = {0};
