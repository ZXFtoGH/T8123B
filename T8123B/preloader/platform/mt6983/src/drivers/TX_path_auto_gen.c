...
{
  mcSHOW_DBG_MSG6 ("=====================================\n"                          );
  mcSHOW_DBG_MSG6 ("print TX_path_config\n"                                           );
  mcSHOW_DBG_MSG6 ("=====================================\n"                          );
  mcSHOW_DBG_MSG6 ("data_ratio                is %d\n", tr->data_ratio                );
  mcSHOW_DBG_MSG6 ("dq_p2s_ratio              is %d\n", tr->dq_p2s_ratio              );
  mcSHOW_DBG_MSG6 ("cs2WL_start               is %d\n", tr->cs2WL_start               );
  mcSHOW_DBG_MSG6 ("byte_num                  is %d\n", tr->byte_num                  );
  mcSHOW_DBG_MSG6 ("rank_num                  is %d\n", tr->rank_num                  );
  mcSHOW_DBG_MSG6 ("CKR                       is %d\n", tr->CKR                       );
  mcSHOW_DBG_MSG6 ("DBI_WR                    is %d\n", tr->DBI_WR                    );
  mcSHOW_DBG_MSG6 ("DRAMOBF_EN                is %d\n", tr->DRAMOBF_EN                );
  mcSHOW_DBG_MSG6 ("DRAMOBF_PIPE_NO           is %d\n", tr->DRAMOBF_PIPE_NO           );
  mcSHOW_DBG_MSG6 ("dly_1T_by_FDIV2           is %d\n", tr->dly_1T_by_FDIV2           );
  mcSHOW_DBG_MSG6 ("WL[0]                     is %d\n", tr->WL[0]                     );
  mcSHOW_DBG_MSG6 ("WL[1]                     is %d\n", tr->WL[1]                     );
  mcSHOW_DBG_MSG6 ("TDQSS[0][0]               is %d\n", tr->TDQSS[0][0]               );
  mcSHOW_DBG_MSG6 ("TDQSS[0][1]               is %d\n", tr->TDQSS[0][1]               );
  mcSHOW_DBG_MSG6 ("TDQSS[1][0]               is %d\n", tr->TDQSS[1][0]               );
  mcSHOW_DBG_MSG6 ("TDQSS[1][1]               is %d\n", tr->TDQSS[1][1]               );
  mcSHOW_DBG_MSG6 ("TDQS2DQ[0][0]             is %d\n", tr->TDQS2DQ[0][0]             );
  mcSHOW_DBG_MSG6 ("TDQS2DQ[0][1]             is %d\n", tr->TDQS2DQ[0][1]             );
  mcSHOW_DBG_MSG6 ("TDQS2DQ[1][0]             is %d\n", tr->TDQS2DQ[1][0]             );
  mcSHOW_DBG_MSG6 ("TDQS2DQ[1][1]             is %d\n", tr->TDQS2DQ[1][1]             );
#if (fcFOR_CHIP_ID == fcFigeac || fcFOR_CHIP_ID == fcLepin)
  mcSHOW_DBG_MSG6 ("TDQS2DQ_skew[0][0]        is %d\n", tr->TDQS2DQ_skew[0][0]        );
  mcSHOW_DBG_MSG6 ("TDQS2DQ_skew[0][1]        is %d\n", tr->TDQS2DQ_skew[0][1]        );
  mcSHOW_DBG_MSG6 ("TDQS2DQ_skew[1][0]        is %d\n", tr->TDQS2DQ_skew[1][0]        );
  mcSHOW_DBG_MSG6 ("TDQS2DQ_skew[1][1]        is %d\n", tr->TDQS2DQ_skew[1][1]        );
#endif
  mcSHOW_DBG_MSG6 ("ca_p2s_ratio              is %d\n", tr->ca_p2s_ratio              );
  mcSHOW_DBG_MSG6 ("ca_default_dly            is %d\n", tr->ca_default_dly            );
  mcSHOW_DBG_MSG6 ("ca_default_pi             is %d\n", tr->ca_default_pi             );
  mcSHOW_DBG_MSG6 ("ca_ser_latency            is %d\n", tr->ca_ser_latency            );
  mcSHOW_DBG_MSG6 ("dqs_ser_laterncy          is %d\n", tr->dqs_ser_laterncy          );
  mcSHOW_DBG_MSG6 ("dqs_default_dly           is %d\n", tr->dqs_default_dly           );
  mcSHOW_DBG_MSG6 ("dqs_oe_default_dly        is %d\n", tr->dqs_oe_default_dly        );
  mcSHOW_DBG_MSG6 ("dq_ser_laterncy           is %d\n", tr->dq_ser_laterncy           );
  mcSHOW_DBG_MSG6 ("MCK_unit                  is %d\n", tr->MCK_unit                  );
  mcSHOW_DBG_MSG6 ("dq_ui_unit                is %d\n", tr->dq_ui_unit                );
  mcSHOW_DBG_MSG6 ("ca_unit                   is %d\n", tr->ca_unit                   );
  mcSHOW_DBG_MSG6 ("ca_MCKIO_unit             is %d\n", tr->ca_MCKIO_unit             );
  mcSHOW_DBG_MSG6 ("ca_frate                  is %d\n", tr->ca_frate                  );
  mcSHOW_DBG_MSG6 ("TX_ECC                    is %d\n", tr->TX_ECC                    );
  mcSHOW_DBG_MSG6 ("TWPRE                     is %d\n", tr->TWPRE                     );
  mcSHOW_DBG_MSG6 ("OE_pre_margin             is %d\n", tr->OE_pre_margin             );
  mcSHOW_DBG_MSG6 ("OE_pst_margin             is %d\n", tr->OE_pst_margin             );
  mcSHOW_DBG_MSG6 ("OE_downgrade              is %d\n", tr->OE_downgrade              );
  mcSHOW_DBG_MSG6 ("aphy_slice_dly            is %d\n", tr->aphy_slice_dly            );
  mcSHOW_DBG_MSG6 ("aphy_dtc_dly              is %d\n", tr->aphy_dtc_dly              );
  mcSHOW_DBG_MSG6 ("aphy_tx_dly               is %d\n", tr->aphy_tx_dly               );
  mcSHOW_DBG_MSG6 ("DDRPHY_CLK_EN_COMB_TX_OPT is %d\n", tr->DDRPHY_CLK_EN_COMB_TX_OPT );
  mcSHOW_DBG_MSG6 ("NEW_RANK_MODE             is %d\n", tr->NEW_RANK_MODE             );
  mcSHOW_DBG_MSG6 ("close_loop_mode           is %d\n", tr->close_loop_mode           );
  mcSHOW_DBG_MSG6 ("semi_open_loop_mode       is %d\n", tr->semi_open_loop_mode       );
  mcSHOW_DBG_MSG6 ("TXP_WORKAROUND_OPT        is %d\n", tr->TXP_WORKAROUND_OPT        );
  mcSHOW_DBG_MSG6 ("ui2pi_ratio               is %d\n", tr->ui2pi_ratio               );
  mcSHOW_DBG_MSG6 ("XRTW2W_PI_mute_time       is %d\n", tr->XRTW2W_PI_mute_time       );
  mcSHOW_DBG_MSG6 ("fake_mode                 is %d\n", tr->fake_mode                 );
  mcSHOW_DBG_MSG6 ("dphy_tx_dly               is %d\n", tr->dphy_tx_dly               );
  mcSHOW_DBG_MSG6 ("impact_lat_dramobf        is %d\n", tr->impact_latency_for_dramobf);
  mcSHOW_DBG_MSG6 ("TX_DQ_Dline               is %d\n", tr->TX_DQ_Dline               );
  mcSHOW_DBG_MSG6 ("===========================================\n"                    );
}
void print_TX_path_attribution(TX_path_attribution_T *tr)
{
  mcSHOW_DBG_MSG6 ("===========================================\n"                 );
  mcSHOW_DBG_MSG6 ("print TX_path_attribution\n"                                   );
  mcSHOW_DBG_MSG6 ("===========================================\n"                 );
  mcSHOW_DBG_MSG6 ("TX_DQ_MCK_OE[0][0]                  is %d\n", tr->TX_DQ_MCK_OE[0][0]                  );
  mcSHOW_DBG_MSG6 ("TX_DQ_MCK_OE[0][1]                  is %d\n", tr->TX_DQ_MCK_OE[0][1]                  );
  mcSHOW_DBG_MSG6 ("TX_DQ_MCK_OE[1][0]                  is %d\n", tr->TX_DQ_MCK_OE[1][0]                  );
  mcSHOW_DBG_MSG6 ("TX_DQ_MCK_OE[1][1]                  is %d\n", tr->TX_DQ_MCK_OE[1][1]                  );
  mcSHOW_DBG_MSG6 ("TX_DQ_UI_OE[0][0]                   is %d\n", tr->TX_DQ_UI_OE[0][0]                   );
  mcSHOW_DBG_MSG6 ("TX_DQ_UI_OE[0][1]                   is %d\n", tr->TX_DQ_UI_OE[0][1]                   );
  mcSHOW_DBG_MSG6 ("TX_DQ_UI_OE[1][0]                   is %d\n", tr->TX_DQ_UI_OE[1][0]                   );
  mcSHOW_DBG_MSG6 ("TX_DQ_UI_OE[1][1]                   is %d\n", tr->TX_DQ_UI_OE[1][1]                   );
  mcSHOW_DBG_MSG6 ("TX_DQ_MCK[0][0]                     is %d\n", tr->TX_DQ_MCK[0][0]                     );
  mcSHOW_DBG_MSG6 ("TX_DQ_MCK[0][1]                     is %d\n", tr->TX_DQ_MCK[0][1]                     );
  mcSHOW_DBG_MSG6 ("TX_DQ_MCK[1][0]                     is %d\n", tr->TX_DQ_MCK[1][0]                     );
  mcSHOW_DBG_MSG6 ("TX_DQ_MCK[1][1]                     is %d\n", tr->TX_DQ_MCK[1][1]                     );
  mcSHOW_DBG_MSG6 ("TX_DQ_UI[0][0]                      is %d\n", tr->TX_DQ_UI[0][0]                      );
  mcSHOW_DBG_MSG6 ("TX_DQ_UI[0][1]                      is %d\n", tr->TX_DQ_UI[0][1]                      );
  mcSHOW_DBG_MSG6 ("TX_DQ_UI[1][0]                      is %d\n", tr->TX_DQ_UI[1][0]                      );
  mcSHOW_DBG_MSG6 ("TX_DQ_UI[1][1]                      is %d\n", tr->TX_DQ_UI[1][1]                      );
  mcSHOW_DBG_MSG6 ("TX_DQ_PI[0][0]                      is %d\n", tr->TX_DQ_PI[0][0]                      );
  mcSHOW_DBG_MSG6 ("TX_DQ_PI[0][1]                      is %d\n", tr->TX_DQ_PI[0][1]                      );
  mcSHOW_DBG_MSG6 ("TX_DQ_PI[1][0]                      is %d\n", tr->TX_DQ_PI[1][0]                      );
  mcSHOW_DBG_MSG6 ("TX_DQ_PI[1][1]                      is %d\n", tr->TX_DQ_PI[1][1]                      );
  mcSHOW_DBG_MSG6 ("TX_DQ_UIPI_all[0][0]                is %d\n", tr->TX_DQ_UIPI_all[0][0]                );
  mcSHOW_DBG_MSG6 ("TX_DQ_UIPI_all[0][1]                is %d\n", tr->TX_DQ_UIPI_all[0][1]                );
  mcSHOW_DBG_MSG6 ("TX_DQ_UIPI_all[1][0]                is %d\n", tr->TX_DQ_UIPI_all[1][0]                );
  mcSHOW_DBG_MSG6 ("TX_DQ_UIPI_all[1][1]                is %d\n", tr->TX_DQ_UIPI_all[1][1]                );
  mcSHOW_DBG_MSG6 ("TX_DQ_dlyline[0][0]                 is %d\n", tr->TX_DQ_dlyline[0][0]                 );
  mcSHOW_DBG_MSG6 ("TX_DQ_dlyline[0][1]                 is %d\n", tr->TX_DQ_dlyline[0][1]                 );
  mcSHOW_DBG_MSG6 ("TX_DQ_dlyline[1][0]                 is %d\n", tr->TX_DQ_dlyline[1][0]                 );
  mcSHOW_DBG_MSG6 ("TX_DQ_dlyline[1][1]                 is %d\n", tr->TX_DQ_dlyline[1][1]                 );
  mcSHOW_DBG_MSG6 ("TX_DQS_MCK_OE[0][0]                 is %d\n", tr->TX_DQS_MCK_OE[0][0]                 );
  mcSHOW_DBG_MSG6 ("TX_DQS_MCK_OE[0][1]                 is %d\n", tr->TX_DQS_MCK_OE[0][1]                 );
  mcSHOW_DBG_MSG6 ("TX_DQS_MCK_OE[1][0]                 is %d\n", tr->TX_DQS_MCK_OE[1][0]                 );
  mcSHOW_DBG_MSG6 ("TX_DQS_MCK_OE[1][1]                 is %d\n", tr->TX_DQS_MCK_OE[1][1]                 );
  mcSHOW_DBG_MSG6 ("TX_DQS_UI_OE[0][0]                  is %d\n", tr->TX_DQS_UI_OE[0][0]                  );
  mcSHOW_DBG_MSG6 ("TX_DQS_UI_OE[0][1]                  is %d\n", tr->TX_DQS_UI_OE[0][1]                  );
  mcSHOW_DBG_MSG6 ("TX_DQS_UI_OE[1][0]                  is %d\n", tr->TX_DQS_UI_OE[1][0]                  );
  mcSHOW_DBG_MSG6 ("TX_DQS_UI_OE[1][1]                  is %d\n", tr->TX_DQS_UI_OE[1][1]                  );
  mcSHOW_DBG_MSG6 ("TX_DQS_MCK[0][0]                    is %d\n", tr->TX_DQS_MCK[0][0]                    );
  mcSHOW_DBG_MSG6 ("TX_DQS_MCK[0][1]                    is %d\n", tr->TX_DQS_MCK[0][1]                    );
  mcSHOW_DBG_MSG6 ("TX_DQS_MCK[1][0]                    is %d\n", tr->TX_DQS_MCK[1][0]                    );
  mcSHOW_DBG_MSG6 ("TX_DQS_MCK[1][1]                    is %d\n", tr->TX_DQS_MCK[1][1]                    );
  mcSHOW_DBG_MSG6 ("TX_DQS_UI[0][0]                     is %d\n", tr->TX_DQS_UI[0][0]                     );
  mcSHOW_DBG_MSG6 ("TX_DQS_UI[0][1]                     is %d\n", tr->TX_DQS_UI[0][1]                     );
  mcSHOW_DBG_MSG6 ("TX_DQS_UI[1][0]                     is %d\n", tr->TX_DQS_UI[1][0]                     );
  mcSHOW_DBG_MSG6 ("TX_DQS_UI[1][1]                     is %d\n", tr->TX_DQS_UI[1][1]                     );
  mcSHOW_DBG_MSG6 ("DDRPHY_CLK_EN_COMB_TX_OPT           is %d\n", tr->DDRPHY_CLK_EN_COMB_TX_OPT           );
  mcSHOW_DBG_MSG6 ("TX_DQS_PI[0][0]                     is %d\n", tr->TX_DQS_PI[0][0]                     );
  mcSHOW_DBG_MSG6 ("TX_DQS_PI[0][1]                     is %d\n", tr->TX_DQS_PI[0][1]                     );
  mcSHOW_DBG_MSG6 ("TX_DQS_PI[1][0]                     is %d\n", tr->TX_DQS_PI[1][0]                     );
  mcSHOW_DBG_MSG6 ("TX_DQS_PI[1][1]                     is %d\n", tr->TX_DQS_PI[1][1]                     );
  mcSHOW_DBG_MSG6 ("DDRPHY_CLK_EN_COMB_TX_PICG_CNT      is %d\n", tr->DDRPHY_CLK_EN_COMB_TX_PICG_CNT      );
  mcSHOW_DBG_MSG6 ("DDRPHY_CLK_EN_COMB_TX_DQS_SEL_P0    is %d\n", tr->DDRPHY_CLK_EN_COMB_TX_DQS_SEL_P0    );
  mcSHOW_DBG_MSG6 ("DDRPHY_CLK_EN_COMB_TX_DQS_SEL_P1    is %d\n", tr->DDRPHY_CLK_EN_COMB_TX_DQS_SEL_P1    );
  mcSHOW_DBG_MSG6 ("DDRPHY_CLK_EN_COMB_TX_DQ_RK0_SEL_P0 is %d\n", tr->DDRPHY_CLK_EN_COMB_TX_DQ_RK0_SEL_P0 );
  mcSHOW_DBG_MSG6 ("DDRPHY_CLK_EN_COMB_TX_DQ_RK0_SEL_P1 is %d\n", tr->DDRPHY_CLK_EN_COMB_TX_DQ_RK0_SEL_P1 );
  mcSHOW_DBG_MSG6 ("DDRPHY_CLK_EN_COMB_TX_DQ_RK1_SEL_P0 is %d\n", tr->DDRPHY_CLK_EN_COMB_TX_DQ_RK1_SEL_P0 );
  mcSHOW_DBG_MSG6 ("DDRPHY_CLK_EN_COMB_TX_DQ_RK1_SEL_P1 is %d\n", tr->DDRPHY_CLK_EN_COMB_TX_DQ_RK1_SEL_P1 );
  mcSHOW_DBG_MSG6 ("DPHY_TX_DCM_EXTCNT                  is %d\n", tr->DPHY_TX_DCM_EXTCNT                  );
  mcSHOW_DBG_MSG6 ("TX_PI_UPD_MODE                      is %d\n", tr->TX_PI_UPD_MODE                      );
  mcSHOW_DBG_MSG6 ("TX_PI_UPDCTL_B0                     is %d\n", tr->TX_PI_UPDCTL_B0                     );
  mcSHOW_DBG_MSG6 ("TX_PI_UPDCTL_B1                     is %d\n", tr->TX_PI_UPDCTL_B1                     );
  mcSHOW_DBG_MSG6 ("TX_RANKINCTL_ROOT                   is %d\n", tr->TX_RANKINCTL_ROOT                   );
  mcSHOW_DBG_MSG6 ("TX_RANKINCTL                        is %d\n", tr->TX_RANKINCTL                        );
  mcSHOW_DBG_MSG6 ("TX_RANKINCTL_TXDLY                  is %d\n", tr->TX_RANKINCTL_TXDLY                  );
  mcSHOW_DBG_MSG6 ("DDRPHY_CLK_DYN_GATING_SEL           is %d\n", tr->DDRPHY_CLK_DYN_GATING_SEL           );
  mcSHOW_DBG_MSG6 ("DDRPHY_CLK_EN_OPT                   is %d\n", tr->DDRPHY_CLK_EN_OPT                   );
  mcSHOW_DBG_MSG6 ("ARPI_CMD                            is %d\n", tr->ARPI_CMD                            );
  mcSHOW_DBG_MSG6 ("TDMY                                is %d\n", tr->TDMY                                );
  mcSHOW_DBG_MSG6 ("TXOEN_AUTOSET_DQ_OFFSET             is %d\n", tr->TXOEN_AUTOSET_DQ_OFFSET             );
  mcSHOW_DBG_MSG6 ("TXOEN_AUTOSET_DQS_OFFSET            is %d\n", tr->TXOEN_AUTOSET_DQS_OFFSET            );
  mcSHOW_DBG_MSG6 ("TXOEN_AUTOSET_EN                    is %d\n", tr->TXOEN_AUTOSET_EN                    );
  mcSHOW_DBG_MSG6 ("TXPICG_AUTOSET_OPT                  is %d\n", tr->TXPICG_AUTOSET_OPT                  );
  mcSHOW_DBG_MSG6 ("TXPICG_AUTOSET_EN                   is %d\n", tr->TXPICG_AUTOSET_EN                   );
  mcSHOW_DBG_MSG6 ("TXPICG_DQ_MCK_OFFSET_LAG            is %d\n", tr->TXPICG_DQ_MCK_OFFSET_LAG            );
  mcSHOW_DBG_MSG6 ("TXPICG_DQS_MCK_OFFSET_LAG           is %d\n", tr->TXPICG_DQS_MCK_OFFSET_LAG           );
  mcSHOW_DBG_MSG6 ("TXPICG_DQ_UI_OFFSET_LEAD            is %d\n", tr->TXPICG_DQ_UI_OFFSET_LEAD            );
  mcSHOW_DBG_MSG6 ("TXPICG_DQ_UI_OFFSET_LAG             is %d\n", tr->TXPICG_DQ_UI_OFFSET_LAG             );
  mcSHOW_DBG_MSG6 ("TXPICG_DQS_UI_OFFSET_LEAD           is %d\n", tr->TXPICG_DQS_UI_OFFSET_LEAD           );
  mcSHOW_DBG_MSG6 ("TXPICG_DQS_UI_OFFSET_LAG            is %d\n", tr->TXPICG_DQS_UI_OFFSET_LAG            );
  mcSHOW_DBG_MSG6 ("===========================================\n"                 );
}
...
void get_TX_path_config(DRAMC_CTX_T *p, TX_path_config_T *TX_C,U8 ch_id, U8 group_id)
{
  U8 BYTE_swap;
  ...
  LP4_DRAM_CONFIG_T LP4_TX_temp = {0};
  if (LPDDR4_EN_S) {
...
#if SA_CONFIG_EN
  TX_C->close_loop_mode = !(u1IsPhaseMode_DQ(DUT_p.ctx));
  TX_C->semi_open_loop_mode = !!(u1IsPhaseMode_DQ(DUT_p.ctx));
#else
  ...
  if (LPDDR5_EN_S == 1)
  {
    ...
    {
      TX_C->WL[0]    = Get_WL_LP5_DVFSC_DIS(LP5_TX_temp.MR_WL, BYTE_MODE, A_D->CKR);
      TX_C->WL[1]    = Get_WL_LP5_DVFSC_DIS(LP5_TX_temp.MR_WL, BYTE_MODE, A_D->CKR);
    }
...
#endif
  {
    mcSHOW_ERR_MSG("Error: wrong memory type, LP4 LP5 DDR3 DDR4 are support lists.--TX caculation\n");
    ASSERT(0);
  }

#if (fcFOR_CHIP_ID == fcFigeac || fcFOR_CHIP_ID == fcLepin)
  if(LPDDR5_EN_S && (TX_C->close_loop_mode==0)){
      //TX_C->TDQS2DQ[0][0] = (TX_C->TDQS2DQ[0][0]+TX_C->TDQS2DQ[1][0])/2;
      //TX_C->TDQS2DQ[0][1] = (TX_C->TDQS2DQ[0][1]+TX_C->TDQS2DQ[1][1])/2;
      //TX_C->TDQS2DQ[1][0] =  TX_C->TDQS2DQ[0][0]                       ;
      //TX_C->TDQS2DQ[1][1] =  TX_C->TDQS2DQ[0][1]                       ;
      ...
      for(rank_id = 0; rank_id < 2; rank_id ++)
      {
        for(byte_id = 0; byte_id < 2; byte_id ++)
        {
             TX_C->TDQS2DQ_skew[rank_id][byte_id] = 0;
        }
      }
  }
#endif
...
//               case 4100: {TX_C->DRAMOBF_PIPE_NO   = 4  ;break;}
...
#else
               case 4266: {TX_C->DRAMOBF_PIPE_NO   = 2  ;break;}
               case 3733: {TX_C->DRAMOBF_PIPE_NO   = 2  ;break;}
               case 3200: {TX_C->DRAMOBF_PIPE_NO   = 2  ;break;}
               case 2667: {TX_C->DRAMOBF_PIPE_NO   = 2  ;break;}
               case 2400: {TX_C->DRAMOBF_PIPE_NO   = 2  ;break;}
               case 2133: {TX_C->DRAMOBF_PIPE_NO   = 2  ;break;}
               case 1866: {TX_C->DRAMOBF_PIPE_NO   = 2  ;break;}
               case 1600: {TX_C->DRAMOBF_PIPE_NO   = 2  ;break;}
               case 1200: {TX_C->DRAMOBF_PIPE_NO   = 2  ;break;}
               case 800 : {TX_C->DRAMOBF_PIPE_NO   = 2  ;break;}
               case 400 : {TX_C->DRAMOBF_PIPE_NO   = 2  ;break;}
#endif
	       default  : mcSHOW_DBG_MSG6("[TX_path_auto_gen] DRAMOBF_PIPE_NO Unexpected DFS(group_id)->data_rate=%1d input \n",TX_C->data_ratio);
	     }//switch
    }
    else 
    {
    ...
    if (DUT_p.DEF_DIGPHY)
      ...
      TX_C->dphy_tx_dly = (TX_C->data_ratio == 2133) ? 1:0;
#else
      TX_C->dphy_tx_dly = 1;
#endif
    else
  ...
  if (PCDDR3_EN_S){
    ...
    TX_C->DBI_WR            = 0  ;
    TX_C->DRAMOBF_EN        = 0  ; //!TBD
    TX_C->DRAMOBF_PIPE_NO   = 0  ; //!TBD
    TX_C->ca_default_dly    = 1  ;
    TX_C->cs2WL_start       = 1  ;
    TX_C->TDQSS[0][0]	    = (TX_C->dq_ui_unit >> 1)  ; 
    TX_C->TDQSS[0][1]  	    = (TX_C->dq_ui_unit >> 1); 
    TX_C->TDQSS[1][0]  	    = (TX_C->dq_ui_unit >> 1); 
    TX_C->TDQSS[1][1]  	    = (TX_C->dq_ui_unit >> 1); 
    TX_C->TX_ECC            = 0  ;
  ...
  if (PCDDR4_EN_S){
    ...
    TX_C->ca_default_dly    = 1  ;
    TX_C->cs2WL_start       = 1  ;
    TX_C->TDQSS[0][0]	    = (TX_C->dq_ui_unit * 4) / 10  ;//SPEC -0.27 ~ 0.27 here fix 0.2 
    TX_C->TDQSS[0][1]  	    = (TX_C->dq_ui_unit * 4) / 10;//SPEC -0.27 ~ 0.27 here fix 0.2 
    TX_C->TDQSS[1][0]  	    = (TX_C->dq_ui_unit * 4) / 10  ;//SPEC -0.27 ~ 0.27 here fix 0.2 
    TX_C->TDQSS[1][1]  	    = (TX_C->dq_ui_unit * 4) / 10  ;//SPEC -0.27 ~ 0.27 here fix 0.2 
    TX_C->TX_ECC            = 0  ;
    //if (TX_C->dq_p2s_ratio == 4)  //TODO
    //  TX_C->dly_1T_by_FDIV2 = 1;
    //else 
...
#endif
  {
    mcSHOW_ERR_MSG("Error: wrong memory type, LP4 LP5 DDR3 DDR4 are support lists.\n");
    ASSERT(0);
  }
...
void calculate_TX_path_rg_val(TX_path_config_T *TX_C, TX_path_attribution_T *TX_R, U8 group_id, U8 ch_id)
{
...
#endif
  {
    mcSHOW_ERR_MSG("Error: don't support this memory type\n");
    ASSERT(0);
  }
  ...
  //}
  mcSHOW_DBG_MSG6("TX_DQ_UI_OE_pre  is %d\n", TX_DQ_UI_OE_pre);
  mcSHOW_DBG_MSG6("TX_DQS_UI_OE_pre is %d\n", TX_DQS_UI_OE_pre);
  for(rank_id = 0; rank_id < 2; rank_id ++)
  {
    for(byte_id = 0; byte_id < 2; byte_id ++)
    {
      ...
      mcSHOW_DBG_MSG6("june_debug: TX_dq_latency_ps bef is %0d\n", TX_dq_latency_ps[rank_id][byte_id]);
      ...
      mcSHOW_DBG_MSG6("june_debug: TX_dq_latency_ps aft is %0d\n", TX_dq_latency_ps[rank_id][byte_id]);
    ...
    if ((TX_R->TX_DQ_PI[rank_id][byte_id] < TX_DQ_PI_min) | (TX_R->TX_DQ_PI[rank_id][byte_id] > TX_DQ_PI_max)) {
        mcSHOW_DBG_MSG6("Warning: calculate wrong TX_DQ_PI, PI is %0d, PI_min is %0d, PI_max is %0d\n", TX_R->TX_DQ_PI[rank_id][byte_id], TX_DQ_PI_min, TX_DQ_PI_max);
    }
      ...
      if(PCDDR4_EN_S && (DUT_p.DEF_DDR4_LP4_EN_TBA == 1)){
       TX_R->TX_DQ_UI_OE[rank_id][byte_id] = (ch_id == 1) ? TX_R->TX_DQ_UI_OE[rank_id][byte_id]+2 : TX_R->TX_DQ_UI_OE[rank_id][byte_id];
      }
      ...
      else 
      {
        switch (DUT_shu_p[group_id].WCK_PI_RANK_DIFF) {
		  ...
		  #else
          case 0: TX_R->TX_DQS_PI[rank_id][byte_id] = 1;                       break;
          case 1: TX_R->TX_DQS_PI[rank_id][byte_id] = (rank_id == 0) ? 2 : 1;  break;
          case 2: TX_R->TX_DQS_PI[rank_id][byte_id] = (rank_id == 1) ? 2 : 1;  break;
          case 3: TX_R->TX_DQS_PI[rank_id][byte_id] = (rank_id + 3);           break;
		  #endif
        }
      }
	...
	TX_R->TX_DQS_MCK_OE[rank_id][byte_id] = TX_R->TX_DQ_MCK_OE[rank_id][byte_id];
      ...
      if((DUT_p.TX_DQ_Dline_EN == 1) && (LPDDR4_EN_S)){
        mcSHOW_DBG_MSG6("Warning: calculate TX_DQS_UI, TX_DQS_UI is %0d, rank_id=%0d, byte_id==%0d\n", TX_R->TX_DQS_UI[rank_id][byte_id], rank_id, byte_id);
        mcSHOW_DBG_MSG6("Warning: calculate TX_DQS_UI_OE, TX_DQS_UI_OE is %0d, rank_id=%0d, byte_id==%0d\n", TX_R->TX_DQS_UI_OE[rank_id][byte_id], rank_id, byte_id);
        ...
        mcSHOW_DBG_MSG6("Warning: calculate_0 TX_DQS_PI, TX_DQS_PI is %0d, rank_id=%0d, byte_id==%0d \n", TX_R->TX_DQS_PI[rank_id][byte_id], rank_id, byte_id);
        TX_R->TX_DQS_PI[rank_id][byte_id]    = ((TX_C->dq_ui_unit - (TX_C->TX_DQ_Dline>>2 )*tx_dly_line_unit)*TX_C->ui2pi_ratio) / TX_C->dq_ui_unit;
        mcSHOW_DBG_MSG6("Warning: calculate_1 TX_DQS_PI, TX_DQS_PI is %0d, rank_id=%0d, byte_id==%0d \n", TX_R->TX_DQS_PI[rank_id][byte_id], rank_id, byte_id);
        if(rank_id == 1) {
...
#if (fcFOR_CHIP_ID == fcFigeac || fcFOR_CHIP_ID == fcLepin)
  // update PI setting for SEMI_OPEN mode not support Rank diff@ fcLepin.
  for(rank_id = 0; rank_id < 2; rank_id ++){
    for(byte_id = 0; byte_id < 2; byte_id ++){
      //mcSHOW_DBG_MSG6("Warning: june_debug TX_DQ_UI_mini is %0d\n", TX_DQ_UI_mini);
      if(TX_DQ_UI_mini > TX_R->TX_DQ_UI[rank_id][byte_id]){
        TX_DQ_UI_mini  = TX_R->TX_DQ_UI[rank_id][byte_id];
      }
      //mcSHOW_DBG_MSG6("Warning: june_debug TX_DQ_UI_mini is %0d\n", TX_DQ_UI_mini);

      //mcSHOW_DBG_MSG6("Warning: june_debug TX_DQ_PI_mini,  is %0h\n", TX_DQ_PI_mini);
      ...
      //mcSHOW_DBG_MSG6("Warning: june_debug TX_DQ_PI_mini,  is %0d\n", TX_DQ_PI_mini);
    }
  }
  if(TX_C->semi_open_loop_mode == 1 && LPDDR5_EN_S/*&& TX_C->data_ratio == 1866*/ )
  {
    ...
    //mcSHOW_DBG_MSG6("Warning: june_debug TX_DQ_PI_mini,  is %0h\n", TX_DQ_PI_mini);
    //mcSHOW_DBG_MSG6("Warning: june_debug TX_DQ_UI is %0d\n", TX_R->TX_DQ_UI[rank_id][byte_id]);
    //mcSHOW_DBG_MSG6("Warning: june_debug TDQS2DQ_skew_mini,  is %0h\n", TDQS2DQ_skew_min);
  }
  ...
  else
  {
    ...
    if ((TX_R->TX_DQS_MCK_OE[0][0] < (ASVA_PICG_SPEC - TX_C->dq_p2s_ratio ==4)) & (TX_R->TX_DQS_UI_OE[0][0] < ( TX_C->dq_p2s_ratio ==8 - dqs_oe_def_ui_dly_p0) )) {
        mcSHOW_ERR_MSG("ERROR: TX_DQS_MCK_OE and TX_DQS_UI_OE don't suit this algorithm"); //make sure the rg val >=0
    }

    TX_R->DDRPHY_CLK_EN_COMB_TX_DQS_SEL_P0 =
        TX_R->TX_DQS_MCK_OE[0][0] + 1 + (TX_C->dq_p2s_ratio == 4) +
            ((TX_R->TX_DQS_UI_OE[0][0] >= (U32)(TX_C->dq_p2s_ratio - dqs_oe_def_ui_dly_p0)) ? 1 : 0)
                - ASVA_PICG_SPEC; //see more in PICG_introduction.pptx by York or TX_path_item.vsdx by jianbo
    TX_R->DDRPHY_CLK_EN_COMB_TX_DQS_SEL_P1 =
        TX_R->TX_DQS_MCK_OE[0][0] + 1 + (TX_C->dq_p2s_ratio == 4) +
            ((TX_R->TX_DQS_UI_OE[0][0] >= (U32)(TX_C->dq_p2s_ratio - dqs_oe_def_ui_dly_p1)) ? 1 : 0)
                - (ASVA_PICG_SPEC - 1); //see more in PICG_introduction.pptx by York or TX_path_item.vsdx by jianbo
  ...
  if (TX_C->NEW_RANK_MODE == 1)
  {
    ...
    //{
    //  //TODO
    //  mcSHOW_DBG_MSG6("Warning: do not support dq_p2s_ratio is %0d\n", TX_C->dq_p2s_ratio);
    //}
    if (TX_C->DRAMOBF_EN) {
    ...
    {
        TX_R->TX_RANKINCTL       = 1;//TODO,for fcLePin LP5-1866,TX DQ PI cross rank
    }
  ...
  else //NEW_RANK_MODE == 0
  {
    ...
    } else if (TX_C->dq_p2s_ratio == 8)
    {
      ...
      { mcSHOW_DBG_MSG6("Warning: do not support data_ratio is %0d", TX_C->data_ratio); }
    }
  }
...
//=================================
void TX_PATH_config(DRAMC_CTX_T *p, TX_path_attribution_T *tr,U32 ch_id, U8 group_id)
{
  U8  rank_id; 
  ...
  p->ShuRGAccessIdx = (group_id == 0) ? DRAM_DFS_REG_SHU0 : DRAM_DFS_REG_SHU1;
    ...
    //oe auto set 
    vIO32WriteFldMulti(DRAMC_REG_ADDR(DRAMC_REG_SHU_TX_SET1), P_Fld(tr->TXOEN_AUTOSET_DQ_OFFSET      , SHU_TX_SET1_TXOEN_AUTOSET_DQ_OFFSET   ) 
                                                            | P_Fld(tr->TXOEN_AUTOSET_DQS_OFFSET     , SHU_TX_SET1_TXOEN_AUTOSET_DQS_OFFSET  ) 
                                                            | P_Fld(tr->TXOEN_AUTOSET_EN	            , SHU_TX_SET1_TXOEN_AUTOSET_EN          ) 
    ...
    #if (fcFOR_CHIP_ID == fcLepin)
    vIO32WriteFldAlign(DRAMC_REG_ADDR(DRAMC_REG_SHU_COMMON0),        tr->TDMY,  SHU_COMMON0_SHU_COMMON0_RSV    ); // jouling: fcLepin ECO
	#else
    vIO32WriteFldAlign(DRAMC_REG_ADDR(DRAMC_REG_SHU_ACTIM7),       tr->TDMY,  SHU_ACTIM7_TDMY  );
	#endif
  for (rank_id = 0; rank_id <=1; rank_id++)
  {
    ...
    //set TX DQ PI delay
    vIO32WriteFldMulti(DRAMC_REG_ADDR(DDRPHY_REG_SHU_RK_B0_DQ),    P_Fld (tr->TX_DQ_PI[rank_id][0],     SHU_RK_B0_DQ_SW_ARPI_DQ_B0)    \
                                                                   |P_Fld(tr->TX_DQ_PI[rank_id][0],     SHU_RK_B0_DQ_SW_ARPI_DQM_B0)   );
    vIO32WriteFldMulti(DRAMC_REG_ADDR(DDRPHY_REG_SHU_RK_B1_DQ),    P_Fld (tr->TX_DQ_PI[rank_id][1],     SHU_RK_B1_DQ_SW_ARPI_DQ_B1)    \
                                                                   |P_Fld(tr->TX_DQ_PI[rank_id][1],     SHU_RK_B1_DQ_SW_ARPI_DQM_B1)   );
    ...
    vIO32WriteFldMulti(DRAMC_REG_ADDR(DRAMC_REG_SHURK_PI),          P_Fld(tr->TX_DQ_PI[rank_id][0],     SHURK_PI_RK0_ARPI_DQ_B0)       \
                                                                   |P_Fld(tr->TX_DQ_PI[rank_id][1],     SHURK_PI_RK0_ARPI_DQ_B1)       \
                                                                   |P_Fld(tr->TX_DQ_PI[rank_id][0],     SHURK_PI_RK0_ARPI_DQM_B0)    \
    ...
    vIO32WriteFldAlign(DRAMC_REG_ADDR(DDRPHY_REG_SHU_RK_B0_TXDLY3),  tr->TX_DQ_dlyline[rank_id][0],  SHU_RK_B0_TXDLY3_TX_ARDQM0_DLY_B0 ); 
    ...
    vIO32WriteFldAlign(DRAMC_REG_ADDR(DDRPHY_REG_SHU_RK_B1_TXDLY3),  tr->TX_DQ_dlyline[rank_id][1],  SHU_RK_B1_TXDLY3_TX_ARDQM0_DLY_B1 ); 
    //set TX DQS dly line
    ...
    vIO32WriteFldAlign(DRAMC_REG_ADDR(DDRPHY_REG_SHU_RK_B0_DQ),  tr->TX_DQS_PI[rank_id][0],  SHU_RK_B0_DQ_ARPI_PBYTE_B0 ); 
    vIO32WriteFldAlign(DRAMC_REG_ADDR(DDRPHY_REG_SHU_RK_B1_DQ),  tr->TX_DQS_PI[rank_id][1],  SHU_RK_B1_DQ_ARPI_PBYTE_B1 ); 
...
TX_path_attribution_T     gTxPathAttr;
void TX_PATH_auto_gen_and_set(DRAMC_CTX_T *p, U32 ch_id, U8 group_id)
{

  TX_path_config_T          TX_C   ;
  TX_path_attribution_T     *TX_R   = &gTxPathAttr;
  get_TX_path_config        (p, &TX_C, ch_id,group_id);
  ...
  TX_PATH_config(p,TX_R,ch_id,group_id);
    ...
    {
      vIO32WriteFldAlign(DRAMC_REG_ADDR(DRAMC_REG_SHU_DCM_CTRL0),  5,    SHU_DCM_CTRL0_APHYPI_CKCGH_CNT); //CG change to high 1T later when FAKE_MODE 
      mcSHOW_DBG_MSG6 ("set APHY_PI_CKCGH_CNT is 5 when fake_mode, cur data_rate is %d\n", TX_C.data_ratio            );
    }
    else
    {
      vIO32WriteFldAlign(DRAMC_REG_ADDR(DRAMC_REG_SHU_DCM_CTRL0),  4,    SHU_DCM_CTRL0_APHYPI_CKCGH_CNT); //CG change to high 1T later when FAKE_MODE 
      mcSHOW_DBG_MSG6 ("set APHY_PI_CKCGH_CNT is 4 when not fake_mode, cur data_rate is %d\n", TX_C.data_ratio            );
    }
      gTxPathAttr.DRAMOBF_PIPE_NO = TX_C.DRAMOBF_PIPE_NO;
      vIO32WriteFldAlign(DRAMC_REG_ADDR(DRAMC_REG_SHU_WODT),  TX_C.DRAMOBF_PIPE_NO,    SHU_WODT_DRAMOBF_PIPE_NO); // 
      mcSHOW_DBG_MSG6 ("set DRAMOBF_PIPE_NO is %d\n", TX_C.DRAMOBF_PIPE_NO           );
}

void getTxDqInitDelay(U8 *mck, U8 *ui, U8 *pi)
{
    *mck = gTxPathAttr.TX_DQ_MCK[0][0];
    *ui = gTxPathAttr.TX_DQ_UI[0][0];
    *pi = gTxPathAttr.TX_DQ_PI[0][0];
}
U8 getDRAMOBF_PIPE(void)
{
	return gTxPathAttr.DRAMOBF_PIPE_NO;
}
