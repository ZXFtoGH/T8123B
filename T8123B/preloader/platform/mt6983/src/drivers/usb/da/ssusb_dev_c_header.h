...
//U3D_LV1IER
#define LV1IER                                    (0xffffffffU<<0) //31:0

//U3D_LV1IESR
#define LV1IESR                                   (0xffffffffU<<0) //31:0

//U3D_LV1IECR
#define LV1IECR                                   (0xffffffffU<<0) //31:0

//U3D_MAC_U1_EN_CTRL
#define EXIT_BY_ERDY_DIS                          (0x1U<<31) //31:31
...
//U3D_EP0DMACTRL
#define FFSTRADDR0                                (0xffffU<<16) //31:16
...
//U3D_EP0DMASTRADDR
#define DMASTRADDR0                               (0xffffffffU<<0) //31:0
...
//U3D_TXDMACTRL
#define FFSTRADDR                                 (0xffffU<<16) //31:16
#define ENDPNT                                    (0xf<<4) //7:4
#define INTEN                                     (0x1<<3) //3:3
#define DMA_DIR                                   (0x1<<1) //1:1
#define DMA_EN                                    (0x1<<0) //0:0
...
//U3D_TXDMASTRADDR
#define DMASTRADDR                                (0xffffffffU<<0) //31:0

//U3D_TXDMATRDCNT
#define DMATFRCNT                                 (0x7ff<<0) //10:0

//U3D_TXDMARLCOUNT
#define DMALIMITER                                (0x3<<28) //29:28
#define DMA_FAKE                                  (0x1<<27) //27:27
#define DMA_BURST                                 (0x3<<24) //25:24
...
//U3D_RXDMARLCOUNT
#define DMA_NON_BUF                               (0x1U<<31) //31:31
#define DMALIMITER                                (0x3<<28) //29:28
#define DMA_FAKE                                  (0x1<<27) //27:27
#define DMA_BURST                                 (0x3<<24) //25:24

//U3D_EP0CSR
#define EP0_EP_RESET                              (0x1U<<31) //31:31
...
//U3D_TX1CSR0
#define TX_EP_RESET                               (0x1U<<31) //31:31
...
//U3D_TX1CSR2
#define TXBINTERVAL                               (0xffU<<24) //31:24
...
//U3D_RX1CSR0
#define RX_EP_RESET                               (0x1U<<31) //31:31
...
//U3D_RX1CSR2
#define RXBINTERVAL                               (0xffU<<24) //31:24
...
//U3D_QCR0
#define RXQ_CS_EN                                 (0x7fffU<<17) //31:17
...
//U3D_QCR3
#define CFG_RX_COZ                                (0x7fffU<<17) //31:17
#define CFG_RX_ZLP                                (0x7fff<<1) //15:1

//U3D_QGCSR
#define RXQ_EN                                    (0x7fffU<<17) //31:17
...
//U3D_TXQSAR1
#define TXQ_START_ADDR                            (0x3fffffffU<<2) //31:2

//U3D_TXQCPR1
#define TXQ_CUR_GPD_ADDR                          (0x3fffffffU<<2) //31:2
...
//U3D_RXQSAR1
#define RXQ_START_ADDR                            (0x3fffffffU<<2) //31:2

//U3D_RXQCPR1
#define RXQ_CUR_GPD_ADDR                          (0x3fffffffU<<2) //31:2

//U3D_RXQLDPR1
#define RXQ_LAST_DONE_PTR                         (0x3fffffffU<<2) //31:2
...
//U3D_QISAR0
#define RXQ_DONE_INT                              (0x7fffU<<17) //31:17
#define TXQ_DONE_INT                              (0x7fff<<1) //15:1

//U3D_QIER0
#define RXQ_DONE_IER                              (0x7fffU<<17) //31:17
#define TXQ_DONE_IER                              (0x7fff<<1) //15:1

//U3D_QIESR0
#define RXQ_DONE_IESR                             (0x7fffU<<17) //31:17
#define TXQ_DONE_IESR                             (0x7fff<<1) //15:1

//U3D_QIECR0
#define RXQ_DONE_IECR                             (0x7fffU<<17) //31:17
...
//U3D_QEMIR
#define RXQ_EMPTY_MASK                            (0x7fffU<<17) //31:17
#define TXQ_EMPTY_MASK                            (0x7fff<<1) //15:1

//U3D_QEMIER
#define RXQ_EMPTY_IER_MASK                        (0x7fffU<<17) //31:17
#define TXQ_EMPTY_IER_MASK                        (0x7fff<<1) //15:1

//U3D_QEMIESR
#define RXQ_EMPTY_IESR_MASK                       (0x7fffU<<17) //31:17
#define TXQ_EMPTY_IESR_MASK                       (0x7fff<<1) //15:1

//U3D_QEMIECR
#define RXQ_EMPTY_IECR_MASK                       (0x7fffU<<17) //31:17
#define TXQ_EMPTY_IECR_MASK                       (0x7fff<<1) //15:1

//U3D_TQERRIR0
#define TXQ_LENERR_MASK                           (0x7fffU<<17) //31:17
#define TXQ_CSERR_MASK                            (0x7fff<<1) //15:1

//U3D_TQERRIER0
#define TXQ_LENERR_IER_MASK                       (0x7fffU<<17) //31:17
#define TXQ_CSERR_IER_MASK                        (0x7fff<<1) //15:1

//U3D_TQERRIESR0
#define TXQ_LENERR_IESR_MASK                      (0x7fffU<<17) //31:17
#define TXQ_CSERR_IESR_MASK                       (0x7fff<<1) //15:1

//U3D_TQERRIECR0
#define TXQ_LENERR_IECR_MASK                      (0x7fffU<<17) //31:17
#define TXQ_CSERR_IECR_MASK                       (0x7fff<<1) //15:1

//U3D_RQERRIR0
#define RXQ_LENERR_MASK                           (0x7fffU<<17) //31:17
#define RXQ_CSERR_MASK                            (0x7fff<<1) //15:1

//U3D_RQERRIER0
#define RXQ_LENERR_IER_MASK                       (0x7fffU<<17) //31:17
#define RXQ_CSERR_IER_MASK                        (0x7fff<<1) //15:1

//U3D_RQERRIESR0
#define RXQ_LENERR_IESR_MASK                      (0x7fffU<<17) //31:17
#define RXQ_CSERR_IESR_MASK                       (0x7fff<<1) //15:1

//U3D_RQERRIECR0
#define RXQ_LENERR_IECR_MASK                      (0x7fffU<<17) //31:17
#define RXQ_CSERR_IECR_MASK                       (0x7fff<<1) //15:1

//U3D_RQERRIR1
#define RXQ_ZLPERR_MASK                           (0x7fffU<<17) //31:17

//U3D_RQERRIER1
#define RXQ_ZLPERR_IER_MASK                       (0x7fffU<<17) //31:17

//U3D_RQERRIESR1
#define RXQ_ZLPERR_IESR_MASK                      (0x7fffU<<17) //31:17

//U3D_RQERRIECR1
#define RXQ_ZLPERR_IECR_MASK                      (0x7fffU<<17) //31:17

//U3D_CAP_EP0FFSZ
#define CAP_EP0FFSZ                               (0xffffffffU<<0) //31:0

//U3D_CAP_EPNTXFFSZ
#define CAP_EPNTXFFSZ                             (0xffffffffU<<0) //31:0

//U3D_CAP_EPNRXFFSZ
#define CAP_EPNRXFFSZ                             (0xffffffffU<<0) //31:0
