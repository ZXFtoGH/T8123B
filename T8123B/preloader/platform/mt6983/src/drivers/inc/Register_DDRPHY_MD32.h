...
#define DDRPHY_MD32_REG_SSPM_CFGREG_SW_RSTN                    (DDRPHY_MD32_BASE_ADDRESS + 0x40000)
    #define SSPM_CFGREG_SW_RSTN_PMEM_OOR_PROT                  Fld(1, 31) //[31:31]
    #define SSPM_CFGREG_SW_RSTN_MEM_RATIO                      Fld(2, 28) //[29:28]
    #define SSPM_CFGREG_SW_RSTN_DRAMC_CONF_RST_B               Fld(1, 1) //[1:1]
    #define SSPM_CFGREG_SW_RSTN_SW_RSTN                        Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_RESOURCE_CTL               (DDRPHY_MD32_BASE_ADDRESS + 0x40004)
...
#define DDRPHY_MD32_REG_SSPM_CFGREG_SYS_RMAP                   (DDRPHY_MD32_BASE_ADDRESS + 0x40008)
...
#define DDRPHY_MD32_REG_SSPM_CFGREG_OCD_BYPASS                 (DDRPHY_MD32_BASE_ADDRESS + 0x4000C)
    #define SSPM_CFGREG_OCD_BYPASS_OCD_BYPASS                  Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD2HOST_IPC                (DDRPHY_MD32_BASE_ADDRESS + 0x40010)
...
#define DDRPHY_MD32_REG_SSPM_CFGREG_MD2SPM_IPC                 (DDRPHY_MD32_BASE_ADDRESS + 0x40014)
    #define SSPM_CFGREG_MD2SPM_IPC_MD2SPM_IPC                  Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_HOST2MD_IPC                (DDRPHY_MD32_BASE_ADDRESS + 0x40018)
    #define SSPM_CFGREG_HOST2MD_IPC_HOST2MD_IPC                Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_SPM2MD_IPC                 (DDRPHY_MD32_BASE_ADDRESS + 0x4001C)
    #define SSPM_CFGREG_SPM2MD_IPC_SPM2MD_IPC                  Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR0                       (DDRPHY_MD32_BASE_ADDRESS + 0x40020)
    #define SSPM_CFGREG_GPR0_GPR0                              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR1                       (DDRPHY_MD32_BASE_ADDRESS + 0x40024)
    #define SSPM_CFGREG_GPR1_GPR1                              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR2                       (DDRPHY_MD32_BASE_ADDRESS + 0x40028)
    #define SSPM_CFGREG_GPR2_GPR2                              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR3                       (DDRPHY_MD32_BASE_ADDRESS + 0x4002C)
    #define SSPM_CFGREG_GPR3_GPR3                              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR4                       (DDRPHY_MD32_BASE_ADDRESS + 0x40030)
    #define SSPM_CFGREG_GPR4_GPR4                              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR5                       (DDRPHY_MD32_BASE_ADDRESS + 0x40034)
    #define SSPM_CFGREG_GPR5_GPR5                              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_DVFS_INFO                  (DDRPHY_MD32_BASE_ADDRESS + 0x40038)
    #define SSPM_CFGREG_DVFS_INFO_DVFS_INFO_0                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_TEMPERATURE                (DDRPHY_MD32_BASE_ADDRESS + 0x4003C)
    #define SSPM_CFGREG_TEMPERATURE_TEMPERATURE                Fld(15, 0) //[14:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_WDT_CFG                    (DDRPHY_MD32_BASE_ADDRESS + 0x40040)
    #define SSPM_CFGREG_WDT_CFG_WDT_VAL                        Fld(20, 0) //[19:0]
    #define SSPM_CFGREG_WDT_CFG_WDT_EN                         Fld(1, 31) //[31:31]

#define DDRPHY_MD32_REG_SSPM_CFGREG_WDT_KICK                   (DDRPHY_MD32_BASE_ADDRESS + 0x40044)
    #define SSPM_CFGREG_WDT_KICK_WDT_KICK                      Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_SEMAPHORE                  (DDRPHY_MD32_BASE_ADDRESS + 0x40048)
...
#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_TBUF_WPTR             (DDRPHY_MD32_BASE_ADDRESS + 0x4004C)
    #define SSPM_CFGREG_MD32_TBUF_WPTR_MON_TBUF_WPTR           Fld(4, 0) //[3:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_CCNT                  (DDRPHY_MD32_BASE_ADDRESS + 0x40050)
    #define SSPM_CFGREG_MD32_CCNT_MON_CCNT                     Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_PCNT0                 (DDRPHY_MD32_BASE_ADDRESS + 0x40054)
    #define SSPM_CFGREG_MD32_PCNT0_MON_PCNT0                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_PCNT1                 (DDRPHY_MD32_BASE_ADDRESS + 0x40058)
    #define SSPM_CFGREG_MD32_PCNT1_MON_PCNT1                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_PCNT2                 (DDRPHY_MD32_BASE_ADDRESS + 0x4005C)
    #define SSPM_CFGREG_MD32_PCNT2_MON_PCNT2                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_CONTID                (DDRPHY_MD32_BASE_ADDRESS + 0x40060)
    #define SSPM_CFGREG_MD32_CONTID_MON_CONTID                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_PC                    (DDRPHY_MD32_BASE_ADDRESS + 0x40064)
    #define SSPM_CFGREG_MD32_PC_MON_PC                         Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_PC_MON                (DDRPHY_MD32_BASE_ADDRESS + 0x40068)
    #define SSPM_CFGREG_MD32_PC_MON_MON_PC                     Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_BUS_STATUS            (DDRPHY_MD32_BASE_ADDRESS + 0x4006C)
    #define SSPM_CFGREG_MD32_BUS_STATUS_BUS_STATUS             Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_AHB_M0_ADDR           (DDRPHY_MD32_BASE_ADDRESS + 0x40070)
    #define SSPM_CFGREG_MD32_AHB_M0_ADDR_AHB_M0_ADDR           Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_AHB_M1_ADDR           (DDRPHY_MD32_BASE_ADDRESS + 0x40074)
    #define SSPM_CFGREG_MD32_AHB_M1_ADDR_AHB_M1_ADDR           Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_ONE_TIME_LOCK              (DDRPHY_MD32_BASE_ADDRESS + 0x40078)
    #define SSPM_CFGREG_ONE_TIME_LOCK_ONE_TIME_LOCK            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_SECURE_CTRL                (DDRPHY_MD32_BASE_ADDRESS + 0x4007C)
...
#define DDRPHY_MD32_REG_SSPM_CFGREG_TCM_LOCK_CNT               (DDRPHY_MD32_BASE_ADDRESS + 0x40080)
    #define SSPM_CFGREG_TCM_LOCK_CNT_TCM_LOCK_CNT              Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_SLPP_S_EN                  (DDRPHY_MD32_BASE_ADDRESS + 0x40088)
    #define SSPM_CFGREG_SLPP_S_EN_SLPP_EN                      Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_P2P_TOEN                   (DDRPHY_MD32_BASE_ADDRESS + 0x4008C)
...
#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX0_IN_IRQ               (DDRPHY_MD32_BASE_ADDRESS + 0x400A0)
    #define SSPM_CFGREG_MBOX0_IN_IRQ_MBOX0_IN_IRQ              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX1_IN_IRQ               (DDRPHY_MD32_BASE_ADDRESS + 0x400A4)
    #define SSPM_CFGREG_MBOX1_IN_IRQ_MBOX1_IN_IRQ              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX2_IN_IRQ               (DDRPHY_MD32_BASE_ADDRESS + 0x400A8)
    #define SSPM_CFGREG_MBOX2_IN_IRQ_MBOX2_IN_IRQ              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX3_IN_IRQ               (DDRPHY_MD32_BASE_ADDRESS + 0x400AC)
    #define SSPM_CFGREG_MBOX3_IN_IRQ_MBOX3_IN_IRQ              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX4_IN_IRQ               (DDRPHY_MD32_BASE_ADDRESS + 0x400B0)
    #define SSPM_CFGREG_MBOX4_IN_IRQ_MBOX4_IN_IRQ              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX0_OUT_IRQ              (DDRPHY_MD32_BASE_ADDRESS + 0x400C0)
    #define SSPM_CFGREG_MBOX0_OUT_IRQ_MBOX0_OUT_IRQ            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX1_OUT_IRQ              (DDRPHY_MD32_BASE_ADDRESS + 0x400C4)
    #define SSPM_CFGREG_MBOX1_OUT_IRQ_MBOX1_OUT_IRQ            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX2_OUT_IRQ              (DDRPHY_MD32_BASE_ADDRESS + 0x400C8)
    #define SSPM_CFGREG_MBOX2_OUT_IRQ_MBOX2_OUT_IRQ            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX3_OUT_IRQ              (DDRPHY_MD32_BASE_ADDRESS + 0x400CC)
    #define SSPM_CFGREG_MBOX3_OUT_IRQ_MBOX3_OUT_IRQ            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX4_OUT_IRQ              (DDRPHY_MD32_BASE_ADDRESS + 0x400D0)
    #define SSPM_CFGREG_MBOX4_OUT_IRQ_MBOX4_OUT_IRQ            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_ACAO_INT_SET               (DDRPHY_MD32_BASE_ADDRESS + 0x400D8)
    #define SSPM_CFGREG_ACAO_INT_SET_ACAO_INT_SET              Fld(17, 0) //[16:0]
    #define SSPM_CFGREG_ACAO_INT_SET_RSV0                      Fld(1, 17) //[17:17]

#define DDRPHY_MD32_REG_SSPM_CFGREG_ACAO_INT_CLR               (DDRPHY_MD32_BASE_ADDRESS + 0x400DC)
    #define SSPM_CFGREG_ACAO_INT_CLR_ACAO_INT_CLR              Fld(17, 0) //[16:0]
    #define SSPM_CFGREG_ACAO_INT_CLR_RSV0                      Fld(1, 17) //[17:17]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX0_BASE                 (DDRPHY_MD32_BASE_ADDRESS + 0x400E0)
    #define SSPM_CFGREG_MBOX0_BASE_MBOX0_BASE                  Fld(13, 0) //[12:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX1_BASE                 (DDRPHY_MD32_BASE_ADDRESS + 0x400E4)
    #define SSPM_CFGREG_MBOX1_BASE_MBOX1_BASE                  Fld(13, 0) //[12:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX2_BASE                 (DDRPHY_MD32_BASE_ADDRESS + 0x400E8)
    #define SSPM_CFGREG_MBOX2_BASE_MBOX2_BASE                  Fld(13, 0) //[12:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX3_BASE                 (DDRPHY_MD32_BASE_ADDRESS + 0x400EC)
    #define SSPM_CFGREG_MBOX3_BASE_MBOX3_BASE                  Fld(13, 0) //[12:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX4_BASE                 (DDRPHY_MD32_BASE_ADDRESS + 0x400F0)
    #define SSPM_CFGREG_MBOX4_BASE_MBOX4_BASE                  Fld(13, 0) //[12:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBOX8_7B_BASE              (DDRPHY_MD32_BASE_ADDRESS + 0x400F4)
    #define SSPM_CFGREG_MBOX8_7B_BASE_MBOX5_7B_4               Fld(5, 0) //[4:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_DVFS_INFO_1                (DDRPHY_MD32_BASE_ADDRESS + 0x400F8)
    #define SSPM_CFGREG_DVFS_INFO_1_DVFS_INFO_1                Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_DVFS_INFO_2                (DDRPHY_MD32_BASE_ADDRESS + 0x400FC)
    #define SSPM_CFGREG_DVFS_INFO_2_DVFS_INFO_2                Fld(5, 0) //[4:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_RSV_RW_REG0                (DDRPHY_MD32_BASE_ADDRESS + 0x40100)
...
#define DDRPHY_MD32_REG_SSPM_CFGREG_RSV_RW_REG1                (DDRPHY_MD32_BASE_ADDRESS + 0x40104)
    #define SSPM_CFGREG_RSV_RW_REG1_RSV_RW_REG1                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_RSV_RO_REG0                (DDRPHY_MD32_BASE_ADDRESS + 0x40108)
    #define SSPM_CFGREG_RSV_RO_REG0_RSV_RO_REG0                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_RSV_RO_REG1                (DDRPHY_MD32_BASE_ADDRESS + 0x4010C)
    #define SSPM_CFGREG_RSV_RO_REG1_RSV_RO_REG1                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR6                       (DDRPHY_MD32_BASE_ADDRESS + 0x40110)
    #define SSPM_CFGREG_GPR6_GPR6                              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR7                       (DDRPHY_MD32_BASE_ADDRESS + 0x40114)
    #define SSPM_CFGREG_GPR7_GPR7                              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR8                       (DDRPHY_MD32_BASE_ADDRESS + 0x40118)
    #define SSPM_CFGREG_GPR8_GPR8                              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR9                       (DDRPHY_MD32_BASE_ADDRESS + 0x4011C)
    #define SSPM_CFGREG_GPR9_GPR9                              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR10                      (DDRPHY_MD32_BASE_ADDRESS + 0x40120)
    #define SSPM_CFGREG_GPR10_GPR10                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR11                      (DDRPHY_MD32_BASE_ADDRESS + 0x40124)
    #define SSPM_CFGREG_GPR11_GPR11                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR12                      (DDRPHY_MD32_BASE_ADDRESS + 0x40128)
    #define SSPM_CFGREG_GPR12_GPR12                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR13                      (DDRPHY_MD32_BASE_ADDRESS + 0x4012C)
    #define SSPM_CFGREG_GPR13_GPR13                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR14                      (DDRPHY_MD32_BASE_ADDRESS + 0x40130)
    #define SSPM_CFGREG_GPR14_GPR14                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_GPR15                      (DDRPHY_MD32_BASE_ADDRESS + 0x40134)
    #define SSPM_CFGREG_GPR15_GPR15                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_PC_DRAM_CHA                (DDRPHY_MD32_BASE_ADDRESS + 0x4013C)
    #define SSPM_CFGREG_PC_DRAM_CHA_PC_DRAM_CHA                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_PC_DRAM_CHB                (DDRPHY_MD32_BASE_ADDRESS + 0x40140)
    #define SSPM_CFGREG_PC_DRAM_CHB_PC_DRAM_CHB                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_PC_DRAM_CHC                (DDRPHY_MD32_BASE_ADDRESS + 0x40144)
    #define SSPM_CFGREG_PC_DRAM_CHC_PC_DRAM_CHC                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_PC_DRAM_CHD                (DDRPHY_MD32_BASE_ADDRESS + 0x40148)
    #define SSPM_CFGREG_PC_DRAM_CHD_PC_DRAM_CHD                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_SP                    (DDRPHY_MD32_BASE_ADDRESS + 0x4014C)
    #define SSPM_CFGREG_MD32_SP_MON_SP                         Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MD32_LR                    (DDRPHY_MD32_BASE_ADDRESS + 0x40150)
    #define SSPM_CFGREG_MD32_LR_MON_LR                         Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_BUS_CTRL0                  (DDRPHY_MD32_BASE_ADDRESS + 0x40168)
    #define SSPM_CFGREG_BUS_CTRL0_BUS_CTRL0                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_BUS_CTRL1                  (DDRPHY_MD32_BASE_ADDRESS + 0x4016C)
    #define SSPM_CFGREG_BUS_CTRL1_BUS_CTRL1                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_BUS_CTRL2                  (DDRPHY_MD32_BASE_ADDRESS + 0x40170)
    #define SSPM_CFGREG_BUS_CTRL2_BUS_CTRL2                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_DR_APBP2P_CTRL             (DDRPHY_MD32_BASE_ADDRESS + 0x40174)
    #define SSPM_CFGREG_DR_APBP2P_CTRL_R_APB_BROADCAST_EN      Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_TBUF_MON_SEL               (DDRPHY_MD32_BASE_ADDRESS + 0x40178)
    #define SSPM_CFGREG_TBUF_MON_SEL_TBU_MON_SEL               Fld(4, 0) //[3:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_TBUFL                      (DDRPHY_MD32_BASE_ADDRESS + 0x4017C)
    #define SSPM_CFGREG_TBUFL_TBUFL                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_TBUFH                      (DDRPHY_MD32_BASE_ADDRESS + 0x40180)
    #define SSPM_CFGREG_TBUFH_TBUFH                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_MBIST_CFG                  (DDRPHY_MD32_BASE_ADDRESS + 0x40190)
    #define SSPM_CFGREG_MBIST_CFG_DM_MD32_MBIST_CFG            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_DPM_DBG_GPIO_DOUT          (DDRPHY_MD32_BASE_ADDRESS + 0x4019C)
    #define SSPM_CFGREG_DPM_DBG_GPIO_DOUT_R_DPM_GPIO_DOUT_0    Fld(1, 0) //[0:0]
    #define SSPM_CFGREG_DPM_DBG_GPIO_DOUT_R_DPM_GPIO_DOUT_1    Fld(1, 1) //[1:1]
    #define SSPM_CFGREG_DPM_DBG_GPIO_DOUT_R_DPM_GPIO_DOUT_2    Fld(1, 2) //[2:2]

#define DDRPHY_MD32_REG_SSPM_CFGREG_CBIP_TX_0_DBG_LATCH        (DDRPHY_MD32_BASE_ADDRESS + 0x401A0)
    #define SSPM_CFGREG_CBIP_TX_0_DBG_LATCH_R_CBIP_TX_0_VIO_ADDR Fld(12, 0) //[11:0]
    #define SSPM_CFGREG_CBIP_TX_0_DBG_LATCH_R_CBIP_TX_0_ERR_FLAG_EN Fld(1, 12) //[12:12]
    #define SSPM_CFGREG_CBIP_TX_0_DBG_LATCH_R_CBIP_TX_0_VIO_RD Fld(1, 29) //[29:29]
    #define SSPM_CFGREG_CBIP_TX_0_DBG_LATCH_R_CBIP_TX_0_VIO_WR Fld(1, 30) //[30:30]
    #define SSPM_CFGREG_CBIP_TX_0_DBG_LATCH_R_CBIP_TX_0_VIO_TIMEOUT Fld(1, 31) //[31:31]

#define DDRPHY_MD32_REG_SSPM_CFGREG_CBIP_TX_1_DBG_LATCH        (DDRPHY_MD32_BASE_ADDRESS + 0x401A4)
    #define SSPM_CFGREG_CBIP_TX_1_DBG_LATCH_R_CBIP_TX_1_VIO_ADDR Fld(12, 0) //[11:0]
    #define SSPM_CFGREG_CBIP_TX_1_DBG_LATCH_R_CBIP_TX_1_ERR_FLAG_EN Fld(1, 12) //[12:12]
    #define SSPM_CFGREG_CBIP_TX_1_DBG_LATCH_R_CBIP_TX_1_VIO_RD Fld(1, 29) //[29:29]
    #define SSPM_CFGREG_CBIP_TX_1_DBG_LATCH_R_CBIP_TX_1_VIO_WR Fld(1, 30) //[30:30]
    #define SSPM_CFGREG_CBIP_TX_1_DBG_LATCH_R_CBIP_TX_1_VIO_TIMEOUT Fld(1, 31) //[31:31]

#define DDRPHY_MD32_REG_SSPM_CFGREG_DBG_LATCH_SW               (DDRPHY_MD32_BASE_ADDRESS + 0x401A8)
    #define SSPM_CFGREG_DBG_LATCH_SW_R_DPY_LATCH_EN            Fld(1, 0) //[0:0]
    #define SSPM_CFGREG_DBG_LATCH_SW_R_DRM_LATCH_EN            Fld(1, 1) //[1:1]
    #define SSPM_CFGREG_DBG_LATCH_SW_R_SYS_WDT_EVENT_LATCH_EN  Fld(1, 2) //[2:2]

#define DDRPHY_MD32_REG_SSPM_CFGREG_IRQ_POR                    (DDRPHY_MD32_BASE_ADDRESS + 0x401AC)
    #define SSPM_CFGREG_IRQ_POR_R_IRQ_ACTIVE_XOR               Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_SPM_UNI_ARB                (DDRPHY_MD32_BASE_ADDRESS + 0x401B0)
    #define SSPM_CFGREG_SPM_UNI_ARB_RG_SLV_SEL                 Fld(1, 2) //[2:2]

#define DDRPHY_MD32_REG_SSPM_CFGREG_SRAM_DELSEL_0              (DDRPHY_MD32_BASE_ADDRESS + 0x401B8)
    #define SSPM_CFGREG_SRAM_DELSEL_0_DM_MD32_SRAM_DELSEL_0    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_SRAM_DELSEL_1              (DDRPHY_MD32_BASE_ADDRESS + 0x401BC)
    #define SSPM_CFGREG_SRAM_DELSEL_1_DM_MD32_SRAM_DELSEL_1    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_SRAM_DELSEL_2              (DDRPHY_MD32_BASE_ADDRESS + 0x401C0)
    #define SSPM_CFGREG_SRAM_DELSEL_2_DM_MD32_SRAM_DELSEL_2    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_SRAM_DELSEL_3              (DDRPHY_MD32_BASE_ADDRESS + 0x401C4)
    #define SSPM_CFGREG_SRAM_DELSEL_3_DM_MD32_SRAM_DELSEL_3    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_DBG_LATCH_DRM_MON_PC        (DDRPHY_MD32_BASE_ADDRESS + 0x401C8)
    #define SSPM_CFGREG_DBG_LATCH_DRM_MON_PC_DBG_LATCH_DRM_MON_PC Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_DBG_LATCH_STATUS           (DDRPHY_MD32_BASE_ADDRESS + 0x401CC)
    #define SSPM_CFGREG_DBG_LATCH_STATUS_DBG_LATCH_DRM_DRAMC_PWR_ACK Fld(1, 0) //[0:0]
    #define SSPM_CFGREG_DBG_LATCH_STATUS_DBG_LATCH_DRM_DPM_PWR_ACK Fld(1, 1) //[1:1]
    #define SSPM_CFGREG_DBG_LATCH_STATUS_DBG_LATCH_DRM_CH0_SREF_ACK Fld(1, 4) //[4:4]
    #define SSPM_CFGREG_DBG_LATCH_STATUS_DBG_LATCH_DRM_CH1_SREF_ACK Fld(1, 5) //[5:5]
    #define SSPM_CFGREG_DBG_LATCH_STATUS_DBG_LATCH_DRM_CH0_DSM Fld(1, 6) //[6:6]
    #define SSPM_CFGREG_DBG_LATCH_STATUS_DBG_LATCH_DRM_CH1_DSM Fld(1, 7) //[7:7]
    #define SSPM_CFGREG_DBG_LATCH_STATUS_DBG_LATCH_DRM_CH0_SHU Fld(2, 8) //[9:8]
    #define SSPM_CFGREG_DBG_LATCH_STATUS_DBG_LATCH_DRM_CH1_SHU Fld(2, 10) //[11:10]
    #define SSPM_CFGREG_DBG_LATCH_STATUS_DBG_LATCH_DRM_CH0_SHU_SRAM Fld(4, 12) //[15:12]
    #define SSPM_CFGREG_DBG_LATCH_STATUS_DBG_LATCH_DRM_CH1_SHU_SRAM Fld(4, 16) //[19:16]

#define DDRPHY_MD32_REG_SSPM_CFGREG_DRM_CTRL                   (DDRPHY_MD32_BASE_ADDRESS + 0x401D0)
    #define SSPM_CFGREG_DRM_CTRL_R_DPM_DRM_DONE_ACK            Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_CFGREG_SRAM_MASK                  (DDRPHY_MD32_BASE_ADDRESS + 0x401D4)
    #define SSPM_CFGREG_SRAM_MASK_R_DPM_SRAM_PD_MASK_SEL       Fld(1, 1) //[1:1]
    #define SSPM_CFGREG_SRAM_MASK_R_DPM_SRAM_PD_MASK           Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_TIMER0_CON                        (DDRPHY_MD32_BASE_ADDRESS + 0x41000)
    #define SSPM_TIMER0_CON_TIMER0_EN                          Fld(1, 0) //[0:0]
    #define SSPM_TIMER0_CON_TIMER0_RTC                         Fld(2, 4) //[5:4]

#define DDRPHY_MD32_REG_SSPM_TIMER0_RESET_VAL                  (DDRPHY_MD32_BASE_ADDRESS + 0x41004)
    #define SSPM_TIMER0_RESET_VAL_TIMER0_RST_VAL               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_TIMER0_CUR_VAL                    (DDRPHY_MD32_BASE_ADDRESS + 0x41008)
    #define SSPM_TIMER0_CUR_VAL_TIMER0_CUR_VAL                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_TIMER0_IRQ_ACK                    (DDRPHY_MD32_BASE_ADDRESS + 0x4100C)
...
#define DDRPHY_MD32_REG_SSPM_TIMER1_CON                        (DDRPHY_MD32_BASE_ADDRESS + 0x41010)
    #define SSPM_TIMER1_CON_TIMER1_EN                          Fld(1, 0) //[0:0]
    #define SSPM_TIMER1_CON_TIMER1_RTC                         Fld(2, 4) //[5:4]

#define DDRPHY_MD32_REG_SSPM_TIMER1_RESET_VAL                  (DDRPHY_MD32_BASE_ADDRESS + 0x41014)
    #define SSPM_TIMER1_RESET_VAL_TIMER1_RST_VAL               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_TIMER1_CUR_VAL                    (DDRPHY_MD32_BASE_ADDRESS + 0x41018)
    #define SSPM_TIMER1_CUR_VAL_TIMER1_CUR_VAL                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_TIMER1_IRQ_ACK                    (DDRPHY_MD32_BASE_ADDRESS + 0x4101C)
...
#define DDRPHY_MD32_REG_SSPM_TIMER2_CON                        (DDRPHY_MD32_BASE_ADDRESS + 0x41020)
    #define SSPM_TIMER2_CON_TIMER2_EN                          Fld(1, 0) //[0:0]
    #define SSPM_TIMER2_CON_TIMER2_RTC                         Fld(2, 4) //[5:4]

#define DDRPHY_MD32_REG_SSPM_TIMER2_RESET_VAL                  (DDRPHY_MD32_BASE_ADDRESS + 0x41024)
    #define SSPM_TIMER2_RESET_VAL_TIMER2_RST_VAL               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_TIMER2_CUR_VAL                    (DDRPHY_MD32_BASE_ADDRESS + 0x41028)
    #define SSPM_TIMER2_CUR_VAL_TIMER2_CUR_VAL                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_TIMER2_IRQ_ACK                    (DDRPHY_MD32_BASE_ADDRESS + 0x4102C)
...
#define DDRPHY_MD32_REG_SSPM_TIMER3_CON                        (DDRPHY_MD32_BASE_ADDRESS + 0x41030)
    #define SSPM_TIMER3_CON_TIMER3_EN                          Fld(1, 0) //[0:0]
    #define SSPM_TIMER3_CON_TIMER3_RTC                         Fld(2, 4) //[5:4]

#define DDRPHY_MD32_REG_SSPM_TIMER3_RESET_VAL                  (DDRPHY_MD32_BASE_ADDRESS + 0x41034)
    #define SSPM_TIMER3_RESET_VAL_TIMER3_RST_VAL               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_TIMER3_CUR_VAL                    (DDRPHY_MD32_BASE_ADDRESS + 0x41038)
    #define SSPM_TIMER3_CUR_VAL_TIMER3_CUR_VAL                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_TIMER3_IRQ_ACK                    (DDRPHY_MD32_BASE_ADDRESS + 0x4103C)
...
#define DDRPHY_MD32_REG_SSPM_OS_TIMER_CON                      (DDRPHY_MD32_BASE_ADDRESS + 0x41080)
    #define SSPM_OS_TIMER_CON_OS_TIMER_EN                      Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_OS_TIMER_CNT_L                    (DDRPHY_MD32_BASE_ADDRESS + 0x4108C)
    #define SSPM_OS_TIMER_CNT_L_OS_TIMER_CNT_L                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_OS_TIMER_CNT_H                    (DDRPHY_MD32_BASE_ADDRESS + 0x41090)
    #define SSPM_OS_TIMER_CNT_H_OS_TIMER_CNT_H                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_OS_TIMER_TVAL                     (DDRPHY_MD32_BASE_ADDRESS + 0x41094)
    #define SSPM_OS_TIMER_TVAL_OS_TIMER_TVAL                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_OS_TIMER_IRQ_ACK                  (DDRPHY_MD32_BASE_ADDRESS + 0x41098)
...
#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_RAW_STA0                 (DDRPHY_MD32_BASE_ADDRESS + 0x42000)
    #define SSPM_INTC_IRQ_RAW_STA0_IRQ_RAW_STA0                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_RAW_STA1                 (DDRPHY_MD32_BASE_ADDRESS + 0x42004)
    #define SSPM_INTC_IRQ_RAW_STA1_IRQ_RAW_STA1                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_STA0                     (DDRPHY_MD32_BASE_ADDRESS + 0x42010)
    #define SSPM_INTC_IRQ_STA0_IRQ_STA0                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_STA1                     (DDRPHY_MD32_BASE_ADDRESS + 0x42014)
    #define SSPM_INTC_IRQ_STA1_IRQ_STA1                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_EN0                      (DDRPHY_MD32_BASE_ADDRESS + 0x42020)
    #define SSPM_INTC_IRQ_EN0_IRQ_EN0                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_EN1                      (DDRPHY_MD32_BASE_ADDRESS + 0x42024)
    #define SSPM_INTC_IRQ_EN1_IRQ_EN1                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_WAKE_TO_DCM_EN0          (DDRPHY_MD32_BASE_ADDRESS + 0x42030)
    #define SSPM_INTC_IRQ_WAKE_TO_DCM_EN0_IRQ_WAKE_TO_DCM_EN0  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_WAKE_TO_DCM_EN1          (DDRPHY_MD32_BASE_ADDRESS + 0x42034)
    #define SSPM_INTC_IRQ_WAKE_TO_DCM_EN1_IRQ_WAKE_TO_DCM_EN1  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_POL0                     (DDRPHY_MD32_BASE_ADDRESS + 0x42040)
    #define SSPM_INTC_IRQ_POL0_IRQ_POL0                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_POL1                     (DDRPHY_MD32_BASE_ADDRESS + 0x42044)
    #define SSPM_INTC_IRQ_POL1_IRQ_POL1                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP0_0                   (DDRPHY_MD32_BASE_ADDRESS + 0x42050)
    #define SSPM_INTC_IRQ_GRP0_0_IRQ_GRP0_0                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP0_1                   (DDRPHY_MD32_BASE_ADDRESS + 0x42054)
    #define SSPM_INTC_IRQ_GRP0_1_IRQ_GRP0_1                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP1_0                   (DDRPHY_MD32_BASE_ADDRESS + 0x42060)
    #define SSPM_INTC_IRQ_GRP1_0_IRQ_GRP1_0                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP1_1                   (DDRPHY_MD32_BASE_ADDRESS + 0x42064)
    #define SSPM_INTC_IRQ_GRP1_1_IRQ_GRP1_1                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP2_0                   (DDRPHY_MD32_BASE_ADDRESS + 0x42070)
    #define SSPM_INTC_IRQ_GRP2_0_IRQ_GRP2_0                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP2_1                   (DDRPHY_MD32_BASE_ADDRESS + 0x42074)
    #define SSPM_INTC_IRQ_GRP2_1_IRQ_GRP2_1                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP3_0                   (DDRPHY_MD32_BASE_ADDRESS + 0x42080)
    #define SSPM_INTC_IRQ_GRP3_0_IRQ_GRP3_0                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP3_1                   (DDRPHY_MD32_BASE_ADDRESS + 0x42084)
    #define SSPM_INTC_IRQ_GRP3_1_IRQ_GRP3_1                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP4_0                   (DDRPHY_MD32_BASE_ADDRESS + 0x42090)
    #define SSPM_INTC_IRQ_GRP4_0_IRQ_GRP4_0                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP4_1                   (DDRPHY_MD32_BASE_ADDRESS + 0x42094)
    #define SSPM_INTC_IRQ_GRP4_1_IRQ_GRP4_1                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP5_0                   (DDRPHY_MD32_BASE_ADDRESS + 0x420A0)
    #define SSPM_INTC_IRQ_GRP5_0_IRQ_GRP5_0                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP5_1                   (DDRPHY_MD32_BASE_ADDRESS + 0x420A4)
    #define SSPM_INTC_IRQ_GRP5_1_IRQ_GRP5_1                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP6_0                   (DDRPHY_MD32_BASE_ADDRESS + 0x420B0)
    #define SSPM_INTC_IRQ_GRP6_0_IRQ_GRP6_0                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP6_1                   (DDRPHY_MD32_BASE_ADDRESS + 0x420B4)
    #define SSPM_INTC_IRQ_GRP6_1_IRQ_GRP6_1                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP7_0                   (DDRPHY_MD32_BASE_ADDRESS + 0x420C0)
    #define SSPM_INTC_IRQ_GRP7_0_IRQ_GRP7_0                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP7_1                   (DDRPHY_MD32_BASE_ADDRESS + 0x420C4)
    #define SSPM_INTC_IRQ_GRP7_1_IRQ_GRP7_1                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP8_0                   (DDRPHY_MD32_BASE_ADDRESS + 0x420D0)
    #define SSPM_INTC_IRQ_GRP8_0_IRQ_GRP8_0                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP8_1                   (DDRPHY_MD32_BASE_ADDRESS + 0x420D4)
    #define SSPM_INTC_IRQ_GRP8_1_IRQ_GRP8_1                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP9_0                   (DDRPHY_MD32_BASE_ADDRESS + 0x420E0)
    #define SSPM_INTC_IRQ_GRP9_0_IRQ_GRP9_0                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP9_1                   (DDRPHY_MD32_BASE_ADDRESS + 0x420E4)
    #define SSPM_INTC_IRQ_GRP9_1_IRQ_GRP9_1                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP10_0                  (DDRPHY_MD32_BASE_ADDRESS + 0x420F0)
    #define SSPM_INTC_IRQ_GRP10_0_IRQ_GRP10_0                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP10_1                  (DDRPHY_MD32_BASE_ADDRESS + 0x420F4)
    #define SSPM_INTC_IRQ_GRP10_1_IRQ_GRP10_1                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP11_0                  (DDRPHY_MD32_BASE_ADDRESS + 0x42100)
    #define SSPM_INTC_IRQ_GRP11_0_IRQ_GRP11_0                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP11_1                  (DDRPHY_MD32_BASE_ADDRESS + 0x42104)
    #define SSPM_INTC_IRQ_GRP11_1_IRQ_GRP11_1                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP12_0                  (DDRPHY_MD32_BASE_ADDRESS + 0x42110)
    #define SSPM_INTC_IRQ_GRP12_0_IRQ_GRP12_0                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP12_1                  (DDRPHY_MD32_BASE_ADDRESS + 0x42114)
    #define SSPM_INTC_IRQ_GRP12_1_IRQ_GRP12_1                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP13_0                  (DDRPHY_MD32_BASE_ADDRESS + 0x42120)
    #define SSPM_INTC_IRQ_GRP13_0_IRQ_GRP13_0                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP13_1                  (DDRPHY_MD32_BASE_ADDRESS + 0x42124)
    #define SSPM_INTC_IRQ_GRP13_1_IRQ_GRP13_1                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP14_0                  (DDRPHY_MD32_BASE_ADDRESS + 0x42130)
    #define SSPM_INTC_IRQ_GRP14_0_IRQ_GRP14_0                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP14_1                  (DDRPHY_MD32_BASE_ADDRESS + 0x42134)
    #define SSPM_INTC_IRQ_GRP14_1_IRQ_GRP14_1                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_WAKE_TO_AP_EN0           (DDRPHY_MD32_BASE_ADDRESS + 0x42140)
    #define SSPM_INTC_IRQ_WAKE_TO_AP_EN0_IRQ_WAKE_TO_AP_EN0    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_WAKE_TO_AP_EN1           (DDRPHY_MD32_BASE_ADDRESS + 0x42144)
    #define SSPM_INTC_IRQ_WAKE_TO_AP_EN1_IRQ_WAKE_TO_AP_EN1    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP0_STA0                (DDRPHY_MD32_BASE_ADDRESS + 0x42150)
    #define SSPM_INTC_IRQ_GRP0_STA0_IRQ_GRP0_STA0              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP0_STA1                (DDRPHY_MD32_BASE_ADDRESS + 0x42154)
    #define SSPM_INTC_IRQ_GRP0_STA1_IRQ_GRP0_STA1              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP1_STA0                (DDRPHY_MD32_BASE_ADDRESS + 0x42160)
    #define SSPM_INTC_IRQ_GRP1_STA0_IRQ_GRP1_STA0              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP1_STA1                (DDRPHY_MD32_BASE_ADDRESS + 0x42164)
    #define SSPM_INTC_IRQ_GRP1_STA1_IRQ_GRP1_STA1              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP2_STA0                (DDRPHY_MD32_BASE_ADDRESS + 0x42170)
    #define SSPM_INTC_IRQ_GRP2_STA0_IRQ_GRP2_STA0              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP2_STA1                (DDRPHY_MD32_BASE_ADDRESS + 0x42174)
    #define SSPM_INTC_IRQ_GRP2_STA1_IRQ_GRP2_STA1              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP3_STA0                (DDRPHY_MD32_BASE_ADDRESS + 0x42180)
    #define SSPM_INTC_IRQ_GRP3_STA0_IRQ_GRP3_STA0              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP3_STA1                (DDRPHY_MD32_BASE_ADDRESS + 0x42184)
    #define SSPM_INTC_IRQ_GRP3_STA1_IRQ_GRP3_STA1              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP4_STA0                (DDRPHY_MD32_BASE_ADDRESS + 0x42190)
    #define SSPM_INTC_IRQ_GRP4_STA0_IRQ_GRP4_STA0              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP4_STA1                (DDRPHY_MD32_BASE_ADDRESS + 0x42194)
    #define SSPM_INTC_IRQ_GRP4_STA1_IRQ_GRP4_STA1              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP5_STA0                (DDRPHY_MD32_BASE_ADDRESS + 0x421A0)
    #define SSPM_INTC_IRQ_GRP5_STA0_IRQ_GRP5_STA0              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP5_STA1                (DDRPHY_MD32_BASE_ADDRESS + 0x421A4)
    #define SSPM_INTC_IRQ_GRP5_STA1_IRQ_GRP5_STA1              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP6_STA0                (DDRPHY_MD32_BASE_ADDRESS + 0x421B0)
    #define SSPM_INTC_IRQ_GRP6_STA0_IRQ_GRP6_STA0              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP6_STA1                (DDRPHY_MD32_BASE_ADDRESS + 0x421B4)
    #define SSPM_INTC_IRQ_GRP6_STA1_IRQ_GRP6_STA1              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP7_STA0                (DDRPHY_MD32_BASE_ADDRESS + 0x421C0)
    #define SSPM_INTC_IRQ_GRP7_STA0_IRQ_GRP7_STA0              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP7_STA1                (DDRPHY_MD32_BASE_ADDRESS + 0x421C4)
    #define SSPM_INTC_IRQ_GRP7_STA1_IRQ_GRP7_STA1              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP8_STA0                (DDRPHY_MD32_BASE_ADDRESS + 0x421D0)
    #define SSPM_INTC_IRQ_GRP8_STA0_IRQ_GRP8_STA0              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP8_STA1                (DDRPHY_MD32_BASE_ADDRESS + 0x421D4)
    #define SSPM_INTC_IRQ_GRP8_STA1_IRQ_GRP8_STA1              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP9_STA0                (DDRPHY_MD32_BASE_ADDRESS + 0x421E0)
    #define SSPM_INTC_IRQ_GRP9_STA0_IRQ_GRP9_STA0              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP9_STA1                (DDRPHY_MD32_BASE_ADDRESS + 0x421E4)
    #define SSPM_INTC_IRQ_GRP9_STA1_IRQ_GRP9_STA1              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP10_STA0               (DDRPHY_MD32_BASE_ADDRESS + 0x421F0)
    #define SSPM_INTC_IRQ_GRP10_STA0_IRQ_GRP10_STA0            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP10_STA1               (DDRPHY_MD32_BASE_ADDRESS + 0x421F4)
    #define SSPM_INTC_IRQ_GRP10_STA1_IRQ_GRP10_STA1            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP11_STA0               (DDRPHY_MD32_BASE_ADDRESS + 0x42200)
    #define SSPM_INTC_IRQ_GRP11_STA0_IRQ_GRP11_STA0            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP11_STA1               (DDRPHY_MD32_BASE_ADDRESS + 0x42204)
    #define SSPM_INTC_IRQ_GRP11_STA1_IRQ_GRP11_STA1            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP12_STA0               (DDRPHY_MD32_BASE_ADDRESS + 0x42210)
    #define SSPM_INTC_IRQ_GRP12_STA0_IRQ_GRP12_STA0            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP12_STA1               (DDRPHY_MD32_BASE_ADDRESS + 0x42214)
    #define SSPM_INTC_IRQ_GRP12_STA1_IRQ_GRP12_STA1            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP13_STA0               (DDRPHY_MD32_BASE_ADDRESS + 0x42220)
    #define SSPM_INTC_IRQ_GRP13_STA0_IRQ_GRP13_STA0            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP13_STA1               (DDRPHY_MD32_BASE_ADDRESS + 0x42224)
    #define SSPM_INTC_IRQ_GRP13_STA1_IRQ_GRP13_STA1            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP14_STA0               (DDRPHY_MD32_BASE_ADDRESS + 0x42230)
    #define SSPM_INTC_IRQ_GRP14_STA0_IRQ_GRP14_STA0            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP14_STA1               (DDRPHY_MD32_BASE_ADDRESS + 0x42234)
    #define SSPM_INTC_IRQ_GRP14_STA1_IRQ_GRP14_STA1            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP15_STA0               (DDRPHY_MD32_BASE_ADDRESS + 0x42240)
    #define SSPM_INTC_IRQ_GRP15_STA0_IRQ_GRP15_STA0            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_GRP15_STA1               (DDRPHY_MD32_BASE_ADDRESS + 0x42244)
    #define SSPM_INTC_IRQ_GRP15_STA1_IRQ_GRP15_STA1            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_OUT                      (DDRPHY_MD32_BASE_ADDRESS + 0x42250)
    #define SSPM_INTC_IRQ_OUT_IRQ_OUT                          Fld(15, 0) //[14:0]

#define DDRPHY_MD32_REG_SSPM_INTC_IRQ_CLR_TRG                  (DDRPHY_MD32_BASE_ADDRESS + 0x42254)
    #define SSPM_INTC_IRQ_CLR_TRG_IRQ_CLR_TRG                  Fld(15, 0) //[14:0]

#define DDRPHY_MD32_REG_SSPM_INTC_UART_RX_IRQ                  (DDRPHY_MD32_BASE_ADDRESS + 0x42258)
    #define SSPM_INTC_UART_RX_IRQ_UART_RX_IRQ                  Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_CK_EN                             (DDRPHY_MD32_BASE_ADDRESS + 0x43000)
...
#define DDRPHY_MD32_REG_SSPM_MCLK_DIV                          (DDRPHY_MD32_BASE_ADDRESS + 0x43004)
...
#define DDRPHY_MD32_REG_SSPM_DCM_CTRL                          (DDRPHY_MD32_BASE_ADDRESS + 0x43008)
...
#define DDRPHY_MD32_REG_SSPM_WAKE_INT                          (DDRPHY_MD32_BASE_ADDRESS + 0x4300C)
    #define SSPM_WAKE_INT_WAKEUP_INT                           Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_UART_CTRL                         (DDRPHY_MD32_BASE_ADDRESS + 0x43010)
...
#define DDRPHY_MD32_REG_SSPM_DMA_GLBSTA                        (DDRPHY_MD32_BASE_ADDRESS + 0x44000)
...
#define DDRPHY_MD32_REG_SSPM_DMA_GLBSTA2                       (DDRPHY_MD32_BASE_ADDRESS + 0x44004)
...
#define DDRPHY_MD32_REG_SSPM_DMA_GLBLIMITER                    (DDRPHY_MD32_BASE_ADDRESS + 0x44028)
    #define SSPM_DMA_GLBLIMITER_GLBLIMITER                     Fld(4, 0) //[3:0]

#define DDRPHY_MD32_REG_SSPM_DMA1_SRC                          (DDRPHY_MD32_BASE_ADDRESS + 0x44100)
    #define SSPM_DMA1_SRC_SRC                                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_DMA1_DST                          (DDRPHY_MD32_BASE_ADDRESS + 0x44104)
    #define SSPM_DMA1_DST_DST                                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_DMA1_WPPT                         (DDRPHY_MD32_BASE_ADDRESS + 0x44108)
    #define SSPM_DMA1_WPPT_WPPT                                Fld(16, 0) //[15:0]

#define DDRPHY_MD32_REG_SSPM_DMA1_WPTO                         (DDRPHY_MD32_BASE_ADDRESS + 0x4410C)
    #define SSPM_DMA1_WPTO_WPTO                                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_DMA1_COUNT                        (DDRPHY_MD32_BASE_ADDRESS + 0x44110)
    #define SSPM_DMA1_COUNT_COUNT                              Fld(16, 0) //[15:0]

#define DDRPHY_MD32_REG_SSPM_DMA1_CON                          (DDRPHY_MD32_BASE_ADDRESS + 0x44114)
...
#define DDRPHY_MD32_REG_SSPM_DMA1_START                        (DDRPHY_MD32_BASE_ADDRESS + 0x44118)
    #define SSPM_DMA1_START_START                              Fld(1, 15) //[15:15]

#define DDRPHY_MD32_REG_SSPM_DMA1_INTSTA                       (DDRPHY_MD32_BASE_ADDRESS + 0x4411C)
    #define SSPM_DMA1_INTSTA_INTSTA                            Fld(1, 15) //[15:15]

#define DDRPHY_MD32_REG_SSPM_DMA1_ACKINT                       (DDRPHY_MD32_BASE_ADDRESS + 0x44120)
    #define SSPM_DMA1_ACKINT_ACKINT                            Fld(1, 15) //[15:15]

#define DDRPHY_MD32_REG_SSPM_DMA1_RLCT                         (DDRPHY_MD32_BASE_ADDRESS + 0x44124)
    #define SSPM_DMA1_RLCT_RLCT                                Fld(16, 0) //[15:0]

#define DDRPHY_MD32_REG_SSPM_DMA1_LIMITER                      (DDRPHY_MD32_BASE_ADDRESS + 0x44128)
    #define SSPM_DMA1_LIMITER_LIMITER                          Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_DMA2_SRC                          (DDRPHY_MD32_BASE_ADDRESS + 0x44200)
    #define SSPM_DMA2_SRC_SRC                                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_DMA2_DST                          (DDRPHY_MD32_BASE_ADDRESS + 0x44204)
    #define SSPM_DMA2_DST_DST                                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_DMA2_WPPT                         (DDRPHY_MD32_BASE_ADDRESS + 0x44208)
    #define SSPM_DMA2_WPPT_WPPT                                Fld(16, 0) //[15:0]

#define DDRPHY_MD32_REG_SSPM_DMA2_WPTO                         (DDRPHY_MD32_BASE_ADDRESS + 0x4420C)
    #define SSPM_DMA2_WPTO_WPTO                                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_DMA2_COUNT                        (DDRPHY_MD32_BASE_ADDRESS + 0x44210)
    #define SSPM_DMA2_COUNT_COUNT                              Fld(16, 0) //[15:0]

#define DDRPHY_MD32_REG_SSPM_DMA2_CON                          (DDRPHY_MD32_BASE_ADDRESS + 0x44214)
...
#define DDRPHY_MD32_REG_SSPM_DMA2_START                        (DDRPHY_MD32_BASE_ADDRESS + 0x44218)
    #define SSPM_DMA2_START_START                              Fld(1, 15) //[15:15]

#define DDRPHY_MD32_REG_SSPM_DMA2_INTSTA                       (DDRPHY_MD32_BASE_ADDRESS + 0x4421C)
    #define SSPM_DMA2_INTSTA_INTSTA                            Fld(1, 15) //[15:15]

#define DDRPHY_MD32_REG_SSPM_DMA2_ACKINT                       (DDRPHY_MD32_BASE_ADDRESS + 0x44220)
    #define SSPM_DMA2_ACKINT_ACKINT                            Fld(1, 15) //[15:15]

#define DDRPHY_MD32_REG_SSPM_DMA2_RLCT                         (DDRPHY_MD32_BASE_ADDRESS + 0x44224)
    #define SSPM_DMA2_RLCT_RLCT                                Fld(16, 0) //[15:0]

#define DDRPHY_MD32_REG_SSPM_DMA2_LIMITER                      (DDRPHY_MD32_BASE_ADDRESS + 0x44228)
    #define SSPM_DMA2_LIMITER_LIMITER                          Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_DMA3_SRC                          (DDRPHY_MD32_BASE_ADDRESS + 0x44300)
    #define SSPM_DMA3_SRC_SRC                                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_DMA3_DST                          (DDRPHY_MD32_BASE_ADDRESS + 0x44304)
    #define SSPM_DMA3_DST_DST                                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_DMA3_WPPT                         (DDRPHY_MD32_BASE_ADDRESS + 0x44308)
    #define SSPM_DMA3_WPPT_WPPT                                Fld(16, 0) //[15:0]

#define DDRPHY_MD32_REG_SSPM_DMA3_WPTO                         (DDRPHY_MD32_BASE_ADDRESS + 0x4430C)
    #define SSPM_DMA3_WPTO_WPTO                                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_DMA3_COUNT                        (DDRPHY_MD32_BASE_ADDRESS + 0x44310)
    #define SSPM_DMA3_COUNT_COUNT                              Fld(16, 0) //[15:0]

#define DDRPHY_MD32_REG_SSPM_DMA3_CON                          (DDRPHY_MD32_BASE_ADDRESS + 0x44314)
...
#define DDRPHY_MD32_REG_SSPM_DMA3_START                        (DDRPHY_MD32_BASE_ADDRESS + 0x44318)
    #define SSPM_DMA3_START_START                              Fld(1, 15) //[15:15]

#define DDRPHY_MD32_REG_SSPM_DMA3_INTSTA                       (DDRPHY_MD32_BASE_ADDRESS + 0x4431C)
    #define SSPM_DMA3_INTSTA_INTSTA                            Fld(1, 15) //[15:15]

#define DDRPHY_MD32_REG_SSPM_DMA3_ACKINT                       (DDRPHY_MD32_BASE_ADDRESS + 0x44320)
    #define SSPM_DMA3_ACKINT_ACKINT                            Fld(1, 15) //[15:15]

#define DDRPHY_MD32_REG_SSPM_DMA3_RLCT                         (DDRPHY_MD32_BASE_ADDRESS + 0x44324)
    #define SSPM_DMA3_RLCT_RLCT                                Fld(16, 0) //[15:0]

#define DDRPHY_MD32_REG_SSPM_DMA3_LIMITER                      (DDRPHY_MD32_BASE_ADDRESS + 0x44328)
    #define SSPM_DMA3_LIMITER_LIMITER                          Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_DMA4_SRC                          (DDRPHY_MD32_BASE_ADDRESS + 0x44400)
    #define SSPM_DMA4_SRC_SRC                                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_DMA4_DST                          (DDRPHY_MD32_BASE_ADDRESS + 0x44404)
    #define SSPM_DMA4_DST_DST                                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_DMA4_WPPT                         (DDRPHY_MD32_BASE_ADDRESS + 0x44408)
    #define SSPM_DMA4_WPPT_WPPT                                Fld(16, 0) //[15:0]

#define DDRPHY_MD32_REG_SSPM_DMA4_WPTO                         (DDRPHY_MD32_BASE_ADDRESS + 0x4440C)
    #define SSPM_DMA4_WPTO_WPTO                                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_DMA4_COUNT                        (DDRPHY_MD32_BASE_ADDRESS + 0x44410)
    #define SSPM_DMA4_COUNT_COUNT                              Fld(16, 0) //[15:0]

#define DDRPHY_MD32_REG_SSPM_DMA4_CON                          (DDRPHY_MD32_BASE_ADDRESS + 0x44414)
...
#define DDRPHY_MD32_REG_SSPM_DMA4_START                        (DDRPHY_MD32_BASE_ADDRESS + 0x44418)
    #define SSPM_DMA4_START_START                              Fld(1, 15) //[15:15]

#define DDRPHY_MD32_REG_SSPM_DMA4_INTSTA                       (DDRPHY_MD32_BASE_ADDRESS + 0x4441C)
    #define SSPM_DMA4_INTSTA_INTSTA                            Fld(1, 15) //[15:15]

#define DDRPHY_MD32_REG_SSPM_DMA4_ACKINT                       (DDRPHY_MD32_BASE_ADDRESS + 0x44420)
    #define SSPM_DMA4_ACKINT_ACKINT                            Fld(1, 15) //[15:15]

#define DDRPHY_MD32_REG_SSPM_DMA4_RLCT                         (DDRPHY_MD32_BASE_ADDRESS + 0x44424)
    #define SSPM_DMA4_RLCT_RLCT                                Fld(16, 0) //[15:0]

#define DDRPHY_MD32_REG_SSPM_DMA4_LIMITER                      (DDRPHY_MD32_BASE_ADDRESS + 0x44428)
    #define SSPM_DMA4_LIMITER_LIMITER                          Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_RBR_THR_DLL_ADDR             (DDRPHY_MD32_BASE_ADDRESS + 0x45000)
    #define SSPM_UART_RBR_THR_DLL_ADDR_RBR                     Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_IER_DLM_ADDR                 (DDRPHY_MD32_BASE_ADDRESS + 0x45004)
...
#define DDRPHY_MD32_REG_SSPM_UART_IIR_FCR_EFR_ADDR             (DDRPHY_MD32_BASE_ADDRESS + 0x45008)
    #define SSPM_UART_IIR_FCR_EFR_ADDR_ID                      Fld(6, 0) //[5:0]
    #define SSPM_UART_IIR_FCR_EFR_ADDR_FIFOE                   Fld(2, 6) //[7:6]

#define DDRPHY_MD32_REG_SSPM_UART_LCR_ADDR                     (DDRPHY_MD32_BASE_ADDRESS + 0x4500C)
...
#define DDRPHY_MD32_REG_SSPM_UART_MCR_XON1_ADDR                (DDRPHY_MD32_BASE_ADDRESS + 0x45010)
...
#define DDRPHY_MD32_REG_SSPM_UART_LSR_XON2_ADDR                (DDRPHY_MD32_BASE_ADDRESS + 0x45014)
...
#define DDRPHY_MD32_REG_SSPM_UART_MSR_XOFF1_ADDR               (DDRPHY_MD32_BASE_ADDRESS + 0x45018)
    #define SSPM_UART_MSR_XOFF1_ADDR_DCTS                      Fld(1, 0) //[0:0]
    #define SSPM_UART_MSR_XOFF1_ADDR_CTS                       Fld(1, 4) //[4:4]

#define DDRPHY_MD32_REG_SSPM_UART_SCR_XOFF2_ADDR               (DDRPHY_MD32_BASE_ADDRESS + 0x4501C)
    #define SSPM_UART_SCR_XOFF2_ADDR_SCR                       Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_AUTOBAUD_EN_ADDR             (DDRPHY_MD32_BASE_ADDRESS + 0x45020)
...
#define DDRPHY_MD32_REG_SSPM_UART_RATE_STEP_ADDR               (DDRPHY_MD32_BASE_ADDRESS + 0x45024)
    #define SSPM_UART_RATE_STEP_ADDR_SPEED                     Fld(2, 0) //[1:0]

#define DDRPHY_MD32_REG_SSPM_UART_STEP_COUNT_ADDR              (DDRPHY_MD32_BASE_ADDRESS + 0x45028)
    #define SSPM_UART_STEP_COUNT_ADDR_SAMPLECOUNT              Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_SAMPLE_COUNT_ADDR            (DDRPHY_MD32_BASE_ADDRESS + 0x4502C)
    #define SSPM_UART_SAMPLE_COUNT_ADDR_SAMPLEPOINT            Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_AUTOBAUD_DATA_ADDR           (DDRPHY_MD32_BASE_ADDRESS + 0x45030)
    #define SSPM_UART_AUTOBAUD_DATA_ADDR_BAUD_RATE             Fld(4, 0) //[3:0]
    #define SSPM_UART_AUTOBAUD_DATA_ADDR_BAUD_STAT             Fld(4, 4) //[7:4]

#define DDRPHY_MD32_REG_SSPM_UART_RATE_FIX_ADDR                (DDRPHY_MD32_BASE_ADDRESS + 0x45034)
...
#define DDRPHY_MD32_REG_SSPM_UART_AUTOBAUD_RATE_ADDR           (DDRPHY_MD32_BASE_ADDRESS + 0x45038)
    #define SSPM_UART_AUTOBAUD_RATE_ADDR_AUTOBAUDSAMPLE        Fld(6, 0) //[5:0]

#define DDRPHY_MD32_REG_SSPM_UART_GUARD_ADDR                   (DDRPHY_MD32_BASE_ADDRESS + 0x4503C)
    #define SSPM_UART_GUARD_ADDR_GUARD_CNT                     Fld(4, 0) //[3:0]
    #define SSPM_UART_GUARD_ADDR_GUARD_EN                      Fld(1, 4) //[4:4]

#define DDRPHY_MD32_REG_SSPM_UART_ESC_CHAR_ADDR                (DDRPHY_MD32_BASE_ADDRESS + 0x45040)
    #define SSPM_UART_ESC_CHAR_ADDR_ESC_CHAR                   Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_ESC_EN_ADDR                  (DDRPHY_MD32_BASE_ADDRESS + 0x45044)
    #define SSPM_UART_ESC_EN_ADDR_ESC_EN                       Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_UART_SLEEP_EN_ADDR                (DDRPHY_MD32_BASE_ADDRESS + 0x45048)
    #define SSPM_UART_SLEEP_EN_ADDR_SLEEP_EN                   Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_UART_RXDMA_EN_ADDR                (DDRPHY_MD32_BASE_ADDRESS + 0x4504C)
...
#define DDRPHY_MD32_REG_SSPM_UART_RXTRIG_ADDR                  (DDRPHY_MD32_BASE_ADDRESS + 0x45050)
    #define SSPM_UART_RXTRIG_ADDR_RXTRIG                       Fld(4, 0) //[3:0]

#define DDRPHY_MD32_REG_SSPM_UART_FRACDIV_L_ADDR               (DDRPHY_MD32_BASE_ADDRESS + 0x45054)
    #define SSPM_UART_FRACDIV_L_ADDR_FRACDIV_L                 Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_FRACDIV_M_ADDR               (DDRPHY_MD32_BASE_ADDRESS + 0x45058)
    #define SSPM_UART_FRACDIV_M_ADDR_FRACDIV_M                 Fld(2, 0) //[1:0]

#define DDRPHY_MD32_REG_SSPM_UART_FCR_ADDR                     (DDRPHY_MD32_BASE_ADDRESS + 0x4505C)
...
#define DDRPHY_MD32_REG_SSPM_UART_DEBUG_SEL                    (DDRPHY_MD32_BASE_ADDRESS + 0x45084)
    #define SSPM_UART_DEBUG_SEL_UART_DBG_SEL                   Fld(3, 0) //[2:0]

#define DDRPHY_MD32_REG_SSPM_UART_DLL_ADDR                     (DDRPHY_MD32_BASE_ADDRESS + 0x45090)
    #define SSPM_UART_DLL_ADDR_DLL                             Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_DLM_ADDR                     (DDRPHY_MD32_BASE_ADDRESS + 0x45094)
    #define SSPM_UART_DLM_ADDR_DLM                             Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_EFR_ADDR                     (DDRPHY_MD32_BASE_ADDRESS + 0x45098)
...
#define DDRPHY_MD32_REG_SSPM_UART_FEATURE_SEL                  (DDRPHY_MD32_BASE_ADDRESS + 0x4509C)
    #define SSPM_UART_FEATURE_SEL_FEATURE_SEL                  Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_UART_XON1_ADDR                    (DDRPHY_MD32_BASE_ADDRESS + 0x450A0)
    #define SSPM_UART_XON1_ADDR_XON1                           Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_XON2_ADDR                    (DDRPHY_MD32_BASE_ADDRESS + 0x450A4)
    #define SSPM_UART_XON2_ADDR_XON2                           Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_XOFF1_ADDR                   (DDRPHY_MD32_BASE_ADDRESS + 0x450A8)
    #define SSPM_UART_XOFF1_ADDR_XOFF1                         Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_XOFF2_ADDR                   (DDRPHY_MD32_BASE_ADDRESS + 0x450AC)
    #define SSPM_UART_XOFF2_ADDR_XOFF2                         Fld(8, 0) //[7:0]

#define DDRPHY_MD32_REG_SSPM_UART_UART_RX_SEL_ADDR             (DDRPHY_MD32_BASE_ADDRESS + 0x450B0)
    #define SSPM_UART_UART_RX_SEL_ADDR_USB_RX_SEL              Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_UART_SLEEP_REQ_ADDR               (DDRPHY_MD32_BASE_ADDRESS + 0x450B4)
    #define SSPM_UART_SLEEP_REQ_ADDR_SLEEP_REQ                 Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_UART_SLEEP_ACK_ADDR               (DDRPHY_MD32_BASE_ADDRESS + 0x450B8)
    #define SSPM_UART_SLEEP_ACK_ADDR_SLEEP_ACK                 Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_UART_SPM_SEL                      (DDRPHY_MD32_BASE_ADDRESS + 0x450BC)
    #define SSPM_UART_SPM_SEL_SPM_SEL                          Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_TWAM_CTRL                         (DDRPHY_MD32_BASE_ADDRESS + 0x46000)
...
#define DDRPHY_MD32_REG_SSPM_TWAM_WINDOW_LEN                   (DDRPHY_MD32_BASE_ADDRESS + 0x46004)
    #define SSPM_TWAM_WINDOW_LEN_TWAM_WINDOW_LEN               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_TWAM_MON_TYPE                     (DDRPHY_MD32_BASE_ADDRESS + 0x46008)
...
#define DDRPHY_MD32_REG_SSPM_TWAM_SIG_SEL0                     (DDRPHY_MD32_BASE_ADDRESS + 0x4600C)
...
#define DDRPHY_MD32_REG_SSPM_TWAM_SIG_SEL1                     (DDRPHY_MD32_BASE_ADDRESS + 0x46010)
...
#define DDRPHY_MD32_REG_SSPM_TWAM_SIG_SEL2                     (DDRPHY_MD32_BASE_ADDRESS + 0x46014)
...
#define DDRPHY_MD32_REG_SSPM_TWAM_IRQ                          (DDRPHY_MD32_BASE_ADDRESS + 0x46018)
...
#define DDRPHY_MD32_REG_SSPM_TWAM_TIMER                        (DDRPHY_MD32_BASE_ADDRESS + 0x4601C)
    #define SSPM_TWAM_TIMER_TWAM_TIMER                         Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_WFI_WFE                           (DDRPHY_MD32_BASE_ADDRESS + 0x46020)
    #define SSPM_WFI_WFE_WFI_WFE                               Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT0                     (DDRPHY_MD32_BASE_ADDRESS + 0x46030)
    #define SSPM_CUR_IDLE_CNT0_CUR_IDLE_CNT0                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT1                     (DDRPHY_MD32_BASE_ADDRESS + 0x46034)
    #define SSPM_CUR_IDLE_CNT1_CUR_IDLE_CNT1                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT2                     (DDRPHY_MD32_BASE_ADDRESS + 0x46038)
    #define SSPM_CUR_IDLE_CNT2_CUR_IDLE_CNT2                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT3                     (DDRPHY_MD32_BASE_ADDRESS + 0x4603C)
    #define SSPM_CUR_IDLE_CNT3_CUR_IDLE_CNT3                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT4                     (DDRPHY_MD32_BASE_ADDRESS + 0x46040)
    #define SSPM_CUR_IDLE_CNT4_CUR_IDLE_CNT4                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT5                     (DDRPHY_MD32_BASE_ADDRESS + 0x46044)
    #define SSPM_CUR_IDLE_CNT5_CUR_IDLE_CNT5                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT6                     (DDRPHY_MD32_BASE_ADDRESS + 0x46048)
    #define SSPM_CUR_IDLE_CNT6_CUR_IDLE_CNT6                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT7                     (DDRPHY_MD32_BASE_ADDRESS + 0x4604C)
    #define SSPM_CUR_IDLE_CNT7_CUR_IDLE_CNT7                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT8                     (DDRPHY_MD32_BASE_ADDRESS + 0x46050)
    #define SSPM_CUR_IDLE_CNT8_CUR_IDLE_CNT8                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT9                     (DDRPHY_MD32_BASE_ADDRESS + 0x46054)
    #define SSPM_CUR_IDLE_CNT9_CUR_IDLE_CNT9                   Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT10                    (DDRPHY_MD32_BASE_ADDRESS + 0x46058)
    #define SSPM_CUR_IDLE_CNT10_CUR_IDLE_CNT10                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT11                    (DDRPHY_MD32_BASE_ADDRESS + 0x4605C)
    #define SSPM_CUR_IDLE_CNT11_CUR_IDLE_CNT11                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT12                    (DDRPHY_MD32_BASE_ADDRESS + 0x46060)
    #define SSPM_CUR_IDLE_CNT12_CUR_IDLE_CNT12                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT13                    (DDRPHY_MD32_BASE_ADDRESS + 0x46064)
    #define SSPM_CUR_IDLE_CNT13_CUR_IDLE_CNT13                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT14                    (DDRPHY_MD32_BASE_ADDRESS + 0x46068)
    #define SSPM_CUR_IDLE_CNT14_CUR_IDLE_CNT14                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_CUR_IDLE_CNT15                    (DDRPHY_MD32_BASE_ADDRESS + 0x4606C)
    #define SSPM_CUR_IDLE_CNT15_CUR_IDLE_CNT15                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT0                    (DDRPHY_MD32_BASE_ADDRESS + 0x46080)
    #define SSPM_LAST_IDLE_CNT0_LAST_IDEL_CNT0                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT1                    (DDRPHY_MD32_BASE_ADDRESS + 0x46084)
    #define SSPM_LAST_IDLE_CNT1_LAST_IDEL_CNT1                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT2                    (DDRPHY_MD32_BASE_ADDRESS + 0x46088)
    #define SSPM_LAST_IDLE_CNT2_LAST_IDEL_CNT2                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT3                    (DDRPHY_MD32_BASE_ADDRESS + 0x4608C)
    #define SSPM_LAST_IDLE_CNT3_LAST_IDEL_CNT3                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT4                    (DDRPHY_MD32_BASE_ADDRESS + 0x46090)
    #define SSPM_LAST_IDLE_CNT4_LAST_IDEL_CNT4                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT5                    (DDRPHY_MD32_BASE_ADDRESS + 0x46094)
    #define SSPM_LAST_IDLE_CNT5_LAST_IDEL_CNT5                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT6                    (DDRPHY_MD32_BASE_ADDRESS + 0x46098)
    #define SSPM_LAST_IDLE_CNT6_LAST_IDEL_CNT6                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT7                    (DDRPHY_MD32_BASE_ADDRESS + 0x4609C)
    #define SSPM_LAST_IDLE_CNT7_LAST_IDEL_CNT7                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT8                    (DDRPHY_MD32_BASE_ADDRESS + 0x460A0)
    #define SSPM_LAST_IDLE_CNT8_LAST_IDEL_CNT8                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT9                    (DDRPHY_MD32_BASE_ADDRESS + 0x460A4)
    #define SSPM_LAST_IDLE_CNT9_LAST_IDEL_CNT9                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT10                   (DDRPHY_MD32_BASE_ADDRESS + 0x460A8)
    #define SSPM_LAST_IDLE_CNT10_LAST_IDEL_CNT10               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT11                   (DDRPHY_MD32_BASE_ADDRESS + 0x460AC)
    #define SSPM_LAST_IDLE_CNT11_LAST_IDEL_CNT11               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT12                   (DDRPHY_MD32_BASE_ADDRESS + 0x460B0)
    #define SSPM_LAST_IDLE_CNT12_LAST_IDEL_CNT12               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT13                   (DDRPHY_MD32_BASE_ADDRESS + 0x460B4)
    #define SSPM_LAST_IDLE_CNT13_LAST_IDEL_CNT13               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT14                   (DDRPHY_MD32_BASE_ADDRESS + 0x460B8)
    #define SSPM_LAST_IDLE_CNT14_LAST_IDEL_CNT14               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SSPM_LAST_IDLE_CNT15                   (DDRPHY_MD32_BASE_ADDRESS + 0x460BC)
    #define SSPM_LAST_IDLE_CNT15_LAST_IDEL_CNT15               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_FSM_CFG                           (DDRPHY_MD32_BASE_ADDRESS + 0x47000)
...
#define DDRPHY_MD32_REG_LPIF_LOW_POWER_CFG_0                   (DDRPHY_MD32_BASE_ADDRESS + 0x47004)
...
#define DDRPHY_MD32_REG_LPIF_LOW_POWER_CFG_1                   (DDRPHY_MD32_BASE_ADDRESS + 0x47008)
...
#define DDRPHY_MD32_REG_LPIF_LOW_POWER_CFG_2                   (DDRPHY_MD32_BASE_ADDRESS + 0x4700C)
...
#define DDRPHY_MD32_REG_LPIF_FSM_OUT_CTRL_0                    (DDRPHY_MD32_BASE_ADDRESS + 0x47010)
...
#define DDRPHY_MD32_REG_LPIF_FSM_OUT_CTRL_1                    (DDRPHY_MD32_BASE_ADDRESS + 0x47014)
    ...
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_ROOT_1ST_CK_SEL_EN Fld(1, 18) //[18:18]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_ROOT_2ND_CK_SEL_EN Fld(1, 19) //[19:19]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_ROOT_CK_SEL        Fld(1, 20) //[20:20]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_ROOT_CK_UPDATE     Fld(1, 21) //[21:21]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_SUB_DCM_FREERUN    Fld(1, 22) //[22:22]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_ALL_TRACKING_OFF   Fld(1, 23) //[23:23]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_SHU_SRAM_LP_RESTORE Fld(1, 24) //[24:24]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_SHU_SRAM_LP_LOAD   Fld(1, 25) //[25:25]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_SHU_DRAM_DMA_STOP  Fld(1, 26) //[26:26]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_SHU_SRAM_DMA_HIGH_PRIORITY Fld(1, 27) //[27:27]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_BLOCK_CTO_ALE      Fld(1, 28) //[28:28]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_PLL_RESETB         Fld(1, 29) //[29:29]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DR_GATE_RETRY_RK       Fld(1, 30) //[30:30]
    #define LPIF_FSM_OUT_CTRL_1_LOG_OPT_DPY_DVFS_NOQUEFLUSH_DIS Fld(1, 31) //[31:31]

#define DDRPHY_MD32_REG_LPIF_IPC_MASK_0                        (DDRPHY_MD32_BASE_ADDRESS + 0x47018)
...
#define DDRPHY_MD32_REG_LPIF_IPC_MASK_1                        (DDRPHY_MD32_BASE_ADDRESS + 0x4701C)
    #define LPIF_IPC_MASK_1_PWR_STATE_IPC_MASK_RESERVED        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_FSM_CTRL_0                        (DDRPHY_MD32_BASE_ADDRESS + 0x47020)
    ...
    #define LPIF_FSM_CTRL_0_LP_INTF_MPLL_OUT_ENABLE            Fld(1, 10) //[10:10]
    #define LPIF_FSM_CTRL_0_LP_INTF_MTCMOS_SRAM_OUT_ENABLE     Fld(1, 11) //[11:11]
    ...
    #define LPIF_FSM_CTRL_0_LP_INTF_OUT_ENABLE                 Fld(1, 28) //[28:28]
    #define LPIF_FSM_CTRL_0_HW_S1_LP_INTF_OUT_ENABLE           Fld(1, 29) //[29:29]
    #define LPIF_FSM_CTRL_0_LEGACY_IN_SYNC_CLOCK_ENABLE        Fld(1, 30) //[30:30]
    #define LPIF_FSM_CTRL_0_DPM_DRAMC_WO_CONF_RSTB             Fld(1, 31) //[31:31]

#define DDRPHY_MD32_REG_LPIF_FSM_CTRL_1                        (DDRPHY_MD32_BASE_ADDRESS + 0x47024)
...
#define DDRPHY_MD32_REG_LPIF_FSM_CTRL_2                        (DDRPHY_MD32_BASE_ADDRESS + 0x47028)
...
#define DDRPHY_MD32_REG_LPIF_FSM_CTRL_3                        (DDRPHY_MD32_BASE_ADDRESS + 0x4702C)
...
#define DDRPHY_MD32_REG_LPIF_FSM_CTRL_4                        (DDRPHY_MD32_BASE_ADDRESS + 0x47030)
...
#define DDRPHY_MD32_REG_LPIF_FSM_CFG_1                         (DDRPHY_MD32_BASE_ADDRESS + 0x47034)
    ...
    #define LPIF_FSM_CFG_1_LPIF_OUTPUT_PATH_DIS_SW             Fld(1, 8) //[8:8]
    #define LPIF_FSM_CFG_1_LPIF_OUTPUT_PATH_DIS_SW_2ND         Fld(1, 9) //[9:9]
    #define LPIF_FSM_CFG_1_RESERVED_X34_11_10                  Fld(2, 10) //[11:10]
    #define LPIF_FSM_CFG_1_LPIF_PWR_COTROL_UPDATE              Fld(1, 12) //[12:12]
    #define LPIF_FSM_CFG_1_RESERVED_X34_15_13                  Fld(3, 13) //[15:13]
    #define LPIF_FSM_CFG_1_LPIF_MTCMOS_SRAM_CONTROL_SOURCE     Fld(1, 16) //[16:16]
    #define LPIF_FSM_CFG_1_LPIF_MPLL_CONTROL_SOURCE            Fld(1, 17) //[17:17]
    #define LPIF_FSM_CFG_1_RESERVED_X34_31_18                  Fld(14, 18) //[31:18]

#define DDRPHY_MD32_REG_LPIF_LOW_POWER_CFG_3                   (DDRPHY_MD32_BASE_ADDRESS + 0x47038)
    ...
    #define LPIF_LOW_POWER_CFG_3_DPY_FSPOP_INDEX               Fld(2, 28) //[29:28]
    #define LPIF_LOW_POWER_CFG_3_RESERVED_X38_31_30            Fld(2, 30) //[31:30]

#define DDRPHY_MD32_REG_LPIF_LOW_POWER_CFG_4                   (DDRPHY_MD32_BASE_ADDRESS + 0x4703C)
    #define LPIF_LOW_POWER_CFG_4_DPY_ROOT_1ST_CK_SEL_EN        Fld(2, 0) //[1:0]
    #define LPIF_LOW_POWER_CFG_4_DPY_ROOT_2ND_CK_SEL_EN        Fld(2, 2) //[3:2]
    #define LPIF_LOW_POWER_CFG_4_DPY_ROOT_CK_SEL               Fld(4, 4) //[7:4]
    #define LPIF_LOW_POWER_CFG_4_DPY_ROOT_CK_UPDATE            Fld(2, 8) //[9:8]
    #define LPIF_LOW_POWER_CFG_4_DPY_SUB_DCM_FREERUN           Fld(2, 10) //[11:10]
    #define LPIF_LOW_POWER_CFG_4_DPY_ALL_TRACKING_OFF          Fld(2, 12) //[13:12]
    #define LPIF_LOW_POWER_CFG_4_DPY_SHU_SRAM_LP_RESTORE       Fld(2, 14) //[15:14]
    #define LPIF_LOW_POWER_CFG_4_DPY_SHU_SRAM_LP_LOAD          Fld(2, 16) //[17:16]
    #define LPIF_LOW_POWER_CFG_4_DPY_SHU_DRAM_DMA_STOP         Fld(2, 18) //[19:18]
    #define LPIF_LOW_POWER_CFG_4_DPY_SHU_SRAM_DMA_HIGH_PRIORITY Fld(2, 20) //[21:20]
    #define LPIF_LOW_POWER_CFG_4_DPY_BLOCK_CTO_ALE             Fld(2, 22) //[23:22]
    #define LPIF_LOW_POWER_CFG_4_DPY_PLL_RESETB                Fld(2, 24) //[25:24]
    #define LPIF_LOW_POWER_CFG_4_DR_GATE_RETRY_RK              Fld(2, 26) //[27:26]
    #define LPIF_LOW_POWER_CFG_4_DPY_DVFS_NOQUEFLUSH_DIS       Fld(2, 28) //[29:28]
    #define LPIF_LOW_POWER_CFG_4_LPIF_DFD_DEBUG_ISO_EN         Fld(1, 30) //[30:30]
    #define LPIF_LOW_POWER_CFG_4_DPM_DRAMC_CKGEN_MCK_CG_EN     Fld(1, 31) //[31:31]

#define DDRPHY_MD32_REG_LPIF_RESERVED_3                        (DDRPHY_MD32_BASE_ADDRESS + 0x47040)
    #define LPIF_RESERVED_3_LOG_OPT_DPY_FSPOP_INDEX            Fld(1, 0) //[0:0]
    #define LPIF_RESERVED_3_LOG_OPT_DPY_SHU_SRAM_LP_OBF_RESTORE Fld(1, 1) //[1:1]
    #define LPIF_RESERVED_3_LOG_OPT_DPY_SHU_SRAM_LP_OBF_LOAD   Fld(1, 2) //[2:2]
    #define LPIF_RESERVED_3_RESERVED_X40_31_3                  Fld(29, 3) //[31:3]

#define DDRPHY_MD32_REG_LPIF_TIMING_COUNTER_CTRL_0             (DDRPHY_MD32_BASE_ADDRESS + 0x47044)
...
#define DDRPHY_MD32_REG_LPIF_TIMING_COUNTER_CTRL_1             (DDRPHY_MD32_BASE_ADDRESS + 0x47048)
    ...
    #define LPIF_TIMING_COUNTER_CTRL_1_COUNTER_SR_MIN_PLS_DEBON Fld(9, 12) //[20:12]
    #define LPIF_TIMING_COUNTER_CTRL_1_COUNTER_SR_DEBON        Fld(11, 21) //[31:21]

#define DDRPHY_MD32_REG_LPIF_TIMING_COUNTER_CTRL_2             (DDRPHY_MD32_BASE_ADDRESS + 0x4704C)
...
#define DDRPHY_MD32_REG_LPIF_TIMING_COUNTER_CTRL_3             (DDRPHY_MD32_BASE_ADDRESS + 0x47050)
...
#define DDRPHY_MD32_REG_LPIF_TIMING_COUNTER_CTRL_4             (DDRPHY_MD32_BASE_ADDRESS + 0x47054)
...
#define DDRPHY_MD32_REG_LPIF_TIMING_COUNTER_CTRL_5             (DDRPHY_MD32_BASE_ADDRESS + 0x47058)
...
#define DDRPHY_MD32_REG_LPIF_TIMING_COUNTER_CTRL_6             (DDRPHY_MD32_BASE_ADDRESS + 0x4705C)
...
#define DDRPHY_MD32_REG_LPIF_FSM_CTRL_5                        (DDRPHY_MD32_BASE_ADDRESS + 0x47060)
...
#define DDRPHY_MD32_REG_LPIF_RESERVED_5                        (DDRPHY_MD32_BASE_ADDRESS + 0x47064)
...
#define DDRPHY_MD32_REG_LPIF_RESERVED_6                        (DDRPHY_MD32_BASE_ADDRESS + 0x47068)
...
#define DDRPHY_MD32_REG_LPIF_RESERVED_7                        (DDRPHY_MD32_BASE_ADDRESS + 0x4706C)
    #define LPIF_RESERVED_7_RESERVED_X6C_31_0                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_RESERVED_8                        (DDRPHY_MD32_BASE_ADDRESS + 0x47070)
    #define LPIF_RESERVED_8_DPY_SHU_SRAM_LP_OBF_RESTORE        Fld(2, 0) //[1:0]
    #define LPIF_RESERVED_8_DPY_SHU_SRAM_LP_OBF_LOAD           Fld(2, 2) //[3:2]
    #define LPIF_RESERVED_8_RESERVED_X70_31_4                  Fld(28, 4) //[31:4]

#define DDRPHY_MD32_REG_LPIF_RESERVED_9                        (DDRPHY_MD32_BASE_ADDRESS + 0x47074)
    #define LPIF_RESERVED_9_RESERVED_X74_31_0                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_SEMA_2MCU_HOR                     (DDRPHY_MD32_BASE_ADDRESS + 0x47078)
    #define LPIF_SEMA_2MCU_HOR_SEMA_HOR_DELAY_CNT_0            Fld(4, 0) //[3:0]
    #define LPIF_SEMA_2MCU_HOR_SEMA_HOR_DPM_REQ                Fld(1, 4) //[4:4]
    #define LPIF_SEMA_2MCU_HOR_SEMA_HOR_DPM_HGIH_PRI           Fld(1, 5) //[5:5]
    #define LPIF_SEMA_2MCU_HOR_RESERVED_X7C_15_6               Fld(10, 6) //[15:6]
    #define LPIF_SEMA_2MCU_HOR_SEMA_DPM_HOR_IN_PRE_REQ         Fld(1, 16) //[16:16]
    #define LPIF_SEMA_2MCU_HOR_SEMA_DPM_HOR_IN_POST_REQ        Fld(1, 17) //[17:17]
    #define LPIF_SEMA_2MCU_HOR_SEMA_DPM_HOR_IN_PRE_ACK         Fld(1, 18) //[18:18]
    #define LPIF_SEMA_2MCU_HOR_SEMA_DPM_HOR_IN_POST_ACK        Fld(1, 19) //[19:19]
    #define LPIF_SEMA_2MCU_HOR_SEMA_DPM_HOR_OUT_PRE_REQ        Fld(1, 20) //[20:20]
    #define LPIF_SEMA_2MCU_HOR_SEMA_DPM_HOR_OUT_POST_REQ       Fld(1, 21) //[21:21]
    #define LPIF_SEMA_2MCU_HOR_SEMA_DPM_HOR_OUT_PRE_ACK        Fld(1, 22) //[22:22]
    #define LPIF_SEMA_2MCU_HOR_SEMA_DPM_HOR_OUT_POST_ACK       Fld(1, 23) //[23:23]
    #define LPIF_SEMA_2MCU_HOR_RESERVED_X7C_31_24              Fld(8, 24) //[31:24]

#define DDRPHY_MD32_REG_LPIF_SEMA_2MCU                         (DDRPHY_MD32_BASE_ADDRESS + 0x4707C)
    #define LPIF_SEMA_2MCU_SEMA_DELAY_CNT_0                    Fld(4, 0) //[3:0]
    #define LPIF_SEMA_2MCU_SEMA_DPM_REQ                        Fld(1, 4) //[4:4]
    #define LPIF_SEMA_2MCU_SEMA_DPM_HGIH_PRI                   Fld(1, 5) //[5:5]
    #define LPIF_SEMA_2MCU_RESERVED_X7C_15_6                   Fld(10, 6) //[15:6]
    #define LPIF_SEMA_2MCU_SEMA_DPM_IN_PRE_REQ                 Fld(1, 16) //[16:16]
    #define LPIF_SEMA_2MCU_SEMA_DPM_IN_POST_REQ                Fld(1, 17) //[17:17]
    #define LPIF_SEMA_2MCU_SEMA_DPM_IN_PRE_ACK                 Fld(1, 18) //[18:18]
    #define LPIF_SEMA_2MCU_SEMA_DPM_IN_POST_ACK                Fld(1, 19) //[19:19]
    #define LPIF_SEMA_2MCU_SEMA_DPM_OUT_PRE_REQ                Fld(1, 20) //[20:20]
    #define LPIF_SEMA_2MCU_SEMA_DPM_OUT_POST_REQ               Fld(1, 21) //[21:21]
    #define LPIF_SEMA_2MCU_SEMA_DPM_OUT_PRE_ACK                Fld(1, 22) //[22:22]
    #define LPIF_SEMA_2MCU_SEMA_DPM_OUT_POST_ACK               Fld(1, 23) //[23:23]
    #define LPIF_SEMA_2MCU_RESERVED_X7C_31_24                  Fld(8, 24) //[31:24]

#define DDRPHY_MD32_REG_LPIF_SEMA_0                            (DDRPHY_MD32_BASE_ADDRESS + 0x47080)
...
#define DDRPHY_MD32_REG_LPIF_SEMA_1                            (DDRPHY_MD32_BASE_ADDRESS + 0x47084)
...
#define DDRPHY_MD32_REG_LPIF_SEMA_2                            (DDRPHY_MD32_BASE_ADDRESS + 0x47088)
...
#define DDRPHY_MD32_REG_LPIF_SEMA_3                            (DDRPHY_MD32_BASE_ADDRESS + 0x4708C)
...
#define DDRPHY_MD32_REG_LPIF_RESERVED_16                       (DDRPHY_MD32_BASE_ADDRESS + 0x47090)
    #define LPIF_RESERVED_16_DRAMC_DPM_BACKUP_FLAG             Fld(1, 0) //[0:0]
    #define LPIF_RESERVED_16_RESERVED_X90_31_0                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_RESERVED_17                       (DDRPHY_MD32_BASE_ADDRESS + 0x47094)
    #define LPIF_RESERVED_17_RESERVED_X94_31_0                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_RESERVED_18                       (DDRPHY_MD32_BASE_ADDRESS + 0x47098)
    #define LPIF_RESERVED_18_RESERVED_X98_31_0                 Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DUMMY_REG                         (DDRPHY_MD32_BASE_ADDRESS + 0x4709C)
    #define LPIF_DUMMY_REG_DUMMY_REG                           Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_STATUS_0                          (DDRPHY_MD32_BASE_ADDRESS + 0x470A0)
    #define LPIF_STATUS_0_LPIF_DDR_PST                         Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_STATUS_1                          (DDRPHY_MD32_BASE_ADDRESS + 0x470A4)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_2                          (DDRPHY_MD32_BASE_ADDRESS + 0x470A8)
    #define LPIF_STATUS_2_DESTINATION_DDR_PST                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_STATUS_3                          (DDRPHY_MD32_BASE_ADDRESS + 0x470AC)
    #define LPIF_STATUS_3_CUR_DDR_PST_STA                      Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_STATUS_4                          (DDRPHY_MD32_BASE_ADDRESS + 0x470B0)
    #define LPIF_STATUS_4_EMI_CLK_OFF_REQ_ACK                  Fld(2, 0) //[1:0]
    #define LPIF_STATUS_4_DPY_FASTK_RQQDS_ACK                  Fld(2, 2) //[3:2]
    #define LPIF_STATUS_4_DRAMC_DFS_STA                        Fld(4, 4) //[7:4]
    #define LPIF_STATUS_4_DPY_SHU_SRAM_LP_RESTORE_ACK          Fld(2, 8) //[9:8]
    #define LPIF_STATUS_4_DPY_SHU_SRAM_LP_LOAD_ACK             Fld(2, 10) //[11:10]
    ...
    #define LPIF_STATUS_4_DR_GATE_RETRY_ACK                    Fld(2, 24) //[25:24]
    #define LPIF_STATUS_4_DPY_FASTK_RDDQS_MPC_ACK              Fld(2, 26) //[27:26]
...
#define DDRPHY_MD32_REG_LPIF_STATUS_5                          (DDRPHY_MD32_BASE_ADDRESS + 0x470B4)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_6                          (DDRPHY_MD32_BASE_ADDRESS + 0x470B8)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_7                          (DDRPHY_MD32_BASE_ADDRESS + 0x470BC)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_8                          (DDRPHY_MD32_BASE_ADDRESS + 0x470C0)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_9                          (DDRPHY_MD32_BASE_ADDRESS + 0x470C4)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_10                         (DDRPHY_MD32_BASE_ADDRESS + 0x470C8)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_11                         (DDRPHY_MD32_BASE_ADDRESS + 0x470CC)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_12                         (DDRPHY_MD32_BASE_ADDRESS + 0x470D0)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_13                         (DDRPHY_MD32_BASE_ADDRESS + 0x470D4)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_14                         (DDRPHY_MD32_BASE_ADDRESS + 0x470D8)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_20                         (DDRPHY_MD32_BASE_ADDRESS + 0x470DC)
    #define LPIF_STATUS_20_DRAMC_DPY_ROOT_1ST_CK_SEL_EN        Fld(2, 0) //[1:0]
    #define LPIF_STATUS_20_DRAMC_DPY_ROOT_2ND_CK_SEL_EN        Fld(2, 2) //[3:2]
    #define LPIF_STATUS_20_DRAMC_DPY_ROOT_CK_SEL               Fld(4, 4) //[7:4]
    #define LPIF_STATUS_20_DRAMC_DPY_ROOT_CK_UPDATE            Fld(2, 8) //[9:8]
    #define LPIF_STATUS_20_DRAMC_DPY_SUB_DCM_FREERUN           Fld(2, 10) //[11:10]
    #define LPIF_STATUS_20_DRAMC_DPY_ALL_TRACKING_OFF          Fld(2, 12) //[13:12]
    #define LPIF_STATUS_20_DRAMC_DPY_SHU_SRAM_LP_RESTORE       Fld(2, 14) //[15:14]
    #define LPIF_STATUS_20_DRAMC_DPY_SHU_SRAM_LP_LOAD          Fld(2, 16) //[17:16]
    #define LPIF_STATUS_20_DRAMC_DPY_SHU_DRAM_DMA_STOP         Fld(2, 18) //[19:18]
    #define LPIF_STATUS_20_DRAMC_DPY_SHU_SRAM_DMA_HIGH_PRIORITY Fld(2, 20) //[21:20]
    #define LPIF_STATUS_20_DRAMC_DPY_BLOCK_CTO_ALE             Fld(2, 22) //[23:22]
    #define LPIF_STATUS_20_DRAMC_DPY_PLL_RESETB                Fld(2, 24) //[25:24]
    #define LPIF_STATUS_20_DRAMC_DR_GATE_RETRY_RK              Fld(2, 26) //[27:26]
    #define LPIF_STATUS_20_DRAMC_DPY_DVFSNOQUEFLUSH_DIS        Fld(2, 28) //[29:28]
    #define LPIF_STATUS_20_DRAMC_DPY_FSPOP_INDEX               Fld(2, 30) //[31:30]

#define DDRPHY_MD32_REG_LPIF_STATUS_15                         (DDRPHY_MD32_BASE_ADDRESS + 0x470E0)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_16                         (DDRPHY_MD32_BASE_ADDRESS + 0x470E4)
    ...
    #define LPIF_STATUS_16_SC_SHU_SRAM_CKISO                   Fld(2, 26) //[27:26]
    #define LPIF_STATUS_16_SC_SHU_SRAM_ISOINT_B                Fld(2, 28) //[29:28]
    #define LPIF_STATUS_16_SC_SHU_SRAM_PDN                     Fld(2, 30) //[31:30]

#define DDRPHY_MD32_REG_LPIF_STATUS_17                         (DDRPHY_MD32_BASE_ADDRESS + 0x470E8)
...
#define DDRPHY_MD32_REG_LPIF_STATUS_18                         (DDRPHY_MD32_BASE_ADDRESS + 0x470EC)
    #define LPIF_STATUS_18_DRAMC_LPIF_COM_VER                  Fld(16, 0) //[15:0]
    #define LPIF_STATUS_18_DRAMC_LPIF_COM_HOR                  Fld(16, 16) //[31:16]

#define DDRPHY_MD32_REG_LPIF_STATUS_19                         (DDRPHY_MD32_BASE_ADDRESS + 0x470F0)
    #define LPIF_STATUS_19_DRAMC_LPIF_STA_VER                  Fld(16, 0) //[15:0]
    #define LPIF_STATUS_19_DRAMC_LPIF_STA_HOR                  Fld(16, 16) //[31:16]

#define DDRPHY_MD32_REG_LPIF_MISC_CTL_0                        (DDRPHY_MD32_BASE_ADDRESS + 0x470F4)
    #define LPIF_MISC_CTL_0_EMI_SLEEP_IDLE                     Fld(1, 0) //[0:0]

#define DDRPHY_MD32_REG_LPIF_MISC_CTL_1                        (DDRPHY_MD32_BASE_ADDRESS + 0x470F8)
...
#define DDRPHY_MD32_REG_LPIF_MISC_STATUS_0                     (DDRPHY_MD32_BASE_ADDRESS + 0x470FC)
    ...
    #define LPIF_MISC_STATUS_0_SC_RESERVED_IN_PORT_FROM_DRAMC  Fld(8, 24) //[31:24]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_0                        (DDRPHY_MD32_BASE_ADDRESS + 0x47100)
    #define LPIF_DVFS_CMD_0_DVFS_CMD0                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_1                        (DDRPHY_MD32_BASE_ADDRESS + 0x47104)
    #define LPIF_DVFS_CMD_1_DVFS_CMD1                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_2                        (DDRPHY_MD32_BASE_ADDRESS + 0x47108)
    #define LPIF_DVFS_CMD_2_DVFS_CMD2                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_3                        (DDRPHY_MD32_BASE_ADDRESS + 0x4710C)
    #define LPIF_DVFS_CMD_3_DVFS_CMD3                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_4                        (DDRPHY_MD32_BASE_ADDRESS + 0x47110)
    #define LPIF_DVFS_CMD_4_DVFS_CMD4                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_5                        (DDRPHY_MD32_BASE_ADDRESS + 0x47114)
    #define LPIF_DVFS_CMD_5_DVFS_CMD5                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_6                        (DDRPHY_MD32_BASE_ADDRESS + 0x47118)
    #define LPIF_DVFS_CMD_6_DVFS_CMD6                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_7                        (DDRPHY_MD32_BASE_ADDRESS + 0x4711C)
    #define LPIF_DVFS_CMD_7_DVFS_CMD7                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_8                        (DDRPHY_MD32_BASE_ADDRESS + 0x47120)
    #define LPIF_DVFS_CMD_8_DVFS_CMD8                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_9                        (DDRPHY_MD32_BASE_ADDRESS + 0x47124)
    #define LPIF_DVFS_CMD_9_DVFS_CMD9                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_10                       (DDRPHY_MD32_BASE_ADDRESS + 0x47128)
    #define LPIF_DVFS_CMD_10_DVFS_CMD10                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_11                       (DDRPHY_MD32_BASE_ADDRESS + 0x4712C)
    #define LPIF_DVFS_CMD_11_DVFS_CMD11                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_12                       (DDRPHY_MD32_BASE_ADDRESS + 0x47130)
    #define LPIF_DVFS_CMD_12_DVFS_CMD12                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_13                       (DDRPHY_MD32_BASE_ADDRESS + 0x47134)
    #define LPIF_DVFS_CMD_13_DVFS_CMD13                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_14                       (DDRPHY_MD32_BASE_ADDRESS + 0x47138)
    #define LPIF_DVFS_CMD_14_DVFS_CMD14                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_15                       (DDRPHY_MD32_BASE_ADDRESS + 0x4713C)
    #define LPIF_DVFS_CMD_15_DVFS_CMD15                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_16                       (DDRPHY_MD32_BASE_ADDRESS + 0x47140)
    #define LPIF_DVFS_CMD_16_DVFS_CMD16                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_17                       (DDRPHY_MD32_BASE_ADDRESS + 0x47144)
    #define LPIF_DVFS_CMD_17_DVFS_CMD17                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_18                       (DDRPHY_MD32_BASE_ADDRESS + 0x47148)
    #define LPIF_DVFS_CMD_18_DVFS_CMD18                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_19                       (DDRPHY_MD32_BASE_ADDRESS + 0x4714C)
    #define LPIF_DVFS_CMD_19_DVFS_CMD19                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_20                       (DDRPHY_MD32_BASE_ADDRESS + 0x47150)
    #define LPIF_DVFS_CMD_20_DVFS_CMD20                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_21                       (DDRPHY_MD32_BASE_ADDRESS + 0x47154)
    #define LPIF_DVFS_CMD_21_DVFS_CMD21                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_22                       (DDRPHY_MD32_BASE_ADDRESS + 0x47158)
    #define LPIF_DVFS_CMD_22_DVFS_CMD22                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CMD_23                       (DDRPHY_MD32_BASE_ADDRESS + 0x4715C)
    #define LPIF_DVFS_CMD_23_DVFS_CMD23                        Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_CONFIG                       (DDRPHY_MD32_BASE_ADDRESS + 0x47160)
    #define LPIF_DVFS_CONFIG_DVFS_CON                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_STATUS_0                     (DDRPHY_MD32_BASE_ADDRESS + 0x47164)
    #define LPIF_DVFS_STATUS_0_DVFS_CMD_ACK                    Fld(1, 0) //[0:0]
    #define LPIF_DVFS_STATUS_0_DVFS_CMD_REQ                    Fld(1, 1) //[1:1]

#define DDRPHY_MD32_REG_LPIF_DVFS_STATUS_1                     (DDRPHY_MD32_BASE_ADDRESS + 0x47168)
    #define LPIF_DVFS_STATUS_1_DVFS_CMD_DAT                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DVFS_STATUS_2                     (DDRPHY_MD32_BASE_ADDRESS + 0x4716C)
    #define LPIF_DVFS_STATUS_2_DVFS_CON_STA                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_RESERVED_170                      (DDRPHY_MD32_BASE_ADDRESS + 0x47170)
    #define LPIF_RESERVED_170_RESERVED_X170_31_0               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_STATUS_21                         (DDRPHY_MD32_BASE_ADDRESS + 0x47174)
    #define LPIF_STATUS_21_SC_DPY_SHU_SRAM_LP_LOAD_SHU_PLL_ACK Fld(2, 0) //[1:0]
    #define LPIF_STATUS_21_SC_DPY_SHU_SRAM_LP_LOAD_SHU_ACK     Fld(2, 2) //[3:2]
    #define LPIF_STATUS_21_SC_DPY_SHU_SRAM_LP_LOAD_PHY_ACK     Fld(2, 4) //[5:4]
    #define LPIF_STATUS_21_SC_DPY_SHU_SRAM_LP_LOAD_EMI_ACK     Fld(2, 6) //[7:6]
    #define LPIF_STATUS_21_SC_DPY_SHU_SRAM_LP_LOAD_PHY_NAO_ACK Fld(2, 8) //[9:8]
    #define LPIF_STATUS_21_SC_DPY_SHU_SRAM_LP_LOAD_DRAMC_ACK   Fld(2, 10) //[11:10]
    #define LPIF_STATUS_21_SC_TX_TRACKING_RETRY_MPC_ACK        Fld(2, 12) //[13:12]
    #define LPIF_STATUS_21_SC_TX_TRACKING_RETRY_ACK            Fld(2, 14) //[15:14]
    #define LPIF_STATUS_21_SC_DRAMOBF_GENKEY_ACK               Fld(2, 16) //[17:16]
    #define LPIF_STATUS_21_SC_DPY_SHU_SRAM_LP_OBF_RESTORE_ACK  Fld(2, 18) //[19:18]
    #define LPIF_STATUS_21_SC_DPY_SHU_SRAM_LP_OBF_LOAD_ACK     Fld(2, 20) //[21:20]
    #define LPIF_STATUS_21_RESERVED_X174_31_22                 Fld(10, 22) //[31:22]

#define DDRPHY_MD32_REG_LPIF_RESERVED_178                      (DDRPHY_MD32_BASE_ADDRESS + 0x47178)
    #define LPIF_RESERVED_178_APHY_PWR_RST_B                   Fld(2, 0) //[1:0]
    #define LPIF_RESERVED_178_APHY_PWR_ISO                     Fld(2, 2) //[3:2]
    #define LPIF_RESERVED_178_APHY_PWR_ON                      Fld(2, 4) //[5:4]
    #define LPIF_RESERVED_178_APHY_PWR_ON_2ND                  Fld(2, 6) //[7:6]
    #define LPIF_RESERVED_178_APHY_PWR_CLOCK_DIS               Fld(2, 8) //[9:8]
    #define LPIF_RESERVED_178_LPIF_DRAMC_APHYPWR_RST_B         Fld(2, 10) //[11:10]
    #define LPIF_RESERVED_178_LPIF_DRAMC_APHYPWR_ISO           Fld(2, 12) //[13:12]
    #define LPIF_RESERVED_178_LPIF_DRAMC_APHYPWR_ON            Fld(2, 14) //[15:14]
    #define LPIF_RESERVED_178_LPIF_DRAMC_APHYPWR_ON_2ND        Fld(2, 16) //[17:16]
    #define LPIF_RESERVED_178_LPIF_DRAMC_APHYPWR_CLOCK_DIS     Fld(2, 18) //[19:18]
    #define LPIF_RESERVED_178_DPM_DRAMC_APHYPWR_RST_B          Fld(2, 20) //[21:20]
    #define LPIF_RESERVED_178_DPM_DRAMC_APHYPWR_ISO            Fld(2, 22) //[23:22]
    #define LPIF_RESERVED_178_DPM_DRAMC_APHYPWR_ON             Fld(2, 24) //[25:24]
    #define LPIF_RESERVED_178_DPM_DRAMC_APHYPWR_ON_2ND         Fld(2, 26) //[27:26]
    #define LPIF_RESERVED_178_DPM_DRAMC_APHYPWR_CLOCK_DIS      Fld(2, 28) //[29:28]
    #define LPIF_RESERVED_178_RESERVED_X178_31_30              Fld(2, 30) //[31:30]

#define DDRPHY_MD32_REG_LPIF_RESERVED_17C                      (DDRPHY_MD32_BASE_ADDRESS + 0x4717C)
    #define LPIF_RESERVED_17C_RESERVED_X17C_31_0               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_0               (DDRPHY_MD32_BASE_ADDRESS + 0x47180)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_1               (DDRPHY_MD32_BASE_ADDRESS + 0x47184)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_2               (DDRPHY_MD32_BASE_ADDRESS + 0x47188)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_0_3               (DDRPHY_MD32_BASE_ADDRESS + 0x4718C)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_0               (DDRPHY_MD32_BASE_ADDRESS + 0x47190)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_1               (DDRPHY_MD32_BASE_ADDRESS + 0x47194)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_2               (DDRPHY_MD32_BASE_ADDRESS + 0x47198)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_1_3               (DDRPHY_MD32_BASE_ADDRESS + 0x4719C)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_2_0               (DDRPHY_MD32_BASE_ADDRESS + 0x471A0)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_2_1               (DDRPHY_MD32_BASE_ADDRESS + 0x471A4)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_2_2               (DDRPHY_MD32_BASE_ADDRESS + 0x471A8)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_2_3               (DDRPHY_MD32_BASE_ADDRESS + 0x471AC)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_3_0               (DDRPHY_MD32_BASE_ADDRESS + 0x471B0)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_3_1               (DDRPHY_MD32_BASE_ADDRESS + 0x471B4)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_3_2               (DDRPHY_MD32_BASE_ADDRESS + 0x471B8)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_3_3               (DDRPHY_MD32_BASE_ADDRESS + 0x471BC)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_4_0               (DDRPHY_MD32_BASE_ADDRESS + 0x471C0)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_4_1               (DDRPHY_MD32_BASE_ADDRESS + 0x471C4)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_4_2               (DDRPHY_MD32_BASE_ADDRESS + 0x471C8)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_4_3               (DDRPHY_MD32_BASE_ADDRESS + 0x471CC)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_5_0               (DDRPHY_MD32_BASE_ADDRESS + 0x471D0)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_5_1               (DDRPHY_MD32_BASE_ADDRESS + 0x471D4)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_5_2               (DDRPHY_MD32_BASE_ADDRESS + 0x471D8)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_5_3               (DDRPHY_MD32_BASE_ADDRESS + 0x471DC)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_6_0               (DDRPHY_MD32_BASE_ADDRESS + 0x471E0)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_6_1               (DDRPHY_MD32_BASE_ADDRESS + 0x471E4)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_6_2               (DDRPHY_MD32_BASE_ADDRESS + 0x471E8)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_6_3               (DDRPHY_MD32_BASE_ADDRESS + 0x471EC)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_7_0               (DDRPHY_MD32_BASE_ADDRESS + 0x471F0)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_7_1               (DDRPHY_MD32_BASE_ADDRESS + 0x471F4)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_7_2               (DDRPHY_MD32_BASE_ADDRESS + 0x471F8)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_7_3               (DDRPHY_MD32_BASE_ADDRESS + 0x471FC)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_8_0               (DDRPHY_MD32_BASE_ADDRESS + 0x47200)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_8_1               (DDRPHY_MD32_BASE_ADDRESS + 0x47204)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_8_2               (DDRPHY_MD32_BASE_ADDRESS + 0x47208)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_8_3               (DDRPHY_MD32_BASE_ADDRESS + 0x4720C)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_9_0               (DDRPHY_MD32_BASE_ADDRESS + 0x47210)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_9_1               (DDRPHY_MD32_BASE_ADDRESS + 0x47214)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_9_2               (DDRPHY_MD32_BASE_ADDRESS + 0x47218)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_9_3               (DDRPHY_MD32_BASE_ADDRESS + 0x4721C)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_10_0              (DDRPHY_MD32_BASE_ADDRESS + 0x47220)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_10_1              (DDRPHY_MD32_BASE_ADDRESS + 0x47224)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_10_2              (DDRPHY_MD32_BASE_ADDRESS + 0x47228)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_10_3              (DDRPHY_MD32_BASE_ADDRESS + 0x4722C)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_11_0              (DDRPHY_MD32_BASE_ADDRESS + 0x47230)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_11_1              (DDRPHY_MD32_BASE_ADDRESS + 0x47234)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_11_2              (DDRPHY_MD32_BASE_ADDRESS + 0x47238)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_11_3              (DDRPHY_MD32_BASE_ADDRESS + 0x4723C)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_12_0              (DDRPHY_MD32_BASE_ADDRESS + 0x47240)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_12_1              (DDRPHY_MD32_BASE_ADDRESS + 0x47244)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_12_2              (DDRPHY_MD32_BASE_ADDRESS + 0x47248)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_12_3              (DDRPHY_MD32_BASE_ADDRESS + 0x4724C)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_13_0              (DDRPHY_MD32_BASE_ADDRESS + 0x47250)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_13_1              (DDRPHY_MD32_BASE_ADDRESS + 0x47254)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_13_2              (DDRPHY_MD32_BASE_ADDRESS + 0x47258)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_13_3              (DDRPHY_MD32_BASE_ADDRESS + 0x4725C)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_14_0              (DDRPHY_MD32_BASE_ADDRESS + 0x47260)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_14_1              (DDRPHY_MD32_BASE_ADDRESS + 0x47264)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_14_2              (DDRPHY_MD32_BASE_ADDRESS + 0x47268)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_14_3              (DDRPHY_MD32_BASE_ADDRESS + 0x4726C)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_15_0              (DDRPHY_MD32_BASE_ADDRESS + 0x47270)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_15_1              (DDRPHY_MD32_BASE_ADDRESS + 0x47274)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_15_2              (DDRPHY_MD32_BASE_ADDRESS + 0x47278)
...
#define DDRPHY_MD32_REG_LPIF_MR_OP_STORE_SHU_15_3              (DDRPHY_MD32_BASE_ADDRESS + 0x4727C)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_0                        (DDRPHY_MD32_BASE_ADDRESS + 0x47280)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_1                        (DDRPHY_MD32_BASE_ADDRESS + 0x47284)
    #define LPIF_INT_PSTA_1_PSTA_LOOP_MODE_TIME                Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_INT_PSTA_2                        (DDRPHY_MD32_BASE_ADDRESS + 0x47288)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_3                        (DDRPHY_MD32_BASE_ADDRESS + 0x4728C)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_4                        (DDRPHY_MD32_BASE_ADDRESS + 0x47290)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_5                        (DDRPHY_MD32_BASE_ADDRESS + 0x47294)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_6                        (DDRPHY_MD32_BASE_ADDRESS + 0x47298)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_7                        (DDRPHY_MD32_BASE_ADDRESS + 0x4729C)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_8                        (DDRPHY_MD32_BASE_ADDRESS + 0x472A0)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_9                        (DDRPHY_MD32_BASE_ADDRESS + 0x472A4)
    #define LPIF_INT_PSTA_9_PSTA_DDR_PST                       Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_INT_PSTA_10                       (DDRPHY_MD32_BASE_ADDRESS + 0x472A8)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_11                       (DDRPHY_MD32_BASE_ADDRESS + 0x472AC)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_12                       (DDRPHY_MD32_BASE_ADDRESS + 0x472B0)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_13                       (DDRPHY_MD32_BASE_ADDRESS + 0x472B4)
...
#define DDRPHY_MD32_REG_LPIF_INT_PSTA_14                       (DDRPHY_MD32_BASE_ADDRESS + 0x472B8)
...
#define DDRPHY_MD32_REG_LPIF_HW_S1_0                           (DDRPHY_MD32_BASE_ADDRESS + 0x472C0)
    ...
    #define LPIF_HW_S1_0_HW_S1_FORCE_EXIT                      Fld(1, 26) //[26:26]
    #define LPIF_HW_S1_0_RESERVED_XB0_31_27                    Fld(5, 27) //[31:27]

#define DDRPHY_MD32_REG_LPIF_HW_S1_1                           (DDRPHY_MD32_BASE_ADDRESS + 0x472C4)
    #define LPIF_HW_S1_1_HW_S1_PST_CHK                         Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_HW_S1_2                           (DDRPHY_MD32_BASE_ADDRESS + 0x472C8)
    #define LPIF_HW_S1_2_HW_S1_PST_CHK_RESULT                  Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_HW_S1_3                           (DDRPHY_MD32_BASE_ADDRESS + 0x472CC)
    ...
    #define LPIF_HW_S1_3_HW_S1_FSM_DIS_DCM                     Fld(1, 3) //[3:3]
    ...
    #define LPIF_HW_S1_3_HW_S1_REQ_AND_FORCE_EXIT              Fld(1, 12) //[12:12]
    #define LPIF_HW_S1_3_RESERVED_XB3_31_13                    Fld(19, 13) //[31:13]

#define DDRPHY_MD32_REG_LPIF_HW_S1_4                           (DDRPHY_MD32_BASE_ADDRESS + 0x472D0)
...
#define DDRPHY_MD32_REG_LPIF_HW_S1_5                           (DDRPHY_MD32_BASE_ADDRESS + 0x472D4)
...
#define DDRPHY_MD32_REG_LPIF_HW_S1_6                           (DDRPHY_MD32_BASE_ADDRESS + 0x472D8)
...
#define DDRPHY_MD32_REG_PST_TRIGGER0                           (DDRPHY_MD32_BASE_ADDRESS + 0x472F0)
    #define PST_TRIGGER0_R_DDR_PST                             Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_PST_TRIGGER1                           (DDRPHY_MD32_BASE_ADDRESS + 0x472F4)
    #define PST_TRIGGER1_R_DDR_PST_PATH_SEL                    Fld(1, 0) //[0:0]
    #define PST_TRIGGER1_R_DDR_PST_REQ                         Fld(1, 4) //[4:4]
    #define PST_TRIGGER1_R_DDR_PST_ABORT_REQ                   Fld(1, 5) //[5:5]

#define DDRPHY_MD32_REG_SW_RESERVE_0                           (DDRPHY_MD32_BASE_ADDRESS + 0x47300)
    #define SW_RESERVE_0_R_SW_RSV_0                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_1                           (DDRPHY_MD32_BASE_ADDRESS + 0x47304)
    #define SW_RESERVE_1_R_SW_RSV_1                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_2                           (DDRPHY_MD32_BASE_ADDRESS + 0x47308)
    #define SW_RESERVE_2_R_SW_RSV_2                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_3                           (DDRPHY_MD32_BASE_ADDRESS + 0x4730C)
    #define SW_RESERVE_3_R_SW_RSV_3                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_4                           (DDRPHY_MD32_BASE_ADDRESS + 0x47310)
    #define SW_RESERVE_4_R_SW_RSV_4                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_5                           (DDRPHY_MD32_BASE_ADDRESS + 0x47314)
    #define SW_RESERVE_5_R_SW_RSV_5                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_6                           (DDRPHY_MD32_BASE_ADDRESS + 0x47318)
    #define SW_RESERVE_6_R_SW_RSV_6                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_7                           (DDRPHY_MD32_BASE_ADDRESS + 0x4731C)
    #define SW_RESERVE_7_R_SW_RSV_7                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_8                           (DDRPHY_MD32_BASE_ADDRESS + 0x47320)
    #define SW_RESERVE_8_R_SW_RSV_8                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_9                           (DDRPHY_MD32_BASE_ADDRESS + 0x47324)
    #define SW_RESERVE_9_R_SW_RSV_9                            Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_10                          (DDRPHY_MD32_BASE_ADDRESS + 0x47328)
    #define SW_RESERVE_10_R_SW_RSV_10                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_11                          (DDRPHY_MD32_BASE_ADDRESS + 0x4732C)
    #define SW_RESERVE_11_R_SW_RSV_11                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_12                          (DDRPHY_MD32_BASE_ADDRESS + 0x47330)
    #define SW_RESERVE_12_R_SW_RSV_12                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_13                          (DDRPHY_MD32_BASE_ADDRESS + 0x47334)
    #define SW_RESERVE_13_R_SW_RSV_13                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_14                          (DDRPHY_MD32_BASE_ADDRESS + 0x47338)
    #define SW_RESERVE_14_R_SW_RSV_14                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_SW_RESERVE_15                          (DDRPHY_MD32_BASE_ADDRESS + 0x4733C)
    #define SW_RESERVE_15_R_SW_RSV_15                          Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DBG_LATCH0                        (DDRPHY_MD32_BASE_ADDRESS + 0x47380)
    #define LPIF_DBG_LATCH0_LPIF_DDR_PST                       Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DBG_LATCH1                        (DDRPHY_MD32_BASE_ADDRESS + 0x47384)
    #define LPIF_DBG_LATCH1_CUR_LPIF_DDR_PST_STA               Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DBG_LATCH2                        (DDRPHY_MD32_BASE_ADDRESS + 0x47388)
    #define LPIF_DBG_LATCH2_EMI_CLK_OFF_REQ_ACK                Fld(2, 0) //[1:0]
    #define LPIF_DBG_LATCH2_DPY_FASTK_RQQDS_ACK                Fld(2, 2) //[3:2]
    #define LPIF_DBG_LATCH2_DRAMC_DFS_STA                      Fld(4, 4) //[7:4]
    #define LPIF_DBG_LATCH2_DPY_SHU_SRAM_LP_RESTORE_ACK        Fld(2, 8) //[9:8]
    #define LPIF_DBG_LATCH2_DPY_SHU_SRAM_LP_LOAD_ACK           Fld(2, 10) //[11:10]
    ...
    #define LPIF_DBG_LATCH2_DR_GATE_RETRY_ACK                  Fld(2, 24) //[25:24]
    #define LPIF_DBG_LATCH2_DPY_FASTK_RDDQS_MPC_ACK            Fld(2, 26) //[27:26]
    #define LPIF_DBG_LATCH2_DDR_PST_ACK                        Fld(1, 28) //[28:28]
    #define LPIF_DBG_LATCH2_DDR_PST_ABORT_ACK                  Fld(1, 29) //[29:29]
    #define LPIF_DBG_LATCH2_DDR_PST_REQ                        Fld(1, 30) //[30:30]
    #define LPIF_DBG_LATCH2_DDR_PST_ABORT_REQ                  Fld(1, 31) //[31:31]

#define DDRPHY_MD32_REG_LPIF_DBG_LATCH3                        (DDRPHY_MD32_BASE_ADDRESS + 0x4738C)
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH4                        (DDRPHY_MD32_BASE_ADDRESS + 0x47390)
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH5                        (DDRPHY_MD32_BASE_ADDRESS + 0x47394)
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH6                        (DDRPHY_MD32_BASE_ADDRESS + 0x47398)
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH7                        (DDRPHY_MD32_BASE_ADDRESS + 0x4739C)
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH8                        (DDRPHY_MD32_BASE_ADDRESS + 0x473A0)
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH9                        (DDRPHY_MD32_BASE_ADDRESS + 0x473A4)
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH10                       (DDRPHY_MD32_BASE_ADDRESS + 0x473A8)
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH11                       (DDRPHY_MD32_BASE_ADDRESS + 0x473AC)
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH12                       (DDRPHY_MD32_BASE_ADDRESS + 0x473B0)
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH13                       (DDRPHY_MD32_BASE_ADDRESS + 0x473B4)
    #define LPIF_DBG_LATCH13_DRAMC_LPIF_COM                    Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DBG_LATCH14                       (DDRPHY_MD32_BASE_ADDRESS + 0x473B8)
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH15                       (DDRPHY_MD32_BASE_ADDRESS + 0x473BC)
    ...
    #define LPIF_DBG_LATCH15_HW_S1_REQ_AND_FORCE_EXIT          Fld(1, 7) //[7:7]
    ...
    #define LPIF_DBG_LATCH15_HW_S1_FSM_DIS_DCM                 Fld(1, 23) //[23:23]
    #define LPIF_DBG_LATCH15_RISING_HW_S1_REQ_LATCH            Fld(1, 24) //[24:24]
    #define LPIF_DBG_LATCH15_FALLING_HW_S1_REQ_LATCH           Fld(1, 25) //[25:25]
    #define LPIF_DBG_LATCH15_HW_S1_FSM                         Fld(6, 26) //[31:26]

#define DDRPHY_MD32_REG_LPIF_DBG_LATCH16                       (DDRPHY_MD32_BASE_ADDRESS + 0x473C0)
    #define LPIF_DBG_LATCH16_HW_S1_PST_CHK_RESULT              Fld(32, 0) //[31:0]

#define DDRPHY_MD32_REG_LPIF_DBG_LATCH17                       (DDRPHY_MD32_BASE_ADDRESS + 0x473C4)
...
#define DDRPHY_MD32_REG_LPIF_DBG_LATCH18                       (DDRPHY_MD32_BASE_ADDRESS + 0x473C8)
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_ROOT_1ST_CK_SEL_EN  Fld(2, 0) //[1:0]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_ROOT_2ND_CK_SEL_EN  Fld(2, 2) //[3:2]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_ROOT_CK_SEL         Fld(4, 4) //[7:4]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_ROOT_CK_UPDATE      Fld(2, 8) //[9:8]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_SUB_DCM_FREERUN     Fld(2, 10) //[11:10]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_ALL_TRACKING_OFF    Fld(2, 12) //[13:12]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_SHU_SRAM_LP_RESTORE Fld(2, 14) //[15:14]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_SHU_SRAM_LP_LOAD    Fld(2, 16) //[17:16]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_SHU_DRAM_DMA_STOP   Fld(2, 18) //[19:18]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_SHU_SRAM_DMA_HIGH_PRIORITY Fld(2, 20) //[21:20]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_BLOCK_CTO_ALE       Fld(2, 22) //[23:22]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_PLL_RESETB          Fld(2, 24) //[25:24]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DR_GATE_RETRY_RK        Fld(2, 26) //[27:26]
    #define LPIF_DBG_LATCH18_DRAMC_DPM_DPY_DVFSNOQUEFLUSH_DIS  Fld(2, 28) //[29:28]
    #define LPIF_DBG_LATCH18_LPIF_DFD_DEBUG_ISO_EN             Fld(1, 30) //[30:30]
    #define LPIF_DBG_LATCH18_DPM_DRAMC_CKGEN_MCK_CG_EN         Fld(1, 31) //[31:31]

#define DDRPHY_MD32_REG_LPIF_DBG_LATCH19                       (DDRPHY_MD32_BASE_ADDRESS + 0x473CC)
    #define LPIF_DBG_LATCH19_EMI_SLEEP_IDLE                    Fld(1, 0) //[0:0]
    #define LPIF_DBG_LATCH19_EMI_SLEEP_PROT_EN                 Fld(1, 1) //[1:1]
    #define LPIF_DBG_LATCH19_DDR_PST_ABORT_REQ_LATCH           Fld(1, 2) //[2:2]
    #define LPIF_DBG_LATCH19_LPC_INTERNAL_COUNTER_ABORT_FLAG   Fld(1, 3) //[3:3]
    #define LPIF_DBG_LATCH19_SC_RESERVED_IN_PORT_FROM_DRAMC    Fld(8, 4) //[11:4]

#define DDRPHY_MD32_REG_LPIF_DBG_LATCH20                       (DDRPHY_MD32_BASE_ADDRESS + 0x473D0)
    #define LPIF_DBG_LATCH20_SC_DPY_SHU_SRAM_LP_LOAD_SHU_PLL_ACK Fld(2, 0) //[1:0]
    #define LPIF_DBG_LATCH20_SC_DPY_SHU_SRAM_LP_LOAD_SHU_ACK   Fld(2, 2) //[3:2]
    #define LPIF_DBG_LATCH20_SC_DPY_SHU_SRAM_LP_LOAD_PHY_ACK   Fld(2, 4) //[5:4]
    #define LPIF_DBG_LATCH20_SC_DPY_SHU_SRAM_LP_LOAD_EMI_ACK   Fld(2, 6) //[7:6]
    #define LPIF_DBG_LATCH20_SC_DPY_SHU_SRAM_LP_LOAD_PHY_NAO_ACK Fld(2, 8) //[9:8]
    #define LPIF_DBG_LATCH20_SC_DPY_SHU_SRAM_LP_LOAD_DRAMC_ACK Fld(2, 10) //[11:10]
    #define LPIF_DBG_LATCH20_SC_TX_TRACKING_RETRY_MPC_ACK      Fld(2, 12) //[13:12]
    #define LPIF_DBG_LATCH20_SC_TX_TRACKING_RETRY_ACK          Fld(2, 14) //[15:14]
    #define LPIF_DBG_LATCH20_SC_DRAMOBF_GENKEY_ACK             Fld(2, 16) //[17:16]
    #define LPIF_DBG_LATCH20_DPM_DRAMC_DPY_FSPOP_INDEX         Fld(2, 18) //[19:18]
    #define LPIF_DBG_LATCH20_RESERVED_X310_31_20               Fld(12, 20) //[31:20]
