...
#define DDRPHY_MD32_REG_LPIF_STATUS_18                                          Rinfo(0, 0, 0, 0, RT_DDRPHY_MD32, 0x470EC)
    #define LPIF_STATUS_18_DRAMC_LPIF_COM_HOR                                   Fld(0, 0, 0, 16, 0) //[15:0] //correct the RG location
    #define LPIF_STATUS_18_DRAMC_LPIF_COM_VER                                   Fld(0, 0, 0, 16, 16) //[31:16] //correct the RG location

#define DDRPHY_MD32_REG_LPIF_STATUS_19                                          Rinfo(0, 0, 0, 0, RT_DDRPHY_MD32, 0x470F0)
    #define LPIF_STATUS_19_DRAMC_LPIF_STA_HOR                                   Fld(0, 0, 0, 16, 0) //[15:0] //correct the RG location
    #define LPIF_STATUS_19_DRAMC_LPIF_STA_VER                                   Fld(0, 0, 0, 16, 16) //[31:16] //correct the RG location
