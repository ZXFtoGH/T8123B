...
#define MSDC0_GPIO_PUPD0_ADDR    (MSDC0_IO_PAD_BASE + 0x80)
#define MSDC0_GPIO_R0_ADDR       (MSDC0_IO_PAD_BASE + 0xA0)
#define MSDC0_GPIO_R1_ADDR       (MSDC0_IO_PAD_BASE + 0xB0)
#define MSDC0_GPIO_RDSEL0_ADDR   (MSDC0_IO_PAD_BASE + 0xC0)
#define MSDC0_GPIO_RDSEL0_ADDR_1 (MSDC0_IO_PAD_BASE + 0xD0)
#define MSDC0_GPIO_SMT_ADDR      (MSDC0_IO_PAD_BASE + 0xF0)
#define MSDC0_GPIO_TDSEL0_ADDR   (MSDC0_IO_PAD_BASE + 0x100)
...
/*jyj  Reduce the original clock frequency*/
