...
#define DRAMC_REG_SWDVFSMRW_STATUS                             (DRAMC_NAO_BASE_ADDRESS + 0x0010)
    #define SWDVFSMRW_STATUS_SWDVFSMRW_RESPONSE                Fld(1, 0) //[0:0]
    #define SWDVFSMRW_STATUS_SWDVFSMRW_MASTER_CURR_STATE       Fld(2, 1) //[2:1]
    #define SWDVFSMRW_STATUS_SWDVFSMRW_REMAINING_CNT           Fld(6, 3) //[8:3]
...
#define DRAMC_REG_RTSWCMD_STATUS0                              (DRAMC_NAO_BASE_ADDRESS + 0x001C)
    #define RTSWCMD_STATUS0_RTSWCMD_REQ_CNT                    Fld(3, 0) //[2:0]
    #define RTSWCMD_STATUS0_RTSWCMD_ACK_CNT                    Fld(3, 3) //[5:3]
    #define RTSWCMD_STATUS0_RTSWCMD_POP_CNT                    Fld(3, 6) //[8:6]
    #define RTSWCMD_STATUS0_RTSWCMD_DLE_CNT                    Fld(3, 9) //[11:9]
    #define RTSWCMD_STATUS0_RTSWCMD_ARB_CURR_STATE             Fld(5, 16) //[20:16]

#define DRAMC_REG_RTSWCMD_STATUS1                              (DRAMC_NAO_BASE_ADDRESS + 0x0020)
    #define RTSWCMD_STATUS1_RTSWCMD0_MRR_RESULT                Fld(16, 0) //[15:0]
    #define RTSWCMD_STATUS1_RTSWCMD1_MRR_RESULT                Fld(16, 16) //[31:16]
...
#define DRAMC_REG_TMBSIST_PREFUSE_STATUS0                      (DRAMC_NAO_BASE_ADDRESS + 0x0028)
    #define TMBSIST_PREFUSE_STATUS0_DRAMC_MBIST_PREFUSE_7      Fld(16, 0) //[15:0]
...
#define DRAMC_REG_RTSWCMD_STATUS2                              (DRAMC_NAO_BASE_ADDRESS + 0x00A8)
    #define RTSWCMD_STATUS2_RTSWCMD2_MRR_RESULT                Fld(16, 0) //[15:0]
    #define RTSWCMD_STATUS2_RTSWCMD3_MRR_RESULT                Fld(16, 16) //[31:16]

#define DRAMC_REG_RTSWCMD_STATUS3                              (DRAMC_NAO_BASE_ADDRESS + 0x00AC)
    #define RTSWCMD_STATUS3_RTSWCMD4_MRR_RESULT                Fld(16, 0) //[15:0]
    #define RTSWCMD_STATUS3_RTSWCMD5_MRR_RESULT                Fld(16, 16) //[31:16]
...
#define DRAMC_REG_CBT_WLEV_STATUS                              (DRAMC_NAO_BASE_ADDRESS + 0x00C8)
    ...
    #define CBT_WLEV_STATUS_CBT_WLEV_ATK_CNT                   Fld(8, 19) //[26:19]
    #define CBT_WLEV_STATUS_CBT_WLEV_ATK_RESPONSE              Fld(1, 27) //[27:27]
    #define CBT_WLEV_STATUS_WLEV_DQ_BYTE0_NO_ALL0_ALL1_FLAG    Fld(1, 28) //[28:28]
    #define CBT_WLEV_STATUS_WLEV_DQ_BYTE1_NO_ALL0_ALL1_FLAG    Fld(1, 29) //[29:29]
    #define CBT_WLEV_STATUS_CBT_WLEV_ATK_EB_FLAG               Fld(1, 30) //[30:30]
...
#define DRAMC_REG_POWER_THROTTLING_STATUS1                     (DRAMC_NAO_BASE_ADDRESS + 0x0424)
    #define POWER_THROTTLING_STATUS1_POWER_THROTTLING_EN_COUNTER Fld(32, 0) //[31:0]

#define DRAMC_REG_POWER_THROTTLING_STATUS2                     (DRAMC_NAO_BASE_ADDRESS + 0x0428)
    #define POWER_THROTTLING_STATUS2_PWRURGENT_STALL_COUNTER   Fld(32, 0) //[31:0]

#define DRAMC_REG_POWER_THROTTLING_STATUS3                     (DRAMC_NAO_BASE_ADDRESS + 0x042C)
    #define POWER_THROTTLING_STATUS3_PWRURGENT_BY_IMAX_COUNTER Fld(32, 0) //[31:0]

#define DRAMC_REG_POWER_THROTTLING_STATUS4                     (DRAMC_NAO_BASE_ADDRESS + 0x0430)
    #define POWER_THROTTLING_STATUS4_PWRURGENT_BY_ISTEP_COUNTER Fld(32, 0) //[31:0]

#define DRAMC_REG_POWER_THROTTLING_STATUS5                     (DRAMC_NAO_BASE_ADDRESS + 0x0434)
    #define POWER_THROTTLING_STATUS5_PWRURGENT_BY_ISLEW_COUNTER Fld(32, 0) //[31:0]

#define DRAMC_REG_POWER_THROTTLING_STATUS6                     (DRAMC_NAO_BASE_ADDRESS + 0x0438)
    #define POWER_THROTTLING_STATUS6_MAX_ACC_POWER_SUM         Fld(32, 0) //[31:0]

#define DRAMC_REG_POWER_THROTTLING_STATUS7                     (DRAMC_NAO_BASE_ADDRESS + 0x043C)
    #define POWER_THROTTLING_STATUS7_PRESENT_BUDGET_WITH_MAX_ACC_POWER_SUM Fld(32, 0) //[31:0]

#define DRAMC_REG_POWER_THROTTLING_STATUS8                     (DRAMC_NAO_BASE_ADDRESS + 0x0440)
    #define POWER_THROTTLING_STATUS8_STB_WITH_MAX_ACC_POWER_SUM Fld(32, 0) //[31:0]
...
#define DRAMC_REG_CMDELA_TRIG_RD_SRAM_RDATA0                   (DRAMC_NAO_BASE_ADDRESS + 0x0550)
    #define CMDELA_TRIG_RD_SRAM_RDATA0_CMDELA_TRIG_RD_SRAM_RDATA0 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_TRIG_RD_SRAM_RDATA1                   (DRAMC_NAO_BASE_ADDRESS + 0x0554)
    #define CMDELA_TRIG_RD_SRAM_RDATA1_CMDELA_TRIG_RD_SRAM_RDATA1 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_TRIG_RD_SRAM_RDATA2                   (DRAMC_NAO_BASE_ADDRESS + 0x0558)
    #define CMDELA_TRIG_RD_SRAM_RDATA2_CMDELA_TRIG_RD_SRAM_RDATA2 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_TRIG_RD_SRAM_RDATA3                   (DRAMC_NAO_BASE_ADDRESS + 0x055C)
    #define CMDELA_TRIG_RD_SRAM_RDATA3_CMDELA_TRIG_RD_SRAM_RDATA3 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_TRIG_RD_SRAM_RDATA4                   (DRAMC_NAO_BASE_ADDRESS + 0x0560)
    #define CMDELA_TRIG_RD_SRAM_RDATA4_CMDELA_TRIG_RD_SRAM_RDATA4 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_TRIG_RD_SRAM_RDATA5                   (DRAMC_NAO_BASE_ADDRESS + 0x0564)
    #define CMDELA_TRIG_RD_SRAM_RDATA5_CMDELA_TRIG_RD_SRAM_RDATA5 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_TRIG_RD_SRAM_RDATA6                   (DRAMC_NAO_BASE_ADDRESS + 0x0568)
    #define CMDELA_TRIG_RD_SRAM_RDATA6_CMDELA_TRIG_RD_SRAM_RDATA6 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_TRIG_RD_SRAM_RDATA7                   (DRAMC_NAO_BASE_ADDRESS + 0x056C)
    #define CMDELA_TRIG_RD_SRAM_RDATA7_CMDELA_TRIG_RD_SRAM_RDATA7 Fld(32, 0) //[31:0]
...
#define DRAMC_REG_RK0_DMYWR_RECORD0                            (DRAMC_NAO_BASE_ADDRESS + 0x068C)
    #define RK0_DMYWR_RECORD0_RK0_B0_TX_OFFSET_RIGHT           Fld(6, 0) //[5:0]
    #define RK0_DMYWR_RECORD0_RK0_B0_TX_OFFSET_LEFT            Fld(6, 8) //[13:8]
    #define RK0_DMYWR_RECORD0_RK0_B1_TX_OFFSET_RIGHT           Fld(6, 16) //[21:16]
    #define RK0_DMYWR_RECORD0_RK0_B1_TX_OFFSET_LEFT            Fld(6, 24) //[29:24]

#define DRAMC_REG_RK0_DMYWR_RECORD1_L                          (DRAMC_NAO_BASE_ADDRESS + 0x0690)
    #define RK0_DMYWR_RECORD1_L_RK0_DMY_TEST_CMP_LEFT_RECORD_L Fld(32, 0) //[31:0]

#define DRAMC_REG_RK0_DMYWR_RECORD1_H                          (DRAMC_NAO_BASE_ADDRESS + 0x0694)
    #define RK0_DMYWR_RECORD1_H_RK0_DMY_TEST_CMP_LEFT_RECORD_H Fld(32, 0) //[31:0]

#define DRAMC_REG_RK0_DMYWR_RECORD2_L                          (DRAMC_NAO_BASE_ADDRESS + 0x0698)
    #define RK0_DMYWR_RECORD2_L_RK0_DMY_TEST_CMP_RIGHT_RECORD_L Fld(32, 0) //[31:0]

#define DRAMC_REG_RK0_DMYWR_RECORD2_H                          (DRAMC_NAO_BASE_ADDRESS + 0x069C)
    #define RK0_DMYWR_RECORD2_H_RK0_DMY_TEST_CMP_RIGHT_RECORD_H Fld(32, 0) //[31:0]
...
#define DRAMC_REG_RK1_DMYWR_RECORD0                            (DRAMC_NAO_BASE_ADDRESS + 0x078C)
    #define RK1_DMYWR_RECORD0_RK1_B0_TX_OFFSET_RIGHT           Fld(6, 0) //[5:0]
    #define RK1_DMYWR_RECORD0_RK1_B0_TX_OFFSET_LEFT            Fld(6, 8) //[13:8]
    #define RK1_DMYWR_RECORD0_RK1_B1_TX_OFFSET_RIGHT           Fld(6, 16) //[21:16]
    #define RK1_DMYWR_RECORD0_RK1_B1_TX_OFFSET_LEFT            Fld(6, 24) //[29:24]

#define DRAMC_REG_RK1_DMYWR_RECORD1_L                          (DRAMC_NAO_BASE_ADDRESS + 0x0790)
    #define RK1_DMYWR_RECORD1_L_RK1_DMY_TEST_CMP_LEFT_RECORD_L Fld(32, 0) //[31:0]

#define DRAMC_REG_RK1_DMYWR_RECORD1_H                          (DRAMC_NAO_BASE_ADDRESS + 0x0794)
    #define RK1_DMYWR_RECORD1_H_RK1_DMY_TEST_CMP_LEFT_RECORD_H Fld(32, 0) //[31:0]

#define DRAMC_REG_RK1_DMYWR_RECORD2_L                          (DRAMC_NAO_BASE_ADDRESS + 0x0798)
    #define RK1_DMYWR_RECORD2_L_RK1_DMY_TEST_CMP_RIGHT_RECORD_L Fld(32, 0) //[31:0]

#define DRAMC_REG_RK1_DMYWR_RECORD2_H                          (DRAMC_NAO_BASE_ADDRESS + 0x079C)
    #define RK1_DMYWR_RECORD2_H_RK1_DMY_TEST_CMP_RIGHT_RECORD_H Fld(32, 0) //[31:0]
...
#define DRAMC_REG_CBT_WLEV_ATK2_RESULT4                        (DRAMC_NAO_BASE_ADDRESS + 0x0810)
    ...
    #define CBT_WLEV_ATK2_RESULT4_CBT_WLEV_ATK_FIND_PASS_BIT7  Fld(1, 7) //[7:7]
    #define CBT_WLEV_ATK2_RESULT4_CBT_WLEV_ATK_FIND_PASS_BIT8  Fld(1, 8) //[8:8]
    #define CBT_WLEV_ATK2_RESULT4_CBT_WLEV_ATK_FIND_PASS_BIT9  Fld(1, 9) //[9:9]
    #define CBT_WLEV_ATK2_RESULT4_CBT_WLEV_ATK_FIND_PASS_BIT10 Fld(1, 10) //[10:10]
    #define CBT_WLEV_ATK2_RESULT4_CBT_WLEV_ATK_FIND_PASS_BIT11 Fld(1, 11) //[11:11]
    #define CBT_WLEV_ATK2_RESULT4_CBT_WLEV_ATK_FIND_PASS_BIT12 Fld(1, 12) //[12:12]
    #define CBT_WLEV_ATK2_RESULT4_CBT_WLEV_ATK_FIND_PASS_BIT13 Fld(1, 13) //[13:13]

#define DRAMC_REG_CBT_WLEV_ATK2_RESULT5                        (DRAMC_NAO_BASE_ADDRESS + 0x0814)
    #define CBT_WLEV_ATK2_RESULT5_CBT_WLEV_ATK_MAX_PW_LEN_BIT7 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK2_RESULT5_CBT_WLEV_ATK_MAX_PW_LEN_BIT8 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK2_RESULT5_CBT_WLEV_ATK_MAX_PW_LEN_BIT9 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK2_RESULT5_CBT_WLEV_ATK_MAX_PW_LEN_BIT10 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK2_RESULT6                        (DRAMC_NAO_BASE_ADDRESS + 0x0818)
    #define CBT_WLEV_ATK2_RESULT6_CBT_WLEV_ATK_MAX_PW_LEN_BIT11 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK2_RESULT6_CBT_WLEV_ATK_MAX_PW_LEN_BIT12 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK2_RESULT6_CBT_WLEV_ATK_MAX_PW_LEN_BIT13 Fld(8, 16) //[23:16]

#define DRAMC_REG_CBT_WLEV_ATK2_RESULT7                        (DRAMC_NAO_BASE_ADDRESS + 0x081C)
    #define CBT_WLEV_ATK2_RESULT7_CBT_WLEV_ATK_MAX_PW_INIT_BIT7 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK2_RESULT7_CBT_WLEV_ATK_MAX_PW_INIT_BIT8 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK2_RESULT7_CBT_WLEV_ATK_MAX_PW_INIT_BIT9 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK2_RESULT7_CBT_WLEV_ATK_MAX_PW_INIT_BIT10 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK2_RESULT8                        (DRAMC_NAO_BASE_ADDRESS + 0x0820)
    #define CBT_WLEV_ATK2_RESULT8_CBT_WLEV_ATK_MAX_PW_INIT_BIT11 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK2_RESULT8_CBT_WLEV_ATK_MAX_PW_INIT_BIT12 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK2_RESULT8_CBT_WLEV_ATK_MAX_PW_INIT_BIT13 Fld(8, 16) //[23:16]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_RESULT0                     (DRAMC_NAO_BASE_ADDRESS + 0x0824)
    #define CBT_WLEV_ATK_6PW_RESULT0_CBT_WLEV_ATK_FIND_PW_CNT_BIT0 Fld(4, 0) //[3:0]
    #define CBT_WLEV_ATK_6PW_RESULT0_CBT_WLEV_ATK_FIND_PW_CNT_BIT1 Fld(4, 4) //[7:4]
    #define CBT_WLEV_ATK_6PW_RESULT0_CBT_WLEV_ATK_FIND_PW_CNT_BIT2 Fld(4, 8) //[11:8]
    #define CBT_WLEV_ATK_6PW_RESULT0_CBT_WLEV_ATK_FIND_PW_CNT_BIT3 Fld(4, 12) //[15:12]
    #define CBT_WLEV_ATK_6PW_RESULT0_CBT_WLEV_ATK_FIND_PW_CNT_BIT4 Fld(4, 16) //[19:16]
    #define CBT_WLEV_ATK_6PW_RESULT0_CBT_WLEV_ATK_FIND_PW_CNT_BIT5 Fld(4, 20) //[23:20]
    #define CBT_WLEV_ATK_6PW_RESULT0_CBT_WLEV_ATK_FIND_PW_CNT_BIT6 Fld(4, 24) //[27:24]
    #define CBT_WLEV_ATK_6PW_RESULT0_CBT_WLEV_ATK_FIND_PW_CNT_BIT7 Fld(4, 28) //[31:28]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_RESULT1                     (DRAMC_NAO_BASE_ADDRESS + 0x0828)
    #define CBT_WLEV_ATK_6PW_RESULT1_CBT_WLEV_ATK_FIND_PW_CNT_BIT8 Fld(4, 0) //[3:0]
    #define CBT_WLEV_ATK_6PW_RESULT1_CBT_WLEV_ATK_FIND_PW_CNT_BIT9 Fld(4, 4) //[7:4]
    #define CBT_WLEV_ATK_6PW_RESULT1_CBT_WLEV_ATK_FIND_PW_CNT_BIT10 Fld(4, 8) //[11:8]
    #define CBT_WLEV_ATK_6PW_RESULT1_CBT_WLEV_ATK_FIND_PW_CNT_BIT11 Fld(4, 12) //[15:12]
    #define CBT_WLEV_ATK_6PW_RESULT1_CBT_WLEV_ATK_FIND_PW_CNT_BIT12 Fld(4, 16) //[19:16]
    #define CBT_WLEV_ATK_6PW_RESULT1_CBT_WLEV_ATK_FIND_PW_CNT_BIT13 Fld(4, 20) //[23:20]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW1_RESULT0                 (DRAMC_NAO_BASE_ADDRESS + 0x082C)
    #define CBT_WLEV_ATK_6PW_PW1_RESULT0_CBT_WLEV_ATK_PW1_LEN_BIT0 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT0_CBT_WLEV_ATK_PW1_LEN_BIT1 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT0_CBT_WLEV_ATK_PW1_LEN_BIT2 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT0_CBT_WLEV_ATK_PW1_LEN_BIT3 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW1_RESULT1                 (DRAMC_NAO_BASE_ADDRESS + 0x0830)
    #define CBT_WLEV_ATK_6PW_PW1_RESULT1_CBT_WLEV_ATK_PW1_LEN_BIT4 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT1_CBT_WLEV_ATK_PW1_LEN_BIT5 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT1_CBT_WLEV_ATK_PW1_LEN_BIT6 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT1_CBT_WLEV_ATK_PW1_LEN_BIT7 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW1_RESULT2                 (DRAMC_NAO_BASE_ADDRESS + 0x0834)
    #define CBT_WLEV_ATK_6PW_PW1_RESULT2_CBT_WLEV_ATK_PW1_LEN_BIT8 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT2_CBT_WLEV_ATK_PW1_LEN_BIT9 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT2_CBT_WLEV_ATK_PW1_LEN_BIT10 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT2_CBT_WLEV_ATK_PW1_LEN_BIT11 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW1_RESULT3                 (DRAMC_NAO_BASE_ADDRESS + 0x0838)
    #define CBT_WLEV_ATK_6PW_PW1_RESULT3_CBT_WLEV_ATK_PW1_LEN_BIT12 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT3_CBT_WLEV_ATK_PW1_LEN_BIT13 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW1_RESULT4                 (DRAMC_NAO_BASE_ADDRESS + 0x083C)
    #define CBT_WLEV_ATK_6PW_PW1_RESULT4_CBT_WLEV_ATK_PW1_INIT_BIT0 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT4_CBT_WLEV_ATK_PW1_INIT_BIT1 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT4_CBT_WLEV_ATK_PW1_INIT_BIT2 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT4_CBT_WLEV_ATK_PW1_INIT_BIT3 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW1_RESULT5                 (DRAMC_NAO_BASE_ADDRESS + 0x0840)
    #define CBT_WLEV_ATK_6PW_PW1_RESULT5_CBT_WLEV_ATK_PW1_INIT_BIT4 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT5_CBT_WLEV_ATK_PW1_INIT_BIT5 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT5_CBT_WLEV_ATK_PW1_INIT_BIT6 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT5_CBT_WLEV_ATK_PW1_INIT_BIT7 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW1_RESULT6                 (DRAMC_NAO_BASE_ADDRESS + 0x0844)
    #define CBT_WLEV_ATK_6PW_PW1_RESULT6_CBT_WLEV_ATK_PW1_INIT_BIT8 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT6_CBT_WLEV_ATK_PW1_INIT_BIT9 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT6_CBT_WLEV_ATK_PW1_INIT_BIT10 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT6_CBT_WLEV_ATK_PW1_INIT_BIT11 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW1_RESULT7                 (DRAMC_NAO_BASE_ADDRESS + 0x0848)
    #define CBT_WLEV_ATK_6PW_PW1_RESULT7_CBT_WLEV_ATK_PW1_INIT_BIT12 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW1_RESULT7_CBT_WLEV_ATK_PW1_INIT_BIT13 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW2_RESULT0                 (DRAMC_NAO_BASE_ADDRESS + 0x084C)
    #define CBT_WLEV_ATK_6PW_PW2_RESULT0_CBT_WLEV_ATK_PW2_LEN_BIT0 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT0_CBT_WLEV_ATK_PW2_LEN_BIT1 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT0_CBT_WLEV_ATK_PW2_LEN_BIT2 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT0_CBT_WLEV_ATK_PW2_LEN_BIT3 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW2_RESULT1                 (DRAMC_NAO_BASE_ADDRESS + 0x0850)
    #define CBT_WLEV_ATK_6PW_PW2_RESULT1_CBT_WLEV_ATK_PW2_LEN_BIT4 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT1_CBT_WLEV_ATK_PW2_LEN_BIT5 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT1_CBT_WLEV_ATK_PW2_LEN_BIT6 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT1_CBT_WLEV_ATK_PW2_LEN_BIT7 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW2_RESULT2                 (DRAMC_NAO_BASE_ADDRESS + 0x0854)
    #define CBT_WLEV_ATK_6PW_PW2_RESULT2_CBT_WLEV_ATK_PW2_LEN_BIT8 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT2_CBT_WLEV_ATK_PW2_LEN_BIT9 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT2_CBT_WLEV_ATK_PW2_LEN_BIT10 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT2_CBT_WLEV_ATK_PW2_LEN_BIT11 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW2_RESULT3                 (DRAMC_NAO_BASE_ADDRESS + 0x0858)
    #define CBT_WLEV_ATK_6PW_PW2_RESULT3_CBT_WLEV_ATK_PW2_LEN_BIT12 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT3_CBT_WLEV_ATK_PW2_LEN_BIT13 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW2_RESULT4                 (DRAMC_NAO_BASE_ADDRESS + 0x085C)
    #define CBT_WLEV_ATK_6PW_PW2_RESULT4_CBT_WLEV_ATK_PW2_INIT_BIT0 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT4_CBT_WLEV_ATK_PW2_INIT_BIT1 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT4_CBT_WLEV_ATK_PW2_INIT_BIT2 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT4_CBT_WLEV_ATK_PW2_INIT_BIT3 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW2_RESULT5                 (DRAMC_NAO_BASE_ADDRESS + 0x0860)
    #define CBT_WLEV_ATK_6PW_PW2_RESULT5_CBT_WLEV_ATK_PW2_INIT_BIT4 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT5_CBT_WLEV_ATK_PW2_INIT_BIT5 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT5_CBT_WLEV_ATK_PW2_INIT_BIT6 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT5_CBT_WLEV_ATK_PW2_INIT_BIT7 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW2_RESULT6                 (DRAMC_NAO_BASE_ADDRESS + 0x0864)
    #define CBT_WLEV_ATK_6PW_PW2_RESULT6_CBT_WLEV_ATK_PW2_INIT_BIT8 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT6_CBT_WLEV_ATK_PW2_INIT_BIT9 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT6_CBT_WLEV_ATK_PW2_INIT_BIT10 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT6_CBT_WLEV_ATK_PW2_INIT_BIT11 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW2_RESULT7                 (DRAMC_NAO_BASE_ADDRESS + 0x0868)
    #define CBT_WLEV_ATK_6PW_PW2_RESULT7_CBT_WLEV_ATK_PW2_INIT_BIT12 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW2_RESULT7_CBT_WLEV_ATK_PW2_INIT_BIT13 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW3_RESULT0                 (DRAMC_NAO_BASE_ADDRESS + 0x086C)
    #define CBT_WLEV_ATK_6PW_PW3_RESULT0_CBT_WLEV_ATK_PW3_LEN_BIT0 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT0_CBT_WLEV_ATK_PW3_LEN_BIT1 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT0_CBT_WLEV_ATK_PW3_LEN_BIT2 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT0_CBT_WLEV_ATK_PW3_LEN_BIT3 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW3_RESULT1                 (DRAMC_NAO_BASE_ADDRESS + 0x0870)
    #define CBT_WLEV_ATK_6PW_PW3_RESULT1_CBT_WLEV_ATK_PW3_LEN_BIT4 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT1_CBT_WLEV_ATK_PW3_LEN_BIT5 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT1_CBT_WLEV_ATK_PW3_LEN_BIT6 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT1_CBT_WLEV_ATK_PW3_LEN_BIT7 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW3_RESULT2                 (DRAMC_NAO_BASE_ADDRESS + 0x0874)
    #define CBT_WLEV_ATK_6PW_PW3_RESULT2_CBT_WLEV_ATK_PW3_LEN_BIT8 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT2_CBT_WLEV_ATK_PW3_LEN_BIT9 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT2_CBT_WLEV_ATK_PW3_LEN_BIT10 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT2_CBT_WLEV_ATK_PW3_LEN_BIT11 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW3_RESULT3                 (DRAMC_NAO_BASE_ADDRESS + 0x0878)
    #define CBT_WLEV_ATK_6PW_PW3_RESULT3_CBT_WLEV_ATK_PW3_LEN_BIT12 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT3_CBT_WLEV_ATK_PW3_LEN_BIT13 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW3_RESULT4                 (DRAMC_NAO_BASE_ADDRESS + 0x087C)
    #define CBT_WLEV_ATK_6PW_PW3_RESULT4_CBT_WLEV_ATK_PW3_INIT_BIT0 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT4_CBT_WLEV_ATK_PW3_INIT_BIT1 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT4_CBT_WLEV_ATK_PW3_INIT_BIT2 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT4_CBT_WLEV_ATK_PW3_INIT_BIT3 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW3_RESULT5                 (DRAMC_NAO_BASE_ADDRESS + 0x0880)
    #define CBT_WLEV_ATK_6PW_PW3_RESULT5_CBT_WLEV_ATK_PW3_INIT_BIT4 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT5_CBT_WLEV_ATK_PW3_INIT_BIT5 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT5_CBT_WLEV_ATK_PW3_INIT_BIT6 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT5_CBT_WLEV_ATK_PW3_INIT_BIT7 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW3_RESULT6                 (DRAMC_NAO_BASE_ADDRESS + 0x0884)
    #define CBT_WLEV_ATK_6PW_PW3_RESULT6_CBT_WLEV_ATK_PW3_INIT_BIT8 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT6_CBT_WLEV_ATK_PW3_INIT_BIT9 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT6_CBT_WLEV_ATK_PW3_INIT_BIT10 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT6_CBT_WLEV_ATK_PW3_INIT_BIT11 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW3_RESULT7                 (DRAMC_NAO_BASE_ADDRESS + 0x0888)
    #define CBT_WLEV_ATK_6PW_PW3_RESULT7_CBT_WLEV_ATK_PW3_INIT_BIT12 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW3_RESULT7_CBT_WLEV_ATK_PW3_INIT_BIT13 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW4_RESULT0                 (DRAMC_NAO_BASE_ADDRESS + 0x088C)
    #define CBT_WLEV_ATK_6PW_PW4_RESULT0_CBT_WLEV_ATK_PW4_LEN_BIT0 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT0_CBT_WLEV_ATK_PW4_LEN_BIT1 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT0_CBT_WLEV_ATK_PW4_LEN_BIT2 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT0_CBT_WLEV_ATK_PW4_LEN_BIT3 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW4_RESULT1                 (DRAMC_NAO_BASE_ADDRESS + 0x0890)
    #define CBT_WLEV_ATK_6PW_PW4_RESULT1_CBT_WLEV_ATK_PW4_LEN_BIT4 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT1_CBT_WLEV_ATK_PW4_LEN_BIT5 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT1_CBT_WLEV_ATK_PW4_LEN_BIT6 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT1_CBT_WLEV_ATK_PW4_LEN_BIT7 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW4_RESULT2                 (DRAMC_NAO_BASE_ADDRESS + 0x0894)
    #define CBT_WLEV_ATK_6PW_PW4_RESULT2_CBT_WLEV_ATK_PW4_LEN_BIT8 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT2_CBT_WLEV_ATK_PW4_LEN_BIT9 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT2_CBT_WLEV_ATK_PW4_LEN_BIT10 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT2_CBT_WLEV_ATK_PW4_LEN_BIT11 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW4_RESULT3                 (DRAMC_NAO_BASE_ADDRESS + 0x0898)
    #define CBT_WLEV_ATK_6PW_PW4_RESULT3_CBT_WLEV_ATK_PW4_LEN_BIT12 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT3_CBT_WLEV_ATK_PW4_LEN_BIT13 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW4_RESULT4                 (DRAMC_NAO_BASE_ADDRESS + 0x089C)
    #define CBT_WLEV_ATK_6PW_PW4_RESULT4_CBT_WLEV_ATK_PW4_INIT_BIT0 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT4_CBT_WLEV_ATK_PW4_INIT_BIT1 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT4_CBT_WLEV_ATK_PW4_INIT_BIT2 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT4_CBT_WLEV_ATK_PW4_INIT_BIT3 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW4_RESULT5                 (DRAMC_NAO_BASE_ADDRESS + 0x08A0)
    #define CBT_WLEV_ATK_6PW_PW4_RESULT5_CBT_WLEV_ATK_PW4_INIT_BIT4 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT5_CBT_WLEV_ATK_PW4_INIT_BIT5 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT5_CBT_WLEV_ATK_PW4_INIT_BIT6 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT5_CBT_WLEV_ATK_PW4_INIT_BIT7 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW4_RESULT6                 (DRAMC_NAO_BASE_ADDRESS + 0x08A4)
    #define CBT_WLEV_ATK_6PW_PW4_RESULT6_CBT_WLEV_ATK_PW4_INIT_BIT8 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT6_CBT_WLEV_ATK_PW4_INIT_BIT9 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT6_CBT_WLEV_ATK_PW4_INIT_BIT10 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT6_CBT_WLEV_ATK_PW4_INIT_BIT11 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW4_RESULT7                 (DRAMC_NAO_BASE_ADDRESS + 0x08A8)
    #define CBT_WLEV_ATK_6PW_PW4_RESULT7_CBT_WLEV_ATK_PW4_INIT_BIT12 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW4_RESULT7_CBT_WLEV_ATK_PW4_INIT_BIT13 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW5_RESULT0                 (DRAMC_NAO_BASE_ADDRESS + 0x08AC)
    #define CBT_WLEV_ATK_6PW_PW5_RESULT0_CBT_WLEV_ATK_PW5_LEN_BIT0 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT0_CBT_WLEV_ATK_PW5_LEN_BIT1 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT0_CBT_WLEV_ATK_PW5_LEN_BIT2 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT0_CBT_WLEV_ATK_PW5_LEN_BIT3 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW5_RESULT1                 (DRAMC_NAO_BASE_ADDRESS + 0x08B0)
    #define CBT_WLEV_ATK_6PW_PW5_RESULT1_CBT_WLEV_ATK_PW5_LEN_BIT4 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT1_CBT_WLEV_ATK_PW5_LEN_BIT5 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT1_CBT_WLEV_ATK_PW5_LEN_BIT6 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT1_CBT_WLEV_ATK_PW5_LEN_BIT7 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW5_RESULT2                 (DRAMC_NAO_BASE_ADDRESS + 0x08B4)
    #define CBT_WLEV_ATK_6PW_PW5_RESULT2_CBT_WLEV_ATK_PW5_LEN_BIT8 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT2_CBT_WLEV_ATK_PW5_LEN_BIT9 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT2_CBT_WLEV_ATK_PW5_LEN_BIT10 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT2_CBT_WLEV_ATK_PW5_LEN_BIT11 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW5_RESULT3                 (DRAMC_NAO_BASE_ADDRESS + 0x08B8)
    #define CBT_WLEV_ATK_6PW_PW5_RESULT3_CBT_WLEV_ATK_PW5_LEN_BIT12 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT3_CBT_WLEV_ATK_PW5_LEN_BIT13 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW5_RESULT4                 (DRAMC_NAO_BASE_ADDRESS + 0x08BC)
    #define CBT_WLEV_ATK_6PW_PW5_RESULT4_CBT_WLEV_ATK_PW5_INIT_BIT0 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT4_CBT_WLEV_ATK_PW5_INIT_BIT1 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT4_CBT_WLEV_ATK_PW5_INIT_BIT2 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT4_CBT_WLEV_ATK_PW5_INIT_BIT3 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW5_RESULT5                 (DRAMC_NAO_BASE_ADDRESS + 0x08C0)
    #define CBT_WLEV_ATK_6PW_PW5_RESULT5_CBT_WLEV_ATK_PW5_INIT_BIT4 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT5_CBT_WLEV_ATK_PW5_INIT_BIT5 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT5_CBT_WLEV_ATK_PW5_INIT_BIT6 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT5_CBT_WLEV_ATK_PW5_INIT_BIT7 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW5_RESULT6                 (DRAMC_NAO_BASE_ADDRESS + 0x08C4)
    #define CBT_WLEV_ATK_6PW_PW5_RESULT6_CBT_WLEV_ATK_PW5_INIT_BIT8 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT6_CBT_WLEV_ATK_PW5_INIT_BIT9 Fld(8, 8) //[15:8]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT6_CBT_WLEV_ATK_PW5_INIT_BIT10 Fld(8, 16) //[23:16]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT6_CBT_WLEV_ATK_PW5_INIT_BIT11 Fld(8, 24) //[31:24]

#define DRAMC_REG_CBT_WLEV_ATK_6PW_PW5_RESULT7                 (DRAMC_NAO_BASE_ADDRESS + 0x08C8)
    #define CBT_WLEV_ATK_6PW_PW5_RESULT7_CBT_WLEV_ATK_PW5_INIT_BIT12 Fld(8, 0) //[7:0]
    #define CBT_WLEV_ATK_6PW_PW5_RESULT7_CBT_WLEV_ATK_PW5_INIT_BIT13 Fld(8, 24) //[31:24]
...
#define DRAMC_REG_VPA_STATUS1                                  (DRAMC_NAO_BASE_ADDRESS + 0x0BF0)
    #define VPA_STATUS1_Q0_STATUS                              Fld(3, 0) //[2:0]
    #define VPA_STATUS1_Q1_STATUS                              Fld(3, 4) //[6:4]
    #define VPA_STATUS1_Q2_STATUS                              Fld(3, 8) //[10:8]
    #define VPA_STATUS1_Q3_STATUS                              Fld(3, 12) //[14:12]
    #define VPA_STATUS1_Q4_STATUS                              Fld(3, 16) //[18:16]
    #define VPA_STATUS1_Q5_STATUS                              Fld(3, 20) //[22:20]
    #define VPA_STATUS1_Q6_STATUS                              Fld(3, 24) //[26:24]
    #define VPA_STATUS1_Q7_STATUS                              Fld(3, 28) //[30:28]

#define DRAMC_REG_VPA_STATUS2                                  (DRAMC_NAO_BASE_ADDRESS + 0x0BF4)
    #define VPA_STATUS2_Q8_STATUS                              Fld(3, 0) //[2:0]
    #define VPA_STATUS2_Q9_STATUS                              Fld(3, 4) //[6:4]

#define DRAMC_REG_VPA_STATUS3                                  (DRAMC_NAO_BASE_ADDRESS + 0x0BF8)
    #define VPA_STATUS3_CMDVLD0_RBANK                          Fld(16, 0) //[15:0]
    #define VPA_STATUS3_CMDVLD1_RBANK                          Fld(16, 16) //[31:16]

#define DRAMC_REG_VPA_STATUS4                                  (DRAMC_NAO_BASE_ADDRESS + 0x0BFC)
    #define VPA_STATUS4_CMDVLD2_RBANK                          Fld(16, 0) //[15:0]
    #define VPA_STATUS4_CMDVLD3_RBANK                          Fld(16, 16) //[31:16]

#define DRAMC_REG_VPA_STATUS5                                  (DRAMC_NAO_BASE_ADDRESS + 0x0C00)
    #define VPA_STATUS5_CMDVLD4_RBANK                          Fld(16, 0) //[15:0]
    #define VPA_STATUS5_CMDVLD5_RBANK                          Fld(16, 16) //[31:16]

#define DRAMC_REG_VPA_STATUS6                                  (DRAMC_NAO_BASE_ADDRESS + 0x0C04)
    #define VPA_STATUS6_CMDVLD6_RBANK                          Fld(16, 0) //[15:0]
    #define VPA_STATUS6_CMDVLD7_RBANK                          Fld(16, 16) //[31:16]

#define DRAMC_REG_VPA_STATUS7                                  (DRAMC_NAO_BASE_ADDRESS + 0x0C08)
    #define VPA_STATUS7_CMDVLD8_RBANK                          Fld(16, 0) //[15:0]
    #define VPA_STATUS7_CMDVLD9_RBANK                          Fld(16, 16) //[31:16]

#define DRAMC_REG_VPA_STATUS8                                  (DRAMC_NAO_BASE_ADDRESS + 0x0C0C)
    #define VPA_STATUS8_REFRESH_QUE_RK0                        Fld(26, 0) //[25:0]

#define DRAMC_REG_VPA_STATUS9                                  (DRAMC_NAO_BASE_ADDRESS + 0x0C10)
    #define VPA_STATUS9_REFRESH_QUE_RK1                        Fld(26, 0) //[25:0]
