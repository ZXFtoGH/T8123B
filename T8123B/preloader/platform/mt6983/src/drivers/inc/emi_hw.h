...
#define SLC_APB_BASE                   (0x10342000)
#define SUB_SLC_APB_BASE               (0x10343000)
#define NTH_EMICFG_REG_BASE            (0x1021C000)
#define STH_EMICFG_REG_BASE            (0x1021E000)

#define CHN_EMI_BASE                   (0x10235000)
...
#define SLC_SLB_ENABLE_AND_DEFAULT_SLB (0)

#define NEMI_SMPU_BASE 0x10351000
#define NEMI_IOMMU_BASE 0x10352000
#define SEMI_SMPU_BASE 0x10355000
#define SEMI_IOMMU_BASE 0x10356000
...
#define CHN0_EMI_BASE               CHN0_EMI_APB_BASE
#define CHN1_EMI_BASE               CHN1_EMI_APB_BASE
...
#define EMI_AXI_BIST_CTRL0          (EMI_BASE+0x980)
#define EMI_AXI_BIST_PAT0           (EMI_BASE+0x988)
#define EMI_AXI_BIST_ADR0           (EMI_BASE+0x98c)
#define EMI_AXI_BIST_ADR1           (EMI_BASE+0x990)
#define EMI_AXI_BIST_ADR2           (EMI_BASE+0x994)

#define		SECURE_REGION_SA0_BASE			(NEMI_SMPU_BASE+0x0)
#define		SECURE_REGION_SA1_BASE			(NEMI_SMPU_BASE+0x4)
...
#define		SECURE_REGION_EA0_BASE			(NEMI_SMPU_BASE+0x8)
#define		SECURE_REGION_EA1_BASE			(NEMI_SMPU_BASE+0xc)
...
#define		SECURE_REGION_ENABLE0			(NEMI_SMPU_BASE+0x1d8)
#define		SECURE_REGION_ENABLE(region)		(SECURE_REGION_ENABLE0 + region*0x200)
#define		SUB_SECURE_REGION_SA0_BASE		(SEMI_SMPU_BASE+0x0)
#define		SUB_SECURE_REGION_SA1_BASE		(SEMI_SMPU_BASE+0x4)
...
#define		SUB_SECURE_REGION_EA0_BASE		(SEMI_SMPU_BASE+0x8)
#define		SUB_SECURE_REGION_EA1_BASE		(SEMI_SMPU_BASE+0xc)
...
#define		SUB_SECURE_REGION_ENABLE0		(SEMI_SMPU_BASE+0x1d8)
#define		SUB_SECURE_REGION_ENABLE(region)	(SUB_SECURE_REGION_ENABLE0 + region*0x200)

#define		NEMI_AID_PERM_TABEL_IDX			(NEMI_SMPU_BASE+0x980)
#define		NEMI_AID_PERM_TABEL_NON_SEC		(NEMI_SMPU_BASE+0x984)
#define		NEMI_AID_PERM_TABEL_SEC0		(NEMI_SMPU_BASE+0x988)
...
#define		SEMI_AID_PERM_TABEL_IDX			(SEMI_SMPU_BASE+0x980)
#define		SEMI_AID_PERM_TABEL_NON_SEC		(SEMI_SMPU_BASE+0x984)
#define		SEMI_AID_PERM_TABEL_SEC0		(SEMI_SMPU_BASE+0x988)
#define		SEMI_AID_PERM_TABEL_SEC(num)		(SEMI_AID_PERM_TABEL_SEC0+ (num*4))
#define		SEMI_AID_PERM_TABEL_TRIG_WRITE		(SEMI_SMPU_BASE+0x800)

#define         EMI_MPU_CTRL_D0				(EMI_MPU_APB_BASE+0x800)
#define         EMI_MPU_CTRL_D(domain)			(EMI_MPU_CTRL_D0 + (domain*4))
#define         SUB_EMI_MPU_CTRL_D0			(SUB_EMI_MPU_APB_BASE+0x800)
#define         SUB_EMI_MPU_CTRL_D(domain)		(SUB_EMI_MPU_CTRL_D0 + (domain*4))

#define		MD_IRQ_MONITOR				(NEMI_SMPU_BASE+0x100)
#define		SUB_MD_IRQ_MONITOR			(SEMI_SMPU_BASE+0x100)
#define		MD_IRQ_ENABLE				(NEMI_SMPU_BASE+0x104)
#define		SUB_MD_IRQ_ENABLE			(SEMI_SMPU_BASE+0x104)

#define	ADDR_BIT 16
#define ADDR_MASK 0xff
#define REGION_ENABLE (1 << 15)
#define MPU_REGION_NUMBER_PER_SET ADDR_BIT
#define MPU_REGION_BIT 8
#define CEN_EMI_NUM 2
