...
#define DRAMC_REG_DDRCOMMON0                                   (DRAMC_AO_BASE_ADDRESS + 0x0000)
    ...
    #define DDRCOMMON0_WRAPEN                                  Fld(1, 6) //[6:6]
...
#define DRAMC_REG_TEST2_A3                                     (DRAMC_AO_BASE_ADDRESS + 0x0108)
    ...
    #define TEST2_A3_DMPAT8                                    Fld(1, 20) //[20:20]
    #define TEST2_A3_TESTFIXPAT                                Fld(1, 21) //[21:21]
    #define TEST2_A3_HFIDPAT2UI                                Fld(1, 22) //[22:22]
...
#define DRAMC_REG_MPRR_CTRL0                                   (DRAMC_AO_BASE_ADDRESS + 0x011C)
    #define MPRR_CTRL0_MPRR0_GOLDEN                            Fld(8, 0) //[7:0]
    #define MPRR_CTRL0_MPRR1_GOLDEN                            Fld(8, 8) //[15:8]
    #define MPRR_CTRL0_MPRR2_GOLDEN                            Fld(8, 16) //[23:16]
    #define MPRR_CTRL0_MPRR3_GOLDEN                            Fld(8, 24) //[31:24]

#define DRAMC_REG_MPRR_CTRL1                                   (DRAMC_AO_BASE_ADDRESS + 0x0120)
    #define MPRR_CTRL1_MPRR_MODE                               Fld(2, 0) //[1:0]
...
#define DRAMC_REG_SWCMD_CTRL0                                  (DRAMC_AO_BASE_ADDRESS + 0x0128)
    ...
    #define SWCMD_CTRL0_MRWBKUP_NO_CHECK_DRAM_TYPE             Fld(1, 31) //[31:31]
...
#define DRAMC_REG_CBT_WLEV_ATK_CTRL0                           (DRAMC_AO_BASE_ADDRESS + 0x0160)
    ...
    #define CBT_WLEV_ATK_CTRL0_CBT_WLEV_ATK_INITPI             Fld(8, 22) //[29:22]
    #define CBT_WLEV_ATK_CTRL0_DLYWCK_SW                       Fld(1, 30) //[30:30]
...
#define DRAMC_REG_CBT_WLEV_ATK_CTRL1                           (DRAMC_AO_BASE_ADDRESS + 0x0164)
    ...
    #define CBT_WLEV_ATK_CTRL1_CBT_ATK_RAW_DATA_BYTE0_SEL      Fld(1, 27) //[27:27]
    #define CBT_WLEV_ATK_CTRL1_CBT_ATK_RAW_DATA_BYTE1_SEL      Fld(1, 28) //[28:28]
    #define CBT_WLEV_ATK_CTRL1_CBT_ATK_PW_RESULT_BYTE01_SPLIT  Fld(1, 29) //[29:29]
...
#define DRAMC_REG_ZQ_SET1                                      (DRAMC_AO_BASE_ADDRESS + 0x01A4)
    #define ZQ_SET1_HWZQ_RTSWCMD_CNT                           Fld(8, 0) //[7:0]
    #define ZQ_SET1_HWZQ_MPC_BY_RTSWCMD                        Fld(1, 8) //[8:8]
...
#define DRAMC_REG_SCRAMBLE_CFG0                                (DRAMC_AO_BASE_ADDRESS + 0x01D0)
    #define SCRAMBLE_CFG0_SC_CFG0                              Fld(32, 0) //[31:0]

#define DRAMC_REG_SCRAMBLE_CFG1                                (DRAMC_AO_BASE_ADDRESS + 0x01D4)
    #define SCRAMBLE_CFG1_SC_CFG1                              Fld(32, 0) //[31:0]

#define DRAMC_REG_SCRAMBLE_CFG2                                (DRAMC_AO_BASE_ADDRESS + 0x01D8)
    #define SCRAMBLE_CFG2_SC_CFG2                              Fld(32, 0) //[31:0]

#define DRAMC_REG_SCRAMBLE_CFG3                                (DRAMC_AO_BASE_ADDRESS + 0x01DC)
    #define SCRAMBLE_CFG3_SC_CFG3                              Fld(32, 0) //[31:0]

#define DRAMC_REG_SCRAMBLE_CFG4                                (DRAMC_AO_BASE_ADDRESS + 0x01E0)
    #define SCRAMBLE_CFG4_SC_CFG4                              Fld(32, 0) //[31:0]

#define DRAMC_REG_SCRAMBLE_CFG5                                (DRAMC_AO_BASE_ADDRESS + 0x01E4)
    #define SCRAMBLE_CFG5_SC_CFG5                              Fld(32, 0) //[31:0]

#define DRAMC_REG_SCRAMBLE_CFG6                                (DRAMC_AO_BASE_ADDRESS + 0x01E8)
    #define SCRAMBLE_CFG6_SC_CFG6                              Fld(32, 0) //[31:0]

#define DRAMC_REG_SCRAMBLE_CFG7                                (DRAMC_AO_BASE_ADDRESS + 0x01EC)
...
#define DRAMC_REG_DRAMC_PD_CTRL                                (DRAMC_AO_BASE_ADDRESS + 0x01FC)
    ...
    #define DRAMC_PD_CTRL_HW_SAVE_FR                           Fld(1, 14) //[14:14]
...
#define DRAMC_REG_DVFS_CTRL0                                   (DRAMC_AO_BASE_ADDRESS + 0x0208)
    ...
    #define DVFS_CTRL0_DVFS_AUTO_HWSET_EN                      Fld(1, 16) //[16:16]
    #define DVFS_CTRL0_DVFS_CKE_OPT                            Fld(1, 18) //[18:18]
...
#define DRAMC_REG_CMD_DEC_CTRL0                                (DRAMC_AO_BASE_ADDRESS + 0x021C)
    ...
    #define CMD_DEC_CTRL0_CS0FORCE1_SRK                        Fld(1, 20) //[20:20]
    #define CMD_DEC_CTRL0_CS1FORCE1_SRK                        Fld(1, 21) //[21:21]
    #define CMD_DEC_CTRL0_CKE0FORCE1_SRK                       Fld(1, 22) //[22:22]
    #define CMD_DEC_CTRL0_CKE1FORCE1_SRK                       Fld(1, 23) //[23:23]
    #define CMD_DEC_CTRL0_CS0FORCE0_SRK                        Fld(1, 24) //[24:24]
    #define CMD_DEC_CTRL0_CS1FORCE0_SRK                        Fld(1, 25) //[25:25]
    #define CMD_DEC_CTRL0_CKE0FORCE0_SRK                       Fld(1, 26) //[26:26]
    #define CMD_DEC_CTRL0_CKE1FORCE0_SRK                       Fld(1, 27) //[27:27]
...
#define DRAMC_REG_RX_SET0                                      (DRAMC_AO_BASE_ADDRESS + 0x0240)
    ...
    #define RX_SET0_RD_PERIOD_CG_NEW                           Fld(1, 5) //[5:5]
    #define RX_SET0_SMRR_UPD_OLD                               Fld(1, 6) //[6:6]
    #define RX_SET0_RXECC_WITH_MRR_DQM_FIX_ZERO_DIS            Fld(1, 7) //[7:7]
    #define RX_SET0_RDLE128_PACKING_RST                        Fld(1, 27) //[27:27]
    #define RX_SET0_RDLE128_PACKING_SKIP_SPEC_RID              Fld(1, 28) //[28:28]
...
#define DRAMC_REG_DRAMCTRL                                     (DRAMC_AO_BASE_ADDRESS + 0x024C)
    ...
    #define DRAMCTRL_DMYRD_EARLY_ADVPRE_EN                     Fld(1, 4) //[4:4]
    #define DRAMCTRL_ADRDEN_1TO4_OPT                           Fld(1, 5) //[5:5]
    #define DRAMCTRL_MATAB_DDR4_BKITLV                         Fld(1, 6) //[6:6]
    #define DRAMCTRL_MATAB_DDR4_BGITLV                         Fld(1, 7) //[7:7]
    ...
    #define DRAMCTRL_SEDA_RBK_OPT                              Fld(1, 11) //[11:11]
    ...
    #define DRAMCTRL_SWCMDBLOCKALE_DIS                         Fld(1, 16) //[16:16]
    #define DRAMCTRL_EBGFIXHPRI                                Fld(1, 17) //[17:17]
...
#define DRAMC_REG_PERFCTL0                                     (DRAMC_AO_BASE_ADDRESS + 0x0254)
    ...
    #define PERFCTL0_EBG_TX_BYPASS_EN                          Fld(1, 1) //[1:1]
...
#define DRAMC_REG_REFCTRL0                                     (DRAMC_AO_BASE_ADDRESS + 0x0264)
    ...
    #define REFCTRL0_OPTIMIZED_REFEN                           Fld(1, 10) //[10:10]
    ...
    #define REFCTRL0_REFRATE_FOR_HPRI_PBREF                    Fld(1, 28) //[28:28]
    #define REFCTRL0_HPRI_PBREF_ALLRATE_EN                     Fld(1, 29) //[29:29]
    #define REFCTRL0_DDR4_REFOTFEN                             Fld(1, 30) //[30:30]
    #define REFCTRL0_DDR4_REFOTF4X                             Fld(1, 31) //[31:31]
...
#define DRAMC_REG_SCSMCTRL                                     (DRAMC_AO_BASE_ADDRESS + 0x0284)
    ...
    #define SCSMCTRL_SWPREA_BLOCK_REF_DIS                      Fld(1, 11) //[11:11]
...
#define DRAMC_REG_CMD_RELATED_CTRL                             (DRAMC_AO_BASE_ADDRESS + 0x02C0)
    #define CMD_RELATED_CTRL_RANK0_10GBEN                      Fld(1, 0) //[0:0]
    #define CMD_RELATED_CTRL_RANK1_10GBEN                      Fld(1, 1) //[1:1]
    #define CMD_RELATED_CTRL_DDR34_2TCMDEN                     Fld(1, 2) //[2:2]
    #define CMD_RELATED_CTRL_DDR34_CA_SHARE                    Fld(1, 3) //[3:3]
    #define CMD_RELATED_CTRL_APHYPI_CACSCGH_CNT                Fld(4, 4) //[7:4]
    #define CMD_RELATED_CTRL_APHYPI_CKE0CGH_CNT                Fld(4, 8) //[11:8]
    #define CMD_RELATED_CTRL_APHYPI_CKE1CGH_CNT                Fld(4, 12) //[15:12]
...
#define DRAMC_REG_DRAMC_IRQ_EN                                 (DRAMC_AO_BASE_ADDRESS + 0x02E0)
    ...
    #define DRAMC_IRQ_EN_CMD_STALL_COUNTER_OVERFLOW_EN         Fld(1, 9) //[9:9]
    #define DRAMC_IRQ_EN_CMD_STALL_WISREF_EN                   Fld(1, 10) //[10:10]
    #define DRAMC_IRQ_EN_CMD_STALL_WODVFS_EN                   Fld(1, 11) //[11:11]
...
#define DRAMC_REG_DRAMC_IRQ_CLEAR                              (DRAMC_AO_BASE_ADDRESS + 0x02E4)
    ...
    #define DRAMC_IRQ_CLEAR_CMD_STALL_COUNTER_OVERFLOW_CLR     Fld(1, 9) //[9:9]
    #define DRAMC_IRQ_CLEAR_CMD_STALL_WISREF_CLR               Fld(1, 10) //[10:10]
    #define DRAMC_IRQ_CLEAR_CMD_STALL_WODVFS_CLR               Fld(1, 11) //[11:11]
...
#define DRAMC_REG_DCM_SUB_CTRL                                 (DRAMC_AO_BASE_ADDRESS + 0x0310)
    ...
    #define DCM_SUB_CTRL_SUBCLK_CTRL_DRAMOBF                   Fld(1, 13) //[13:13]
...
#define DRAMC_REG_EBG_BYPASS_INF1                              (DRAMC_AO_BASE_ADDRESS + 0x0398)
    #define EBG_BYPASS_INF1_CTO_EBG_BYPASS_PRE                 Fld(16, 0) //[15:0]
    #define EBG_BYPASS_INF1_CTO_EBG_CNT                        Fld(16, 16) //[31:16]

#define DRAMC_REG_EBG_BYPASS_INF2                              (DRAMC_AO_BASE_ADDRESS + 0x039C)
    #define EBG_BYPASS_INF2_CTO_EBG_BYPASS_REV1                Fld(16, 0) //[15:0]
    #define EBG_BYPASS_INF2_CTO_EBG_BYPASS_ACT                 Fld(16, 16) //[31:16]

#define DRAMC_REG_EBG_BYPASS_INF3                              (DRAMC_AO_BASE_ADDRESS + 0x03A0)
    #define EBG_BYPASS_INF3_CTO_EBG_BYPASS_REV2                Fld(32, 0) //[31:0]

#define DRAMC_REG_EBG_BYPASS_INF4                              (DRAMC_AO_BASE_ADDRESS + 0x03A4)
    #define EBG_BYPASS_INF4_CTO_EBG_BYPASS_REV3                Fld(32, 0) //[31:0]

#define DRAMC_REG_EBG_BYPASS_INF5                              (DRAMC_AO_BASE_ADDRESS + 0x03A8)
    #define EBG_BYPASS_INF5_CTO_EBG_BYPASS_REV4                Fld(32, 0) //[31:0]

#define DRAMC_REG_EBG_BYPASS_INF6                              (DRAMC_AO_BASE_ADDRESS + 0x03AC)
    #define EBG_BYPASS_INF6_CTO_EBG_BYPASS_REV5                Fld(32, 0) //[31:0]

#define DRAMC_REG_EBG_BYPASS_INF7                              (DRAMC_AO_BASE_ADDRESS + 0x03B0)
    #define EBG_BYPASS_INF7_CTO_EBG_BYPASS_REV6                Fld(32, 0) //[31:0]

#define DRAMC_REG_EBG_BYPASS_INF8                              (DRAMC_AO_BASE_ADDRESS + 0x03B4)
    #define EBG_BYPASS_INF8_CTO_EBG_BYPASS_REV7                Fld(32, 0) //[31:0]

#define DRAMC_REG_TXZQCNT_FR_CLK                               (DRAMC_AO_BASE_ADDRESS + 0x03C0)
    #define TXZQCNT_FR_CLK_TXZQCNT_FR_CLK                      Fld(12, 0) //[11:0]
...
#define DRAMC_REG_CMDELA_CMD_BA_FILTER1                        (DRAMC_AO_BASE_ADDRESS + 0x03D4)
...
#define DRAMC_REG_CMDELA_CMD_BA_FILTER2                        (DRAMC_AO_BASE_ADDRESS + 0x03D8)
...
#define DRAMC_REG_CMDELA_CMD_BA_FILTER3                        (DRAMC_AO_BASE_ADDRESS + 0x03DC)
...
#define DRAMC_REG_CMDELA_LP4CMD_FILTER                         (DRAMC_AO_BASE_ADDRESS + 0x03E0)
...
#define DRAMC_REG_CMDELA_CTRL0                                 (DRAMC_AO_BASE_ADDRESS + 0x03E4)
    ...
    #define CMDELA_CTRL0_CMDELA_SRAM_SREFCG_EN                 Fld(1, 8) //[8:8]

#define DRAMC_REG_CMDELA_TRIGGER_MODE_CTRL0                    (DRAMC_AO_BASE_ADDRESS + 0x03E8)
    #define CMDELA_TRIGGER_MODE_CTRL0_CMDELA_DDRPHY_IRQ_TRIGGER_EN Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_TRIGGER_MODE_CTRL1                    (DRAMC_AO_BASE_ADDRESS + 0x03EC)
    #define CMDELA_TRIGGER_MODE_CTRL1_CMDELA_DRAMC_1_IRQ_TRIGGER_EN Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_TRIGGER_MODE_CTRL2                    (DRAMC_AO_BASE_ADDRESS + 0x03F0)
    #define CMDELA_TRIGGER_MODE_CTRL2_CMDELA_DRAMC_2_IRQ_TRIGGER_EN Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_TRIGGER_MODE_CTRL3                    (DRAMC_AO_BASE_ADDRESS + 0x03F4)
...
#define DRAMC_REG_CMDELA_BUF_CTRL0                             (DRAMC_AO_BASE_ADDRESS + 0x03F8)
    #define CMDELA_BUF_CTRL0_ELA_MODE                          Fld(1, 0) //[0:0]
    #define CMDELA_BUF_CTRL0_ELA_RST                           Fld(1, 1) //[1:1]
    #define CMDELA_BUF_CTRL0_SRAM_RD                           Fld(1, 2) //[2:2]
    #define CMDELA_BUF_CTRL0_SET_RPTR                          Fld(8, 3) //[10:3]
    #define CMDELA_BUF_CTRL0_CNT_AFT_TRIG                      Fld(8, 11) //[18:11]

#define DRAMC_REG_CMDELA_BUF_INT_CTRL                          (DRAMC_AO_BASE_ADDRESS + 0x03FC)
    #define CMDELA_BUF_INT_CTRL_ELA_INTEN                      Fld(8, 0) //[7:0]
    #define CMDELA_BUF_INT_CTRL_ELA_INTCLR                     Fld(8, 8) //[15:8]

#define DRAMC_REG_CMDELA_STREAM_CTRL                           (DRAMC_AO_BASE_ADDRESS + 0x0400)
...
#define DRAMC_REG_CMDELA_BUF0_BADDR_L                          (DRAMC_AO_BASE_ADDRESS + 0x0404)
    #define CMDELA_BUF0_BADDR_L_BUF0_BADDR_L                   Fld(27, 5) //[31:5]

#define DRAMC_REG_CMDELA_BUF0_BADDR_H                          (DRAMC_AO_BASE_ADDRESS + 0x0408)
    #define CMDELA_BUF0_BADDR_H_BUF0_BADDR_H                   Fld(16, 0) //[15:0]

#define DRAMC_REG_CMDELA_BUF1_BADDR_L                          (DRAMC_AO_BASE_ADDRESS + 0x040C)
    #define CMDELA_BUF1_BADDR_L_BUF1_BADDR_L                   Fld(27, 5) //[31:5]

#define DRAMC_REG_CMDELA_BUF1_BADDR_H                          (DRAMC_AO_BASE_ADDRESS + 0x0410)
    #define CMDELA_BUF1_BADDR_H_BUF1_BADDR_H                   Fld(16, 0) //[15:0]

#define DRAMC_REG_CMDELA_BUF2_BADDR_L                          (DRAMC_AO_BASE_ADDRESS + 0x0414)
    #define CMDELA_BUF2_BADDR_L_BUF2_BADDR_L                   Fld(27, 5) //[31:5]

#define DRAMC_REG_CMDELA_BUF2_BADDR_H                          (DRAMC_AO_BASE_ADDRESS + 0x0418)
    #define CMDELA_BUF2_BADDR_H_BUF2_BADDR_H                   Fld(16, 0) //[15:0]

#define DRAMC_REG_CMDELA_BUF3_BADDR_L                          (DRAMC_AO_BASE_ADDRESS + 0x041C)
    #define CMDELA_BUF3_BADDR_L_BUF3_BADDR_L                   Fld(27, 5) //[31:5]

#define DRAMC_REG_CMDELA_BUF3_BADDR_H                          (DRAMC_AO_BASE_ADDRESS + 0x0420)
    #define CMDELA_BUF3_BADDR_H_BUF3_BADDR_H                   Fld(16, 0) //[15:0]

#define DRAMC_REG_CMDELA_BUF0_LEN                              (DRAMC_AO_BASE_ADDRESS + 0x0424)
    #define CMDELA_BUF0_LEN_BUF0_LEN                           Fld(27, 5) //[31:5]

#define DRAMC_REG_CMDELA_BUF1_LEN                              (DRAMC_AO_BASE_ADDRESS + 0x0428)
    #define CMDELA_BUF1_LEN_BUF1_LEN                           Fld(27, 5) //[31:5]

#define DRAMC_REG_CMDELA_BUF2_LEN                              (DRAMC_AO_BASE_ADDRESS + 0x042C)
    #define CMDELA_BUF2_LEN_BUF2_LEN                           Fld(27, 5) //[31:5]

#define DRAMC_REG_CMDELA_BUF3_LEN                              (DRAMC_AO_BASE_ADDRESS + 0x0430)
    #define CMDELA_BUF3_LEN_BUF3_LEN                           Fld(27, 5) //[31:5]

#define DRAMC_REG_CMDELA_LP5CMD_FILTER                         (DRAMC_AO_BASE_ADDRESS + 0x0434)
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_WR16_FILTER        Fld(1, 0) //[0:0]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_WR32_FILTER        Fld(1, 1) //[1:1]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_RD16_FILTER        Fld(1, 2) //[2:2]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_RD32_FILTER        Fld(1, 3) //[3:3]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_PDE_FILTER         Fld(1, 4) //[4:4]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_PDX_FILTER         Fld(1, 5) //[5:5]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_ACT_FILTER         Fld(1, 6) //[6:6]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_ACT2_FILTER        Fld(1, 7) //[7:7]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_PRE_FILTER         Fld(1, 8) //[8:8]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_REF_FILTER         Fld(1, 9) //[9:9]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_MPC_FILTER         Fld(1, 10) //[10:10]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_SRE_FILTER         Fld(1, 11) //[11:11]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_SRX_FILTER         Fld(1, 12) //[12:12]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_MRW_FILTER         Fld(1, 13) //[13:13]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_MRR_FILTER         Fld(1, 14) //[14:14]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_WFF_FILTER         Fld(1, 15) //[15:15]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_RFF_FILTER         Fld(1, 16) //[16:16]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_RDC_FILTER         Fld(1, 17) //[17:17]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_CAS_FILTER         Fld(1, 18) //[18:18]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_MWR_FILTER         Fld(1, 19) //[19:19]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_CBT_CA_FILTER      Fld(1, 20) //[20:20]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_CBT_CS_FILTER      Fld(1, 21) //[21:21]
    #define CMDELA_LP5CMD_FILTER_CMDELA_LP5_SW_DBG_FILTER      Fld(1, 22) //[22:22]

#define DRAMC_REG_CMDELA_SRAM_CTRL_SIG                         (DRAMC_AO_BASE_ADDRESS + 0x0438)
    #define CMDELA_SRAM_CTRL_SIG_MBIST_DELSEL_7                Fld(20, 0) //[19:0]
    #define CMDELA_SRAM_CTRL_SIG_MBIST_USE_DEFAULT_DELSEL_7    Fld(1, 20) //[20:20]
    #define CMDELA_SRAM_CTRL_SIG_MBIST_FUSE_SEL                Fld(1, 21) //[21:21]
    #define CMDELA_SRAM_CTRL_SIG_MBIST_LOAD                    Fld(1, 22) //[22:22]

#define DRAMC_REG_SCRAMBLE_CFG8                                (DRAMC_AO_BASE_ADDRESS + 0x0440)
...
#define DRAMC_REG_SCRAMBLE_CFG9                                (DRAMC_AO_BASE_ADDRESS + 0x0444)
    #define SCRAMBLE_CFG9_SC_DWADDR_3                          Fld(16, 0) //[15:0]
    #define SCRAMBLE_CFG9_SC_UPADDR_3                          Fld(16, 16) //[31:16]

#define DRAMC_REG_SCRAMBLE_CFGA                                (DRAMC_AO_BASE_ADDRESS + 0x0448)
    #define SCRAMBLE_CFGA_SC_DWADDR_2                          Fld(16, 0) //[15:0]
    #define SCRAMBLE_CFGA_SC_UPADDR_2                          Fld(16, 16) //[31:16]

#define DRAMC_REG_SCRAMBLE_CFGB                                (DRAMC_AO_BASE_ADDRESS + 0x044C)
    #define SCRAMBLE_CFGB_SC_DWADDR_1                          Fld(16, 0) //[15:0]
    #define SCRAMBLE_CFGB_SC_UPADDR_1                          Fld(16, 16) //[31:16]

#define DRAMC_REG_SCRAMBLE_CFGC                                (DRAMC_AO_BASE_ADDRESS + 0x0450)
    #define SCRAMBLE_CFGC_SC_DWADDR_0                          Fld(16, 0) //[15:0]
    #define SCRAMBLE_CFGC_SC_UPADDR_0                          Fld(16, 16) //[31:16]

#define DRAMC_REG_SCRAMBLE_CFGD                                (DRAMC_AO_BASE_ADDRESS + 0x0454)
    #define SCRAMBLE_CFGD_SC_CFGD                              Fld(32, 0) //[31:0]

#define DRAMC_REG_SCRAMBLE_CFGE                                (DRAMC_AO_BASE_ADDRESS + 0x0458)
    #define SCRAMBLE_CFGE_SC_CFGE                              Fld(32, 0) //[31:0]

#define DRAMC_REG_SCRAMBLE_CFGF                                (DRAMC_AO_BASE_ADDRESS + 0x045C)
    #define SCRAMBLE_CFGF_SC_CFGF                              Fld(32, 0) //[31:0]

#define DRAMC_REG_RTSWCMD_P2S_CTRL0                            (DRAMC_AO_BASE_ADDRESS + 0x0460)
    #define RTSWCMD_P2S_CTRL0_RTSWCMD1_AGE                     Fld(10, 0) //[9:0]
    #define RTSWCMD_P2S_CTRL0_RTSWCMD2_AGE                     Fld(10, 10) //[19:10]
    #define RTSWCMD_P2S_CTRL0_RTSWCMD_LEN                      Fld(3, 20) //[22:20]

#define DRAMC_REG_RTSWCMD_P2S_CTRL1                            (DRAMC_AO_BASE_ADDRESS + 0x0464)
    #define RTSWCMD_P2S_CTRL1_RTSWCMD3_AGE                     Fld(10, 0) //[9:0]
    #define RTSWCMD_P2S_CTRL1_RTSWCMD4_AGE                     Fld(10, 10) //[19:10]
    #define RTSWCMD_P2S_CTRL1_RTSWCMD5_AGE                     Fld(10, 20) //[29:20]

#define DRAMC_REG_RTSWCMD_P2S_2ND_CMD_CTRL0                    (DRAMC_AO_BASE_ADDRESS + 0x0468)
    #define RTSWCMD_P2S_2ND_CMD_CTRL0_RTSWCMD1_SEL             Fld(6, 0) //[5:0]
    #define RTSWCMD_P2S_2ND_CMD_CTRL0_RTSWCMD1_RK              Fld(2, 10) //[11:10]
    #define RTSWCMD_P2S_2ND_CMD_CTRL0_RTSWCMD1_MA              Fld(8, 12) //[19:12]
    #define RTSWCMD_P2S_2ND_CMD_CTRL0_RTSWCMD1_OP              Fld(8, 20) //[27:20]

#define DRAMC_REG_RTSWCMD_P2S_3RD_CMD_CTRL0                    (DRAMC_AO_BASE_ADDRESS + 0x046C)
    #define RTSWCMD_P2S_3RD_CMD_CTRL0_RTSWCMD2_SEL             Fld(6, 0) //[5:0]
    #define RTSWCMD_P2S_3RD_CMD_CTRL0_RTSWCMD2_RK              Fld(2, 10) //[11:10]
    #define RTSWCMD_P2S_3RD_CMD_CTRL0_RTSWCMD2_MA              Fld(8, 12) //[19:12]
    #define RTSWCMD_P2S_3RD_CMD_CTRL0_RTSWCMD2_OP              Fld(8, 20) //[27:20]

#define DRAMC_REG_RTSWCMD_P2S_4TH_CMD_CTRL0                    (DRAMC_AO_BASE_ADDRESS + 0x0470)
    #define RTSWCMD_P2S_4TH_CMD_CTRL0_RTSWCMD3_SEL             Fld(6, 0) //[5:0]
    #define RTSWCMD_P2S_4TH_CMD_CTRL0_RTSWCMD3_RK              Fld(2, 10) //[11:10]
    #define RTSWCMD_P2S_4TH_CMD_CTRL0_RTSWCMD3_MA              Fld(8, 12) //[19:12]
    #define RTSWCMD_P2S_4TH_CMD_CTRL0_RTSWCMD3_OP              Fld(8, 20) //[27:20]

#define DRAMC_REG_RTSWCMD_P2S_5TH_CMD_CTRL0                    (DRAMC_AO_BASE_ADDRESS + 0x0474)
    #define RTSWCMD_P2S_5TH_CMD_CTRL0_RTSWCMD4_SEL             Fld(6, 0) //[5:0]
    #define RTSWCMD_P2S_5TH_CMD_CTRL0_RTSWCMD4_RK              Fld(2, 10) //[11:10]
    #define RTSWCMD_P2S_5TH_CMD_CTRL0_RTSWCMD4_MA              Fld(8, 12) //[19:12]
    #define RTSWCMD_P2S_5TH_CMD_CTRL0_RTSWCMD4_OP              Fld(8, 20) //[27:20]

#define DRAMC_REG_RTSWCMD_P2S_6TH_CMD_CTRL0                    (DRAMC_AO_BASE_ADDRESS + 0x0478)
    #define RTSWCMD_P2S_6TH_CMD_CTRL0_RTSWCMD5_SEL             Fld(6, 0) //[5:0]
    #define RTSWCMD_P2S_6TH_CMD_CTRL0_RTSWCMD5_RK              Fld(2, 10) //[11:10]
    #define RTSWCMD_P2S_6TH_CMD_CTRL0_RTSWCMD5_MA              Fld(8, 12) //[19:12]
    #define RTSWCMD_P2S_6TH_CMD_CTRL0_RTSWCMD5_OP              Fld(8, 20) //[27:20]

#define DRAMC_REG_RTSWCMD_P2S_2ND_CMD_CTRL1                    (DRAMC_AO_BASE_ADDRESS + 0x047C)
    #define RTSWCMD_P2S_2ND_CMD_CTRL1_RTSWCMD1_CNT             Fld(32, 0) //[31:0]

#define DRAMC_REG_RTSWCMD_P2S_3RD_CMD_CTRL1                    (DRAMC_AO_BASE_ADDRESS + 0x0480)
    #define RTSWCMD_P2S_3RD_CMD_CTRL1_RTSWCMD2_CNT             Fld(32, 0) //[31:0]

#define DRAMC_REG_RTSWCMD_P2S_4TH_CMD_CTRL1                    (DRAMC_AO_BASE_ADDRESS + 0x0484)
    #define RTSWCMD_P2S_4TH_CMD_CTRL1_RTSWCMD3_CNT             Fld(32, 0) //[31:0]

#define DRAMC_REG_RTSWCMD_P2S_5TH_CMD_CTRL1                    (DRAMC_AO_BASE_ADDRESS + 0x0488)
    #define RTSWCMD_P2S_5TH_CMD_CTRL1_RTSWCMD4_CNT             Fld(32, 0) //[31:0]

#define DRAMC_REG_RTSWCMD_P2S_6TH_CMD_CTRL1                    (DRAMC_AO_BASE_ADDRESS + 0x048C)
    #define RTSWCMD_P2S_6TH_CMD_CTRL1_RTSWCMD5_CNT             Fld(32, 0) //[31:0]

#define DRAMC_REG_RTSWCMD_P2S_2ND_CMD_CTRL2                    (DRAMC_AO_BASE_ADDRESS + 0x0490)
    #define RTSWCMD_P2S_2ND_CMD_CTRL2_RTSWCMD1_CA0_DBGCMD_PAT  Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_2ND_CMD_CTRL2_RTSWCMD1_CA1_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_2ND_CMD_CTRL2_RTSWCMD1_CA2_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_2ND_CMD_CTRL2_RTSWCMD1_CA3_DBGCMD_PAT  Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_2ND_CMD_CTRL2_RTSWCMD1_CA4_DBGCMD_PAT  Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_2ND_CMD_CTRL2_RTSWCMD1_CA5_DBGCMD_PAT  Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_2ND_CMD_CTRL2_RTSWCMD1_CA6_DBGCMD_PAT  Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_2ND_CMD_CTRL2_RTSWCMD1_CS_DBGCMD_PAT   Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_3RD_CMD_CTRL2                    (DRAMC_AO_BASE_ADDRESS + 0x0494)
    #define RTSWCMD_P2S_3RD_CMD_CTRL2_RTSWCMD2_CA0_DBGCMD_PAT  Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_3RD_CMD_CTRL2_RTSWCMD2_CA1_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_3RD_CMD_CTRL2_RTSWCMD2_CA2_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_3RD_CMD_CTRL2_RTSWCMD2_CA3_DBGCMD_PAT  Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_3RD_CMD_CTRL2_RTSWCMD2_CA4_DBGCMD_PAT  Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_3RD_CMD_CTRL2_RTSWCMD2_CA5_DBGCMD_PAT  Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_3RD_CMD_CTRL2_RTSWCMD2_CA6_DBGCMD_PAT  Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_3RD_CMD_CTRL2_RTSWCMD2_CS_DBGCMD_PAT   Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_4TH_CMD_CTRL2                    (DRAMC_AO_BASE_ADDRESS + 0x0498)
    #define RTSWCMD_P2S_4TH_CMD_CTRL2_RTSWCMD3_CA0_DBGCMD_PAT  Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_4TH_CMD_CTRL2_RTSWCMD3_CA1_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_4TH_CMD_CTRL2_RTSWCMD3_CA2_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_4TH_CMD_CTRL2_RTSWCMD3_CA3_DBGCMD_PAT  Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_4TH_CMD_CTRL2_RTSWCMD3_CA4_DBGCMD_PAT  Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_4TH_CMD_CTRL2_RTSWCMD3_CA5_DBGCMD_PAT  Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_4TH_CMD_CTRL2_RTSWCMD3_CA6_DBGCMD_PAT  Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_4TH_CMD_CTRL2_RTSWCMD3_CS_DBGCMD_PAT   Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_5TH_CMD_CTRL2                    (DRAMC_AO_BASE_ADDRESS + 0x049C)
    #define RTSWCMD_P2S_5TH_CMD_CTRL2_RTSWCMD4_CA0_DBGCMD_PAT  Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_5TH_CMD_CTRL2_RTSWCMD4_CA1_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_5TH_CMD_CTRL2_RTSWCMD4_CA2_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_5TH_CMD_CTRL2_RTSWCMD4_CA3_DBGCMD_PAT  Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_5TH_CMD_CTRL2_RTSWCMD4_CA4_DBGCMD_PAT  Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_5TH_CMD_CTRL2_RTSWCMD4_CA5_DBGCMD_PAT  Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_5TH_CMD_CTRL2_RTSWCMD4_CA6_DBGCMD_PAT  Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_5TH_CMD_CTRL2_RTSWCMD4_CS_DBGCMD_PAT   Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_6TH_CMD_CTRL2                    (DRAMC_AO_BASE_ADDRESS + 0x04A0)
    #define RTSWCMD_P2S_6TH_CMD_CTRL2_RTSWCMD5_CA0_DBGCMD_PAT  Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_6TH_CMD_CTRL2_RTSWCMD5_CA1_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_6TH_CMD_CTRL2_RTSWCMD5_CA2_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_6TH_CMD_CTRL2_RTSWCMD5_CA3_DBGCMD_PAT  Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_6TH_CMD_CTRL2_RTSWCMD5_CA4_DBGCMD_PAT  Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_6TH_CMD_CTRL2_RTSWCMD5_CA5_DBGCMD_PAT  Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_6TH_CMD_CTRL2_RTSWCMD5_CA6_DBGCMD_PAT  Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_6TH_CMD_CTRL2_RTSWCMD5_CS_DBGCMD_PAT   Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_1ST_CMD_CTRL3                    (DRAMC_AO_BASE_ADDRESS + 0x04A4)
    #define RTSWCMD_P2S_1ST_CMD_CTRL3_RTSWCMD0_CA7_DBGCMD_PAT  Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_1ST_CMD_CTRL3_RTSWCMD0_CA8_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_1ST_CMD_CTRL3_RTSWCMD0_CA9_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_1ST_CMD_CTRL3_RTSWCMD0_CA10_DBGCMD_PAT Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_1ST_CMD_CTRL3_RTSWCMD0_CA11_DBGCMD_PAT Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_1ST_CMD_CTRL3_RTSWCMD0_CA12_DBGCMD_PAT Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_1ST_CMD_CTRL3_RTSWCMD0_CA13_DBGCMD_PAT Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_1ST_CMD_CTRL3_RTSWCMD0_CA14_DBGCMD_PAT Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_1ST_CMD_CTRL4                    (DRAMC_AO_BASE_ADDRESS + 0x04A8)
    #define RTSWCMD_P2S_1ST_CMD_CTRL4_RTSWCMD0_CA15_DBGCMD_PAT Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_1ST_CMD_CTRL4_RTSWCMD0_CA16_DBGCMD_PAT Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_1ST_CMD_CTRL4_RTSWCMD0_CA17_DBGCMD_PAT Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_1ST_CMD_CTRL4_RTSWCMD0_CA18_DBGCMD_PAT Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_1ST_CMD_CTRL4_RTSWCMD0_BA0_DBGCMD_PAT  Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_1ST_CMD_CTRL4_RTSWCMD0_BA1_DBGCMD_PAT  Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_1ST_CMD_CTRL4_RTSWCMD0_BA2_DBGCMD_PAT  Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_1ST_CMD_CTRL4_RTSWCMD0_BA3_DBGCMD_PAT  Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_1ST_CMD_CTRL5                    (DRAMC_AO_BASE_ADDRESS + 0x04AC)
    #define RTSWCMD_P2S_1ST_CMD_CTRL5_RTSWCMD0_WE_DBGCMD_PAT   Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_1ST_CMD_CTRL5_RTSWCMD0_ACT_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_1ST_CMD_CTRL5_RTSWCMD0_CAS_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_1ST_CMD_CTRL5_RTSWCMD0_RAS_DBGCMD_PAT  Fld(4, 12) //[15:12]

#define DRAMC_REG_RTSWCMD_P2S_2ND_CMD_CTRL3                    (DRAMC_AO_BASE_ADDRESS + 0x04B0)
    #define RTSWCMD_P2S_2ND_CMD_CTRL3_RTSWCMD1_CA7_DBGCMD_PAT  Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_2ND_CMD_CTRL3_RTSWCMD1_CA8_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_2ND_CMD_CTRL3_RTSWCMD1_CA9_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_2ND_CMD_CTRL3_RTSWCMD1_CA10_DBGCMD_PAT Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_2ND_CMD_CTRL3_RTSWCMD1_CA11_DBGCMD_PAT Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_2ND_CMD_CTRL3_RTSWCMD1_CA12_DBGCMD_PAT Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_2ND_CMD_CTRL3_RTSWCMD1_CA13_DBGCMD_PAT Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_2ND_CMD_CTRL3_RTSWCMD1_CA14_DBGCMD_PAT Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_2ND_CMD_CTRL4                    (DRAMC_AO_BASE_ADDRESS + 0x04B4)
    #define RTSWCMD_P2S_2ND_CMD_CTRL4_RTSWCMD1_CA15_DBGCMD_PAT Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_2ND_CMD_CTRL4_RTSWCMD1_CA16_DBGCMD_PAT Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_2ND_CMD_CTRL4_RTSWCMD1_CA17_DBGCMD_PAT Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_2ND_CMD_CTRL4_RTSWCMD1_CA18_DBGCMD_PAT Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_2ND_CMD_CTRL4_RTSWCMD1_BA0_DBGCMD_PAT  Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_2ND_CMD_CTRL4_RTSWCMD1_BA1_DBGCMD_PAT  Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_2ND_CMD_CTRL4_RTSWCMD1_BA2_DBGCMD_PAT  Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_2ND_CMD_CTRL4_RTSWCMD1_BA3_DBGCMD_PAT  Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_2ND_CMD_CTRL5                    (DRAMC_AO_BASE_ADDRESS + 0x04B8)
    #define RTSWCMD_P2S_2ND_CMD_CTRL5_RTSWCMD1_WE_DBGCMD_PAT   Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_2ND_CMD_CTRL5_RTSWCMD1_ACT_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_2ND_CMD_CTRL5_RTSWCMD1_CAS_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_2ND_CMD_CTRL5_RTSWCMD1_RAS_DBGCMD_PAT  Fld(4, 12) //[15:12]

#define DRAMC_REG_RTSWCMD_P2S_3RD_CMD_CTRL3                    (DRAMC_AO_BASE_ADDRESS + 0x04BC)
    #define RTSWCMD_P2S_3RD_CMD_CTRL3_RTSWCMD2_CA7_DBGCMD_PAT  Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_3RD_CMD_CTRL3_RTSWCMD2_CA8_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_3RD_CMD_CTRL3_RTSWCMD2_CA9_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_3RD_CMD_CTRL3_RTSWCMD2_CA10_DBGCMD_PAT Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_3RD_CMD_CTRL3_RTSWCMD2_CA11_DBGCMD_PAT Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_3RD_CMD_CTRL3_RTSWCMD2_CA12_DBGCMD_PAT Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_3RD_CMD_CTRL3_RTSWCMD2_CA13_DBGCMD_PAT Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_3RD_CMD_CTRL3_RTSWCMD2_CA14_DBGCMD_PAT Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_3RD_CMD_CTRL4                    (DRAMC_AO_BASE_ADDRESS + 0x04C0)
    #define RTSWCMD_P2S_3RD_CMD_CTRL4_RTSWCMD2_CA15_DBGCMD_PAT Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_3RD_CMD_CTRL4_RTSWCMD2_CA16_DBGCMD_PAT Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_3RD_CMD_CTRL4_RTSWCMD2_CA17_DBGCMD_PAT Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_3RD_CMD_CTRL4_RTSWCMD2_CA18_DBGCMD_PAT Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_3RD_CMD_CTRL4_RTSWCMD2_BA0_DBGCMD_PAT  Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_3RD_CMD_CTRL4_RTSWCMD2_BA1_DBGCMD_PAT  Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_3RD_CMD_CTRL4_RTSWCMD2_BA2_DBGCMD_PAT  Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_3RD_CMD_CTRL4_RTSWCMD2_BA3_DBGCMD_PAT  Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_3RD_CMD_CTRL5                    (DRAMC_AO_BASE_ADDRESS + 0x04C4)
    #define RTSWCMD_P2S_3RD_CMD_CTRL5_RTSWCMD2_WE_DBGCMD_PAT   Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_3RD_CMD_CTRL5_RTSWCMD2_ACT_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_3RD_CMD_CTRL5_RTSWCMD2_CAS_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_3RD_CMD_CTRL5_RTSWCMD2_RAS_DBGCMD_PAT  Fld(4, 12) //[15:12]

#define DRAMC_REG_RTSWCMD_P2S_4TH_CMD_CTRL3                    (DRAMC_AO_BASE_ADDRESS + 0x04C8)
    #define RTSWCMD_P2S_4TH_CMD_CTRL3_RTSWCMD3_CA7_DBGCMD_PAT  Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_4TH_CMD_CTRL3_RTSWCMD3_CA8_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_4TH_CMD_CTRL3_RTSWCMD3_CA9_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_4TH_CMD_CTRL3_RTSWCMD3_CA10_DBGCMD_PAT Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_4TH_CMD_CTRL3_RTSWCMD3_CA11_DBGCMD_PAT Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_4TH_CMD_CTRL3_RTSWCMD3_CA12_DBGCMD_PAT Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_4TH_CMD_CTRL3_RTSWCMD3_CA13_DBGCMD_PAT Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_4TH_CMD_CTRL3_RTSWCMD3_CA14_DBGCMD_PAT Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_4TH_CMD_CTRL4                    (DRAMC_AO_BASE_ADDRESS + 0x04CC)
    #define RTSWCMD_P2S_4TH_CMD_CTRL4_RTSWCMD3_CA15_DBGCMD_PAT Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_4TH_CMD_CTRL4_RTSWCMD3_CA16_DBGCMD_PAT Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_4TH_CMD_CTRL4_RTSWCMD3_CA17_DBGCMD_PAT Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_4TH_CMD_CTRL4_RTSWCMD3_CA18_DBGCMD_PAT Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_4TH_CMD_CTRL4_RTSWCMD3_BA0_DBGCMD_PAT  Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_4TH_CMD_CTRL4_RTSWCMD3_BA1_DBGCMD_PAT  Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_4TH_CMD_CTRL4_RTSWCMD3_BA2_DBGCMD_PAT  Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_4TH_CMD_CTRL4_RTSWCMD3_BA3_DBGCMD_PAT  Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_4TH_CMD_CTRL5                    (DRAMC_AO_BASE_ADDRESS + 0x04D0)
    #define RTSWCMD_P2S_4TH_CMD_CTRL5_RTSWCMD3_WE_DBGCMD_PAT   Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_4TH_CMD_CTRL5_RTSWCMD3_ACT_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_4TH_CMD_CTRL5_RTSWCMD3_CAS_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_4TH_CMD_CTRL5_RTSWCMD3_RAS_DBGCMD_PAT  Fld(4, 12) //[15:12]

#define DRAMC_REG_RTSWCMD_P2S_5TH_CMD_CTRL3                    (DRAMC_AO_BASE_ADDRESS + 0x04D4)
    #define RTSWCMD_P2S_5TH_CMD_CTRL3_RTSWCMD4_CA7_DBGCMD_PAT  Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_5TH_CMD_CTRL3_RTSWCMD4_CA8_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_5TH_CMD_CTRL3_RTSWCMD4_CA9_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_5TH_CMD_CTRL3_RTSWCMD4_CA10_DBGCMD_PAT Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_5TH_CMD_CTRL3_RTSWCMD4_CA11_DBGCMD_PAT Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_5TH_CMD_CTRL3_RTSWCMD4_CA12_DBGCMD_PAT Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_5TH_CMD_CTRL3_RTSWCMD4_CA13_DBGCMD_PAT Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_5TH_CMD_CTRL3_RTSWCMD4_CA14_DBGCMD_PAT Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_5TH_CMD_CTRL4                    (DRAMC_AO_BASE_ADDRESS + 0x04D8)
    #define RTSWCMD_P2S_5TH_CMD_CTRL4_RTSWCMD4_CA15_DBGCMD_PAT Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_5TH_CMD_CTRL4_RTSWCMD4_CA16_DBGCMD_PAT Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_5TH_CMD_CTRL4_RTSWCMD4_CA17_DBGCMD_PAT Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_5TH_CMD_CTRL4_RTSWCMD4_CA18_DBGCMD_PAT Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_5TH_CMD_CTRL4_RTSWCMD4_BA0_DBGCMD_PAT  Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_5TH_CMD_CTRL4_RTSWCMD4_BA1_DBGCMD_PAT  Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_5TH_CMD_CTRL4_RTSWCMD4_BA2_DBGCMD_PAT  Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_5TH_CMD_CTRL4_RTSWCMD4_BA3_DBGCMD_PAT  Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_5TH_CMD_CTRL5                    (DRAMC_AO_BASE_ADDRESS + 0x04DC)
    #define RTSWCMD_P2S_5TH_CMD_CTRL5_RTSWCMD4_WE_DBGCMD_PAT   Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_5TH_CMD_CTRL5_RTSWCMD4_ACT_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_5TH_CMD_CTRL5_RTSWCMD4_CAS_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_5TH_CMD_CTRL5_RTSWCMD4_RAS_DBGCMD_PAT  Fld(4, 12) //[15:12]

#define DRAMC_REG_RTSWCMD_P2S_6TH_CMD_CTRL3                    (DRAMC_AO_BASE_ADDRESS + 0x04E0)
    #define RTSWCMD_P2S_6TH_CMD_CTRL3_RTSWCMD5_CA7_DBGCMD_PAT  Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_6TH_CMD_CTRL3_RTSWCMD5_CA8_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_6TH_CMD_CTRL3_RTSWCMD5_CA9_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_6TH_CMD_CTRL3_RTSWCMD5_CA10_DBGCMD_PAT Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_6TH_CMD_CTRL3_RTSWCMD5_CA11_DBGCMD_PAT Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_6TH_CMD_CTRL3_RTSWCMD5_CA12_DBGCMD_PAT Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_6TH_CMD_CTRL3_RTSWCMD5_CA13_DBGCMD_PAT Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_6TH_CMD_CTRL3_RTSWCMD5_CA14_DBGCMD_PAT Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_6TH_CMD_CTRL4                    (DRAMC_AO_BASE_ADDRESS + 0x04E4)
    #define RTSWCMD_P2S_6TH_CMD_CTRL4_RTSWCMD5_CA15_DBGCMD_PAT Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_6TH_CMD_CTRL4_RTSWCMD5_CA16_DBGCMD_PAT Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_6TH_CMD_CTRL4_RTSWCMD5_CA17_DBGCMD_PAT Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_6TH_CMD_CTRL4_RTSWCMD5_CA18_DBGCMD_PAT Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_6TH_CMD_CTRL4_RTSWCMD5_BA0_DBGCMD_PAT  Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_6TH_CMD_CTRL4_RTSWCMD5_BA1_DBGCMD_PAT  Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_6TH_CMD_CTRL4_RTSWCMD5_BA2_DBGCMD_PAT  Fld(4, 24) //[27:24]
    #define RTSWCMD_P2S_6TH_CMD_CTRL4_RTSWCMD5_BA3_DBGCMD_PAT  Fld(4, 28) //[31:28]

#define DRAMC_REG_RTSWCMD_P2S_6TH_CMD_CTRL5                    (DRAMC_AO_BASE_ADDRESS + 0x04E8)
    #define RTSWCMD_P2S_6TH_CMD_CTRL5_RTSWCMD5_WE_DBGCMD_PAT   Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_6TH_CMD_CTRL5_RTSWCMD5_ACT_DBGCMD_PAT  Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_6TH_CMD_CTRL5_RTSWCMD5_CAS_DBGCMD_PAT  Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_6TH_CMD_CTRL5_RTSWCMD5_RAS_DBGCMD_PAT  Fld(4, 12) //[15:12]

#define DRAMC_REG_RTSWCMD_P2S_CTRL2                            (DRAMC_AO_BASE_ADDRESS + 0x04EC)
    #define RTSWCMD_P2S_CTRL2_RTSWCMD0_BA                      Fld(4, 0) //[3:0]
    #define RTSWCMD_P2S_CTRL2_RTSWCMD1_BA                      Fld(4, 4) //[7:4]
    #define RTSWCMD_P2S_CTRL2_RTSWCMD2_BA                      Fld(4, 8) //[11:8]
    #define RTSWCMD_P2S_CTRL2_RTSWCMD3_BA                      Fld(4, 12) //[15:12]
    #define RTSWCMD_P2S_CTRL2_RTSWCMD4_BA                      Fld(4, 16) //[19:16]
    #define RTSWCMD_P2S_CTRL2_RTSWCMD5_BA                      Fld(4, 20) //[23:20]
    #define RTSWCMD_P2S_CTRL2_RTSWCMD0_OP_8TO13                Fld(6, 24) //[29:24]

#define DRAMC_REG_RTSWCMD_P2S_CTRL3                            (DRAMC_AO_BASE_ADDRESS + 0x04F0)
    #define RTSWCMD_P2S_CTRL3_RTSWCMD1_OP_8TO13                Fld(6, 0) //[5:0]
    #define RTSWCMD_P2S_CTRL3_RTSWCMD2_OP_8TO13                Fld(6, 6) //[11:6]
    #define RTSWCMD_P2S_CTRL3_RTSWCMD3_OP_8TO13                Fld(6, 12) //[17:12]
    #define RTSWCMD_P2S_CTRL3_RTSWCMD4_OP_8TO13                Fld(6, 18) //[23:18]
    #define RTSWCMD_P2S_CTRL3_RTSWCMD5_OP_8TO13                Fld(6, 24) //[29:24]

#define DRAMC_REG_SWDVFSMRW                                    (DRAMC_AO_BASE_ADDRESS + 0x04F4)
    #define SWDVFSMRW_SWDVFSMRWEN                              Fld(1, 0) //[0:0]
    #define SWDVFSMRW_SWDVFSMRW_LEN                            Fld(5, 1) //[5:1]
    #define SWDVFSMRW_SWDVFSMRW_INTV                           Fld(10, 6) //[15:6]
    #define SWDVFSMRW_SWDVFSMRW0_OP_MUX_SEL                    Fld(1, 16) //[16:16]
    #define SWDVFSMRW_SWDVFSMRW_RTMRW_SEL                      Fld(1, 17) //[17:17]
...
#define DRAMC_REG_RK_DQSOSC                                    (DRAMC_AO_BASE_ADDRESS + 0x0590)
    #define RK_DQSOSC_TX_TRACKING_MRR_BYTE_SWAP                Fld(1, 28) //[28:28]
...
#define DRAMC_REG_RFM_ACT_CNT_LAT0                             (DRAMC_AO_BASE_ADDRESS + 0x0900)
    #define RFM_ACT_CNT_LAT0_RFM_ACT_CNT0_CONF                 Fld(12, 0) //[11:0]
    #define RFM_ACT_CNT_LAT0_RFM_ACT_CNT1_CONF                 Fld(12, 16) //[27:16]

#define DRAMC_REG_RFM_ACT_CNT_LAT1                             (DRAMC_AO_BASE_ADDRESS + 0x0904)
    #define RFM_ACT_CNT_LAT1_RFM_ACT_CNT2_CONF                 Fld(12, 0) //[11:0]
    #define RFM_ACT_CNT_LAT1_RFM_ACT_CNT3_CONF                 Fld(12, 16) //[27:16]

#define DRAMC_REG_RFM_ACT_CNT_LAT2                             (DRAMC_AO_BASE_ADDRESS + 0x0908)
    #define RFM_ACT_CNT_LAT2_RFM_ACT_CNT4_CONF                 Fld(12, 0) //[11:0]
    #define RFM_ACT_CNT_LAT2_RFM_ACT_CNT5_CONF                 Fld(12, 16) //[27:16]

#define DRAMC_REG_RFM_ACT_CNT_LAT3                             (DRAMC_AO_BASE_ADDRESS + 0x090C)
    #define RFM_ACT_CNT_LAT3_RFM_ACT_CNT6_CONF                 Fld(12, 0) //[11:0]
    #define RFM_ACT_CNT_LAT3_RFM_ACT_CNT7_CONF                 Fld(12, 16) //[27:16]

#define DRAMC_REG_RFM_ACT_CNT_LAT4                             (DRAMC_AO_BASE_ADDRESS + 0x0910)
    #define RFM_ACT_CNT_LAT4_RFM_ACT_CNT8_CONF                 Fld(12, 0) //[11:0]
    #define RFM_ACT_CNT_LAT4_RFM_ACT_CNT9_CONF                 Fld(12, 16) //[27:16]

#define DRAMC_REG_RFM_ACT_CNT_LAT5                             (DRAMC_AO_BASE_ADDRESS + 0x0914)
    #define RFM_ACT_CNT_LAT5_RFM_ACT_CNT10_CONF                Fld(12, 0) //[11:0]
    #define RFM_ACT_CNT_LAT5_RFM_ACT_CNT11_CONF                Fld(12, 16) //[27:16]

#define DRAMC_REG_RFM_ACT_CNT_LAT6                             (DRAMC_AO_BASE_ADDRESS + 0x0918)
    #define RFM_ACT_CNT_LAT6_RFM_ACT_CNT12_CONF                Fld(12, 0) //[11:0]
    #define RFM_ACT_CNT_LAT6_RFM_ACT_CNT13_CONF                Fld(12, 16) //[27:16]

#define DRAMC_REG_RFM_ACT_CNT_LAT7                             (DRAMC_AO_BASE_ADDRESS + 0x091C)
    #define RFM_ACT_CNT_LAT7_RFM_ACT_CNT14_CONF                Fld(12, 0) //[11:0]
    #define RFM_ACT_CNT_LAT7_RFM_ACT_CNT15_CONF                Fld(12, 16) //[27:16]

#define DRAMC_REG_REF_QUECNT_LAT0                              (DRAMC_AO_BASE_ADDRESS + 0x0920)
    #define REF_QUECNT_LAT0_REFRESH_QUEUE_CNT_CONF             Fld(4, 0) //[3:0]

#define DRAMC_REG_MR_BACKUP_00_RK0_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0980)
    #define MR_BACKUP_00_RK0_FSP0_MRWBK_RK0_FSP0_MR10          Fld(8, 24) //[31:24]
...
#define DRAMC_REG_MR_BACKUP_01_RK0_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0984)
    #define MR_BACKUP_01_RK0_FSP0_MRWBK_RK0_FSP0_MR15          Fld(8, 24) //[31:24]
    #define MR_BACKUP_01_RK0_FSP0_MRWBK_RK0_FSP0_MR14          Fld(8, 16) //[23:16]
    #define MR_BACKUP_01_RK0_FSP0_MRWBK_RK0_FSP0_MR12          Fld(8, 8) //[15:8]
    #define MR_BACKUP_01_RK0_FSP0_MRWBK_RK0_FSP0_MR11          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_02_RK0_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0988)
    #define MR_BACKUP_02_RK0_FSP0_MRWBK_RK0_FSP0_MR20          Fld(8, 24) //[31:24]
    #define MR_BACKUP_02_RK0_FSP0_MRWBK_RK0_FSP0_MR19          Fld(8, 16) //[23:16]
    #define MR_BACKUP_02_RK0_FSP0_MRWBK_RK0_FSP0_MR18          Fld(8, 8) //[15:8]
    #define MR_BACKUP_02_RK0_FSP0_MRWBK_RK0_FSP0_MR17          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_03_RK0_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x098C)
    #define MR_BACKUP_03_RK0_FSP0_MRWBK_RK0_FSP0_MR30          Fld(8, 24) //[31:24]
    #define MR_BACKUP_03_RK0_FSP0_MRWBK_RK0_FSP0_MR24          Fld(8, 16) //[23:16]
    #define MR_BACKUP_03_RK0_FSP0_MRWBK_RK0_FSP0_MR22          Fld(8, 8) //[15:8]
    #define MR_BACKUP_03_RK0_FSP0_MRWBK_RK0_FSP0_MR21          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_04_RK0_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0990)
    #define MR_BACKUP_04_RK0_FSP0_MRWBK_RK0_FSP0_MR51          Fld(8, 8) //[15:8]
    #define MR_BACKUP_04_RK0_FSP0_MRWBK_RK0_FSP0_MR41          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_00_RK0_FSP1                        (DRAMC_AO_BASE_ADDRESS + 0x09A0)
...
#define DRAMC_REG_MR_BACKUP_01_RK0_FSP1                        (DRAMC_AO_BASE_ADDRESS + 0x09A4)
...
#define DRAMC_REG_MR_BACKUP_02_RK0_FSP1                        (DRAMC_AO_BASE_ADDRESS + 0x09A8)
...
#define DRAMC_REG_MR_BACKUP_03_RK0_FSP1                        (DRAMC_AO_BASE_ADDRESS + 0x09AC)
    #define MR_BACKUP_03_RK0_FSP1_MRWBK_RK0_FSP1_MR30          Fld(8, 24) //[31:24]
    #define MR_BACKUP_03_RK0_FSP1_MRWBK_RK0_FSP1_MR24          Fld(8, 16) //[23:16]
    #define MR_BACKUP_03_RK0_FSP1_MRWBK_RK0_FSP1_MR22          Fld(8, 8) //[15:8]
    #define MR_BACKUP_03_RK0_FSP1_MRWBK_RK0_FSP1_MR21          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_04_RK0_FSP1                        (DRAMC_AO_BASE_ADDRESS + 0x09B0)
    #define MR_BACKUP_04_RK0_FSP1_MRWBK_RK0_FSP1_MR51          Fld(8, 8) //[15:8]
    #define MR_BACKUP_04_RK0_FSP1_MRWBK_RK0_FSP1_MR41          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_00_RK0_FSP2                        (DRAMC_AO_BASE_ADDRESS + 0x09C0)
...
#define DRAMC_REG_MR_BACKUP_01_RK0_FSP2                        (DRAMC_AO_BASE_ADDRESS + 0x09C4)
...
#define DRAMC_REG_MR_BACKUP_02_RK0_FSP2                        (DRAMC_AO_BASE_ADDRESS + 0x09C8)
...
#define DRAMC_REG_MR_BACKUP_03_RK0_FSP2                        (DRAMC_AO_BASE_ADDRESS + 0x09CC)
    #define MR_BACKUP_03_RK0_FSP2_MRWBK_RK0_FSP2_MR30          Fld(8, 24) //[31:24]
    #define MR_BACKUP_03_RK0_FSP2_MRWBK_RK0_FSP2_MR24          Fld(8, 16) //[23:16]
    #define MR_BACKUP_03_RK0_FSP2_MRWBK_RK0_FSP2_MR22          Fld(8, 8) //[15:8]

#define DRAMC_REG_MR_BACKUP_04_RK0_FSP2                        (DRAMC_AO_BASE_ADDRESS + 0x09D0)
    #define MR_BACKUP_04_RK0_FSP2_MRWBK_RK0_FSP2_MR41          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_05_RK0_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x09E0)
    #define MR_BACKUP_05_RK0_FSP0_MRWBK_RK0_FSP0_MR16          Fld(8, 24) //[31:24]
    #define MR_BACKUP_05_RK0_FSP0_MRWBK_RK0_FSP0_MR13          Fld(8, 16) //[23:16]
    #define MR_BACKUP_05_RK0_FSP0_MRWBK_RK0_FSP0_MR9           Fld(8, 8) //[15:8]
    #define MR_BACKUP_05_RK0_FSP0_MRWBK_RK0_FSP0_MR4           Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_06_RK0_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x09E4)
    #define MR_BACKUP_06_RK0_FSP0_MRWBK_RK0_FSP0_MR28          Fld(8, 24) //[31:24]
    #define MR_BACKUP_06_RK0_FSP0_MRWBK_RK0_FSP0_MR26          Fld(8, 16) //[23:16]
    #define MR_BACKUP_06_RK0_FSP0_MRWBK_RK0_FSP0_MR25          Fld(8, 8) //[15:8]
    #define MR_BACKUP_06_RK0_FSP0_MRWBK_RK0_FSP0_MR23          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_07_RK0_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x09E8)
    #define MR_BACKUP_07_RK0_FSP0_MRWBK_RK0_FSP0_MR34          Fld(8, 24) //[31:24]
    #define MR_BACKUP_07_RK0_FSP0_MRWBK_RK0_FSP0_MR33          Fld(8, 16) //[23:16]
    #define MR_BACKUP_07_RK0_FSP0_MRWBK_RK0_FSP0_MR32          Fld(8, 8) //[15:8]
    #define MR_BACKUP_07_RK0_FSP0_MRWBK_RK0_FSP0_MR31          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_08_RK0_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x09EC)
    #define MR_BACKUP_08_RK0_FSP0_MRWBK_RK0_FSP0_MR42          Fld(8, 24) //[31:24]
    #define MR_BACKUP_08_RK0_FSP0_MRWBK_RK0_FSP0_MR40          Fld(8, 16) //[23:16]
    #define MR_BACKUP_08_RK0_FSP0_MRWBK_RK0_FSP0_MR39          Fld(8, 8) //[15:8]
    #define MR_BACKUP_08_RK0_FSP0_MRWBK_RK0_FSP0_MR37          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_09_RK0_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x09F0)
    #define MR_BACKUP_09_RK0_FSP0_MRWBK_RK0_FSP0_MR63          Fld(8, 24) //[31:24]
    #define MR_BACKUP_09_RK0_FSP0_MRWBK_RK0_FSP0_MR57          Fld(8, 16) //[23:16]
    #define MR_BACKUP_09_RK0_FSP0_MRWBK_RK0_FSP0_MR48          Fld(8, 8) //[15:8]
    #define MR_BACKUP_09_RK0_FSP0_MRWBK_RK0_FSP0_MR46          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_00_RK1_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0B80)
    #define MR_BACKUP_00_RK1_FSP0_MRWBK_RK1_FSP0_MR10          Fld(8, 24) //[31:24]
...
#define DRAMC_REG_MR_BACKUP_01_RK1_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0B84)
    #define MR_BACKUP_01_RK1_FSP0_MRWBK_RK1_FSP0_MR15          Fld(8, 24) //[31:24]
    #define MR_BACKUP_01_RK1_FSP0_MRWBK_RK1_FSP0_MR14          Fld(8, 16) //[23:16]
    #define MR_BACKUP_01_RK1_FSP0_MRWBK_RK1_FSP0_MR12          Fld(8, 8) //[15:8]
    #define MR_BACKUP_01_RK1_FSP0_MRWBK_RK1_FSP0_MR11          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_02_RK1_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0B88)
    #define MR_BACKUP_02_RK1_FSP0_MRWBK_RK1_FSP0_MR20          Fld(8, 24) //[31:24]
    #define MR_BACKUP_02_RK1_FSP0_MRWBK_RK1_FSP0_MR19          Fld(8, 16) //[23:16]
    #define MR_BACKUP_02_RK1_FSP0_MRWBK_RK1_FSP0_MR18          Fld(8, 8) //[15:8]
    #define MR_BACKUP_02_RK1_FSP0_MRWBK_RK1_FSP0_MR17          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_03_RK1_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0B8C)
    #define MR_BACKUP_03_RK1_FSP0_MRWBK_RK1_FSP0_MR30          Fld(8, 24) //[31:24]
    #define MR_BACKUP_03_RK1_FSP0_MRWBK_RK1_FSP0_MR24          Fld(8, 16) //[23:16]
    #define MR_BACKUP_03_RK1_FSP0_MRWBK_RK1_FSP0_MR22          Fld(8, 8) //[15:8]
    #define MR_BACKUP_03_RK1_FSP0_MRWBK_RK1_FSP0_MR21          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_04_RK1_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0B90)
    #define MR_BACKUP_04_RK1_FSP0_MRWBK_RK1_FSP0_MR51          Fld(8, 8) //[15:8]
    #define MR_BACKUP_04_RK1_FSP0_MRWBK_RK1_FSP0_MR41          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_00_RK1_FSP1                        (DRAMC_AO_BASE_ADDRESS + 0x0BA0)
...
#define DRAMC_REG_MR_BACKUP_01_RK1_FSP1                        (DRAMC_AO_BASE_ADDRESS + 0x0BA4)
...
#define DRAMC_REG_MR_BACKUP_02_RK1_FSP1                        (DRAMC_AO_BASE_ADDRESS + 0x0BA8)
...
#define DRAMC_REG_MR_BACKUP_03_RK1_FSP1                        (DRAMC_AO_BASE_ADDRESS + 0x0BAC)
    #define MR_BACKUP_03_RK1_FSP1_MRWBK_RK1_FSP1_MR30          Fld(8, 24) //[31:24]
    #define MR_BACKUP_03_RK1_FSP1_MRWBK_RK1_FSP1_MR24          Fld(8, 16) //[23:16]
    #define MR_BACKUP_03_RK1_FSP1_MRWBK_RK1_FSP1_MR22          Fld(8, 8) //[15:8]
    #define MR_BACKUP_03_RK1_FSP1_MRWBK_RK1_FSP1_MR21          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_04_RK1_FSP1                        (DRAMC_AO_BASE_ADDRESS + 0x0BB0)
    #define MR_BACKUP_04_RK1_FSP1_MRWBK_RK1_FSP1_MR51          Fld(8, 8) //[15:8]
    #define MR_BACKUP_04_RK1_FSP1_MRWBK_RK1_FSP1_MR41          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_00_RK1_FSP2                        (DRAMC_AO_BASE_ADDRESS + 0x0BC0)
...
#define DRAMC_REG_MR_BACKUP_01_RK1_FSP2                        (DRAMC_AO_BASE_ADDRESS + 0x0BC4)
...
#define DRAMC_REG_MR_BACKUP_02_RK1_FSP2                        (DRAMC_AO_BASE_ADDRESS + 0x0BC8)
...
#define DRAMC_REG_MR_BACKUP_03_RK1_FSP2                        (DRAMC_AO_BASE_ADDRESS + 0x0BCC)
    #define MR_BACKUP_03_RK1_FSP2_MRWBK_RK1_FSP2_MR30          Fld(8, 24) //[31:24]
    #define MR_BACKUP_03_RK1_FSP2_MRWBK_RK1_FSP2_MR24          Fld(8, 16) //[23:16]
    #define MR_BACKUP_03_RK1_FSP2_MRWBK_RK1_FSP2_MR22          Fld(8, 8) //[15:8]

#define DRAMC_REG_MR_BACKUP_04_RK1_FSP2                        (DRAMC_AO_BASE_ADDRESS + 0x0BD0)
    #define MR_BACKUP_04_RK1_FSP2_MRWBK_RK1_FSP2_MR41          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_05_RK1_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0BE0)
    #define MR_BACKUP_05_RK1_FSP0_MRWBK_RK1_FSP0_MR16          Fld(8, 24) //[31:24]
    #define MR_BACKUP_05_RK1_FSP0_MRWBK_RK1_FSP0_MR13          Fld(8, 16) //[23:16]
    #define MR_BACKUP_05_RK1_FSP0_MRWBK_RK1_FSP0_MR9           Fld(8, 8) //[15:8]
    #define MR_BACKUP_05_RK1_FSP0_MRWBK_RK1_FSP0_MR4           Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_06_RK1_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0BE4)
    #define MR_BACKUP_06_RK1_FSP0_MRWBK_RK1_FSP0_MR28          Fld(8, 24) //[31:24]
    #define MR_BACKUP_06_RK1_FSP0_MRWBK_RK1_FSP0_MR26          Fld(8, 16) //[23:16]
    #define MR_BACKUP_06_RK1_FSP0_MRWBK_RK1_FSP0_MR25          Fld(8, 8) //[15:8]
    #define MR_BACKUP_06_RK1_FSP0_MRWBK_RK1_FSP0_MR23          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_07_RK1_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0BE8)
    #define MR_BACKUP_07_RK1_FSP0_MRWBK_RK1_FSP0_MR34          Fld(8, 24) //[31:24]
    #define MR_BACKUP_07_RK1_FSP0_MRWBK_RK1_FSP0_MR33          Fld(8, 16) //[23:16]
    #define MR_BACKUP_07_RK1_FSP0_MRWBK_RK1_FSP0_MR32          Fld(8, 8) //[15:8]
    #define MR_BACKUP_07_RK1_FSP0_MRWBK_RK1_FSP0_MR31          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_08_RK1_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0BEC)
    #define MR_BACKUP_08_RK1_FSP0_MRWBK_RK1_FSP0_MR42          Fld(8, 24) //[31:24]
    #define MR_BACKUP_08_RK1_FSP0_MRWBK_RK1_FSP0_MR40          Fld(8, 16) //[23:16]
    #define MR_BACKUP_08_RK1_FSP0_MRWBK_RK1_FSP0_MR39          Fld(8, 8) //[15:8]
    #define MR_BACKUP_08_RK1_FSP0_MRWBK_RK1_FSP0_MR37          Fld(8, 0) //[7:0]

#define DRAMC_REG_MR_BACKUP_09_RK1_FSP0                        (DRAMC_AO_BASE_ADDRESS + 0x0BF0)
    #define MR_BACKUP_09_RK1_FSP0_MRWBK_RK1_FSP0_MR63          Fld(8, 24) //[31:24]
    #define MR_BACKUP_09_RK1_FSP0_MRWBK_RK1_FSP0_MR57          Fld(8, 16) //[23:16]
    #define MR_BACKUP_09_RK1_FSP0_MRWBK_RK1_FSP0_MR48          Fld(8, 8) //[15:8]
    #define MR_BACKUP_09_RK1_FSP0_MRWBK_RK1_FSP0_MR46          Fld(8, 0) //[7:0]
...
#define DRAMC_REG_MR_BACKUP_FSP_WR                             (DRAMC_AO_BASE_ADDRESS + 0x0D10)
    #define MR_BACKUP_FSP_WR_MRWBK_RK1_FSP_WR                  Fld(2, 2) //[3:2]
    #define MR_BACKUP_FSP_WR_MRWBK_RK0_FSP_WR                  Fld(2, 0) //[1:0]

#define DRAMC_REG_EMI_HANG_DBG1                                (DRAMC_AO_BASE_ADDRESS + 0x0D14)
...
#define DRAMC_REG_CMDELA_BUF0_CNT                              (DRAMC_AO_BASE_ADDRESS + 0x0D50)
    #define CMDELA_BUF0_CNT_BUF0_CNT                           Fld(27, 5) //[31:5]

#define DRAMC_REG_CMDELA_BUF1_CNT                              (DRAMC_AO_BASE_ADDRESS + 0x0D54)
    #define CMDELA_BUF1_CNT_BUF1_CNT                           Fld(27, 5) //[31:5]

#define DRAMC_REG_CMDELA_BUF2_CNT                              (DRAMC_AO_BASE_ADDRESS + 0x0D58)
    #define CMDELA_BUF2_CNT_BUF2_CNT                           Fld(27, 5) //[31:5]

#define DRAMC_REG_CMDELA_BUF3_CNT                              (DRAMC_AO_BASE_ADDRESS + 0x0D5C)
    #define CMDELA_BUF3_CNT_BUF3_CNT                           Fld(27, 5) //[31:5]

#define DRAMC_REG_CMDELA_INT_FSM_STA                           (DRAMC_AO_BASE_ADDRESS + 0x0D60)
    #define CMDELA_INT_FSM_STA_FSMSTA                          Fld(16, 0) //[15:0]
    #define CMDELA_INT_FSM_STA_ELA_INTSTA                      Fld(8, 16) //[23:16]

#define DRAMC_REG_CMDELA_PTR_FLAG0                             (DRAMC_AO_BASE_ADDRESS + 0x0D64)
    #define CMDELA_PTR_FLAG0_CURR_WPTR                         Fld(10, 0) //[9:0]
    #define CMDELA_PTR_FLAG0_CURR_RPTR                         Fld(10, 20) //[29:20]

#define DRAMC_REG_CMDELA_PACK_HWSAVE_FALG0                     (DRAMC_AO_BASE_ADDRESS + 0x0D88)
    #define CMDELA_PACK_HWSAVE_FALG0_CMDELA_CMD_INTV_TIME_CNT  Fld(14, 9) //[22:9]
    #define CMDELA_PACK_HWSAVE_FALG0_CMDELA_TEMP_SUBCNT        Fld(4, 5) //[8:5]
    #define CMDELA_PACK_HWSAVE_FALG0_CMDELA_TEMP_MAINCNT       Fld(1, 4) //[4:4]
    #define CMDELA_PACK_HWSAVE_FALG0_DRAMC_ELA_DATA_MUXSEL     Fld(1, 3) //[3:3]
    #define CMDELA_PACK_HWSAVE_FALG0_SRAM_FULL_FLAG            Fld(1, 2) //[2:2]
    #define CMDELA_PACK_HWSAVE_FALG0_DRAMC_ELA_READY_Q         Fld(1, 1) //[1:1]
    #define CMDELA_PACK_HWSAVE_FALG0_CMDELA_EN_Q               Fld(1, 0) //[0:0]

#define DRAMC_REG_CMDELA_PACK_1ST_256BITS_DATA0                (DRAMC_AO_BASE_ADDRESS + 0x0D8C)
    #define CMDELA_PACK_1ST_256BITS_DATA0_CMDELA_PACK_1ST_256BITS_DATA0 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_1ST_256BITS_DATA1                (DRAMC_AO_BASE_ADDRESS + 0x0D90)
    #define CMDELA_PACK_1ST_256BITS_DATA1_CMDELA_PACK_1ST_256BITS_DATA1 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_1ST_256BITS_DATA2                (DRAMC_AO_BASE_ADDRESS + 0x0D94)
    #define CMDELA_PACK_1ST_256BITS_DATA2_CMDELA_PACK_1ST_256BITS_DATA2 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_1ST_256BITS_DATA3                (DRAMC_AO_BASE_ADDRESS + 0x0D98)
    #define CMDELA_PACK_1ST_256BITS_DATA3_CMDELA_PACK_1ST_256BITS_DATA3 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_1ST_256BITS_DATA4                (DRAMC_AO_BASE_ADDRESS + 0x0D9C)
    #define CMDELA_PACK_1ST_256BITS_DATA4_CMDELA_PACK_1ST_256BITS_DATA4 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_1ST_256BITS_DATA5                (DRAMC_AO_BASE_ADDRESS + 0x0DA0)
    #define CMDELA_PACK_1ST_256BITS_DATA5_CMDELA_PACK_1ST_256BITS_DATA5 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_1ST_256BITS_DATA6                (DRAMC_AO_BASE_ADDRESS + 0x0DA4)
    #define CMDELA_PACK_1ST_256BITS_DATA6_CMDELA_PACK_1ST_256BITS_DATA6 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_1ST_256BITS_DATA7                (DRAMC_AO_BASE_ADDRESS + 0x0DA8)
    #define CMDELA_PACK_1ST_256BITS_DATA7_CMDELA_PACK_1ST_256BITS_DATA7 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_2ND_256BITS_DATA0                (DRAMC_AO_BASE_ADDRESS + 0x0DAC)
    #define CMDELA_PACK_2ND_256BITS_DATA0_CMDELA_PACK_2ND_256BITS_DATA0 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_2ND_256BITS_DATA1                (DRAMC_AO_BASE_ADDRESS + 0x0DB0)
    #define CMDELA_PACK_2ND_256BITS_DATA1_CMDELA_PACK_2ND_256BITS_DATA1 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_2ND_256BITS_DATA2                (DRAMC_AO_BASE_ADDRESS + 0x0DB4)
    #define CMDELA_PACK_2ND_256BITS_DATA2_CMDELA_PACK_2ND_256BITS_DATA2 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_2ND_256BITS_DATA3                (DRAMC_AO_BASE_ADDRESS + 0x0DB8)
    #define CMDELA_PACK_2ND_256BITS_DATA3_CMDELA_PACK_2ND_256BITS_DATA3 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_2ND_256BITS_DATA4                (DRAMC_AO_BASE_ADDRESS + 0x0DBC)
    #define CMDELA_PACK_2ND_256BITS_DATA4_CMDELA_PACK_2ND_256BITS_DATA4 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_2ND_256BITS_DATA5                (DRAMC_AO_BASE_ADDRESS + 0x0DC0)
    #define CMDELA_PACK_2ND_256BITS_DATA5_CMDELA_PACK_2ND_256BITS_DATA5 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_2ND_256BITS_DATA6                (DRAMC_AO_BASE_ADDRESS + 0x0DC4)
    #define CMDELA_PACK_2ND_256BITS_DATA6_CMDELA_PACK_2ND_256BITS_DATA6 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_PACK_2ND_256BITS_DATA7                (DRAMC_AO_BASE_ADDRESS + 0x0DCC)
    #define CMDELA_PACK_2ND_256BITS_DATA7_CMDELA_PACK_2ND_256BITS_DATA7 Fld(32, 0) //[31:0]

#define DRAMC_REG_CMDELA_BUF_TRIG_HWSAVE_FALG0                 (DRAMC_AO_BASE_ADDRESS + 0x0DD0)
    #define CMDELA_BUF_TRIG_HWSAVE_FALG0_CMDELA_BUF_TRIG_SRAM_EVER_FULL Fld(1, 23) //[23:23]
    #define CMDELA_BUF_TRIG_HWSAVE_FALG0_CMDELA_BUF_TRIG_CNT_AFT_TRIG_DONE Fld(1, 22) //[22:22]
    #define CMDELA_BUF_TRIG_HWSAVE_FALG0_CMDELA_BUF_TRIG_CNT_AFT_TRIG_EN Fld(1, 21) //[21:21]
    #define CMDELA_BUF_TRIG_HWSAVE_FALG0_CMDELA_BUF_TRIG_CNT_AFT_TRIG Fld(8, 13) //[20:13]
    #define CMDELA_BUF_TRIG_HWSAVE_FALG0_CMDELA_BUF_TRIG_HAS_1ST_TRIG Fld(1, 12) //[12:12]
    #define CMDELA_BUF_TRIG_HWSAVE_FALG0_CMDELA_BUF_TRIG_TRIG_WPTR Fld(9, 3) //[11:3]
    #define CMDELA_BUF_TRIG_HWSAVE_FALG0_CMDELA_BUF_TRIG_CUR_ST Fld(3, 0) //[2:0]

#define DRAMC_REG_CMDELA_BUF_SRAM_HWSAVE_FALG0                 (DRAMC_AO_BASE_ADDRESS + 0x0DD4)
    #define CMDELA_BUF_SRAM_HWSAVE_FALG0_CMDELA_BUF_SRAM_SRAM_WPTR Fld(9, 0) //[8:0]

#define DRAMC_REG_DRAMC_IRQ_STATUS1                            (DRAMC_AO_BASE_ADDRESS + 0x0F00)
    #define DRAMC_IRQ_STATUS1_DRAMC_IRQ_STATUS1                Fld(32, 0) //[31:0]

#define DRAMC_REG_DRAMC_IRQ_STATUS2                            (DRAMC_AO_BASE_ADDRESS + 0x0F04)
    #define DRAMC_IRQ_STATUS2_DRAMC_IRQ_STATUS2                Fld(32, 0) //[31:0]

#define DRAMC_REG_DRAMC_IRQ_INFO1                              (DRAMC_AO_BASE_ADDRESS + 0x0F10)
    #define DRAMC_IRQ_INFO1_REFRESH_RATE_FOR_INT               Fld(5, 0) //[4:0]
    #define DRAMC_IRQ_INFO1_REFRESH_QUEUE_CNT_FOR_INT          Fld(4, 8) //[11:8]
    #define DRAMC_IRQ_INFO1_REFRESH_RATE_CHG_QUEUE_CNT_FOR_INT Fld(4, 12) //[15:12]
    #define DRAMC_IRQ_INFO1_REFRESH_RATE_RK1_FOR_INT           Fld(5, 16) //[20:16]
    #define DRAMC_IRQ_INFO1_REFRESH_QUEUE_CNT_RK1_FOR_INT      Fld(4, 24) //[27:24]
    #define DRAMC_IRQ_INFO1_REFRESH_RATE_CHG_QUEUE_CNT_RK1_FOR_INT Fld(4, 28) //[31:28]

#define DRAMC_REG_DRAMC_IRQ_INFO1A                             (DRAMC_AO_BASE_ADDRESS + 0x0F14)
    #define DRAMC_IRQ_INFO1A_PRE_REFRESH_RATE_RK0_FOR_INT      Fld(5, 0) //[4:0]
    #define DRAMC_IRQ_INFO1A_PRE_REFRESH_RATE_RK1_FOR_INT      Fld(5, 8) //[12:8]
    #define DRAMC_IRQ_INFO1A_PRE_REFRESH_RATE_RK0_B1_FOR_INT   Fld(5, 16) //[20:16]
    #define DRAMC_IRQ_INFO1A_PRE_REFRESH_RATE_RK1_B1_FOR_INT   Fld(5, 24) //[28:24]

#define DRAMC_REG_DRAMC_IRQ_INFO2                              (DRAMC_AO_BASE_ADDRESS + 0x0F20)
    #define DRAMC_IRQ_INFO2_RK0_MR18_INT1_FOR_INT              Fld(16, 0) //[15:0]
    #define DRAMC_IRQ_INFO2_RK0_MR19_INT1_FOR_INT              Fld(16, 16) //[31:16]

#define DRAMC_REG_DRAMC_IRQ_INFO3                              (DRAMC_AO_BASE_ADDRESS + 0x0F24)
    #define DRAMC_IRQ_INFO3_RK1_MR18_INT1_FOR_INT              Fld(16, 0) //[15:0]
    #define DRAMC_IRQ_INFO3_RK1_MR19_INT1_FOR_INT              Fld(16, 16) //[31:16]

#define DRAMC_REG_DRAMC_IRQ_INFO4                              (DRAMC_AO_BASE_ADDRESS + 0x0F28)
    #define DRAMC_IRQ_INFO4_RK0_MR18_INT2_FOR_INT              Fld(16, 0) //[15:0]
    #define DRAMC_IRQ_INFO4_RK0_MR19_INT2_FOR_INT              Fld(16, 16) //[31:16]

#define DRAMC_REG_DRAMC_IRQ_INFO5                              (DRAMC_AO_BASE_ADDRESS + 0x0F2C)
    #define DRAMC_IRQ_INFO5_RK1_MR18_INT2_FOR_INT              Fld(16, 0) //[15:0]
    #define DRAMC_IRQ_INFO5_RK1_MR19_INT2_FOR_INT              Fld(16, 16) //[31:16]

#define DRAMC_REG_DRAMC_IRQ_INFO1B                             (DRAMC_AO_BASE_ADDRESS + 0x0F30)
    #define DRAMC_IRQ_INFO1B_RXECC_SYD_B0_FOR_INT              Fld(9, 0) //[8:0]
    #define DRAMC_IRQ_INFO1B_RXECC_SYD_B1_FOR_INT              Fld(9, 16) //[24:16]

#define DRAMC_REG_DRAMC_IRQ_INFO2B                             (DRAMC_AO_BASE_ADDRESS + 0x0F34)
    #define DRAMC_IRQ_INFO2B_RXECC_CV_B0_FOR_INT               Fld(9, 0) //[8:0]
    #define DRAMC_IRQ_INFO2B_RXECC_CV_B1_FOR_INT               Fld(9, 16) //[24:16]

#define DRAMC_REG_DRAMC_IRQ_INFO3B                             (DRAMC_AO_BASE_ADDRESS + 0x0F38)
    #define DRAMC_IRQ_INFO3B_RXECC_SBE_CNT_B0_FOR_INT          Fld(7, 0) //[6:0]
    #define DRAMC_IRQ_INFO3B_RXECC_SBE_CNT_B1_FOR_INT          Fld(7, 8) //[14:8]
    #define DRAMC_IRQ_INFO3B_RXECC_DBE_CNT_B0_FOR_INT          Fld(7, 16) //[22:16]
    #define DRAMC_IRQ_INFO3B_RXECC_DBE_CNT_B1_FOR_INT          Fld(7, 24) //[30:24]

#define DRAMC_REG_DRAMC_IRQ_INFO4B                             (DRAMC_AO_BASE_ADDRESS + 0x0F3C)
    #define DRAMC_IRQ_INFO4B_SHUFFLE_END_FOR_INT               Fld(1, 0) //[0:0]
    #define DRAMC_IRQ_INFO4B_TCKFSPE_OK_FOR_INT                Fld(1, 1) //[1:1]
    #define DRAMC_IRQ_INFO4B_TCKFSPX_OK_FOR_INT                Fld(1, 2) //[2:2]
    #define DRAMC_IRQ_INFO4B_TVRCG_EN_OK_FOR_INT               Fld(1, 3) //[3:3]
    #define DRAMC_IRQ_INFO4B_RTMRW_MRW1_RSP_FOR_INT            Fld(1, 4) //[4:4]
    #define DRAMC_IRQ_INFO4B_RTMRW_MRW2_RSP_FOR_INT            Fld(1, 5) //[5:5]
    #define DRAMC_IRQ_INFO4B_RTMRW_MRW3_RSP_FOR_INT            Fld(1, 6) //[6:6]
    #define DRAMC_IRQ_INFO4B_DVFS_STATE_FOR_INT                Fld(8, 8) //[15:8]
    #define DRAMC_IRQ_INFO4B_SCARB_SM_FOR_INT                  Fld(5, 16) //[20:16]

#define DRAMC_REG_DRAMC_IRQ_INFO7                              (DRAMC_AO_BASE_ADDRESS + 0x0F40)
    #define DRAMC_IRQ_INFO7_PENDING_DLE_CNT_FOR_INT            Fld(8, 0) //[7:0]
    #define DRAMC_IRQ_INFO7_CMD_STALL_FOR_INT                  Fld(1, 8) //[8:8]
    #define DRAMC_IRQ_INFO7_CMD_STALL_CMD_OUT_CNT_FOR_INT      Fld(4, 12) //[15:12]
    #define DRAMC_IRQ_INFO7_CMD_STALL_DLE_CNT_MAX_FOR_INT      Fld(8, 16) //[23:16]
    #define DRAMC_IRQ_INFO7_PENDING_DLE_CNT_MAX_FOR_INT        Fld(8, 24) //[31:24]

#define DRAMC_REG_DRAMC_IRQ_INFO8                              (DRAMC_AO_BASE_ADDRESS + 0x0F44)
    #define DRAMC_IRQ_INFO8_CMD_STALL_COUNTER_FOR_INT          Fld(32, 0) //[31:0]

#define DRAMC_REG_DRAMC_IRQ_INFO9                              (DRAMC_AO_BASE_ADDRESS + 0x0F48)
    #define DRAMC_IRQ_INFO9_CMD_STALL_MAX_COUNTER_FOR_INT      Fld(32, 0) //[31:0]
...
#define DRAMC_REG_SHURK_APHY_TX_PICG_CTRL                      (DRAMC_AO_BASE_ADDRESS + 0x1234)
    #define SHURK_APHY_TX_PICG_CTRL_DDRPHY_CLK_EN_COMB_TX_DQ_RK_SEL_P1 Fld(5, 0) //[4:0]
    #define SHURK_APHY_TX_PICG_CTRL_DDRPHY_CLK_EN_COMB_TX_DQ_RK_SEL_P0 Fld(5, 8) //[12:8]
    #define SHURK_APHY_TX_PICG_CTRL_DDRPHY_CLK_EN_COMB_TX_WCK_RK_SEL_P1 Fld(5, 16) //[20:16]
    #define SHURK_APHY_TX_PICG_CTRL_DDRPHY_CLK_EN_COMB_TX_WCK_RK_SEL_P0 Fld(5, 24) //[28:24]
...
#define DRAMC_REG_SHU_ACTIM3                                   (DRAMC_AO_BASE_ADDRESS + 0x1650)
    #define SHU_ACTIM3_TRFCPB                                  Fld(9, 0) //[8:0]
    #define SHU_ACTIM3_MANTMRR                                 Fld(4, 9) //[12:9]
    #define SHU_ACTIM3_TR2MRR                                  Fld(4, 13) //[16:13]
    #define SHU_ACTIM3_TRFC                                    Fld(9, 17) //[25:17]
    #define SHU_ACTIM3_TWTR_L                                  Fld(6, 26) //[31:26]
...
#define DRAMC_REG_SHU_ACTIM_XRT                                (DRAMC_AO_BASE_ADDRESS + 0x1660)
    #define SHU_ACTIM_XRT_XRTR2R                               Fld(6, 0) //[5:0]
    #define SHU_ACTIM_XRT_XRTR2W                               Fld(6, 8) //[13:8]
    #define SHU_ACTIM_XRT_XRTW2R                               Fld(5, 16) //[20:16]
...
#define DRAMC_REG_SHU_CKECTRL                                  (DRAMC_AO_BASE_ADDRESS + 0x1678)
    ...
    #define SHU_CKECTRL_TPDE                                   Fld(4, 12) //[15:12]
    #define SHU_CKECTRL_TPDX                                   Fld(4, 16) //[19:16]
    #define SHU_CKECTRL_TCKEPRD                                Fld(4, 20) //[23:20]
    #define SHU_CKECTRL_TCKESRX                                Fld(2, 24) //[25:24]

#define DRAMC_REG_SHU_RX_SET0                                  (DRAMC_AO_BASE_ADDRESS + 0x1680)
    #define SHU_RX_SET0_RDLE128_PACKING_EN                     Fld(1, 31) //[31:31]
...
#define DRAMC_REG_SHU_WODT                                     (DRAMC_AO_BASE_ADDRESS + 0x1684)
    ...
    #define SHU_WODT_DRAMOBF_PIPE_NO                           Fld(4, 28) //[31:28]
...
#define DRAMC_REG_SHU_APHY_TX_PICG_CTRL                        (DRAMC_AO_BASE_ADDRESS + 0x16AC)
    ...
    #define SHU_APHY_TX_PICG_CTRL_DDRPHY_CLK_EN_COMB_TX_DQS_SEL_P1 Fld(5, 4) //[8:4]
    #define SHU_APHY_TX_PICG_CTRL_DDRPHY_CLK_EN_COMB_TX_DQS_SEL_P0 Fld(5, 16) //[20:16]
    #define SHU_APHY_TX_PICG_CTRL_DPHY_TX_DCM_EXTCNT           Fld(3, 24) //[26:24]
    #define SHU_APHY_TX_PICG_CTRL_DPHY_WCK_DCM_EXTCNT          Fld(3, 28) //[30:28]
...
#define DRAMC_REG_SHU_TX_SET1                                  (DRAMC_AO_BASE_ADDRESS + 0x16C8)
    ...
    #define SHU_TX_SET1_TXPICG_DQ_MCK_OFFSET_LAG               Fld(1, 13) //[13:13]
    #define SHU_TX_SET1_TXPICG_DQS_MCK_OFFSET_LAG              Fld(1, 14) //[14:14]
...
#define DRAMC_REG_SHU_DVFS_ST_TIMING_CTRL0                     (DRAMC_AO_BASE_ADDRESS + 0x16D0)
...
#define DRAMC_REG_SHU_CMD_PICG                                 (DRAMC_AO_BASE_ADDRESS + 0x16D8)
    #define SHU_CMD_PICG_SP_CMDCG_OPT                          Fld(1, 0) //[0:0]
...
#define DRAMC_REG_SHU_ACTIM8                                   (DRAMC_AO_BASE_ADDRESS + 0x16EC)
    #define SHU_ACTIM8_TRFMPB                                  Fld(9, 0) //[8:0]
    #define SHU_ACTIM8_TRFMPB_05T                              Fld(1, 9) //[9:9]
    #define SHU_ACTIM8_NWR                                     Fld(8, 10) //[17:10]
    #define SHU_ACTIM8_NRBTP                                   Fld(6, 18) //[23:18]

#define DRAMC_REG_SHU_ACTIM9                                   (DRAMC_AO_BASE_ADDRESS + 0x16F0)
    #define SHU_ACTIM9_TCCD_L                                  Fld(4, 0) //[3:0]
    #define SHU_ACTIM9_TRRD_L                                  Fld(4, 4) //[7:4]
    #define SHU_ACTIM9_TCCD_L_05T                              Fld(1, 15) //[15:15]
    #define SHU_ACTIM9_TRRD_L_05T                              Fld(1, 16) //[16:16]
...
#define DRAMC_REG_SHU_TX_TRACKING_SET0                         (DRAMC_AO_BASE_ADDRESS + 0x16F8)
    #define SHU_TX_TRACKING_SET0_DMYWR_MARGIN                  Fld(6, 0) //[5:0]
    #define SHU_TX_TRACKING_SET0_DMYWR_MARGIN_LEN              Fld(6, 8) //[13:8]
...
#define DRAMC_REG_SHU_DVFS_MRW0                                (DRAMC_AO_BASE_ADDRESS + 0x1704)
    #define SHU_DVFS_MRW0_SWDVFSMRW0_OP                        Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW0_SWDVFSMRW0_MA                        Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW0_SWDVFSMRW0_RK                        Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW1                                (DRAMC_AO_BASE_ADDRESS + 0x1708)
    #define SHU_DVFS_MRW1_SWDVFSMRW1_OP                        Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW1_SWDVFSMRW1_MA                        Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW1_SWDVFSMRW1_RK                        Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW2                                (DRAMC_AO_BASE_ADDRESS + 0x170C)
    #define SHU_DVFS_MRW2_SWDVFSMRW2_OP                        Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW2_SWDVFSMRW2_MA                        Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW2_SWDVFSMRW2_RK                        Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW3                                (DRAMC_AO_BASE_ADDRESS + 0x1710)
    #define SHU_DVFS_MRW3_SWDVFSMRW3_OP                        Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW3_SWDVFSMRW3_MA                        Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW3_SWDVFSMRW3_RK                        Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW4                                (DRAMC_AO_BASE_ADDRESS + 0x1714)
    #define SHU_DVFS_MRW4_SWDVFSMRW4_OP                        Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW4_SWDVFSMRW4_MA                        Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW4_SWDVFSMRW4_RK                        Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW5                                (DRAMC_AO_BASE_ADDRESS + 0x1718)
    #define SHU_DVFS_MRW5_SWDVFSMRW5_OP                        Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW5_SWDVFSMRW5_MA                        Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW5_SWDVFSMRW5_RK                        Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW6                                (DRAMC_AO_BASE_ADDRESS + 0x171C)
    #define SHU_DVFS_MRW6_SWDVFSMRW6_OP                        Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW6_SWDVFSMRW6_MA                        Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW6_SWDVFSMRW6_RK                        Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW7                                (DRAMC_AO_BASE_ADDRESS + 0x1720)
    #define SHU_DVFS_MRW7_SWDVFSMRW7_OP                        Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW7_SWDVFSMRW7_MA                        Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW7_SWDVFSMRW7_RK                        Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW8                                (DRAMC_AO_BASE_ADDRESS + 0x1724)
    #define SHU_DVFS_MRW8_SWDVFSMRW8_OP                        Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW8_SWDVFSMRW8_MA                        Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW8_SWDVFSMRW8_RK                        Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW9                                (DRAMC_AO_BASE_ADDRESS + 0x1728)
    #define SHU_DVFS_MRW9_SWDVFSMRW9_OP                        Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW9_SWDVFSMRW9_MA                        Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW9_SWDVFSMRW9_RK                        Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW10                               (DRAMC_AO_BASE_ADDRESS + 0x172C)
    #define SHU_DVFS_MRW10_SWDVFSMRW10_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW10_SWDVFSMRW10_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW10_SWDVFSMRW10_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW11                               (DRAMC_AO_BASE_ADDRESS + 0x1730)
    #define SHU_DVFS_MRW11_SWDVFSMRW11_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW11_SWDVFSMRW11_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW11_SWDVFSMRW11_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW12                               (DRAMC_AO_BASE_ADDRESS + 0x1734)
    #define SHU_DVFS_MRW12_SWDVFSMRW12_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW12_SWDVFSMRW12_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW12_SWDVFSMRW12_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW13                               (DRAMC_AO_BASE_ADDRESS + 0x1738)
    #define SHU_DVFS_MRW13_SWDVFSMRW13_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW13_SWDVFSMRW13_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW13_SWDVFSMRW13_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW14                               (DRAMC_AO_BASE_ADDRESS + 0x173C)
    #define SHU_DVFS_MRW14_SWDVFSMRW14_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW14_SWDVFSMRW14_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW14_SWDVFSMRW14_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW15                               (DRAMC_AO_BASE_ADDRESS + 0x1740)
    #define SHU_DVFS_MRW15_SWDVFSMRW15_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW15_SWDVFSMRW15_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW15_SWDVFSMRW15_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW16                               (DRAMC_AO_BASE_ADDRESS + 0x1744)
    #define SHU_DVFS_MRW16_SWDVFSMRW16_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW16_SWDVFSMRW16_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW16_SWDVFSMRW16_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW17                               (DRAMC_AO_BASE_ADDRESS + 0x1748)
    #define SHU_DVFS_MRW17_SWDVFSMRW17_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW17_SWDVFSMRW17_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW17_SWDVFSMRW17_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW18                               (DRAMC_AO_BASE_ADDRESS + 0x174C)
    #define SHU_DVFS_MRW18_SWDVFSMRW18_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW18_SWDVFSMRW18_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW18_SWDVFSMRW18_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW19                               (DRAMC_AO_BASE_ADDRESS + 0x1750)
    #define SHU_DVFS_MRW19_SWDVFSMRW19_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW19_SWDVFSMRW19_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW19_SWDVFSMRW19_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW20                               (DRAMC_AO_BASE_ADDRESS + 0x1754)
    #define SHU_DVFS_MRW20_SWDVFSMRW20_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW20_SWDVFSMRW20_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW20_SWDVFSMRW20_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW21                               (DRAMC_AO_BASE_ADDRESS + 0x1758)
    #define SHU_DVFS_MRW21_SWDVFSMRW21_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW21_SWDVFSMRW21_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW21_SWDVFSMRW21_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW22                               (DRAMC_AO_BASE_ADDRESS + 0x175C)
    #define SHU_DVFS_MRW22_SWDVFSMRW22_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW22_SWDVFSMRW22_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW22_SWDVFSMRW22_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW23                               (DRAMC_AO_BASE_ADDRESS + 0x1760)
    #define SHU_DVFS_MRW23_SWDVFSMRW23_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW23_SWDVFSMRW23_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW23_SWDVFSMRW23_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW24                               (DRAMC_AO_BASE_ADDRESS + 0x1764)
    #define SHU_DVFS_MRW24_SWDVFSMRW24_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW24_SWDVFSMRW24_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW24_SWDVFSMRW24_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW25                               (DRAMC_AO_BASE_ADDRESS + 0x1768)
    #define SHU_DVFS_MRW25_SWDVFSMRW25_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW25_SWDVFSMRW25_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW25_SWDVFSMRW25_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW26                               (DRAMC_AO_BASE_ADDRESS + 0x176C)
    #define SHU_DVFS_MRW26_SWDVFSMRW26_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW26_SWDVFSMRW26_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW26_SWDVFSMRW26_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW27                               (DRAMC_AO_BASE_ADDRESS + 0x1770)
    #define SHU_DVFS_MRW27_SWDVFSMRW27_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW27_SWDVFSMRW27_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW27_SWDVFSMRW27_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW28                               (DRAMC_AO_BASE_ADDRESS + 0x1774)
    #define SHU_DVFS_MRW28_SWDVFSMRW28_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW28_SWDVFSMRW28_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW28_SWDVFSMRW28_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW29                               (DRAMC_AO_BASE_ADDRESS + 0x1778)
    #define SHU_DVFS_MRW29_SWDVFSMRW29_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW29_SWDVFSMRW29_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW29_SWDVFSMRW29_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW30                               (DRAMC_AO_BASE_ADDRESS + 0x177C)
    #define SHU_DVFS_MRW30_SWDVFSMRW30_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW30_SWDVFSMRW30_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW30_SWDVFSMRW30_RK                      Fld(2, 30) //[31:30]

#define DRAMC_REG_SHU_DVFS_MRW31                               (DRAMC_AO_BASE_ADDRESS + 0x1780)
    #define SHU_DVFS_MRW31_SWDVFSMRW31_OP                      Fld(8, 0) //[7:0]
    #define SHU_DVFS_MRW31_SWDVFSMRW31_MA                      Fld(8, 16) //[23:16]
    #define SHU_DVFS_MRW31_SWDVFSMRW31_RK                      Fld(2, 30) //[31:30]
