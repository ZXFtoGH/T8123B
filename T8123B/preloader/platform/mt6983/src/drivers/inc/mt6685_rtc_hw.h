...
#define RTC_BBPU_2SEC_MODE_MSK			(MT6685_BBPU_2SEC_MODE_MASK << (MT6685_BBPU_2SEC_MODE_SHIFT + 8)) /* RTC mask include shift */
...
#define RTC_XOSCCALI_MASK			(MT6685_XOSCCALI_MASK << MT6685_XOSCCALI_SHIFT)		/*Default 4'b0111, 2nd step suggest to set to 4'b0000 EOSC_CALI = charging cap calibration*/
#define RTC_XOSC32_ENB				(MT6685_RTC_XOSC32_ENB_MASK << MT6685_RTC_XOSC32_ENB_SHIFT)	/* 0 (32k crystal exist)	1 (32k crystal doesn't exist)*/
...
#define RTC_GP_OSC32_CON			(2U << (MT6685_RTC_GP_OSC32_CON_SHIFT + 8)) /* Keep RG_EOSC_RSV[0] to low for lower EOSC leakage current hardware design change. */
#define RTC_REG_XOSC32_ENB			(MT6685_RTC_REG_XOSC32_ENB_MASK << (MT6685_RTC_REG_XOSC32_ENB_SHIFT + 8))

#define RTC_EMBCK_SEL_HW 			(0 << MT6685_RTC_EMBCK_SEL_MODE_SHIFT)	/* 0: emb_hw	1: emb_k_eosc_32		2:dcxo_ck	3: eosc32_ck*/
...
#define RTC_CON_F32KOB				(MT6685_F32KOB_MASK << MT6685_F32KOB_SHIFT)	/* 0: RTC_GPIO exports 32K */
#define RTC_CON_GPO					(MT6685_GPO_MASK << MT6685_GPO_SHIFT)
#define RTC_CON_GOE					(MT6685_GOE_MASK << MT6685_GOE_SHIFT)	/* 1: GPO mode, 0: GPI mode */
...
#define RTC_CON_LPSTA_RAW			(MT6685_LPSTA_RAW_MASK << (MT6685_LPSTA_RAW_SHIFT + 8))	/* 32K was stopped */
