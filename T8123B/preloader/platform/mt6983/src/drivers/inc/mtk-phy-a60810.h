...
//U3D_USBPHYACR4
#define A60810_RG_USB20_DP_ABIST_SOURCE_EN        (0x1U<<31) //31:31
...
//U3D_USBPHYACR6
#define A60810_RG_USB20_ISO_EN				(0x1U << 31) /* 31:31 */
#define A60810_RG_USB20_PHY_REV                   (0xffU<<24) //31:24
...
//U3D_U2PHYACR3
#define A60810_RG_USB20_HSTX_DBIST                (0xfU<<28) //31:28
...
//U3D_U2PHYDCR0
#define A60810_RG_USB20_CDR_TST                   (0x3U<<30) //31:30
...
//U3D_U2PHYDCR1
#define A60810_RG_USB20_PROBE_SEL                 (0xffU<<24) //31:24
...
//U3D_U2PHYDTM0
#define A60810_RG_UART_MODE                       (0x3U<<30) //31:30
...
//U3D_U2PHYDTM1
#define A60810_RG_USB20_PRBS7_EN                  (0x1U<<31) //31:31
...
//U3D_U2PHYDMON1
#define A60810_USB20_UART_O                       (0x1U<<31) //31:31
...
//U3D_U2PHYDMON2
#define A60810_RGO_TXVALID_CNT                    (0xffU<<24) //31:24
...
//U3D_U2PHYDMON3
#define A60810_RGO_USB20_PRBS7_ERRCNT             (0xffffU<<16) //31:16
...
//U3D_U2PHYBC12C
#define A60810_RG_SIFSLV_CHGDT_DEGLCH_CNT         (0xfU<<28) //31:28
...
//U3D_VERSIONC
#define A60810_VERSION_CODE_REGFILE               (0xffU<<24) //31:24
...
//U3D_REGFCOM
#define A60810_RG_PAGE                            (0xffU<<24) //31:24
...
//U3D_reg0
#define A60810_RG_SSUSB_BGR_EN                    (0x1U<<31) //31:31
...
//U3D_reg1
#define A60810_RG_PCIE_CLKDRV_AMP                 (0x7U<<29) //31:29
...
//U3D_reg2
#define A60810_RG_SSUSB_SYSPLL_BR                 (0x1U<<31) //31:31
...
//U3D_reg3
#define A60810_RG_SSUSB_SYSPLL_FBDIV              (0x7fffffffU<<1) //31:1
#define A60810_RG_SSUSB_SYSPLL_HR_EN              (0x1<<0) //0:0

//U3D_reg4
#define A60810_RG_SSUSB_SYSPLL_SDM_DI_EN          (0x1U<<31) //31:31
...
//U3D_reg5
#define A60810_RG_SSUSB_TX250MCK_INVB             (0x1U<<31) //31:31
...
//U3D_reg6
#define A60810_RG_SSUSB_TX_EIDLE_CM               (0xfU<<28) //31:28
...
//U3D_reg7
#define A60810_RG_SSUSB_PLL_RESERVE               (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_PLL_SSC_PRD               (0xffff<<0) //15:0

//U3D_reg8
#define A60810_RG_SSUSB_PLL_SSC_PHASE_INI         (0x1U<<31) //31:31
...
//U3D_reg9
#define A60810_RG_SSUSB_CDR_PD_DIV_BYPASS         (0x1U<<31) //31:31
...
//U3D_regA
#define A60810_RG_SSUSB_RX_T2R_EN                 (0x1U<<31) //31:31
...
//U3D_regB
#define A60810_RG_SSUSB_CDR_RESERVE               (0xffU<<24) //31:24
...
//U3D_reg5
#define A60810_RG_SSUSB_PLL_BR_PE2D               (0x3U<<30) //31:30
...
//U3D_reg19
#define A60810_RG_SSUSB_PLL_SSC_DELTA1_PE1H       (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_PLL_SSC_DELTA1_U3         (0xffff<<0) //15:0

//U3D_reg20
#define A60810_RG_SSUSB_PLL_SSC_DELTA1_PE2H       (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_PLL_SSC_DELTA1_PE1D       (0xffff<<0) //15:0

//U3D_reg21
#define A60810_RG_SSUSB_PLL_SSC_DELTA_U3          (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_PLL_SSC_DELTA1_PE2D       (0xffff<<0) //15:0

//U3D_reg23
#define A60810_RG_SSUSB_PLL_SSC_DELTA_PE1D        (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_PLL_SSC_DELTA_PE1H        (0xffff<<0) //15:0

//U3D_reg25
#define A60810_RG_SSUSB_PLL_SSC_DELTA_PE2D        (0xffffU<<16) //31:16
...
//U3D_reg32
#define A60810_RG_SSUSB_EQ_RSTEP1_PE2D            (0x3U<<30) //31:30
...
//U3D_PHYD_MIX0
#define A60810_RG_SSUSB_P_P3_TX_NG                (0x1U<<31) //31:31
...
//U3D_PHYD_MIX1
#define A60810_RG_SSUSB_SLEEP_EN                  (0x1U<<31) //31:31
...
//U3D_PHYD_LFPS1
#define A60810_RG_SSUSB_RX_IMP_BIAS               (0xfU<<28) //31:28
...
//U3D_PHYD_IMPCAL0
#define A60810_RG_SSUSB_FORCE_TX_IMPSEL           (0x1U<<31) //31:31
...
//U3D_PHYD_IMPCAL1
#define A60810_RG_SSUSB_FORCE_RX_IMPSEL           (0x1U<<31) //31:31
...
//U3D_PHYD_TXPLL0
#define A60810_RG_SSUSB_TXPLL_DDSEN_CYC           (0x1fU<<27) //31:27
...
//U3D_PHYD_TXPLL1
#define A60810_RG_SSUSB_PLL_NCPO_EN               (0x1U<<31) //31:31
...
//U3D_PHYD_TXPLL2
#define A60810_RG_SSUSB_TX_LFPS_EN                (0x1U<<31) //31:31
...
//U3D_PHYD_FL0
#define A60810_RG_SSUSB_RX_FL_TARGET              (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_RX_FL_CYCLECNT            (0xffff<<0) //15:0

//U3D_PHYD_MIX2
#define A60810_RG_SSUSB_RX_EQ_RST                 (0x1U<<31) //31:31
...
//U3D_PHYD_RX0
#define A60810_RG_SSUSB_T2RLB_BERTH               (0xffU<<24) //31:24
...
//U3D_PHYD_MIX3
#define A60810_RG_SSUSB_CDR_TCADJ_MINUS           (0x1U<<31) //31:31
...
//U3D_PHYD_EBUFCTL
#define A60810_RG_SSUSB_EBUFCTL                   (0xffffffffU<<0) //31:0
...
//U3D_PHYD_PIPE1
#define A60810_RG_SSUSB_TXDATA                    (0xffffffffU<<0) //31:0
...
//U3D_PHYD_MIX5
#define A60810_RG_SSUSB_PRB_SEL                   (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_RXPLL_STBCYC              (0x7ff<<0) //10:0

//U3D_PHYD_RESERVED
#define A60810_RG_SSUSB_PHYD_RESERVE              (0xffffffffU<<0) //31:0

//U3D_PHYD_CDR0
#define A60810_RG_SSUSB_CDR_BIC_LTR               (0xfU<<28) //31:28
...
//U3D_PHYD_PLL_1
#define A60810_RG_SSUSB_CDR_BAND_5G               (0xffU<<24) //31:24
...
//U3D_PHYD_BCN_DET_1
#define A60810_RG_SSUSB_P_BCN_OBS_PRD             (0xffffU<<16) //31:16
...
//U3D_EQ3
#define A60810_RG_SSUSB_EQ_DLEQ_LFI_GEN2          (0xfU<<28) //31:28
...
//U3D_EQ_EYE0
#define A60810_RG_SSUSB_EQ_EYE_XOFFSET            (0x7fU<<25) //31:25
...
//U3D_EQ_EYE2
#define A60810_RG_SSUSB_EQ_RX500M_CK_SEL          (0x1U<<31) //31:31
...
//U3D_EQ_DFE0
#define A60810_RG_SSUSB_EQ_LEQMAX                 (0xfU<<28) //31:28
...
//U3D_EQ_DFE1
#define A60810_RG_SSUSB_EQ_REV                    (0xffffU<<16) //31:16
...
//U3D_EQ_DFE3
#define A60810_RG_SSUSB_EQ_RESERVED               (0xffffffffU<<0) //31:0

//U3D_PHYD_MON0
#define A60810_RGS_SSUSB_BERT_BERC                (0xffffU<<16) //31:16
...
//U3D_PHYD_MON2
#define A60810_RGS_SSUSB_T2RLB_ERRCNT             (0xffffU<<16) //31:16
...
//U3D_PHYD_MON3
#define A60810_RGS_SSUSB_TSEQ_ERRCNT              (0xffffU<<16) //31:16
...
//U3D_PHYD_MON5
#define A60810_RGS_SSUSB_EBUFMSG                  (0xffffU<<16) //31:16
...
//U3D_PHYA_RX_MON2
#define A60810_RGS_SSUSB_EQ_LEQ_STOP              (0x1U<<31) //31:31
...
//U3D_KBAND_OUT
#define A60810_RGS_SSUSB_CDR_BAND_5G              (0xffU<<24) //31:24
...
//U3D_B2_PHYD_TOP1
#define A60810_RG_SSUSB_PCIE2_K_EMP               (0xfU<<28) //31:28
...
//U3D_B2_PHYD_TOP4
#define A60810_RG_SSUSB_G1_CDR_BIC_LTR            (0xfU<<28) //31:28
...
//U3D_B2_PHYD_TOP6
#define A60810_RG_SSUSB_G2_CDR_BIC_LTR            (0xfU<<28) //31:28
...
#define A60810_RG_SSUSB_P_SIGDET_FLT_DIS          (0x1U<<31) //31:31
...
//U3D_B2_PHYD_RXDET1
#define A60810_RG_SSUSB_RXDET_PRB_SEL             (0x1U<<31) //31:31
...
//U3D_B2_PHYD_RXDET2
#define A60810_RG_SSUSB_PHYD_TRAINDEC_FORCE_CGEN  (0x1U<<31) //31:31
...
//U3D_B2_PHYD_MISC0
#define A60810_RG_SSUSB_TX_EIDLE_LP_P0DLYCYC      (0x3fU<<26) //31:26
...
//U3D_B2_PHYD_MISC2
#define A60810_RG_SSUSB_FRC_PLL_DDS_PREDIV2       (0x1U<<31) //31:31
...
//U3D_B2_PHYD_L1SS
#define A60810_RG_SSUSB_L1SS_REV1                 (0xffU<<24) //31:24
...
//U3D_B2_ROSC_0
#define A60810_RG_SSUSB_RING_OSC_CNTEND           (0x1ffU<<23) //31:23
...
//U3D_B2_ROSC_2
#define A60810_RG_SSUSB_RING_DET_STRCYC2          (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_RING_DET_STRCYC1          (0xffff<<0) //15:0

//U3D_B2_ROSC_3
#define A60810_RG_SSUSB_RING_DET_DETWIN1          (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_RING_DET_STRCYC3          (0xffff<<0) //15:0

//U3D_B2_ROSC_4
#define A60810_RG_SSUSB_RING_DET_DETWIN3          (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_RING_DET_DETWIN2          (0xffff<<0) //15:0

//U3D_B2_ROSC_5
#define A60810_RG_SSUSB_RING_DET_LBOND1           (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_RING_DET_UBOND1           (0xffff<<0) //15:0

//U3D_B2_ROSC_6
#define A60810_RG_SSUSB_RING_DET_LBOND2           (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_RING_DET_UBOND2           (0xffff<<0) //15:0

//U3D_B2_ROSC_7
#define A60810_RG_SSUSB_RING_DET_LBOND3           (0xffffU<<16) //31:16
#define A60810_RG_SSUSB_RING_DET_UBOND3           (0xffff<<0) //15:0

//U3D_B2_ROSC_8
#define A60810_RG_SSUSB_RING_RESERVE              (0xffffU<<16) //31:16
...
//U3D_B2_ROSC_9
#define A60810_RGS_FM_RING_CNT                    (0xffffU<<16) //31:16
...
//U3D_PHYD_VERSION
#define A60810_RGS_SSUSB_PHYD_VERSION             (0xffffffffU<<0) //31:0

//U3D_PHYD_MODEL
#define A60810_RGS_SSUSB_PHYD_MODEL               (0xffffffffU<<0) //31:0
...
//U3D_FMCR0
#define A60810_RG_LOCKTH                                 (0xfU<<28) //31:28
...
//U3D_FMCR1
#define A60810_RG_TARGET                                 (0xffffffffU<<0) //31:0

//U3D_FMCR2
#define A60810_RG_OFFSET                                 (0xffffffffU<<0) //31:0

//U3D_FMMONR0
#define A60810_USB_FM_OUT                                (0xffffffffU<<0) //31:0
...
//U3D_SYSPLL_0
#define A60810_RG_SSUSB_SPLL_DDSEN_CYC                   (0x1fU<<27) //31:27
...
//U3D_SYSPLL_1
#define A60810_RG_SSUSB_PLL_BIAS_CYC                     (0xffU<<24) //31:24
