...
/* U3D_reg32 */
#define RG_SSUSB_EQ_RSTEP1_PE2D            (0x3U<<30)	/* 31:30 */
...
/* U3D_B2_PHYD_RXDET2 */
#define RG_SSUSB_PHYD_TRAINDEC_FORCE_CGEN  (0x1U<<31)	/* 31:31 */
...
#define RG_SSUSB_TX_EIDLE_CM            (0xfU<<28)
...
/* U3D_SSUSB_HW_ID */
#define SSUSB_HW_ID				(0xffffffffU << 0) /* 31:0 */

/* U3D_SSUSB_HW_SUB_ID */
#define SSUSB_HW_SUB_ID				(0xffffffffU << 0) /* 31:0 */
...
/* U3D_SSUSB_PRB_CTRL1 */
#define PRB_BYTE1_SEL				(0xffffU << 16) /* 31:16 */
#define PRB_BYTE0_SEL				(0xffff << 0) /* 15:0 */

/* U3D_SSUSB_PRB_CTRL2 */
#define PRB_BYTE3_SEL				(0xffffU << 16) /* 31:16 */
#define PRB_BYTE2_SEL				(0xffff << 0) /* 15:0 */

/* U3D_SSUSB_PRB_CTRL3 */
#define PRB_BYTE3_MODULE_SEL			(0xffU << 24) /* 31:24 */
#define PRB_BYTE2_MODULE_SEL			(0xff << 16) /* 23:16 */
#define PRB_BYTE1_MODULE_SEL			(0xff << 8) /* 15:8 */
#define PRB_BYTE0_MODULE_SEL			(0xff << 0) /* 7:0 */

/* U3D_SSUSB_PRB_CTRL4 */
#define SW_PRB_OUT				(0xffffffffU << 0) /* 31:0 */

/* U3D_SSUSB_PRB_CTRL5 */
#define PRB_RD_DATA				(0xffffffffU << 0) /* 31:0 */

/* U3D_SSUSB_IP_SPARE0 */
#define SSUSB_IP_SPARE0				(0xffffffffU << 0) /* 31:0 */

/* U3D_SSUSB_IP_SPARE1 */
#define SSUSB_IP_SPARE1				(0xffffffffU << 0) /* 31:0 */
...
#define SSUSB_IP_SLV_TMOUT			(0xffffffffU << 0) /* 31:0 */
