...
static const struct auxadc_chan_spec mt6368_auxadc_chan_specs[] = {
	AUXADC_CHAN_SPEC(CHIP_TEMP, 1, 1, 32, 12, MT6368_AUXADC_RQST0, BIT(4),
			 MT6368_PMIC_AUXADC_ADC_OUT_CH4_L_ADDR),
	AUXADC_CHAN_SPEC(VCORE_TEMP, 1, 1, 32, 12, MT6368_AUXADC_RQST3, BIT(0),
			 MT6368_PMIC_AUXADC_ADC_OUT_CH4_BY_THR1_L_ADDR),
	AUXADC_CHAN_SPEC(VPROC_TEMP, 1, 1, 32, 12, MT6368_AUXADC_RQST3, BIT(1),
			 MT6368_PMIC_AUXADC_ADC_OUT_CH4_BY_THR2_L_ADDR),
	AUXADC_CHAN_SPEC(VGPU_TEMP, 1, 1, 32, 12, MT6368_AUXADC_RQST3, BIT(2),
			 MT6368_PMIC_AUXADC_ADC_OUT_CH4_BY_THR3_L_ADDR),
	AUXADC_CHAN_SPEC(ACCDET, 1, 1, 32, 12, MT6368_AUXADC_RQST0, BIT(5),
			 MT6368_PMIC_AUXADC_ADC_OUT_CH5_L_ADDR),
	AUXADC_CHAN_SPEC(HPOFS_CAL, 1, 1, 128, 15, MT6368_AUXADC_RQST1, BIT(1),
			 MT6368_PMIC_AUXADC_ADC_OUT_CH9_L_ADDR),
};
...
static struct auxadc_device mt6368_auxadc_device = {
	.name = "second_pmic",
	.chans = mt6368_auxadc_chan_specs,
	.num_chans = ARRAY_SIZE(mt6368_auxadc_chan_specs),
	.write_regs = mt6368_auxadc_write_regs,
	.read_regs = mt6368_auxadc_read_regs,
};

void mt6368_auxadc_init(void)
{
	int ret;
	...
	ret = pmic_auxadc_device_register(&mt6368_auxadc_device);
	if (ret < 0)
