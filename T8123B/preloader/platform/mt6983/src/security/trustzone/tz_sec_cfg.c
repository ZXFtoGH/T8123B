...
*/
    if (region == 0) {
        ...
        if(!enable) /*Disable*/
            ...
            DRV_SetReg32(SRAMROM_SEC_ADDR, (0x1U<<SRAMROM_SEC_ADDR_SEC3_SEC_EN));
    }
}
...
void tz_sram_sec_init(u32 start)
{
    ...
    TZ_SET_FIELD(SRAMROM_SEC_CTRL5, SRAMROM_SEC_CTRL5_SEC3_DOM1_MASK, PERMIT_S_RW_NS_RW         << SRAMROM_SEC_CTRL5_SEC3_DOM1_SHIFT);
    TZ_SET_FIELD(SRAMROM_SEC_CTRL5, SRAMROM_SEC_CTRL5_SEC3_DOM2_MASK, PERMIT_S_RW_NS_RW         << SRAMROM_SEC_CTRL5_SEC3_DOM2_SHIFT);
    TZ_SET_FIELD(SRAMROM_SEC_CTRL5, SRAMROM_SEC_CTRL5_SEC3_DOM3_MASK, PERMIT_S_RW_NS_RW         << SRAMROM_SEC_CTRL5_SEC3_DOM3_SHIFT);
    TZ_SET_FIELD(SRAMROM_SEC_CTRL6, SRAMROM_SEC_CTRL6_SEC3_DOM4_MASK, PERMIT_S_RW_NS_RW         << SRAMROM_SEC_CTRL6_SEC3_DOM4_SHIFT);
    TZ_SET_FIELD(SRAMROM_SEC_CTRL6, SRAMROM_SEC_CTRL6_SEC3_DOM5_MASK, PERMIT_S_RW_NS_RW         << SRAMROM_SEC_CTRL6_SEC3_DOM5_SHIFT);
    TZ_SET_FIELD(SRAMROM_SEC_CTRL6, SRAMROM_SEC_CTRL6_SEC3_DOM6_MASK, PERMIT_S_RW_NS_RW         << SRAMROM_SEC_CTRL6_SEC3_DOM6_SHIFT);
    TZ_SET_FIELD(SRAMROM_SEC_CTRL6, SRAMROM_SEC_CTRL6_SEC3_DOM7_MASK, PERMIT_S_RW_NS_RW         << SRAMROM_SEC_CTRL6_SEC3_DOM7_SHIFT);
