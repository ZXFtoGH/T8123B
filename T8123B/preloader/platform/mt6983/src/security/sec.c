...
u8 g_2048_oemkey[OEM_PUBK_SZ]      = {OEM_PUBK};
u8 g_3072_oemkey[OEM_3072_PUBK_SZ] = {OEM_3072_PUBK};
...
void sec_lib_init (void)
{
	...
	/* set root public key */
	seclib_set_pubk(g_2048_oemkey, OEM_PUBK_SZ);
	seclib_set_pubk(g_3072_oemkey, OEM_3072_PUBK_SZ);
#else
