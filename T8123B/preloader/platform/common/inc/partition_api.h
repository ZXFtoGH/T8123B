...
#define PART_MAX_ENTRY_SUPPORT (192)
/* macros */
/* empty */
...
ssize_t partition_read(const char *part_name, uint64_t offset,
		       uint8_t *buf, uint32_t read_sz);
ssize_t partition_write(const char *part_name, uint64_t offset,
			uint8_t *buf, uint32_t read_sz);
ssize_t partition_read_inactive(const char *part_name, uint64_t offset,
				uint8_t *buf, uint32_t read_sz);
ssize_t partition_write_inactive(const char *part_name, uint64_t offset,
				 uint8_t *buf, uint32_t read_sz);
