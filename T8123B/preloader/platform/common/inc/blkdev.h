...
struct blkdev {
    ...
    int (*erase)(blkdev_t *bdev, u64 src, u64 size, u32 part_id);
...
extern int blkdev_read64(blkdev_t *bdev, u64 src, u64 size, u8 *dst, u32 part_id);
extern int blkdev_write64(blkdev_t *bdev, u64 dst, u64 size, u8 *src, u32 part_id);
extern int blkdev_erase(blkdev_t *bdev, u64 src, u64 size, u32 part_id);
