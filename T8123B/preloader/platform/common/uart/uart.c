...
void da_mtk_serial_set_current_uart(U8 uart_id)
{
    unsigned int uart_base = UART1;
...
void mtk_uart0_init (U32 uartclk, U32 baudrate)
{
#if !CFG_FPGA_PLATFORM
...
void mtk_uart1_init (U32 uartclk, U32 baudrate)
{
#if !CFG_FPGA_PLATFORM
...
{
    mtk_uart0_init(uartclk, baudrate);
    mtk_uart1_init(uartclk, baudrate);
