...
#define EXT_CSD_PRE_EOL_INFO            267 /* R (5.0) */
#define EXT_CSD_DEVICE_LIFE_TYP_A       268 /* R (5.0) */
#define EXT_CSD_DEVICE_LIFE_TYP_B       269 /* R (5.0) */
 ...
 * MMC_ERASE arguments
 */
#define MMC_ERASE_SECURE_REQ        (1U << 31)
