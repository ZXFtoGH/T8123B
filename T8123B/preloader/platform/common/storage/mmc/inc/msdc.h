...
// to resolve 8-bytes unaligned access at the following
// msdc_emmc_hard_reset() -> MSDC_SET_BIT32(EMMC_IOCON, EMMC_IOCON_BOOTRST);
// ldr x8, [x19] where x9 is 0x1123007C
#include "stdint.h"
...
#define MSDC_WRITE32(addr, data)    mmio_write_32(addr, data)
//#define MSDC_READ32(addr)           (*(volatile uint32*)(addr))
#define MSDC_READ32(addr)           mmio_read_32(addr)
