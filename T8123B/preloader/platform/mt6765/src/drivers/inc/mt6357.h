...
#define vs1_mode_shift      PMIC_RG_VS1_MODESET_SHIFT
...
#define vproc_mode_shift      PMIC_RG_VPROC_FPWM_SHIFT
...
#define vpa_vol_mask        PMIC_RG_BUCK_VPA_VOSEL_MASK
#define vpa_vol_shift       PMIC_RG_BUCK_VPA_VOSEL_SHIFT
#define vpa_enable_reg      PMIC_RG_BUCK_VPA_EN_ADDR
#define vpa_enable_shift    PMIC_RG_BUCK_VPA_EN_SHIFT
#define vpa_mode_reg        PMIC_RG_VPA_MODESET_ADDR
#define vpa_mode_shift      PMIC_RG_VPA_MODESET_SHIFT
...
#define vpa_step_uV         50000
#define vpa_volt_type       REGULAR_VOLTAGE
#define vpa_stb             220

#define vdram_vol_reg         PMIC_RG_VDRAM_VOSEL_ADDR
#define vdram_vol_mask        PMIC_RG_VDRAM_VOSEL_MASK
#define vdram_vol_shift       PMIC_RG_VDRAM_VOSEL_SHIFT
#define vdram_enable_reg      PMIC_RG_LDO_VDRAM_EN_ADDR
#define vdram_enable_shift    PMIC_RG_LDO_VDRAM_EN_SHIFT
#define vdram_mode_reg        0
#define vdram_mode_shift      0
