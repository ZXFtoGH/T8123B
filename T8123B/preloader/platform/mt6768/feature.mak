...
ifeq ($(strip "$(CONFIG_MTK_TC10_FEATURE)"),"yes")
C_OPTION += -DCONFIG_MTK_TC10_FEATURE
export CONFIG_MTK_TC10_FEATURE

ifeq ($(strip "$(MTK_MUIC_UART_LOG_WORKAROUND)"),"yes")
C_OPTION += -DMTK_MUIC_UART_LOG_WORKAROUND
export MTK_MUIC_UART_LOG_WORKAROUND
endif
...
ifeq ("$(MT6768_REF_DEV)","yes")
C_OPTION += -DMT6768_REF_DEV="$(MT6768_REF_DEV)"
export MT6768_REF_DEV
endif

ifeq ($(strip "$(MTK_EMI_COMMON)"),"yes")
C_OPTION += -DMTK_EMI_COMMON="$(MTK_EMI_COMMON)"
export MTK_EMI_COMMON
endif

ifeq ($(strip "$(MTK_I2C_MULTI_HOST_DIS)"),"yes")
C_OPTION += -DMTK_I2C_MULTI_HOST_DIS="$(MTK_I2C_MULTI_HOST_DIS)"
export MTK_I2C_MULTI_HOST_DIS
endif

ifeq ($(strip "$(MTK_MODIFY_EH_MODE_FOR_SPI1)"),"yes")
C_OPTION += -DMTK_MODIFY_EH_MODE_FOR_SPI1="$(MTK_MODIFY_EH_MODE_FOR_SPI1)"
export MTK_MODIFY_EH_MODE_FOR_SPI1
endif
