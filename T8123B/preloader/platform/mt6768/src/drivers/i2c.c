...
int i2c_hw_init(void)
{
	...
	/*I2C0,1*/
#ifndef MTK_MODIFY_EH_MODE_FOR_SPI1
	I2C_SET_REG32((IOCFG_RB_BASE + 0x30), 0x0FFF, 0x0FFF);
#else
	I2C_SET_REG32((IOCFG_RB_BASE + 0x30), 0x0FFF, 0x0000);
	I2CLOG("[i2c]addr:0x%x,value:0x%x\n", IOCFG_RB_BASE + 0x30,
		DRV_Reg32(IOCFG_RB_BASE + 0x30));
#endif
	/*I2C2,4*/
	...
	I2CLOG("I2C shadow register enabled...\n");
#else
//	I2C_SET_REG32((I2C2_BASE_SE + OFFSET_MULTI_DMA), SHADOW_REG_MODE, (0x01<<1));
//	I2C_SET_REG32((I2C3_BASE_SE + OFFSET_MULTI_DMA), SHADOW_REG_MODE, (0x01<<1));
//	I2C_SET_REG32((I2C4_BASE_SE + OFFSET_MULTI_DMA), SHADOW_REG_MODE, (0x01<<1));
	I2CLOG("I2C shadow register disabled...\n");
#endif
...
#ifdef MT6768_REF_DEV
	I2C_SET_REG32(0x10002200, 0xfc0000, 0xfc0000);
#endif
