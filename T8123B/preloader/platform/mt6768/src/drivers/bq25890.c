...
#define BQ25890_SLAVE_ADDR	(0x6A)

static struct mt_i2c_t i2c = {
	.id = I2C0,
	.addr = BQ25890_SLAVE_ADDR,
	.mode = FS_MODE,
	.speed = 400,
};

static int bq25890_i2c_read_byte(u8 cmd, u8 *data)
{
	int ret = 0;
	u8 regval = cmd;
...
static int bq25890_i2c_write_byte(u8 cmd, u8 data)
{
	int ret = 0;
...
static int bq25890_i2c_update_bits(u8 cmd, u8 data, u8 mask)
{
	int ret = 0;
	u8 regval = 0;
	...
	return bq25890_i2c_write_byte(cmd, regval);
}
...
int mtk_ext_chgdet(CHARGER_TYPE *chg_type)
{
	...
	pal_log_info("%s, force STANDARD_HOST\n", __func__);
...
{
	int ret, part_no, revision;
	int data;

	ret = bq25890_i2c_read_byte(BQ2589X_REG_14, &data);
	if (!ret) {
...
static int bq2589x_init_device(struct bq2589x *bq)
{
	...
	ret |= bq25890_i2c_update_bits(BQ2589X_REG_02, 0, BQ2589X_HVDCPEN_MASK);
	ret |= bq25890_i2c_update_bits(BQ2589X_REG_02, 0, BQ2589X_MAXCEN_MASK);
