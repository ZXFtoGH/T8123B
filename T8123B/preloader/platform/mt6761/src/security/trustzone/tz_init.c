...
#if CFG_TEE_SUPPORT && CFG_TEE_SECURE_MEM_TAG_FORMAT
#define TEE_RESERVED_SEC_MEM_SIZE (2*1024*1024) /* 2MB */
#define TEEI_RESERVED_SEC_MEM_SIZE (2*1024*1024) /* 2MB */

static u32 tz_get_reserved_sec_mem_start(void)
{
#if CFG_TRUSTONIC_TEE_SUPPORT
    return tee_entry_addr + tee_secmem_size - TEE_RESERVED_SEC_MEM_SIZE;
#elif CFG_MICROTRUST_TEE_SUPPORT
...
#if CFG_TRUSTONIC_TEE_SUPPORT
    tbase_boot_param_prepare(TEE_BOOT_ARG_ADDR, tee_entry_addr, tee_secmem_size - TEE_RESERVED_SEC_MEM_SIZE,
