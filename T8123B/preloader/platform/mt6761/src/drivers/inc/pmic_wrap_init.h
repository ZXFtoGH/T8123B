...
#define PWRAPTAG                "[PWRAP] "
		...
		#define PWRAPFUC(fmt, arg...)   pal_log_debug(PWRAPTAG "%s\n", __func__)
		#define PWRAPLOG(fmt, arg...)   pal_log_debug(PWRAPTAG fmt, ##arg)
	#else
	...
	#define PWRAPERR(fmt, arg...)   pal_log_err(PWRAPTAG fmt, ##arg)
#elif (PMIC_WRAP_LK)
	#ifdef PMIC_WRAP_DEBUG
