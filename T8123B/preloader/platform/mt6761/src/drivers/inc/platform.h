...
extern int usb_accessory_in(void);

extern bool platform_com_wait_forever_check(void);
...
extern bool platform_is_boot_reason_valid(void);
...
extern void platform_safe_mode(int en, u32 timeout);
