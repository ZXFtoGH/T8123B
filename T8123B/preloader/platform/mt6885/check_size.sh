...
# 920 KB Preloader      : 0x0020_1000 ~ 0x002E_6FFF
# 80 KB Preloader BSS2  : 0x002E_7000 ~ 0x002F_B000
PL_START_ADDR=0x00201000
PL_END_ADDR=0x002E6FFF
...
# Keep ROM size smaller than 920 KB
# Keep ROM size smaller than 0x002E_6FFF - 0x0020_1000 - Signature
