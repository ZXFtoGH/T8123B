...
void mt_pll_init(void)
{
     ...
     * TOP CLKMUX
     *************/
    /* MT6885. At infra_ao, rg_axi_dcm_dis_en = 1 , rg_pllck_sel_no_spm = 1*/
    DRV_WriteReg32(INFRA_BUS_DCM_CTRL, DRV_Reg32(INFRA_BUS_DCM_CTRL) | (1 << 21) | (1 << 22));

    /* For MT6885 SPM request, must be initialized in preloader. */
    ...
    DRV_WriteReg32(CLK_CFG_12_CLR, 0xFFFFFFFF);
    DRV_WriteReg32(CLK_CFG_12_SET, 0x01060602);
...
#else
    /*DISP CG Clear and DCM disable 2nd revision, to meet MT6885 idle condition table */
