...
#define XO_SETTLE_TIME		0x1	/* 2^(step_sz+5) * 0x33 *30.77ns~=400us */
#define DCXO_SETTLE_TIME	0x1	/* 2^(step_sz+5) * 0x87 *30.77ns~= 1063us */
#define CENTROL_CNT_STEP	0x3	/* Fix in 3, central align with Mxx Channel */
#define DCXO_STABLE_TIME 0x70
#define XO_STABLE_TIME 0x70
