...
void RX_INTPUT_Config(DRAMC_CTX_T *p)
{
    ...
    vIO32WriteFldMulti(DRAMC_REG_ADDR(DDRPHY_REG_B0_RXDVS0)      , P_Fld(  0   , B0_RXDVS0_R_HWSAVE_MODE_ENA_B0                            ) \
                                                                 | P_Fld(  0   , B0_RXDVS0_R_DMRXDVS_CNTCMP_OPT_B0                         ) \
                                                                 | P_Fld(  1   , B0_RXDVS0_R_DMRXDVS_DQIENPRE_OPT_B0                       ) \
                                                                 | P_Fld(  1   , B0_RXDVS0_R_HWRESTORE_ENA_B0                              ));
    vIO32WriteFldMulti(DRAMC_REG_ADDR(DDRPHY_REG_B1_RXDVS0)      , P_Fld(  0   , B1_RXDVS0_R_HWSAVE_MODE_ENA_B1                            ) \
...
void DDRPHY_PICG_Config(DRAMC_CTX_T *p)
{
...
//                                                                    | P_Fld(   1             , SCHEDULER_COM_BGPIPEEN           )); //diff with IPMV2 compile error
    ...
    vIO32WriteFldMulti(DRAMC_REG_ADDR(DRAMC_REG_DQSOSCR)            , P_Fld(   1             , DQSOSCR_SREF_TXUI_RELOAD_OPT     ) \
...
void DVFS_PRE_config(DRAMC_CTX_T *p)
{
    ...
    vIO32WriteFldMulti_All(DRAMC_REG_ADDR(DDRPHY_REG_MISC_DVFSCTL2   )  , P_Fld(   1             , MISC_DVFSCTL2_R_DVFS_CDC_OPTION                  )\
                                                                    | P_Fld(   1             , MISC_DVFSCTL2_R_DVFS_DLL_CHA                     )\
