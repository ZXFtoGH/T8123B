...
#define IOCFG_BM_EH_CFG1_CLR		((IOCFG_BM_BASE+0x058))
#define IOCFG_BM_IES_CFG1_SET		((IOCFG_BM_BASE+0x074))
#define IOCFG_BM_IES_CFG1_CLR		((IOCFG_BM_BASE+0x078))
#define IOCFG_BM_PD_CFG1_CLR		((IOCFG_BM_BASE+0x098))
#define IOCFG_BM_PU_CFG1_CLR		((IOCFG_BM_BASE+0x0B8))
#define IOCFG_BM_RDSEL_CFG0_CLR		((IOCFG_BM_BASE+0x0C8))
#define IOCFG_BM_SMT_CFG0_SET		((IOCFG_BM_BASE+0x0F4))
#define IOCFG_BM_TDSEL_CFG1_CLR		((IOCFG_BM_BASE+0x128))
