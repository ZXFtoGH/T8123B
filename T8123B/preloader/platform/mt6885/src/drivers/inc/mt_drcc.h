...
#define DRCC_ARRAY_SIZE(arr)    (sizeof(arr) / sizeof((arr)[0]))
...
#define CPU4_DRCC_CFG_REG0	(DRCC_BASEADDR + 0x2290)
#define CPU4_DRCC_CFG_REG2	(DRCC_BASEADDR + 0x2298)
#define CPU4_DRCC_CFG_REG3	(DRCC_BASEADDR + 0x229C)

#define CPU5_DRCC_A0_CONFIG	(DRCC_BASEADDR + 0xBA00)
#define CPU5_DRCC_CFG_REG0	(DRCC_BASEADDR + 0x2A90)
#define CPU5_DRCC_CFG_REG2	(DRCC_BASEADDR + 0x2A98)
#define CPU5_DRCC_CFG_REG3	(DRCC_BASEADDR + 0x2A9C)

#define CPU6_DRCC_A0_CONFIG	(DRCC_BASEADDR + 0xBC00)
#define CPU6_DRCC_CFG_REG0	(DRCC_BASEADDR + 0x3290)
#define CPU6_DRCC_CFG_REG2	(DRCC_BASEADDR + 0x3298)
#define CPU6_DRCC_CFG_REG3	(DRCC_BASEADDR + 0x329C)

#define CPU7_DRCC_A0_CONFIG	(DRCC_BASEADDR + 0xBE00)
#define CPU7_DRCC_CFG_REG0	(DRCC_BASEADDR + 0x3A90)
#define CPU7_DRCC_CFG_REG2	(DRCC_BASEADDR + 0x3A98)
#define CPU7_DRCC_CFG_REG3	(DRCC_BASEADDR + 0x3A9C)
