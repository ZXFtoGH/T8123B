...
#define RC_STATE_BASE		(0x10006E00)
...
#define PMIFSPI_SLEEP_PROTECTION_CRL (PMIF_SPI_BASE + 0x03E8)
...
#define PMIFSPI_MODE_CRL (PMIF_SPI_BASE + 0x0400)
	#define PMIFSPI_MD_CTL_PMIF_RDY_MSK 0x1
	#define PMIFSPI_MD_CTL_PMIF_RDY_SHFT 11
	#define PMIFSPI_MD_CTL_SRCLK_EN_MSK 0x1
	#define PMIFSPI_MD_CTL_SRCLK_EN_SHFT 12
	#define PMIFSPI_MD_CTL_SRVOL_EN_MSK 0x1
	#define PMIFSPI_MD_CTL_SRVOL_EN_SHFT 13

#define PMIFSPMI_SLEEP_PROTECTION_CRL (PMIF_SPMI_BASE + 0x03E8)
...
#define PMIFSPMI_MODE_CRL (PMIF_SPMI_BASE + 0x0400)
	#define PMIFSPMI_MD_CTL_PMIF_RDY_MSK 0x1
	#define PMIFSPMI_MD_CTL_PMIF_RDY_SHFT 11
	#define PMIFSPMI_MD_CTL_SRCLK_EN_MSK 0x1
	#define PMIFSPMI_MD_CTL_SRCLK_EN_SHFT 12
	#define PMIFSPMI_MD_CTL_SRVOL_EN_MSK 0x1
	#define PMIFSPMI_MD_CTL_SRVOL_EN_SHFT 13
