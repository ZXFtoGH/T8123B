...
void DramCLKAlwaysOnOff(DRAMC_CTX_T *p, U8 option)
{
...
U32 TestEngineCompare(DRAMC_CTX_T *p)
{
    ...
    #define EMI_APB_BASE    0x10219000///TODO:Jeremy confirm
 ...
 * 2_BASE     1 1 1 1 1 1 1 9 8 7 6 5 4 3 2 1 0|A A A|9 8 7 6 5 4
 *            6 5 4 3 2 1 0                    |2 1 0|
 * AXI    ---------------------------------------------------------------
 * Addr:  R R R R R R R R R R R R R R R R|B B B|C C C|C C|C C C C C C C -
 *        1 1 1 1 1 1 9 8 7 6 5 4 3 2 1 0|A A A|9 8 7|H H|6 5 4 3 2 1 0
 *        5 4 3 2 1 0                    |2 1 0|     |   |
 * ----------------------------------------------------------------------
 */
#define TA2_RANK0_ADDRESS   (0x40200000)
#define AXI_CHAN_BIT_WIDTH 2//2: 4_channel 1:2_channel
...
void TA2_Test_Run_Time_HW_Presetting(DRAMC_CTX_T * p, U32 len, TA2_RKSEL_TYPE_T rksel_mode)/* Should call after TA2_Test_Run_Time_Pat_Setting() */
{
    ...
    {
        u4BaseR0 = (((u4Addr & ~0x3ff) >> (AXI_CHAN_BIT_WIDTH + 1) ) | (u4Addr & 0xff) >> 1) >> 4;// drop bit8 bit9 bit0
...
U32 TA2_Test_Run_Time_HW_Status(DRAMC_CTX_T * p)
{
    ...
    for (u1ChannelIdx = 0; u1ChannelIdx < p->support_channel_num; u1ChannelIdx++)
    {
        ...
        for (u1RankIdx = 0; u1RankIdx < p->support_rank_num; u1RankIdx++)
        {
            ...
            {
				u4Error |= u4ErrorValue & (1 << u1RankIdx);
                err_count++;
#if ENABLE_EMI_LPBK_TEST
                if (gEmiLpbkTest!=1)
#endif
...
U8 DramcMRWriteBackup(DRAMC_CTX_T *p, U8 u1MRIdx, U8 u1Rank)
{
    ...
    if (gFSPWR_Flag[u1Rank]==FSP_1)
        u2Offset+=0x30;
    else if (gFSPWR_Flag[u1Rank]==FSP_2)
        u2Offset+=0x60;
    ...
    if (is_lp5_family(p))
    {
        ...
        {
            case 1:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_00_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_00_RK0_FSP0_MR_01_01_01_RK0_FSP0_FROM_AO;
                break;
            case 2:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_00_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_00_RK0_FSP0_MR_02_02_02_RK0_FSP0_FROM_AO;
                break;
            case 3:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_00_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_00_RK0_FSP0_MR_03_03_03_RK0_FSP0_FROM_AO;
                break;
            case 9:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_00_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_00_RK0_FSP0_MR_09_04_09_RK0_FSP0_FROM_AO;
                break;
            case 10:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_01_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_01_RK0_FSP0_MR_10_10_10_RK0_FSP0_FROM_AO;
                break;
            case 11:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_01_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_01_RK0_FSP0_MR_11_11_11_RK0_FSP0_FROM_AO;
                break;
            case 13:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_01_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_01_RK0_FSP0_MR_XX_13_13_RK0_FSP0_FROM_AO;
                break;
            case 17:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_01_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_01_RK0_FSP0_MR_17_17_17_RK0_FSP0_FROM_AO;
                break;
            case 18:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_02_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_02_RK0_FSP0_MR_XX_15_18_RK0_FSP0_FROM_AO;
                break;
            case 19:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_02_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_02_RK0_FSP0_MR_16_16_19_RK0_FSP0_FROM_AO;
                break;
            case 20:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_02_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_02_RK0_FSP0_MR_41_20_20_RK0_FSP0_FROM_AO;
                break;
            case 23:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_02_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_02_RK0_FSP0_MR_42_23_23_RK0_FSP0_FROM_AO;
                break;
            case 28:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_03_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_03_RK0_FSP0_MR_XX_22_28_RK0_FSP0_FROM_AO;
                break;
            case 29:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_03_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_03_RK0_FSP0_MR_XX_24_29_RK0_FSP0_FROM_AO;
                break;
            case 31:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_03_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_03_RK0_FSP0_MR_XX_30_31_RK0_FSP0_FROM_AO;
                break;
            case 32:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_03_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_03_RK0_FSP0_MR_XX_32_32_RK0_FSP0_FROM_AO;
                break;
            case 33:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_04_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_04_RK0_FSP0_MR_XX_39_33_RK0_FSP0_FROM_AO;
                break;
            case 34:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_04_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_04_RK0_FSP0_MR_48_XX_34_RK0_FSP0_FROM_AO;
                break;
            case 37:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_04_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_04_RK0_FSP0_MR_63_XX_37_RK0_FSP0_FROM_AO;
                break;
            case 40:
                TransferReg.u4Addr = DRAMC_REG_WO_MR_BACKUP_04_RK0_FSP0+u2Offset;
                TransferReg.u4Fld = WO_MR_BACKUP_04_RK0_FSP0_MR_XX_40_40_RK0_FSP0_FROM_AO;
                break;
            default:
               u1MRBackup_ERR_Flag=1;
                mcSHOW_MRW_MSG(("  [MRW Backup] MR%d=NO BACKUP \n",u1MRIdx));
                break;
        }
    }
    else
    ...
    if (u1MRBackup_ERR_Flag==0)
    {
        ...
        mcSHOW_MRW_MSG(("  [MRW Backup] Rank%d FSP%d MR%d=0x%x\n",u1Rank, p->dram_fsp,u1MRIdx, u1Value));

        if (u1MRIdx == 13)
        {
			mcSHOW_MRW_MSG(("    Rank%d FSP%d MR%d=0x%x\n",u1Rank, 0, u1MRIdx,
						u4IO32ReadFldAlign(DRAMC_REG_ADDR(DRAMC_REG_WO_MR_BACKUP_01_RK0_FSP0), WO_MR_BACKUP_01_RK0_FSP0_MR_XX_13_13_RK0_FSP0_FROM_AO)));
			mcSHOW_MRW_MSG(("    Rank%d FSP%d MR%d=0x%x\n",u1Rank, 1, u1MRIdx,
						u4IO32ReadFldAlign(DRAMC_REG_ADDR(DRAMC_REG_WO_MR_BACKUP_01_RK0_FSP0+0x30), WO_MR_BACKUP_01_RK0_FSP0_MR_XX_13_13_RK0_FSP0_FROM_AO)));
        }
        else
        {
            if (gFSPWR_Flag[u1Rank]==FSP_1)
                TransferReg.u4Addr-=0x30;
            else if (gFSPWR_Flag[u1Rank]==FSP_2)
                TransferReg.u4Addr-=0x60;

			mcSHOW_MRW_MSG(("    Rank%d FSP%d MR%d=0x%x\n",u1Rank, 0, u1MRIdx,
						u4IO32ReadFldAlign(DRAMC_REG_ADDR(TransferReg.u4Addr), TransferReg.u4Fld)));
			mcSHOW_MRW_MSG(("    Rank%d FSP%d MR%d=0x%x\n",u1Rank, 1, u1MRIdx,
						u4IO32ReadFldAlign(DRAMC_REG_ADDR(TransferReg.u4Addr+0x30), TransferReg.u4Fld)));
        }
    }
...
void DramcModeRegWriteByRank_RTSWCMD_MRW(DRAMC_CTX_T *p, U8 u1Rank, U8 u1MRIdx, U8 u1Value)
{
	...
	if (u4TimeCnt == 0)//time out
	{
		mcSHOW_DBG_MSG(("[LP5 RT SW Cmd MRW ] Resp fail (time out) Rank=%d, MR%d=0x%x\n", u1Rank, u1MRIdx, u1Value));
	}
...
void DramcModeRegWriteByRank(DRAMC_CTX_T *p, U8 u1Rank, U8 u1MRIdx, U8 u1Value)
{
    ...
    for (u1RankIdx=u1RankStart;u1RankIdx<u1RankStart+u1RankNum;u1RankIdx++)
    {
        ...
        if (u1MRIdx==u1FSPMRIdx)
        {
            ...
            u2MRRecord[p->channel][u1RankIdx][p->dram_fsp][u1MRIdx] =u1Value;
        ...
        if(u1PrintModeRegWrite)
        {
            ...
            #endif
            #if MRW_CHECK_ONLY
            mcSHOW_MRW_MSG(("MRW CH%d Rank%d FSP%d MR%d =0x%x\n", p->channel, u1RankIdx, p->dram_fsp, u1MRIdx, u1Value));
            #endif
        ...
        U8 MR_backup;
            ...
            if (MR_backup!=0xff)
            mcSHOW_MRW_MSG(("  [MRW Check] Rank%d FSP%d Backup_MR%d= 0x%x MR%d= 0x%x ==>%s\n", u1RankIdx, p->dram_fsp, u1MRIdx, MR_backup, u1MRIdx, u1Value, (u1Value==MR_backup?"PASS":"FAIL")));
...
U8 DramcDBGIRQOnOff(DRAMC_CTX_T *p, U8 OnOff)
{
	U8 val;

	val = (OnOff == ENABLE) ? 1 : 0;

	/* DRAMC IRQ switch */
    vIO32WriteFldMulti_All(DRAMC_REG_DRAMC_IRQ_EN,
#if ENABLE_REFRESH_RATE_DEBOUNCE
		P_Fld(val, DRAMC_IRQ_EN_MR4INT_EN) |
		P_Fld(val, DRAMC_IRQ_EN_PRE_MR4INT_EN) |
#endif
#if ENABLE_TX_TRACKING
		P_Fld(val, DRAMC_IRQ_EN_TX_TRACKING_INT1_EN) |
		P_Fld(val, DRAMC_IRQ_EN_TX_TRACKING_INT2_EN) |
#endif
		P_Fld(val, DRAMC_IRQ_EN_INT_SREF_REQ_NO_ACK_EN) |
		P_Fld(val, DRAMC_IRQ_EN_INT_SREF_REQ_SHORT_EN));

	/* DRAMC IRQ switch on DDRPHY */
	vIO32WriteFldMulti_All(DDRPHY_REG_MISC_DBG_IRQ_CTRL1,
#if ENABLE_REFRESH_RATE_DEBOUNCE
		P_Fld(val, MISC_DBG_IRQ_CTRL1_REFRATE_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL1_PRE_REFRATE_EN) |
#endif
#if ENABLE_TX_TRACKING
		P_Fld(val, MISC_DBG_IRQ_CTRL1_TX_TRACKING1_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL1_TX_TRACKING2_EN) |
#endif
		P_Fld(val, MISC_DBG_IRQ_CTRL1_SREF_REQ_NO_ACK_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL1_SREF_REQ_SHORT_EN));

#ifdef HW_GATING
	vIO32WriteFldMulti_All(DDRPHY_REG_MISC_DBG_IRQ_CTRL7,
		P_Fld(val, MISC_DBG_IRQ_CTRL7_PI_TRACKING_WAR_RK1_B0_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL7_PI_TRACKING_WAR_RK0_B0_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL7_PI_TRACKING_WAR_RK1_B1_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL7_PI_TRACKING_WAR_RK0_B1_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL7_STB_GATTING_ERR_EN));
#endif

#if ENABLE_RX_FIFO_MISMATCH_DEBUG
	vIO32WriteFldMulti_All(DDRPHY_REG_MISC_DBG_IRQ_CTRL7,
		P_Fld(val, MISC_DBG_IRQ_CTRL7_RX_ARDQ0_FIFO_STBEN_ERR_B0_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL7_RX_ARDQ4_FIFO_STBEN_ERR_B0_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL7_RX_ARDQ0_FIFO_STBEN_ERR_B1_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL7_RX_ARDQ4_FIFO_STBEN_ERR_B1_EN));
#endif

#if ENABLE_RX_TRACKING
	vIO32WriteFldMulti_All(DDRPHY_REG_MISC_DBG_IRQ_CTRL7,
		P_Fld(val, MISC_DBG_IRQ_CTRL7_TRACKING_STATUS_ERR_RISING_R1_B1_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL7_TRACKING_STATUS_ERR_RISING_R1_B0_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL7_TRACKING_STATUS_ERR_RISING_R0_B1_EN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL7_TRACKING_STATUS_ERR_RISING_R0_B0_EN));
#endif

#if 0//ENABLE_TX_TRACKING
	/* workaround to clear tx tracking irq at first */
	vIO32WriteFldMulti_All(DDRPHY_REG_MISC_DBG_IRQ_CTRL3,
		P_Fld(val, MISC_DBG_IRQ_CTRL3_TX_TRACKING1_CLEAN) |
		P_Fld(val, MISC_DBG_IRQ_CTRL3_TX_TRACKING2_CLEAN));
#endif
	return 0;
}
