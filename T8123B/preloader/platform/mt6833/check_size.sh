# L3 Cache Share SRAM contains:
# 4 KB GFH              : 0x0020_0000 ~ 0x0020_1000
# 444 KB Preloader      : 0x0020_1000 ~ 0x0026_FFFF
# 64 KB Preloader BSS2  : 0x0027_0000 ~ 0x0027_FFFF
PL_START_ADDR=0x00201000
PL_END_ADDR=0x0026FFFF

# Preloader BSS is splitted into bss1 and bss2. Both bss sections cannot be
# overwritten.
PL_MAX_RAM_SIZE=65536

# Keep ROM size smaller than 0x0026_FFFF - 0x0020_1000 - Signature
