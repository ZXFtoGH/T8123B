...
ifeq ($(strip "$(MTK_LP4X_HIGHSET_DDR3733)"),"yes")
    C_OPTION += -DMTK_LP4X_HIGHSET_DDR3733
endif

ifeq ($(strip "$(MTK_LP4X_HIGHSET_DDR4266)"),"yes")
    C_OPTION += -DMTK_LP4X_HIGHSET_DDR4266
endif
...
ifdef CFG_BL2_EXT_MEMADDR
C_OPTION += -DCFG_BL2_EXT_MEMADDR="$(CFG_BL2_EXT_MEMADDR)"
export CFG_BL2_EXT_MEMADDR
endif
...
ifdef CFG_LOAD_SLT_DPM
C_OPTION += -DCFG_LOAD_SLT_DPM="$(CFG_LOAD_SLT_DPM)"
export CFG_LOAD_SLT_DPM
endif
...
ifeq ($(strip "$(MTK_MT6362_SUPPORT)"),"yes")
    C_OPTION += -DMTK_SUBPMIC_SUPPORT

    ifeq ($(strip "$(MTK_MT6362_LPSD_RST)"),"yes")
        C_OPTION += -DMTK_MT6362_LPSD_RST
    endif

    ifeq ($(strip "$(MTK_MT6362_SDCARD_DET)"),"yes")
        C_OPTION += -DMTK_MT6362_SDCARD_DET
    endif

    ifeq ($(strip "$(MTK_MT6362_CHRIND)"),"yes")
        C_OPTION += -DMTK_MT6362_CHRIND
    endif
endif

ifeq ($(strip "$(MTK_5G_B_MT6360_MT6315)"),"yes")
    C_OPTION += -DMTK_5G_B_MT6360_MT6315
endif
...
ifeq ($(strip "$(MTK_FIX_DRAM_SIZE)"),"yes")
C_OPTION += -DMTK_FIX_DRAM_SIZE
endif
...
ifeq ("$(TFA_AS_BL31)","yes")
C_OPTION += -DTFA_AS_BL31="$(TFA_AS_BL31)"
export TFA_AS_BL31
endif
...
ifeq ($(strip "$(MTK_TB_WIFI_ONLY)"),"yes")
C_OPTION += -DMTK_TB_WIFI_ONLY
endif
