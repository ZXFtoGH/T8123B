...
U32 efuse_vcore_blow(void)
{
	...
	//MT6873: follow MT6885 do not set vsram_others
	/* ---------- Control the vsram_others ---------- */
	/* Required to set VSRAM to 0.85V in MT6873 because VSRAM must be 0.1V higher than VCORE */
