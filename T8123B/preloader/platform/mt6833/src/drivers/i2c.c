	...
	U32 *timing_sample_cnt)
{
	...
	/* Just for MT6761/MT6762/MT6765/MT6833 */
...
static void i2c_set_driving(void)
{
	...
	/* SDA0[11:9]  SCL0[2:0]*/
	I2C_SET_REG32((IOCFG_BL_BASE + 0x50), (7 << 9 | 7), (7 << 9 | 7));
	/*SCL1[11:9]  SDA1[14:12]*/
	I2C_SET_REG32((IOCFG_BM_BASE + 0x70), (7 << 9 | 7 << 12), (7 << 9 | 7 << 12));
	/*SDA2[29:27]  SCL2[17:15]*/
	I2C_SET_REG32((IOCFG_BM_BASE + 0x60), (7 << 27 | 7 << 15), (7 << 27 | 7 << 15));
	/*SDA3[5:3]  SCL3[2:0]*/
	I2C_SET_REG32((IOCFG_RT_BASE + 0x40), 0x3F, 0x3F);
	/*SDA4[17:15]*/
	I2C_SET_REG32((IOCFG_BM_BASE + 0x70), 7, 7);
	/*SCL4[20:18]*/
	I2C_SET_REG32((IOCFG_BM_BASE + 0x60), (7 << 18), (7 << 18));
	/*SDA5[14:12]  SCL5[5:3]*/
	I2C_SET_REG32((IOCFG_BL_BASE + 0x50), (7 << 12 | 7 << 3), (7 << 12 | 7 << 3));
	/*SDA6[5:3]  SCL6[2:0]*/
	I2C_SET_REG32((IOCFG_LM_BASE + 0x30), 0x3F, 0x3F);
	/*SDA7[17:15]  SCL7[8:6]*/
	I2C_SET_REG32((IOCFG_BL_BASE + 0x50), (7 << 15 | 7 << 6), (7 << 15 | 7 << 6));
	/*SCL8[23:21]*/
	I2C_SET_REG32((IOCFG_BM_BASE + 0x60), (7 << 21), (7 << 21));
	/*SDA8[5:3]*/
	I2C_SET_REG32((IOCFG_BM_BASE + 0x70), (7 << 3), (7 << 3));
	/*SCL9[26:24]*/
	I2C_SET_REG32((IOCFG_BM_BASE + 0x60), (7 << 24), (7 << 24));
	/*SDA9[8:6]*/
	I2C_SET_REG32((IOCFG_BM_BASE + 0x70), (7 << 6), (7 << 6));
}
...
static void internal_resister_setting(void)
{
	...
	/* 0x2:15k 0x3:1k */
	/*I2C7,5,0*/
	I2C_SET_REG32(IOCFG_BL_BASE + 0x110, 0x3FFFF,
		7 << 15 | 7 << 12 | 7 << 9 | 7 << 6 | 7 << 3 | 7);
	/*I2C2,4,8,9,1*/
	I2C_SET_REG32(IOCFG_BM_BASE + 0x170, 0x3FFFFFFF,
		7 << 27 | 7 << 24 | 7 << 21 | 7 << 18 | 7 << 15 | 7 << 12 | 7 << 9 | 7 << 6 | 7 << 3 | 7);
	/*I2C3*/
	I2C_SET_REG32(IOCFG_RT_BASE + 0xD0, 0x3F, 7 << 3 | 7);
	/*I2C6*/
	I2C_SET_REG32(IOCFG_LM_BASE + 0xE0, 0x3F, 7 << 3 | 7);
}
#endif
