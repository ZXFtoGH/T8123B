...
#define SPMI_SCL_DRV_ADDR		(IOCFG_BL_BASE+0x0030)
#define SPMI_SDA_DRV_ADDR		(IOCFG_BL_BASE+0x0030)
#define SPMI_SCL_DRV_OFFSET		(9)
#define SPMI_SDA_DRV_OFFSET		(12)
#define SPMI_SCL_P_DRV_OFFSET		(15)
#define SPMI_SDA_P_DRV_OFFSET		(18)
