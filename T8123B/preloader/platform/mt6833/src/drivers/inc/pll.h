...
/* for MT6833 DISP/MDP MTCMOS on/off APIs  */
...
#define APLL1_TUNER_CON0	(APMIXED_BASE + 0x040)
#define APLL2_TUNER_CON0	(APMIXED_BASE + 0x044)
...
#define USBPLL_CON1		(APMIXED_BASE + 0x3C8)
...
#define INFRA_MCU2EMI_SLICE_CTRL		(INFRACFG_AO_MEM_BASE + 0x54)
#define INFRA_MCU2EMI_SLICE_M0		(INFRACFG_AO_MEM_BASE + 0x58)
#define INFRA_MCU2EMI_SLICE_M1		(INFRACFG_AO_MEM_BASE + 0x5C)
...
#define MDPSYS_CG_CON0		(MDPSYS_CONFIG_BASE + 0x100)
#define MDPSYS_CG_SET0		(MDPSYS_CONFIG_BASE + 0x104)
#define MDPSYS_CG_CLR0		(MDPSYS_CONFIG_BASE + 0x108)

/* SCP Register */
#define ADSP_SW_CG		(SCP_BASE + 0x20180)
