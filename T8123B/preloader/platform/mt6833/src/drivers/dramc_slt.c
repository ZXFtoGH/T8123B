...
DRAM_DVFS_TABLE_T slt_gDVFSTbl[] = {
    //0.725V
    {LP4_DDR800,  SRAM_SHU6, 550000},
    {LP4_DDR1600, SRAM_SHU4, 550000},
#ifdef SLT_2400_EXIT_PRELOADER
    {LP4_DDR2400, SRAM_SHU0, 600000},
    {LP4_DDR3200, SRAM_SHU1, 650000},    //fra, Mou_ton test 3200 but 2400 exit
    {LP4_DDR3200, SRAM_SHU1, 725000},
    {LP4_DDR2400, SRAM_SHU0, 725000},
#else
    {LP4_DDR2400, SRAM_SHU2, 600000},
//fra Mou_ton can't run 4266 on socket    {LP4_DDR4266, DIV8_MODE, SRAM_SHU1, 725000},
    {LP4_DDR2400, SRAM_SHU2, 650000},
    {LP4_DDR3200, SRAM_SHU0, 650000},
    {LP4_DDR3200, SRAM_SHU0, 725000},
#endif
};
#endif
...
void O1Path_Test(DRAMC_CTX_T * p)
{
    ...
    for (channel_idx = CHANNEL_A; channel_idx < p->support_channel_num; channel_idx++)
    {
        ...
        U32 u4RegBackupAddress[] =
        {
            ...
            (DRAMC_REG_ADDR(DDRPHY_REG_CA_LP_CTRL0)),
            (DRAMC_REG_ADDR(DDRPHY_REG_CA_TX_ARCS_CTRL)),
            (DRAMC_REG_ADDR(DDRPHY_REG_CA_TX_ARDQ_CTRL)),
        ...
        vIO32WriteFldAlign(DRAMC_REG_ADDR(DDRPHY_REG_CA_CMD6), 1, CA_CMD6_RG_RX_ARCMD_RES_BIAS_EN);

        vIO32WriteFldMulti(DRAMC_REG_ADDR(DDRPHY_REG_CA_LP_CTRL0),
                            P_Fld(0, CA_LP_CTRL0_RG_TX_ARCA_PULL_UP_LP_SEL) |
                            P_Fld(0, CA_LP_CTRL0_RG_TX_ARCA_PULL_DN_LP_SEL) |
                            P_Fld(0, CA_LP_CTRL0_RG_TX_ARCS_PULL_UP_LP_SEL) |
                            P_Fld(0, CA_LP_CTRL0_RG_TX_ARCS_PULL_DN_LP_SEL));
        ...
        vIO32WriteFldMulti(DRAMC_REG_ADDR(DDRPHY_REG_CA_CMD2),
                            ...
                            P_Fld(0, CA_CMD2_RG_TX_ARCS_OE_TIE_EN_CA) |
                            P_Fld(0, CA_CMD2_RG_TX_ARCS_OE_TIE_SEL_CA));

        vIO32WriteFldAlign(DRAMC_REG_ADDR(DDRPHY_REG_CA_TX_ARCS_CTRL), 0, CA_TX_ARCS_CTRL_RG_TX_ARCS_OE_TIE_SEL_C0);

        vIO32WriteFldMulti(DRAMC_REG_ADDR(DDRPHY_REG_CA_TX_ARDQ_CTRL),
                            P_Fld(0, CA_TX_ARDQ_CTRL_RG_TX_ARDQ6_OE_TIE_EN_C0) |
                            P_Fld(0, CA_TX_ARDQ_CTRL_RG_TX_ARDQ7_OE_TIE_EN_C0));
        ...
        vIO32WriteFldMulti_All((DDRPHY_REG_B0_DQ2), P_Fld(0x1, B0_DQ2_RG_TX_ARDQ_OE_DIS_B0) | P_Fld(0x1, B0_DQ2_RG_TX_ARDQM0_OE_DIS_B0));
        vIO32WriteFldMulti_All((DDRPHY_REG_B1_DQ2), P_Fld(0x1, B1_DQ2_RG_TX_ARDQ_OE_DIS_B1) | P_Fld(0x1, B1_DQ2_RG_TX_ARDQM0_OE_DIS_B1));
        vIO32WriteFldMulti_All((DDRPHY_REG_CA_CMD2), P_Fld(0x1, CA_CMD2_RG_TX_ARCMD_OE_DIS_CA) | P_Fld(0x1, CA_CMD2_RG_TX_ARCLK_OE_DIS_CA));

        // Leo: R_DM_TX_ARCMD_OE & R_DM_TX_ARCLK_OE set to 0
        vIO32WriteFldMulti(DRAMC_REG_ADDR(DDRPHY_REG_MISC_CTRL1), P_Fld(0x0, MISC_CTRL1_R_DM_TX_ARCMD_OE) | P_Fld(0x0, MISC_CTRL1_R_DM_TX_ARCLK_OE));
        ...
        vIO32WriteFldMulti(DRAMC_REG_ADDR(DDRPHY_REG_CA_CMD7), P_Fld(0x1, CA_CMD7_RG_TX_ARCMD_PULL_DN) |
                                                               ...
                                                               P_Fld(0x1, CA_CMD7_RG_TX_ARCS1_PULL_DN) |
                                                               P_Fld(0x1, CA_CMD7_RG_TX_ARCLK_PULL_DN));

        vIO32WriteFldAlign(DRAMC_REG_ADDR(DDRPHY_REG_CA_TX_ARCS_CTRL), 0x1, CA_TX_ARCS_CTRL_RG_TX_ARCS_PULL_DN_C0);
        mcDELAY_US(1);
...
//fra        if (u4dq_o1 != 0 || u4ca_o1 != 0) //refer to RG coda field
        ...
        vIO32WriteFldMulti(DRAMC_REG_ADDR(DDRPHY_REG_CA_CMD7), P_Fld(0x0, CA_CMD7_RG_TX_ARCMD_PULL_DN) |
                                                          ...
                                                          P_Fld(0x0, CA_CMD7_RG_TX_ARCS1_PULL_DN) |
                                                          P_Fld(0x0, CA_CMD7_RG_TX_ARCLK_PULL_DN) |
                                                          P_Fld(0x1, CA_CMD7_RG_TX_ARCMD_PULL_UP) |
                                                          P_Fld(0x1, CA_CMD7_RG_TX_ARCS0_PULL_UP) |
                                                          P_Fld(0x1, CA_CMD7_RG_TX_ARCS1_PULL_UP) |
                                                          P_Fld(0x1, CA_CMD7_RG_TX_ARCLK_PULL_UP));

        vIO32WriteFldMulti(DRAMC_REG_ADDR(DDRPHY_REG_CA_TX_ARCS_CTRL), P_Fld(0x0, CA_TX_ARCS_CTRL_RG_TX_ARCS_PULL_DN_C0) |
                                                          P_Fld(0x1, CA_TX_ARCS_CTRL_RG_TX_ARCS_PULL_UP_C0));
        mcDELAY_US(1);
...
//fra        if (u4dq_o1 != 0x1FF01FF || u4ca_o1 != 0x60FF) //refer to RG coda field
        if (u4dq_o1 != 0x7FF01FF || u4ca_o1 != 0x160FF) //refer to RG coda field
        {
            u4fail_up = 1;
        }
        mcSHOW_ERR_MSG(("[O1Path] CH_%d PULL UP=1, DQ-DQM O1=0x%x (%s), CS-CKE-CA O1=0x%x (%s)\n",channel_idx,u4dq_o1,(u4dq_o1==0x7FF01FF)?"pass":"fail",u4ca_o1,(u4ca_o1==0x160FF)?"pass":"fail"));
...
for(ii=0;ii<64;ii+=4) // Tx DQ or DQS dly scan: 0~63 to scan rx win
{
            ...
            if (K_win)
            {
                ...
                //set RG_TX_ARDQ_LPBK_SEL_B0/B1/CA for internal lpbk pattern @ Pal_mer
...
if (shu_num>1)
{
        ...
        DPMInit(p); //#define DRAMC_DFS_MODE 1 // 0:Legacy, 1:DPM RG, 2: PHY RG, 3: DPM PST
        //go_ahead(0,0,0);
...
#if FREQ_METER
                Final_Result &= DFS_Freq_Meter_Check(p, DDRPhyFreqMeter(p));
#endif
            }
        }
    }
...
/*
    ...
    for (u1ShuIdx = s1ShuStart; u1ShuIdx >= s1ShuEnd; u1ShuIdx--)
    {
        ...
        if (u1ShuIdx == 5) continue; //skip scan 1200
        if (u1ShuIdx == 4) continue; //skip scan 1800
