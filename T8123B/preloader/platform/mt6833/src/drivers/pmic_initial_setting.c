...
static struct pmic_setting init_setting[] = {
	...
	{0xA3C, 0x1E00, 0x1F00, 0},
	{0xA3E, 0xBC1, 0x7FFF, 0},
	{0xA40, 0x4BBD, 0x7FFF, 0},
	{0xA42, 0x401B, 0x7FFF, 0},
	{0xA44, 0x52B3, 0x7FFF, 0},
	{0xA46, 0x5739, 0x7FFF, 0},
	{0xA48, 0x7AF6, 0x7FFF, 0},
	{0xA4A, 0x6F98, 0x7FFF, 0},
	{0xA4C, 0x635B, 0x7FFF, 0},
	{0xA4E, 0x7BBC, 0x7FFF, 0},
	{0xA50, 0x280, 0x7FFF, 0},
	...
	{0xA3E, 0xBC1, 0x7FFF, 0},
	{0xA40, 0x4BBD, 0x7FFF, 0},
	{0xA42, 0x439E, 0x7FFF, 0},
	{0xA44, 0x52B3, 0x7FFF, 0},
	{0xA46, 0x5739, 0x7FFF, 0},
	{0xA48, 0x5EF6, 0x7FFF, 0},
	{0xA4A, 0x6F98, 0x7FFF, 0},
	{0xA4C, 0x635B, 0x7FFF, 0},
	{0xA4E, 0x7BBC, 0x7FFF, 0},
	{0xA50, 0x280, 0x7FFF, 0},
...
static void doe_load(void)
{
	...
	if (vproc1_rrate) {
		pmic_config_interface(PMIC_RG_BUCK_VGPU11_SFCHG_RRATE_ADDR,
	...
	if (vproc1_frate) {
		pmic_config_interface(PMIC_RG_BUCK_VGPU11_SFCHG_FRATE_ADDR,
...
#else
		pmic_config_interface(PMIC_RG_BUCK_VMODEM_SFCHG_RRATE_ADDR,
				      162500 / vproc2_rrate / 1000 - 1,
...
#else
		pmic_config_interface(PMIC_RG_BUCK_VMODEM_SFCHG_FRATE_ADDR,
				      162500 / vproc2_frate / 1000 - 1,
...
{
#ifdef MTK_5G_B_MT6360_MT6315
	/* VRF09 use MT6359 VMODEM in MT6833 */
	...
	/* VRF13 use MT6360 VBUCK2 in MT6833 */
#else
	/* VRF09 use MT6362 VBUCK5 in MT6833 */
	/* VRF13 use MT6362 VBUCK6 in MT6833 */
#endif
	/* VRF18 use VRF18 in MT6833 */
...
void pmic_default_voltage(void)
{
	...
	int vproc1_vol = 600000;
	int vproc2_vol = 706250;
	int vsram_proc1_vol;
	int vsram_proc2_vol;
	int vsram_gpu_vol = 850000;
	int vgpu_vol = 850000;
...
static void mt6359_code_check(void)
{
	...
	if (code != 0x3) {
#endif
		pal_log_info("MT6359 PF_CODE=%d is wrong for MT6833\n", code);
		ASSERT(0);
	}
}
...
void pmic_init_setting(void)
{
	...
	pal_log_info("[PMIC] pmic_init_setting end. v200416\n");
