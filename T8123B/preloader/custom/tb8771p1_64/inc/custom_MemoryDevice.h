...
#define BOARD_ID                MT6833_EVB

#define CS_PART_NUMBER[0]       H9HQ16AFAMMDAR
#define CS_PART_NUMBER[1]       KM8V8001JM_B813
#define CS_PART_NUMBER[2]       H9HQ16AFAMMDAR_DIS
#define CS_PART_NUMBER[3]       MT29VZZZBD9GQFPR_046W_9Q9

#define CS_PART_NUMBER[4]       H9HQ15AFAMBDAR
#define CS_PART_NUMBER[5]       MT29VZZZCD9GQKPR_046W_12L
#define CS_PART_NUMBER[6]       KM2V8001CM_B707
#define CS_PART_NUMBER[7]       H9HCNNNFAMMLXR
