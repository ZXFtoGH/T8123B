...
#define BOARD_ID                MT8185_EVB

#define CS_PART_NUMBER[0]	MT29VZZZAD8FQFSL_046W_G8K
#define CS_PART_NUMBER[1]	MT29VZZZAD9FQFSM_046W_G9K
#define CS_PART_NUMBER[2]	KM5P8001DM_B424
#define CS_PART_NUMBER[3]	KM5V8001DM_B622
#define CS_PART_NUMBER[4]	MT29VZZZBDAFQKWL_046W_G0J
#define CS_PART_NUMBER[5]	KM2F8001CM_B707
#define CS_PART_NUMBER[6]	H9HQ15ACPMADAR
#define CS_PART_NUMBER[7]	K4U6E3S4AA_MGCL
#define CS_PART_NUMBER[8]	K4UBE3D4AA_MGCL
#define CS_PART_NUMBER[9]	H9HCNNNCPMMLXR_NEE
