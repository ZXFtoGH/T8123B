...
ifneq (,$(findstring cert_chain,$(PADDING_TYPE)))
	...
	@echo "plext = " $(PLEXT_FILE)
ifeq ($(PLEXT_FILE_EXIST),TRUE)
	@echo "Include Bootloader Extension"
	PYTHONDONTWRITEBYTECODE=True python $(PBP_TOOL) -i $(CHIP_KEY) -k ${PRELOADER_OUT}/key_cert.bin -g $(GFH_PATH)/pl_gfh_config_cert_chain.ini -c ${KEY_PATH}/pl_content.ini -func sign -o $@  -blext $(PLEXT_FILE) $(D_BIN)/$(PL_IMAGE_NAME)_NO_GFH.bin
else
