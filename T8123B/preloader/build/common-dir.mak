...
$(2): $(3) FORCE
	$$(MAKE) -e -r -C $(1) --no-print-directory OBJ_PATH=$(4) DA_BUILD_STAGE=$(5) DA_MODE=$(6) PL_CODE=$(7)
endef
...
$(foreach d,$(SUBDIRS),\
  ...
  $(eval t := $(OBJ_PATH)/$(subst /,_,$(r)).flag)\
  $(eval $(call build-subdirs,$(d),$(t),$(ALL_PREGEN_FILE),$(OBJ_PATH),$(DA_BUILD_STAGE),$(DA_MODE),$(PL_CODE)))\
