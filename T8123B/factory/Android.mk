...
# touch panel ata test by mtk method (use node: mtk-kpd/mtk-kpd2)
ifeq ($(LINUX_KERNEL_VERSION), $(filter $(LINUX_KERNEL_VERSION), kernel-5.10))
LOCAL_CFLAGS += -DTOUCH_FACTORY_TEST_BY_MTK_METHOD
endif
...
TEST_SRC_FILES := \
	...
	src/test/ftm_irtx_led_test.c \
        ...
        src/test/ftm_keybox.cpp \
		src/test/ftm_ntc.cpp \
        src/test/ftm_gms_info.cpp \
        src/test/ftm_hall.cpp
#	src/test/ftm_dcdc.cpp 
...
ifeq ($(MTK_MT7902_ATA_TEST), yes)
LOCAL_CFLAGS += -DMTK_MT7902_ATA_TEST
endif
...
ifeq ($(MTK_PLATFORM), $(filter $(MTK_PLATFORM), MT6771))
TEST_SRC_FILES += src/test/ftm_battery.c
else
TEST_SRC_FILES += src/test/ftm_battery_gki.cpp
endif
...
LOCAL_CFLAGS += -DFEATURE_FTM_NTC
LOCAL_CFLAGS += -DFEATURE_FTM_KEYBOX
#LOCAL_CFLAGS += -DFEATURE_FTM_DCDC
LOCAL_CFLAGS += -DFEATURE_FTM_USB_TYPEC
LOCAL_CFLAGS += -DFEATURE_FTM_HALL
