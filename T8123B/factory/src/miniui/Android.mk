...
LOCAL_SRC_FILES := miniui.c graphics.cpp events.c resources.c graphics_drm.cpp uistrings.c
...
ifndef MTK_GENERIC_HAL
	...
	LOCAL_CUST_INC_PATH := $(LOCAL_PATH)/../../inc/cust
...
LOCAL_C_INCLUDES +=\
    ...
    external/zlib\
    $(LOCAL_PATH)/../../inc \
    $(LOCAL_PATH)/../../inc/pixelflinger \
    $(LOCAL_CUST_INC_PATH) \
 
LOCAL_SHARED_LIBRARIES += libpixelflinger libpng libutils liblog libcutils libdrm libbase
