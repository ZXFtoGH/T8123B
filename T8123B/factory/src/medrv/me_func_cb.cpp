...
URCTABLE urc_proc_t[] = 
{
  ...
  {ID_VPON,		ME_URC_VPON_Parser},
  {ID_EUSIM,		ME_URC_EUSIM_Parser},
  {ID_UIMST,		ME_URC_UIMST_Parser},
	{ID_MAX, NULL}
};
...
void ME_Query_3G_Status_CB(void *pData)
{
	ME_Singleline_Response_Parser(pData, ME_Query_3G_Status_Parser);
}
