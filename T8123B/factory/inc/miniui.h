...
#define UNAVAIL_ROW 1
#define CHAR_WIDTH_ITEM   CHAR_WIDTH
#define CHAR_HEIGHT_ITEM  CHAR_HEIGHT
#else
#define UNAVAIL_ROW 3
#endif
...
extern int g_CBTN;
/* key definition */
#define UI_KEY_DOWN     KEY_DOWN
#define UI_KEY_VOLDOWN  KEY_VOLUMEDOWN
#define UI_KEY_UP       KEY_UP
#ifdef FEATURE_FTM_EVB
#define UI_KEY_VOLUP    KEY_VOLUMEUP
#define UI_KEY_CONFIRM  KEY_HOME
#define UI_KEY_BACK     KEY_BACK
#else
#define UI_KEY_VOLUP KEY_BACK
#define UI_KEY_CONFIRM  KEY_POWER
#define UI_KEY_BACK     KEY_VOLUMEUP
#endif
#define UI_KEY_CENTER   KEY_HOME
#define UI_KEY_LEFT     KEY_MENU
#define UI_KEY_RIGHT    KEY_BACK
...
struct itemview {
    ...
    int (*set_btn)(struct itemview *iv, text_t *left, text_t *center, text_t *right);
