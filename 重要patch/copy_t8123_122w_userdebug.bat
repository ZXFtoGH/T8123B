...
set project_name=t8123_l40mmeiw_T122_64
...
set out_path=\\192.168.2.170\软件部\临时文件\zhangxiangfei\T8123_T122\merged
set out_path_sub=\\192.168.2.170\软件部\临时文件\zhangxiangfei\T8123_T122\merged\download_agent
...
copy  %source_path%\preloader_t8123_l40mmeiw_T122_64.bin %out_path%\ /y
